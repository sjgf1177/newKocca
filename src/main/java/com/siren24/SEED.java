...
public final class SEED extends BlockCipher
{
    ...
    protected void initialize(byte key[], AlgorithmParameterSpec params)
    ...
    private static final int[] bytesToInts(byte bytes[], int offset, int length)
    {
        ...
        for(int j = 0; j < length; j++)
            retval[j / 4] += (bytes[j + offset] & 0xff) << 8 * ((3 - j) % 4);
    ...
    private void seedkey(byte keyBlock[], boolean encrypting, int KnL[])
    {
        ...
        {
            temp = 0L;
            temp |= (long)keyBlock[i] & 255L;
            A[0] = A[0] << 8;
            A[0] |= temp;
            temp = 0L;
            temp |= (long)keyBlock[i + 4] & 255L;
            B[0] = B[0] << 8;
            B[0] |= temp;
            temp = 0L;
            temp |= (long)keyBlock[i + 8] & 255L;
            C[0] = C[0] << 8;
            C[0] |= temp;
            temp = 0L;
            temp |= (long)keyBlock[i + 12] & 255L;
            D[0] = D[0] << 8;
            D[0] |= temp;
        }
        ...
        if(KC[0] < 0)
        {
            temp = KC[0] & 0x7fffffff;
            temp |= 0xffffffff80000000L;
        } else
        {
            temp = KC[0];
        }
        long T0 = (A[0] + C[0]) - temp;
        long T1 = (B[0] - D[0]) + temp;
        if(encrypting)
        {
            KnL[0] = SS0[(short)(int)(255L & T0)] ^ SS1[(short)(int)(255L & T0 >>> 8)] ^ SS2[(short)(int)(255L & T0 >>> 16)] ^ SS3[(short)(int)(255L & T0 >>> 24)];
            KnL[1] = SS0[(short)(int)(255L & T1)] ^ SS1[(short)(int)(255L & T1 >>> 8)] ^ SS2[(short)(int)(255L & T1 >>> 16)] ^ SS3[(short)(int)(255L & T1 >>> 24)];
        } else
        {
            KnL[30] = SS0[(short)(int)(255L & T0)] ^ SS1[(short)(int)(255L & T0 >>> 8)] ^ SS2[(short)(int)(255L & T0 >>> 16)] ^ SS3[(short)(int)(255L & T0 >>> 24)];
            KnL[31] = SS0[(short)(int)(255L & T1)] ^ SS1[(short)(int)(255L & T1 >>> 8)] ^ SS2[(short)(int)(255L & T1 >>> 16)] ^ SS3[(short)(int)(255L & T1 >>> 24)];
        }
    ...
    {
        long T0 = A[0];
        A[0] = A[0] >>> 8 & 0xffffffL | B[0] << 24 & 0xffffffffff000000L;
        B[0] = B[0] >>> 8 & 0xffffffL | T0 << 24 & 0xffffffffff000000L;
        long temp;
        if(KC[i] < 0)
        {
            temp = KC[i] & 0x7fffffff;
            temp |= 0xffffffff80000000L;
        } else
        {
            temp = KC[i];
        ...
        T0 = (A[0] + C[0]) - temp;
        long T1 = (B[0] + temp) - D[0];
        if(encrypting)
        {
            KnL[i * 2] = SS0[(short)(int)(255L & T0)] ^ SS1[(short)(int)(255L & T0 >>> 8)] ^ SS2[(short)(int)(255L & T0 >>> 16)] ^ SS3[(short)(int)(255L & T0 >>> 24)];
            KnL[i * 2 + 1] = SS0[(short)(int)(255L & T1)] ^ SS1[(short)(int)(255L & T1 >>> 8)] ^ SS2[(short)(int)(255L & T1 >>> 16)] ^ SS3[(short)(int)(255L & T1 >>> 24)];
        } else
        {
            KnL[31 - (i * 2 + 1)] = SS0[(short)(int)(255L & T0)] ^ SS1[(short)(int)(255L & T0 >>> 8)] ^ SS2[(short)(int)(255L & T0 >>> 16)] ^ SS3[(short)(int)(255L & T0 >>> 24)];
            KnL[31 - i * 2] = SS0[(short)(int)(255L & T1)] ^ SS1[(short)(int)(255L & T1 >>> 8)] ^ SS2[(short)(int)(255L & T1 >>> 16)] ^ SS3[(short)(int)(255L & T1 >>> 24)];
        }
    }
    ...
    {
        long T0 = C[0];
        C[0] = C[0] << 8 & -256L | D[0] >>> 24 & 255L;
        D[0] = D[0] << 8 & -256L | T0 >>> 24 & 255L;
        long temp;
        if(KC[i] < 0)
        {
            temp = KC[i] & 0x7fffffff;
