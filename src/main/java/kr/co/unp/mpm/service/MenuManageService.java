...
public interface MenuManageService {
	...
	void insertDeptMenuCreatList(ZValue zvl) throws Exception;
	...
	List selectAllMenuBySiteId(String siteId) throws Exception;

	List selectAuthoMenuList(ZValue zvl) throws Exception;

	List selectAuthoAdminDeptMenuListByUserId(String userId) throws Exception;

	public List selectAuthoMenuListByAuthorities(ZValue zvl) throws Exception;

	void rearrangeMenu(HashMap map) throws Exception;

	String selectContentsPathByMenuNo(int menuNo) throws Exception;
	
	List menuLinkSearch(ZValue zvl) throws Exception;
	
	int menuLinkSearchCnt(ZValue zvl) throws Exception;
	
	ZValue selectMenuByContents(ZValue zvl) throws Exception;
