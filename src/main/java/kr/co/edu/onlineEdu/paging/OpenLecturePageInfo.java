...
@Service("openLecturePageInfo")
public class OpenLecturePageInfo implements IPageInfo
{
	...
	public String getPageNavStringToFunc( int pageSize, int total, int cpage, String funcName )
	{
		...
		if (prev10 > 0)
		{
			sbuf.append("<li class='first'><a style='opacity:1' title=\"처음 페이지로 이동\" href='javascript:"+funcName+"(1);' title='처음 페이지로 이동'>")/*.append(lastPrevImg)*/.append("</a></li>");
