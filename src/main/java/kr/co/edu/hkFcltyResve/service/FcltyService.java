...
import kr.co.edu.hkFcltyResve.paging.FcltyPageQuery;
...
public class FcltyService extends DefaultCmmProgramService {
	...
	public void viewPopup(ParameterContext<ZValue> paramCtx) throws Exception {
		...
		super.setViewQueryId("HkFcltyResveDAO.viewFclty");
		super.view(paramCtx);
	}
	...
	public void list(ParameterContext<ZValue> paramCtx) throws Exception {
		...
		super.setCountQueryId("HkFcltyResveDAO.listFcltyCnt");
		super.setListQueryId("HkFcltyResveDAO.listFclty");
		super.list(paramCtx);
	...
	public void view(ParameterContext<ZValue> paramCtx) throws Exception {
		...
		List<ZValue> eqpmnList = sqlDao.listDAO("HkFcltyResveDAO.listEqpmnByFclty", param);
	...
	public void insert(ParameterContext<ZValue> paramCtx) throws Exception {
		...
		super.setInsertQueryId("HkFcltyResveDAO.insertFclty");
		...
		if (eqpmnSns != null) {
			for (String eqpmnSn : eqpmnSns) {
				...
				sqlDao.insertDAO("HkFcltyResveDAO.insertFcltyEqpmn", param);
			}
		}

		String pageQueryString = param.getString("pageQueryString");
		StringBuilder url = new StringBuilder("/bos/hkFcltyResve/fclty/list.do");
	...
	public void forUpdate(ParameterContext<ZValue> paramCtx) throws Exception {
		...
		super.setViewQueryId("HkFcltyResveDAO.fcltyView");
	...
	public void update(ParameterContext<ZValue> paramCtx) throws Exception {
		...
		super.setUpdateQueryId("HkFcltyResveDAO.updateFclty");
		super.update(paramCtx);

		if ("N".equals(param.getString("eqpmnUseAt"))) {
			sqlDao.deleteDAO("HkFcltyResveDAO.deleteFcltyEqpmnByFcltySn", param);
		}
		else {
			if (eqpmnSns != null) {
				sqlDao.deleteDAO("HkFcltyResveDAO.deleteFcltyEqpmnByFcltySn", param);
		...
		String pageQueryString = param.getString("pageQueryString");
		StringBuilder url = new StringBuilder("/bos/hkFcltyResve/fclty/view.do");
	...
	public void delete(ParameterContext<ZValue> paramCtx) throws Exception {
		...
		super.setDeleteQueryId("HkFcltyResveDAO.deleteFclty");
	...
	public void eqpmnPopup(ParameterContext<ZValue> paramCtx) throws Exception {
		...
		List<ZValue> list = sqlDao.listDAO("HkFcltyResveDAO.listEqpmnPopup", param);
	...
	public void listForLayout(ParameterContext<ZValue> paramCtx) throws Exception {
		...
		List<ZValue> list = sqlDao.listDAO("HkFcltyResveDAO.listFcltyForLayout", param);
