 ...
 * 채용 공고
 */
public class EmpmnPblancService  extends DefaultCmmProgramService  {
	Logger log = Logger.getLogger(this.getClass());

	public EmpmnPblancService() {
		super.setDeleteQueryId("empmnPblanc.deleteEmpmnPblanc");
	}
	...
	public void list(ParameterContext<ZValue> paramCtx) throws Exception {
		...
		if ((SiteMngService.CKLMOBILE_SITE_NAME).equals(param.getString("siteName")) || (SiteMngService.EDUMOBILE_SITE_NAME).equals(param.getString("siteName"))) {
			...
			if ( (SiteMngService.EDUMOBILE_SITE_NAME).equals(param.getString("siteName")) )
					param.put("pageSize", "10");//채용정보 rsg20171214pm0530
		}
		...
		super.setCountQueryId("empmnPblanc.selectEmpmnPblancListCnt");
		super.setListQueryId("empmnPblanc.selectEmpmnPblancList");
		super.list(paramCtx);
	}
