...
public class SchdulService  extends DefaultCmmProgramService {
	...
	public SchdulService() {
		super.setCountQueryId("FcltyResveDAO.listSchdulCnt");
		super.setListQueryId("FcltyResveDAO.listSchdul");
		super.setViewQueryId("FcltyResveDAO.viewSchdul");
		super.setInsertQueryId("FcltyResveDAO.insertSchdul");
		super.setUpdateQueryId("FcltyResveDAO.updateSchdul");
		super.setDeleteQueryId("FcltyResveDAO.deleteSchdul");
	}
	...
	public void insert(ParameterContext<ZValue> paramCtx) throws Exception {
		ZValue param = paramCtx.getParam();
		ModelMap model = paramCtx.getModel();
		int cnt = sqlDao.selectCount("FcltyResveDAO.schdulChkCnt", param);
		if (cnt > 0) {
