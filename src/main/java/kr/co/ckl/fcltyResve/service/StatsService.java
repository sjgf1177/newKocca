...
public class StatsService  extends DefaultCmmProgramService {
	...
	public void statsFclty(ParameterContext<ZValue> paramCtx) throws Exception {
		...
		List<ZValue> list = sqlDao.listDAO("FcltyResveDAO.listStatsFclty", param);
	...
	public void downloadExcelStatsFclty(ParameterContext<ZValue> paramCtx) throws Exception {
		...
		List<ZValue> list = sqlDao.listDAO("FcltyResveDAO.listStatsFclty", param);
		ExcelGenerateVO vo = new ExcelGenerateVO("시설예약(시설/공간) 통계", titles, list);
	...
	public void statsEqpmn(ParameterContext<ZValue> paramCtx) throws Exception {
		...
		List<ZValue> list = sqlDao.listDAO("FcltyResveDAO.listStatsEqpmn", param);
		model.addAttribute("resultList",list);
	...
	public void downloadExcelStatsEqpmn(ParameterContext<ZValue> paramCtx) throws Exception {
		...
		List<ZValue> list = sqlDao.listDAO("FcltyResveDAO.listStatsEqpmn", param);
		ExcelGenerateVO vo = new ExcelGenerateVO("시설예약(장비) 통계", titles, list);
		model.addAttribute("excel", vo);
	...
	public void statsUsePurps(ParameterContext<ZValue> paramCtx) throws Exception {
		...
		List<ZValue> list = sqlDao.listDAO("FcltyResveDAO.listStatsUsePurps", param);
		model.addAttribute("resultList",list);
	}
	...
	public void downloadExcelStatsUsePurps(ParameterContext<ZValue> paramCtx) throws Exception {
		...
		List<ZValue> list = sqlDao.listDAO("FcltyResveDAO.listStatsUsePurps", param);
		ExcelGenerateVO vo = new ExcelGenerateVO("시설예약(사용목적) 통계", titles, list);
		model.addAttribute("excel", vo);
	...
	public void statsVisit(ParameterContext<ZValue> paramCtx) throws Exception {
		...
		List<ZValue> list = sqlDao.listDAO("FcltyResveDAO.listStatsVisit", param);
		model.addAttribute("resultList",list);
	}
	...
	public void downloadExcelStatsVisit(ParameterContext<ZValue> paramCtx) throws Exception {
		...
		List<ZValue> list = sqlDao.listDAO("FcltyResveDAO.listStatsVisit", param);
		ExcelGenerateVO vo = new ExcelGenerateVO("시설예약(열린공간 방문) 통계", titles, list);
		model.addAttribute("excel", vo);
	...
	public void downloadExcelStatsOriData(ParameterContext<ZValue> paramCtx) throws Exception {
		...
		List<ZValue> list = sqlDao.listDAO("FcltyResveDAO.listStatsOriData", param);
		...
		ExcelGenerateVO vo = new ExcelGenerateVO("시설예약(원시데이터) 통계", titles, list);
		model.addAttribute("excel", vo);
	}
	...
	public void downloadExcelStatsUsePurpsByMonth(ParameterContext<ZValue> paramCtx) throws Exception {
		...
		List<ZValue> list = sqlDao.listDAO("FcltyResveDAO.listStatsUsePurpsByMonth", param);
		ExcelGenerateVO vo = new ExcelGenerateVO("시설예약(시설이용목적별 현황) 통계", titles, list);
		model.addAttribute("excel", vo);
	}
	...
	public void downloadExcelStatsFcltyByMonth(ParameterContext<ZValue> paramCtx) throws Exception {
		...
		List<ZValue> titVoList = sqlDao.listDAO("FcltyResveDAO.listFcltyTitle", param);
		titList.add("");
		...
		List<ZValue> tmpList = sqlDao.listDAO("FcltyResveDAO.listStatsFcltyByMonth", param);
		...
		ExcelGenerateVO vo = new ExcelGenerateVO("시설예약(시설별 이용현황) 통계", titles, resultList);
		model.addAttribute("excel", vo);
	}
