...
public class Globals {
    ...
    //웹루트경로
    public static final String WEB_ROOT_PATH = EgovProperties.getProperty("Globals.webRootPath");
    //도메인URL
    public static final String HOST_URL = "http://" + EgovProperties.getProperty("Globals.ckl.domain");
	...
	//테스트모드
	public static final String TEST_MODE = EgovProperties.getProperty("Globals.testMode");

	public static final String BOS_TEMPLATE_VIEW = "bos/main/bosIndex";
