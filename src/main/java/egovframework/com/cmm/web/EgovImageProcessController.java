...
public class EgovImageProcessController extends HttpServlet {
    ...
    private FnwFileMngService fileService;
    ...
    public void getImageInf(ModelMap model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		vo.setAtchFileId(request.getParameter("atchFileId"));
		vo.setFileSn(StrUtils.parseInt(request.getParameter("fileSn")));
		vo.setFileFieldName(request.getParameter("fileFieldNm"));
