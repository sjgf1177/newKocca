...
function mainProgrm(id, more, date) {
	...
	$.post(
		"/cklmobile/progrm/master/listCklMain.json",
		...
		function(data)
		{
			...
			if (cnt > 3 && num == 3) {
				...
				html += '	<a href="#" onclick="mainProgrm(\''+id+'\', \'Y\', \''+moreDate+'\')"><span class="icoMore"></span> 더보기</a>';
				html += '</div>';
			}
			html += '<div class="posa">';
			html += '	<a href="/cklmobile/progrm/master/list.do?prgSe=03&prgCl=30&menuNo=400018"><strong>창작지원 프로그램</strong> 바로가기<span class="mainIcos icoArrB"></span></a>';
			html += '</div>';
		},"json"
	);
