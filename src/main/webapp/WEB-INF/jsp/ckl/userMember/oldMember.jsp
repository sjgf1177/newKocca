				...
				if (data.resultCode == "success") {
					if (data.emailCnt > 0) {
						if (confirm("이미 등록된 이메일입니다. 아이디 찾기 페이지로 이동하시겠습니까?")) {
							location.href = "/ckl/userMember/idSearch.do?menuNo=200057";
						}
						flag = false;
					}
				}
...
//]]>
	...
	<div>
		...
		<div tabindex="0" class="agreeScr" style="height:175px">
			<ul>
	...
	<form id="frm" name="frm" method="post" action="/ckl/userMember/insertOldMember.do" >
