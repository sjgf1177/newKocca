		...
		<div class="tabSisul">
			...
			<div class="sisulCts" id="tabSSL0${status.count }">
				...
				<ul>
					...
					<li>
						<dl>
							<dt><span class="imgLt"><img style="width:320px;height:180px;" src="/cmm/fms/getImage.do?atchFileId=<c:out value="${fcltyVO.atchFileId }" />&amp;fileFieldNm=mainImg" alt="<c:out value="${fcltyVO.spceNm }" />사진"></span>
							<strong class="title"><c:out value="${fcltyVO.spceNm }" /></strong></dt>
							<dd><util:head length="120" value="${fcltyVO.prpos }" /></dd>
							<dd><a href="/ckl/fcltyResve/resveSttus/step0.do?menuNo=200020&amp;fcltySn=<c:out value="${fcltyVO.fcltySn }" />" class="btn btnCircle btnMd resveBtn"><span class="ico icoCal"></span> 예약 바로가기</a></dd>
						</dl>
					</li>
					</c:if>
					</c:forEach>
