...
$(function() {
	...
	$("#prevBtn").click(function() {
		window.location.href = "/<c:out value="${paramVO.siteName}" />/fcltyResve/resveSttus/step1.do?menuNo=<c:out value="${param.menuNo}" />";
		return false;
	});
...
function fnResveSave(resveTp) {
	...
	var url = "/<c:out value="${paramVO.siteName}" />/fcltyResve/resveSttus/step3.do";
...
<div class="tabs child4 noLink">
	<ol>
		<li>개인정보 동의</li>
		<li class="on">공간 및 일자/시간 선택<span class="sr-only">(현재단계)</span></li>
		<li>예약자 정보 입력</li>
		<li>예약완료</li>
	</ol>
</div>
...
<fieldset>
	<legend>시설 예약 운영정책 안내 입력양식</legend>
...
<h3>주의사항 </h3>
<ul class="bull">
	<li>콘텐츠코리아랩 지원사업에 활용되는 기재, 시설의 경우 일부 이용이 제한될 수 있습니다.</li>
	<li>사용목적이 허위로 기재되었거나, 운영목적과 위배(상업적 이용 등) 되는 경우 즉시 퇴실조치 됩니다.</li>
	<li>시설 및 집기 훼손 시 이용자에게 책임이 있고, 타인에게 방해가 되는 행동(고성방가, 화기사용, 음식물반입 등)을 금합니다.</li>
</ul>
<h3>시설 예약 안내 </h3>
<ul class="bull">
	<li>이용일 기준 30일 전부터 3일 전까지 예약이 가능합니다. (이용일별 예약 2건, 대기예약 1건까지 가능)</li>
...
<div class="well">관련 문의사항 : 02-2161-0000</div>
		...
		<div class="btnSet">
			<a href="#self" class="btn btn-primary" id="agreeBtn">시설 예약 운영정책에 동의합니다.</a>
		</div>
...
<!-- 시설 박스 정보 -->
<div class="reservSysSet" style="display:none;">
	<div class="reservSys">
	  <div class="head">
			...
			<div class="btnSet">
				<div class="row">
					<div class="col-md-6 tal">
						<a href="javascript:void(0);" class="btn btn-gray btnIcPrev" id="prevBtn">이전</a>
						<a href="javascript:void(0);" class="btn btn-gray btnReset" id="resetBtn">초기화</a>
					</div>
