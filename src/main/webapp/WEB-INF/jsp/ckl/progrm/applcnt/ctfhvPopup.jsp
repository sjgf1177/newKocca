...
<div class="popup">
		...
		<div class="contents">
			<div class="certiInfo">
				<ul>
					...
					<li><img src="/images/certificate/certificate_04.gif" alt="">
						<span class="day">교육 기간</span> :  <c:out value="${masterResult.prgBgnde}"/> ~ <c:out value="${masterResult.prgEndde}"/></li>
					<li><img src="/images/certificate/certificate_04.gif" alt="">
						<span class="name">이 름</span> :  <c:out value="${result.nm}"/></li>
				</ul>

				<div class="desc tal">
					위 사람은 한국콘텐츠진흥원에 진행한 ‘<c:out value="${masterResult.prgNm}"/>’에 참여하여<br />
					상기 교육과정을 이수하였으므로 이 증서를 수여합니다.
				</div>
			</div>
		</div>
		<div class="orgInfo tar">
			<p><c:out value="${today}"/></p>
			<p><strong>한국콘텐츠진흥원 원장    (인)</strong></p>
		</div>
	...
	<div class="tac">
		<a href="#btn_print" onclick="window.print();return false;" onkeypress="this.onclick();" ><span class="printBtn"></span></a>
