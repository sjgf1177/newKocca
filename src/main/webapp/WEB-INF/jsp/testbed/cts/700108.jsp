...
<div class="over-hidden sub_contents_header">
    <div class="linemap_wrap"> <!-- fl class 삭제 -->
        <ul class="col-12 linemap_con">
            ...
            <li><a href="javascript:void(0);" tabindex="-1"><span>대관 안내</span></a></li>
        </ul>
    </div>
</div>

<div class="sub_title s_tit02">
    <div class="col-center mw-1280">대관 안내</div>
</div>
...
<div class="col-center mw-1280 dream_list">
    ...
    <div class="tab_style_1_con">
        <ul class="tab_style_1 seven_tab size_24">
            ...
            <li id="tab4" class="active"><a href="/testbed/main/contents.do?menuNo=700108" title="현재탭"><span>대관 안내</span></a></li>
    ...
    <div class="share_room_img_box">
        ...
        <div class="img_box">
            <img src="/edu/images/bm/share_room_img_002.jpg" alt="콘텐츠문화광장 이미지3">
        </div>
    </div>
    ...
    <table class="mb66 contents_insight_view big_table style_3 is_side_border_none">
        <caption>콘텐츠문화광장 대관 이용 유틸 다운로드</caption>
        <colgroup>
            <col width="30%">
            <col width="20%">
            <col width="30%">
        ...
        <tbody>
        <tr>
            <th class="color_black">대관규약</th>
            <td>
                <div class="board_util_btn_con">
                    <a href="/upload/testbedupload/testbedpolicy_2018.hwp" class="btn_style_0 share_room_download_icon_con">
    ...
    <div class="mb66 alert white_box">
        <div class="horizon_step_style_0_con">
            <div class="horizon_step_style_0_list">
                <div class="horizon_icon_box">
                    <img src="/edu/images/bm/share_room_step_icon_000.png" alt="접수">
                </div>
                <div class="horizon_count_text">
                    01
                </div>
                <div class="horizon_title">
                    접수
                </div>
            </div>
            <div class="horizon_step_style_0_list step_arrow">
                <img src="/edu/images/bm/share_room_step_arrow.png" alt="다음 단계">
            </div>
            <div class="horizon_step_style_0_list">
                <div class="horizon_icon_box">
                    <img src="/edu/images/bm/share_room_step_icon_001.png" alt="심사">
                </div>
                <div class="horizon_count_text">
                    02
                </div>
            ...
            <div class="horizon_step_style_0_list">
                <div class="horizon_icon_box">
                    <img src="/edu/images/bm/share_room_step_icon_002.png" alt="승인">
                </div>
                <div class="horizon_count_text">
                    03
                </div>
            ...
            <div class="horizon_step_style_0_list">
                <div class="horizon_icon_box">
                    <img src="/edu/images/bm/share_room_step_icon_003.png" alt="행사공연">
                </div>
                <div class="horizon_count_text">
                    04
                </div>
        ...
        <div class="facilities_body_list">
            ...
            <div class="facilities_text_box">
                <ul class="list_style_10 on_margin">
                    <li>
                        극장 형태
                        <p class="small_text_box">
                            <span class="font_light">블랙박스</span><!-- <br/> -->
                            <!-- <span class="font_light">극장형태 프로시니엄 극장 객석을 수납하여 최대 19m 깊이를 가진 블랙박스 형식의 공간으로 활용가능</span> -->
                        </p>
                    </li>
                    <li>
                        무대공간
                        <p class="small_text_box">
                            <span class="font_light">폭  14m X 깊이 17m X 높이 9m</span>
                        </p>
                    </li>
                    <li>
                        객석
                        <p class="small_text_box">
                            <span class="font_light">수납식객석 (135석)</span>
                        </p>
                    </li>
                    <li>
                        주요 장비
                        <p class="small_text_box">
                            <span class="font_light">장치봉, 조명봉, 캣워크, 승강무대</span>
                        </p>
                    </li>
                </ul>
            </div>
    ...
    <div class="download_file_list_wrap">
        <!-- <div class="download_file_list_con">
            <div class="download_file_list">
                <div class="download_file_name">
                    극장 기술 정보 - <span class="download_file_type">(zip)</span>
                </div>
                <div class="download_file_icon">
                    <a href="/upload/testbed/testbedtechinfo.zip" class="show-block">
    ...
    <div class="download_file_list_con">
        <div class="download_file_list">
            <div class="download_file_name">
                CAD 도면(평면도, 단면도, 조명 회로도) - <span class="download_file_type">(dwg)</span>
            </div>
            <div class="download_file_icon">
    <!--             <a href="/upload/testbed/1.CAD.dwg" class="show-block"> -->
                <a href="/upload/testbedupload/STAGE66_202012.dwg" class="show-block">
                    <img src="/edu/images/bm/download_file_icon_icon.png" alt="다운로드">
                </a>
            </div>
        </div>
    ...
    <div class="download_file_list_con">
        <div class="download_file_list">
            <div class="download_file_name">
                SkethUp 도면 - <span class="download_file_type">(skp)</span>
            </div>
            <div class="download_file_icon">
                <a href="/upload/testbedupload/STAGE66_202101.skp" class="show-block">
                    <img src="/edu/images/bm/download_file_icon_icon.png" alt="다운로드">
                </a>
            </div>
        </div>
    ...
    <div class="download_file_list_con">
        <div class="download_file_list">
            <div class="download_file_name">
                PDF 평면도 - <span class="download_file_type">(pdf)</span>
            </div>
            <div class="download_file_icon">
                <a href="/upload/testbedupload/STAGE66_Ground_202012.pdf" class="show-block">
                    <img src="/edu/images/bm/download_file_icon_icon.png" alt="다운로드">
                </a>
            </div>
        </div>
    ...
    <div class="download_file_list_con">
        <div class="download_file_list">
            <div class="download_file_name">
                PDF 단면도 - <span class="download_file_type">(pdf)</span>
            </div>
            <div class="download_file_icon">
                <a href="/upload/testbedupload/STAGE66_Section_202012.pdf" class="show-block">
                    <img src="/edu/images/bm/download_file_icon_icon.png" alt="다운로드">
                </a>
            </div>
        </div>
    ...
    <div class="download_file_list_con">
        <div class="download_file_list">
            <div class="download_file_name">
                PDF 조명 회로도 - <span class="download_file_type">(pdf)</span>
            </div>
            <div class="download_file_icon">
                <a href="/upload/testbedupload/STAGE66_LIGHTCIRCUITPLAN_202012.pdf" class="show-block">
                    <img src="/edu/images/bm/download_file_icon_icon.png" alt="다운로드">
                </a>
            </div>
        </div>
