...
$(function(){
	$("#pwdSearchBtn").click(function(){
		...
		$.post(
			"/testbed/userMember/pwdSearchRequest.json",
            ...
            <form action="#" class="search_pw_form">
                <div class="input_wrap">
                    ...
                    <div class="input_style_2_con">
                        <input name="userNm" type="text" class="input_style_2" id="userNm" placeholder="홍길동" title="이름을 입력해 주세요">
                ...
                <div class="input_wrap last">
	            	...
	            	<div id="mbtlnumDiv" style="display: none; font-size:12px; line-height:18px;">
		                <p class="red_star_text">
		                    휴대폰
		                </p>
		                <div class="select_style_2_con" style="margin-right:5px;">
						...
						-
						<div class="input_style_2_con short" style="margin-right:5px; margin-left:5px;">
						...
						-
						<div class="input_style_2_con middle" style="margin-left:5px;">
                ...
                <div class="input_wrap last">
                    ...
                    <div class="input_style_2_con">
                        <input type="text" class="input_style_2" name="userId" id="userId" placeholder="abcdef111" title="아이디를 입력해 주세요">
                        <!-- <label for="userId"></label> -->
                    </div>
                </div>
				<span class="btn_style_2_con" style="margin-left: 0; margin-bottom: 20px;">
