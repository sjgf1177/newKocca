			...
			$.post(
				...
				function(data) {
					if (data.resultCode == "success") {
						alert(data.msg);
						if (mode == "PE" || mode == "CE") {
							opener.location.href =	"/testbed/member/forLogin.do?menuNo=700115";
						}
						else if (mode == "FU") {
...
<div class="popBx sub_section">
	<div class="popBoxIn">
		<div class="fr">
			<img src="/edu/images/bm/testbed_black_logo.png" title="콘텐츠문화광장" width="206px" height="100px">
		</div>
		<!-- <span class="popLogo" style="background:url('/edu/images/bm/testbed_black_logo.png') no-repeat;"><span class="sr-only">한국콘텐츠진흥원</span></span> -->
