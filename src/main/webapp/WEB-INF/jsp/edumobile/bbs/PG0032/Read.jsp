...
<table class="contents_insight_view">
	<caption>(콘텐츠아카데미) 오프라인 콘텐츠 뷰</caption>
	<colgroup>
		<col width="20%">
		<col width="auto">
		<col width="20%">
...
<div class="insight_view_contents">
	...
	<c:forEach var="fileVO" items="${fileList}" varStatus="status">
		...
		<img alt="${result.nttSj } 기업 소개" src="/cmm/fms/getImage.do?atchFileId=<c:out value="${fileVO.atchFileId}" />&amp;fileSn=<c:out value="${fileVO.fileSn}" />"  />
	</c:forEach>
	</c:if>
</div>
