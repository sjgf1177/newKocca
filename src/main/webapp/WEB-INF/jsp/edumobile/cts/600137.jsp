...
<div class="fontsize0 sub_contents_body sub_board_wrap">
	<!-- 일별을 누르면 movie_plan_calendar_wrap 에 active 제거, 연/월별을 누르면 active 부여 -->
	<div class="movie_plan_calendar_wrap active"> 
        <div class="movie_plan_calendar_con">
            <div class="movie_plan_view_type_select_con">
                ...
                <div class="movie_plan_view_type_select type_2">
                    연/월별
                </div>
            </div>
        ...
        <div class="movie_plan_calendar_view_con">
            <div class="mb14 movie_plan_view_select_con">
	    ...
	    <div class="col-12 calc_wrap25">
	    	<div class="col-12 col-sm-4 sub_contents_view_calendar_list">
	            <div class="border_box">
	                ...
	                <div class="text_box">
	                    <h5>
	                        <span class="concert_title">[공연 A]</span>타이터스
	                    </h5>
	                    <p class="h_data5">
	                        일자  :
	            ...
	            <div class="border_box">
	                <div class="img_box">
	                    <div class="hidden_text_wrap">
	                        <div class="hidden_text_con">
	                            <div class="hidden_text">
	                                <a class="quick_btn" href="javascript:void(0)" data-for="sub_view_${paramVO.menuNo}">
	                                    바로가기
	                                </a>
	                            </div>
	                        </div>
	                ...
	                <div class="text_box">
	                    <h5>
	                        <span class="concert_title">[공연 B]</span>데이드림 - Day Dream
	                    </h5>
	                    <p class="h_data5">
	                        일자  :
	        ...
	        <div class="col-12 col-sm-4 sub_contents_view_calendar_list">
	            <div class="border_box">
	                ...
	                <div class="text_box">
	                    <h5>
	                        <span class="concert_title">[공연 C]</span>드로잉 로봇 - Drawing Robot
	                    </h5>
	                    <p class="h_data5">
	                        일자  :
	                    ...
	                    <div class="col-12 popup_contents_inner_border">
	                        ...
	                        <div class="mb48 select_style_2_wrap">
	                            <div class="select_style_2_con testbed_style">
	                                <select name="view_people_select" id="" class="select_style_2">
	                    ...
	                    <div class="col-12 popup_contents_inner_border">
	                        ...
	                        <div class="col-12 col-md-6 article_list_type_0 right">
	                            ...
	                            <table class="popup_table_style_0">
	                                <caption>(콘텐츠문화광장) 예매정보 입력 확인</caption>
	                                <colgroup>
	                                    <col width="30%">
	                                    <col width="auto">
	                                </colgroup>
	                        ...
	                        <div class="col-12 reserve_check_movie_con">
	                            ...
	                            <div class="reserve_check_movie_text_box">
	                                ...
	                                <table class="reserve_check_movie_desc">
	                                    <caption>(콘텐츠문화광장) 예매정보 확인</caption>
	                                    <colgroup>
	                                        <col width="84px">
	                                        <col width="auto">
	                                    </colgroup>
	            ...
	            <div class="col-12 popup_contents_wrap">
	                ...
	                <div class="col-12 popup_contents_inner">
	                    ...
	                    <div class="col-12 mb65 popup_util_btn_con">
	                        <a href="javascript:void(0)" class="popup_util_btn_style black">
	                            출력
	                        </a>
	                        <a href="javascript:void(0)" class="popup_util_btn_style gray">
	                            이전
	                    ...
	                    <div class="col-12 reserve_print_contents">
