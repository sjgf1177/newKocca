...
<div class="col-12 sub_contents_view_location">
    ...
    <div class="sub_contents_view_location_header">
        ...
        <div class="table_box">
            ...
            <table class="table_style_2 type_2">
            	<caption>(콘텐츠 문화광장) [<c:out value="${result.concertType}"/>] <c:out value="${result.concertTitle}"/> - 상세 내용 테이블</caption>
                <colgroup>
                    <col width="22%">
                    <col width="auto">
                </colgroup>
        	...
        	<div class="ticketing_btn_wrap">
            	...
            	<c:if test="${result.useReserv eq 1 && canReservTimeCnt ne 0 && result.canReservNow eq 1 }">
	            	...
	            	<c:when test="${!empty result.reservUrl}">
						<a class="btn_style_3 ticketing" href="${result.reservUrl}" target="_blank" title="새 탭으로 열림">예약하기</a>
					</c:when>
	            	<c:when test="${empty userVO.userKey}">
						...
						<c:if test="${paramVO.siteName eq 'edumobile' }">
							<c:set var="loginMenuNo" value="600137" />
						</c:if>	
						<form class="login_form" name="detailLoginForm" id="detailLoginForm" action="/${paramVO.siteName}/member/forLogin.do?menuNo=${loginMenuNo}" method="post" style="display:none;">
							<input type="hidden" name="redirectUrl" value="/edumobile/concert/info/list.do?menuNo=600137" />
						</form>
					</c:when>
					<c:otherwise>
    ...
    <div class="sub_contents_view_location_body view_date_contents0 line">
        ...
        <div class="sub_contents_view_location_body_list" id="movieCon" style="display:none; <c:if test="${!empty result.vimeoUrl }">display:block;</c:if>">
	        ...
	        <div>
	        	<p style="text-align:center; padding:40px 0;"><iframe src="${result.vimeoUrl}" width="360" height="202" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen title="홍보영상"></iframe></p>
	        </div>
        </div>
	        ...
	        <div class="sub_contents_view_location_body_list">
	            ...
	            <ul class="list_style_contents_view">
	                <li>
	                    ...
	                    <div class="wper-129">
	                        관람일 전일 23시까지 가능<br/>
	                        <span class="desc">(주말, 공휴일의 경우 그전일 23시까지 가능)</span>
	                    </div>
	                </li>
	                <li>
	                    <div class="w-129">
	                    ...
	                    <div class="wper-129">
	                        인터넷 예약이 불가능한 경우 담당자 문의를 통해 변경가능<br/>
	                    ...
	                    <div class="col-12 popup_contents_inner_border">
	                        ...
	                        <div class="col-12 col-md-6 article_list_type_0 right">
		                        <div class="concert_time_area">
		                            ...
		                            <div class="tc mb15" style="display: block;">
	                            ...
	                            <table class="popup_table_style_0" id="confirmDateAndTime" style="display:none;">
	                                <caption>(콘텐츠문화광장) 공연 내용 입력 확인</caption>
	                                <colgroup>
	                                    <col width="30%">
	                                    <col width="auto">
	                                </colgroup>
	                                ...
	                                <tr>
	                                    <th>관람일</th>
	                                    <td class="point0" id="confirmSelectedDate">2018.08.17</td>
	                                </tr>
	                                <tr>
	                                    <th>공연 시간</th>
	                        ...
	                        <div class="col-12 reserve_check_movie_con">
	                            ...
	                            <div class="reserve_check_movie_text_box">
	                                ...
	                                <table class="reserve_check_movie_desc">
	                                    <caption>(콘텐츠문화광장) 공연 예매 정보 확인</caption>
	                                    <colgroup>
	                                        <col width="84px">
	                                        <col width="auto">
	                                    </colgroup>
