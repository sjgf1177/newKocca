...
<script type="text/javascript">
	...
	$(function(){
		...
		crtfcPopup = function(authSe) { // 이메일/휴대폰 인증 팝업창
			...
			window.open("/edumobile/userMember/crtfcPopup.do?viewType=BODY&authSe="+authSe+"&val="+val+"&mode=FU&authSeVal="+authSeVal, "crtfcPopup", "top=300, left=600, width=568, height="+height+", status=yes, resizable=yes, scrollbars=no");
		};
		...
		$("#emailAuthDel").click(function(){
			...
			$.post(
				"/edumobile/userMember/authSeChange.json",
		...
		$("#chgMemTpBtn").click(function() {
			...
			if (confirm("14세 이상 회원으로 전환하시겠습니까?")) {
				var url = "/edumobile/userMember/updateParntsAgreChange.json";
				var params = {};
...
<fieldset>
	...
	<form method="post" name="agreeForm" id="agreeForm" action="/edumobile/userMember/update.do" >
