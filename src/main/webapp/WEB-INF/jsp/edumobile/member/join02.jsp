...
//<![CDATA[
	...
	$(function(){
		...
		crtfcPopup = function(authSe) { // 이메일/휴대폰 인증 팝업창
			...
			window.open("/edumobile/userMember/crtfcPopup.do?viewType=BODY&authSe="+authSe+"&val="+val+"&mode="+mode, "crtfcPopup", "top=300, left=600, width=568, height="+height+", status=yes, resizable=yes, scrollbars=no");
		};
		...
		parntsCrtfcPopup = function() { // 이메일/휴대폰 인증 팝업창
			...
			*/
			...
			window.open("/edumobile/userMember/parntsCrtfcPopup.do?viewType=BODY&authSe=02&val="+val+"&mode="+mode, "parntsCrtfcPopup", "top=300, left=600, width=568, height="+height+", status=yes, resizable=yes, scrollbars=no");
		};
	...
	function checkIdFc() {
		...
		if (checkIdVal()) {
			...
			$.post(
				"/edumobile/member/checkDupId.json",
	...
	function checkEmailFc() {
		...
		if (checkEmail()) {
			...
			$.post(
				"/edumobile/member/checkDupEmail.json",
	...
	function checkMbtlnumFc() {
		...
		if (checkMbtlnum()) {
			...
			$.post(
				"/edumobile/member/checkDupMbtlnum.json",
...
<div class="memberStep1">
	<form name="agreeForm" id="agreeForm" action="/edumobile/userMember/joinMember.do" method="post">
		...
		<div id="joinStep2">
			...
			<div>
	            ...
	            <div class="signup_agree_con">
	                ...
	                <div tabindex="0" class="agreeScr" style="font-size: 1.45rem; line-height: 2.05rem;">
	                    <ul>
	                        <li>1. 수집 &middot; 이용 목적 : 한국콘텐츠아카데미 회원가입을 위한 사용자 정보 수집 및 이용</li>
	                        <li>2. 개인정보 수집 항목 :
	                            <div class="m1">
	                                <dl>
	                                    <dt>[회원가입]</dt>
	                        ...
	                        <li class="fontsize19" style="font-weight:bold">3. 개인정보 보유 및 이용기간 : 회원탈퇴시 까지, 3년 이상 홈페이지에 접속이 없는 경우</li>
			...
			<div class="fr board_util_btn_con">
                <a href="/edumobile/member/join01.do?menuNo=500076" onclick="return confirm('취소하시겠습니까?');" class="btn_style_0 close">
                    취소
                </a>
		...
		<div id="joinStep3" style="display: none;">
			...
			<div class="signup_write_con">
				...
				<table class="table_style_0">
					<caption>(콘텐츠아카데미) 회원가입 기본정보 목록</caption>
					<colgroup>
				...
				<table class="table_style_0">
					<caption>(콘텐츠아카데미) 로그인 정보 입력</caption>
					<colgroup>
						<col width="auto" class="table_header_column">
						<col width="auto">
					</colgroup>
				...
				<table class="table_style_0">
					<caption>(콘텐츠아카데미) 회원가입 필수 정보 인력</caption>
					<colgroup>
						<col width="auto" class="table_header_column">
						<col width="auto">
					</colgroup>
				...
				<table class="table_style_0">
					<caption>(콘텐츠아카데미) 회원가입 선택항목 입력</caption>
					<colgroup>
						<col width="auto" class="table_header_column">
						<col width="auto">
					</colgroup>
