...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/ckleng/css/bootstrap.reset.css"/>
	...
	<link rel="stylesheet" type="text/css" href="/ckleng/css/sub.css" />
	...
	//<![CDATA[
	    ...
	    if (url.indexOf("/ckl/userMember/reAgre.do") == -1 && url.indexOf("/ckl/userMember/secsn.do") == -1 && url.indexOf("/ckl/userMember/secsnRequest.do") == -1) {
			...
			if (Number(reAgreDt) <= Number(today)) {
				...
				location.href = "/ckl/userMember/reAgre.do?menuNo=200055";
			}
	    }
	//]]>
	</script>
