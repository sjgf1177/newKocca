                ...
                <form id="agreeForm" name="agreeForm" action="/edu/userMember/joinMember.do" method="post" novalidate="novalidate">
                    ...
                    <div class="">
                        <div class="form-group">
                            <div class="col-sm-12">
                                <input type="text" name="userId" id="userId"  value="" onkeyup="this.value=checkId(this.value)" class="form-control input_bline h45" placeholder="6~30자까지 영문자(소문자), 숫자 사용 가능합니다." title="아이디">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <input type="password" name="password" id="password" value="" class="form-control input_bline h45" placeholder="8~16자 영문, 숫자, 특수문자중 3개 이상 조합. ID, 동일/연속문자 불가"
                    ...
                    <div class="agree_new_box">
                        ...
                        <div class="bg_agree_box">
                            ...
                            <div class="layer_agree_wrap01" style=" width: 100%; height: 100%; top:0; left:0; position: fixed; background-color: rgb(0,0,0,0.5); z-index: 9999;">
                                <div class="layer_agree_inner">
                                    ...
                                    <div class="layer_top">
                                        <button type="button" onclick="$('.layer_agree_wrap01').css({'display':'none'})" style="background: transparent; color:#000 !important;">닫기</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="layer_agree_wrap02" style=" width: 100%; height: 100%; top:0; left:0; position: fixed; background-color: rgb(0,0,0,0.5); z-index: 9999;">
                                <div class="layer_agree_inner">
                                    ...
                                    <div class="layer_top">
                                        <button type="button" onclick="$('.layer_agree_wrap02').css({'display':'none'})" style="background: transparent; color:#000 !important;">닫기</button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="layer_agree_wrap03" style=" width: 100%; height: 100%; top:0; left:0; position: fixed; background-color: rgb(0,0,0,0.5); z-index: 9999;">
                            <div class="layer_agree_inner">
                                ...
                                <div class="layer_top">
                                    <button type="button" onclick="$('.layer_agree_wrap03').css({'display':'none'})" style="background: transparent; color:#000 !important;">닫기</button>
                                </div>
                            </div>
                        </div>
