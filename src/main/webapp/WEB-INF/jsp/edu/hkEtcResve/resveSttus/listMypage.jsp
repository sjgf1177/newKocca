...
$(function(){
	...
	$(".resveCancelBtn").click(function() {
		if (confirm("예약을 취소하시겠습니까?")) {
			var url = "/<c:out value="${paramVO.siteName}" />/hkEtcResve/resveSttus/cancelResveSttus.json";
			var params = {
...
<form id="resveSttusForm" name="resveSttusForm" method="get" class="form-inline" action="/<c:out value="${paramVO.siteName }" />/hkEtcResve/resveSttus/listMypage.do">
...
<div class="row clear tar mb20 board_util_btn_con board_sorting_con">
	...
	<table class="board_type_0 small" style="word-break:break-all;">
		...
		<c:forEach var="result" items="${resultList}" varStatus="status">
			<tr>
				...
				<td class="tal"><a href="#self" class="aTrigger"><c:out value="${result.eqpmnNms }" /></a></td>
		...
		<c:if test="${fn:length(resultList) == 0}">
			<tr class="listMyPageNoData2"><td colspan="6" class="tac">- 검색 결과가 없습니다 -</td></tr>
		</c:if>
		</tbody>
	</table>
</div>
