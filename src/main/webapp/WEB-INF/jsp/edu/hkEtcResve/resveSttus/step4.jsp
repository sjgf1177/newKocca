...
<div class="tac">
	...
	<p class="fs36">장비예약이 정상적으로 <span class="text-danger">완료</span>되었습니다.</p>
</div>
...
<div class="btnSet board_util_btn_con">
	<a href="/edu/hkEtcResve/resveSttus/step0.do?menuNo=<c:out value="${param.menuNo}" />" class="btn_style_0 green radius">확인</a>
</div>
