...
<script type="text/javascript">
    ...
    function fnDirectLoadMP4(file, width, height, vttPath) {
        ...
        tagObj = '<video id="jp_video_0" width="100%" height="auto" max-width="' + width + '" crossorigin="anonymous" oncontextmenu="return false;" controls="true" controlslist="nodownload">\n';
