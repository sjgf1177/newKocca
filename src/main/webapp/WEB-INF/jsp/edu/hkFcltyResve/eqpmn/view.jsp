...
<div class="visualSysSet">
	...
	<div class="visualSys">
		<div class="thumbs" id="vsThumbs">
			...
			<div> <a href="#self"><img style="margin-top: 85px;" src="/cmm/fms/getImage.do?atchFileId=${fileVO.atchFileId}&fileSn=${fileVO.fileSn}" width="370" height="300" alt="<c:out value="${result.eqpmnNm }" /> 장비 큰이미지  ${status.count }번" /></a></div>
			</c:forEach>
		</div>
...
<div class="revInfo ml40 posr">
	...
	<div class="mt20 tar board_util_btn_con">
		<a href="/edu/hkFcltyResve/eqpmn/list.do?${pageQueryString }" class="btn_style_0 green radius">목록</a>
	</div>
</div>