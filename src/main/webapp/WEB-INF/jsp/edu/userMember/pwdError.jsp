...
//<![CDATA[
	...
	$(function(){
		...
		crtfcPopup = function(authSe) { // 휴대폰 인증 팝업창
			...
			window.open("/edu/userMember/crtfcPopup.do?viewType=BODY&authSe="+authSe+"&val="+val+"&mode=PE", "crtfcPopup", "top=300, left=600, width=568, height=463, status=yes, resizable=yes, scrollbars=no");
		};
