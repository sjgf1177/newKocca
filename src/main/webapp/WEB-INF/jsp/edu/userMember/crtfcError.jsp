...
$(function() {
	...
	crtfcPopup = function() { // 휴대폰 인증 팝업창
		...
		window.open("/edu/userMember/crtfcPopup.do?viewType=BODY&authSe=02&val="+val+"&mode=CE", "crtfcPopup", "top=300, left=600, width=568, height=463, status=yes, resizable=yes, scrollbars=no");
	};
