...
<div class="over-hidden sub_contents_header">
	<div class="linemap_wrap"> <!-- fl class 삭제 -->
		<ul class="col-12 linemap_con">
			...
			<li><a href="javascript:void(0);" tabindex="-1"><span>신청정보입력</span></a></li>
		</ul>
	</div>
</div>

<div class="sub_title s_tit02">
	<div class="col-center mw-1280">신청정보입력</div>
</div>
	...
	<form name="agreeForm" id="agreeForm" action="/edu/bbs/B0000036/join03.do" method="post" enctype="multipart/form-data" class="form-inline"  onsubmit="return checkForm(this);return false;">
		...
		<div class="w100p">
			<div class="fl board_util_btn_con">
				<a href="/edu/bbs/B0000036/join01.do?menuNo=<c:out value="${param.menuNo }" />&amp;locationTp=prev" class="btn_style_0 gray">이전</a>
			</div>
			<div class="fr board_util_btn_con">
				<button type="submit" class="btn_style_0 full right">다음</button>
				<a href="javascript:void(0);" class="btn_style_0 gray">취소</a>
			</div>
		</div>
	</form>
