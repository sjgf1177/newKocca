...
<div class="over-hidden sub_contents_header">
	<div class="linemap_wrap"> <!-- fl class 삭제 -->
		<ul class="col-12 linemap_con">
			...
			<li><a href="javascript:void(0);" tabindex="-1"><span>글쓰기</span></a></li>
		</ul>
	</div>
</div>

<div class="sub_title s_tit02">
	<div class="col-center mw-1280">글쓰기</div>
</div>
				...
				<tbody style="border-top:2px solid #cccccc;">
					<tr class="phoneAtTr">
						...
						<td>
							...
							<a href="javascript:crtfcPopup('02');" title="휴대폰 인증하기(새창열림)" class="btn btn-default btn-sm" id="mbtlnumAuth" style=" color:white;">인증하기</a>
					...
					<tr class="emailAtTr" style="display:none;">
						...
						<td>
							...
							<a href="javascript:crtfcPopup('01');" title="이메일 인증하기(새창열림)" class="btn btn-default btn-sm" id="emailAuth" style=" color:white;">인증하기</a>
