...
<body>
<form id="frm" name="frm" action ="/bos/visitorLog/getByDay" method="post">
...
<ul class="tab_list">
	<!--현재 페이지일 경우 class="on" -->
	<li class="on"><a href="/bos/visitorLog/getByDay?vlSiteId=${param.vlSiteId}&sdate=${param.sdate}&edate=${param.edate}"><span>일별</span></a></li>
	<li ><a href="/bos/visitorLog/getByMonth?vlSiteId=${param.vlSiteId}&sdate=${param.sdate}&edate=${param.edate}"><span>월별</span></a></li>
	...
	<div>
		<table class="table table-bordered table-striped table-hover">
			...
			<c:forEach var="result" items="${resultList}" varStatus="status">
				<tr>
					<td class="output">${result.vlVisitDate}</td>
