...
<form action="/bos/fcltyResve/hldy/list.do" name="hldyForm" id="hldyForm" method="get" class="form-inline">
	...
	<table class="table table-bordered">
		...
		<c:forEach var="result" items="${resultList}" varStatus="status">
			<tr>
				...
				<td><a href="/bos/fcltyResve/hldy/forUpdate.do?hldyDe=<c:out value="${result.hldyDe }" />&amp;menuNo=<c:out value="${param.menuNo }" />"><c:out value="${result.hldyNm }" /></a></td>
...
<div class="btn_set"><a class="btn btn-primary" href="/bos/fcltyResve/hldy/forInsert.do?menuNo=<c:out value="${param.menuNo}"/>"><span>등록</span></a></div>
