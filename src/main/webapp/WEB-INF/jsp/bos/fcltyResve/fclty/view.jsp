...
<div class="btnSet clear mt20">
	...
	<div class="row">
		<div class="col-md-10 tac"><a class="btn btn-primary" href="/bos/fcltyResve/fclty/forUpdate.do?fcltySn=<c:out value="${result.fcltySn }" />&amp;${pageQueryString }"><span>수정</span></a>
			<a class="btn btn-default" href="/bos/fcltyResve/fclty/delete.do?fcltySn=<c:out value="${result.fcltySn }" />&amp;${pageQueryString }" id="delBtn"><span>삭제</span></a>
		</div>
		<div class="col-md-2 tac"><a class="btn btn-primary" href="/bos/fcltyResve/fclty/list.do?${pageQueryString }"><span>목록</span></a></div>
	</div>
</div>