...
<form id="fcltyForm" name="fcltyForm" method="get" action="/bos/fcltyResve/fclty/list.do">
	...
	<col />
		...
		<c:forEach var="result" items="${resultList}" varStatus="status">
			<tr>
				...
				<td><a href="/bos/fcltyResve/fclty/view.do?fcltySn=<c:out value="${result.fcltySn }" />&amp;${pageQueryString}"><c:out value="${result.spceNm }" />(<c:out value="${result.spceNmEn }" />)</a></td>
...
<div class="btn_set"><a class="btn btn-primary" href="/bos/fcltyResve/fclty/forInsert.do?${pageQueryString}"><span>등록</span></a></div>
