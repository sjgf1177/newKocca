...
$(function(){
	...
	$("#eqpmnPopupBtn").click(function() {
		if ($("input[name=eqpmnUseAt]:checked").val() != "Y") {
	  	...
	  	$( "#eqpmnPopup" ).load("/bos/fcltyResve/fclty/eqpmnPopup.do", params, function() {
...
<div class="btnSet clear mt20">
	...
	<div class="row">
		<div class="col-md-12 tac"><a class="btn btn-primary" href="#self" id="regBtn"><span>확인</span></a>
			<a class="btn btn-default" href="/bos/fcltyResve/fclty/list.do?${pageQueryString }"><span>취소</span></a>
		</div>
	</div>
</div>
