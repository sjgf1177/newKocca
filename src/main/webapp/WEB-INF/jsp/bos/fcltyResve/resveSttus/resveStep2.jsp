...
<form action="/bos/fcltyResve/resveSttus/resveSave.do" name="resveForm" id="resveForm" method="post" class="form-inline">
...
<div class="row clear mt20 tac">
	<div class="col-md-2"><a href="/bos/fcltyResve/resveSttus/resveStep1.do?menuNo=<c:out value="${param.menuNo }" />&amp;locationTp=prev" class="btn btn-default">이전</a></div>
	<div class="col-md-10">
		<a href="#self" class="btn btn-primary" id="resveRegBtn">다음</a>
		<a href="/bos/fcltyResve/resveSttus/list.do?menuNo=<c:out value="${param.menuNo }" />" class="btn btn-default">취소</a>
	</div>
</div>
</form>
