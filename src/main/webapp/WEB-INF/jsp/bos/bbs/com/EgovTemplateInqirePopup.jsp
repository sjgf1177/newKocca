	...
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="40%"class="title_left">
	   <img src="<c:url value='/images/egovframework/cop/com/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="absmiddle" alt="title icon">&nbsp;템플릿 목록</td>
	  <th >
	  </th>
	  <td width="10%" >
	...
	<table width="100%" cellpadding="8" class="table-line" border="0">
	 <thead>
	  <tr>
	    ...
	    <th class="title" width="37%" nowrap>템플릿경로</th>
		  ...
		  <tr>
			...
			<td class="lt_text3" nowrap>
		    	<c:if test="${result.useAt == 'Y'}">
		    		<input type="button" class="btn btn-default" name="selectTmplat" value="선택"
