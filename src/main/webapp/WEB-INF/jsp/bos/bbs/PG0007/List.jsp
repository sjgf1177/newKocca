...
<%-- 					<td class="output"><input type="checkbox" name="nttIdData" id="nttIdData_${result.nttId}" class="input_check" value="<c:out value="${result.nttId}"/>" /></td> --%>
					...
					<td class="tit">
						...
						<c:choose>
							...
							<span class="del">${result.option1}</span>
							</c:when>
							<c:otherwise>${result.option1}</c:otherwise>
						</c:choose>
					...
					<td class="output">${result.option2}</td>
			    	 ...
			    	 <td class="output">${result.option3Nm} 	</td>

					<td class="output">${result.option4}</td>
