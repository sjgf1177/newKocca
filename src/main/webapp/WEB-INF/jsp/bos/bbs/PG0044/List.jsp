	...
	<div id="content">
		...
		<div class="sh">
			...
			<legend>게시판 게시물검색</legend>
				...
				<label for="input1">
					<input id="input1" type="text" title="검색어입력" style="width:300px" name="searchWrd" value="${paramVO.searchWrd}" />
				</label>
			...
			<table class="table table-bordered table-striped table-hover">
				...
				<thead>
					<tr>
						...
						<th scope="col">첨부</th>
						<th scope="col">등록일</th>
						<th scope="col">요청 처리</th>
					</tr>
				</thead>
				<tbody>
				<c:forEach var="result" items="${resultList}" varStatus="status">
					<tr>
						<td class="output" style="text-align: center; vertical-align: middle;">${(resultCnt) - (paramVO.pageSize * (paramVO.pageIndex-1))}</td>
						<td class="tit" style="vertical-align: middle;">
				...
				<c:if test="${fn:length(resultList) == 0}"><tr style="text-align: center"><td colspan="7">데이터가 없습니다.</td></tr></c:if>
				</tbody>
			</table>
		</div>
