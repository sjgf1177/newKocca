...
$(function() {
	...
	$("#excelBtn").click(function() {
		$("#statsForm").attr("action","/bos/hkFcltyResve/stats/downloadExcelStatsFcltyByMonth.xls");
		$("#statsForm").submit();
		return false;
	});
});
...
<!-- 게시판 게시물검색 -->
<form name="statsForm" id="statsForm" method="get" action="/bos/hkFcltyResve/stats/downloadExcelStatsFcltyByMonth.xls">
	<input type="hidden" name="menuNo" value="<c:out value="${param.menuNo }" />" />
<div class="sh form-inline pr10">
	<fieldset>
		<legend>시섧별 이용현황 현황 검색</legend>
		<div class="shView">
			<table class="table">
				<caption>
				</caption>
