...
$(document).ready(function(){
	...
	var strKey = '${paramVO.searchWrd}'; // 하이라이트를 적용할 스트링
	 ...
	 if(strKey != ''){
		...
		<!-- 게시판 게시물검색 start -->
	<form  id="frm" name="frm" action="/bos/ntcnAlert/list.do?type=02&siteId=${param.siteId}&menuNo=${param.menuNo}" method="post">
		<div class="sh">
			<fieldset>
			...
			<tbody>
				<c:forEach items="${resultList}" var="item" varStatus="status">
					<tr>
						...
						<td><fmt:formatDate value="${item.frstRegistPnttm}" pattern="yyyy-MM-dd"/></td>
