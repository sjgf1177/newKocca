...
<form method="post" name="frm" action="/bos/admin/member/listPop">
	...
	<div>
		<table class="table table-bordered table-striped table-hover">
			...
			<c:forEach var="result" items="${resultList}" varStatus="status">
				...
				<a href="${url}">${result.userId}</a>
					</td>
					<td><a href="${url}">${result.userName}</a></td>
					<td><a href="${url}">${result.smNm}</a></td>
					<td><a href="${url}">${result.gwaName}</a></td>
