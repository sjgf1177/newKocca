...
<html lang="ko">
<head>
<title>총괄담당자 관리(구청장에게 바란다)</title>
<meta charset="utf-8" />
...
<script type="text/javascript">
	...
	$(function(){
		...
		var link = "/bos/member/managerYnMemberList.do?programId=adminMember";
		...
		$("#assignDeptY").click(function(){
			...
			$.post(
					"/bos/member/updateManagerYn.json",
					{userId : userId, managerYn : 'Y'},
					function(data)
					{
...
<body>
	...
	<div id="content">
		<div class="hgroup">
			<h3>총괄담당관리(구청장에게 바란다)</h3>
		</div>

	<form method="post" name="frm" action="/bos/member/managerYnMemberList.do?programId=adminMember">
		<div class="sh">
			<fieldset>
		...
		<tbody>
			<tr>
				...
				<td colspan="3">
					...
					<span class="button sky"><a id="assignDeptY" href="javascript:void(0)">총괄담당 지정하기</a></span>
					<br />
				</td>
			</tr>
		</tbody>
