...
$(function() {
	...
	$("#excelBtn").click(function() {
		$("#statsForm").attr("action","/bos/hkFcltyResve/stats/downloadExcelStatsUsePurpsByMonth.xls");
		$("#statsForm").submit();
		return false;
	});
});
...
<!-- 게시판 게시물검색 -->
<form name="statsForm" id="statsForm" method="get" action="/bos/hkFcltyResve/stats/downloadExcelStatsUsePurpsByMonth.xls">
