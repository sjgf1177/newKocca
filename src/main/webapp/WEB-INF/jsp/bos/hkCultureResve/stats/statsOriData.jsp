...
$(function() {
	...
	$("#excelBtn").click(function() {
		$("#statsForm").attr("action","/bos/hkFcltyResve/stats/downloadExcelStatsOriData.xls");
		$("#statsForm").submit();
		return false;
	});
});
...
<!-- 게시판 게시물검색 -->
<form name="statsForm" id="statsForm" method="get" action="/bos/hkFcltyResve/stats/downloadExcelStatsOriData.xls">
	<input type="hidden" name="menuNo" value="<c:out value="${param.menuNo }" />" />
<div class="sh form-inline pr10">
	<fieldset>
		<legend>시설예약(원시데이터) 검색</legend>
		<div class="shView">
			<table class="table">
				<caption>
				</caption>
