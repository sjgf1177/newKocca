...
<form id="eqpmnForm" name="eqpmnForm" method="get" action="/bos/hkEtcResve/eqpmn/list.do" class="form-inline">
	...
	<table class="table table-bordered">
		...
		<c:forEach var="result" items="${resultList}" varStatus="status">
			<tr>
				...
				<td><a href="/bos/hkEtcResve/eqpmn/view.do?eqpmnSn=<c:out value="${result.eqpmnSn }" />&amp;${pageQueryString}"><c:out value="${result.eqpmnNm }" /></a></td>
...
<div class="btn_set"><a class="btn btn-primary" href="/bos/hkEtcResve/eqpmn/forInsert.do?${pageQueryString}"><span>등록</span></a></div>
