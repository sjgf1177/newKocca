...
<c:if test="${empty result}">
	<c:set var="action" value="/bos/hkEtcResve/eqpmn/insert.do" />
	<c:set var="actTp" value="insert" />
</c:if>
<c:if test="${not empty result}">
	<c:set var="action" value="/bos/hkEtcResve/eqpmn/update.do" />
...
<input type="hidden" name="resveSe" value="A" id="resveSe01" checked="checked"/>
<fieldset>
	<legend></legend>
		<div class="bdView">
				...
				<tr>
					...
					<td colspan="3">
						<select name="eqpmnSe" id="eqpmnSe" title="장비구분을 선택해 주세요.">
						 ...
						 <c:forEach var="item" items="${COM148CodeList }">
...
<div class="btnSet clear mt20">
	...
	<div class="row">
		<div class="col-md-12 tac"><a class="btn btn-primary" href="#self" id="regBtn"><span>확인</span></a>
			<a class="btn btn-default" href="/bos/hkEtcResve/eqpmn/list.do?${pageQueryString }"><span>취소</span></a>
		</div>
	</div>
</div>
