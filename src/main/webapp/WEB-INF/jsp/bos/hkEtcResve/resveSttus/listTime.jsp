...
<!-- <p class="timerHead">
	<span class="fcGreen"><span class="reserve_dot1"></span>예약가능</span>
	<span class="fcRed"><span class="reserve_dot2 ml5"></span>예약완료</span>
</p> -->
<div class="timerBox">
	<div class="timerAm">
		<ul>
	...
	<div class="timerPm">
		<ul>
			...
			<li class="resve_ok"><div><a id="AllTime" data-value="23" href="javascript:AllTimeClick();" style="font-size: 11px;">전체선택</a></div></li>
		</ul>
	</div>
</div>
