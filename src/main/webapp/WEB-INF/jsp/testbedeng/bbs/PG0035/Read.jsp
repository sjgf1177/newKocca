...
<script type="text/javascript">
	...
	<div class="board_util_btn_con">
		...
		<a href="/${paramVO.siteName}/bbs/${paramVO.bbsId}/forUpdate.do?nttId=${result.nttId}&amp;${pageQueryString}" class="btn_style_0 full edit" style="border-color: #ff7800;background-color: #ff7800;">
			수정
		</a>
	</div>