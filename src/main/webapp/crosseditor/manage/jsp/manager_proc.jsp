...
<%
	...
	if(check){
		result_sc = "<script type='text/javascript' language='javascript'>alert(pe_bE.pe_os); window.document.location.href='manager_setting.jsp?Tab=" + detectXSSEx(request.getParameter("Tab")) + "';</script>";
	}
	else{
