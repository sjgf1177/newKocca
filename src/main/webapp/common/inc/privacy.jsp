...
<div class="col-12 sub_section useful_section">
	...
	<table class="table_style_1" summary="personal data referral">
		...
		<tbody>
			<tr>
				<td>개인 회원명부</td>
				<td style="text-align:left; padding-left:10px;">· 필수항목 : 이름, 생년월일, 성별, 아이디, 비밀번호, 이메일, 휴대폰, 인재캠퍼스 정보수신 여부,<br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					콘텐츠문화광장 정보수신 여부, 직업, 거주지역-국내·해외, 거주지역-시도·군구, 소속,<br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<tr>
				<td>오프라인교육<br>신청</td>
				<td style="text-align:left; padding-left:10px;">
					· 필수항목 : 아이디, 이름, 생년월일, 성별, 이메일, 자택 전화번호, 휴대폰번호, 회사 전화번호, <br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					주소, 거주지역, 직업, 소속
					<br>
					· 선택항목 : 전문분야, 직위, 경력, 학력 등 교육프로그램에 따라 다르며 정보주체로부터 별도의 <br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					동의를 얻어 수집 및 처리
				</td>
				<td>3년</td>
