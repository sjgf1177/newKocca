...
$(function(){
		...
		for (var i=0;i<date_s.length ; i++ ){
			var innerhtml="<div class=\"calendarzone\"><input type=\"button\" src=\"/portal/images/common/cal.gif\" alt=\"시작날짜 달력에서 선택\" onclick=\"return showCalendar('startDate-lry');\"/><div id=\"startDate-lry\" class=\"calendarSLayer\"><iframe id=\"startDate-ifrm\" name=\"startDate-ifrm\" class=\"calendar-frame\" src=\"/deu/html/incFrCalendar.html\" title=\"시작 날짜입력 프레임\" frameborder=\"0\" scrolling=\"no\"><\/iframe></div></div>";
			$(date_s[i]).before( innerhtml );
		}

		var date_e = $('.edate');
		for (var i=0;i<date_e.length ; i++ ){
			var innerhtml="<div class=\"calendarzone\"><input type=\"button\" src=\"/deu/images/common/cal.gif\" alt=\"종료날짜 달력에서 선택\"  onclick=\"return showCalendar('endDate-lry');\"/><div id=\"endDate-lry\" class=\"calendarSLayer\"><iframe id=\"endDate-ifrm\" name=\"endDate-ifrm\" class=\"calendar-frame\" src=\"/edu/html/incFrCalendar.html\" title=\"종료 날짜입력 프레임\" frameborder=\"0\" scrolling=\"no\"><\/iframe></div></div>";
