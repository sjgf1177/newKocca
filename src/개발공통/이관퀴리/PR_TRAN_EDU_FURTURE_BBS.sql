CREATE OR REPLACE PROCEDURE PR_TRAN_EDU_FURTURE_BBS
IS
v_maxNttId NUMBER;
v_maxFileId	NUMBER;
BEGIN
    ...
    AND B.OPENYN = 'Y' AND B.category = '3'
    AND ATCH_FILE_ID IS NOT NULL
    AND A.BBS_ID = 'B0000020'
