...
<style type="text/css">
    ...
    @media print{
        *{margin:0; padding:0;}
        ...
        .reserve_print_contents{position:absolute; top:10px; left:50%; margin-left:-175px;}
    }
...
<script type="text/javascript">
	...
	if(contentObj)
    {
        ...
        var str = //"<div id='wrap'>\n"
            "<div class='col-12 reserve_print_contents' id='ticketPrint' onselectstart='return false'>\n"
            + openerHtml
        + "<\/div>";
        //+ "<\/div>";
        document.write(str);
