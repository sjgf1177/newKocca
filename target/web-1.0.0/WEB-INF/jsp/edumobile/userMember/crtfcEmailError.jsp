...
$(function() {
		...
		$.post(
			...
			function(data) {
				if (data.resultCode == "success") {
					alert("재발송되었습니다.");
					//location.href = "/edumobile/member/forLogin.do?menuNo=500077";
				}
			},"json"
		);
	};
	...
	crtfcPopup = function() { // 휴대폰 인증 팝업창
		...
		window.open("/edumobile/userMember/crtfcPopup.do?viewType=BODY&authSe=02&val="+val+"&mode=CE", "crtfcPopup", "top=300, left=600, width=568, height=463, status=yes, resizable=yes, scrollbars=no");
	};
