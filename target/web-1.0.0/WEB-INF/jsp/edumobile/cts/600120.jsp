...
<div class="fontsize0 sub_contents_body sub_board_wrap">
	...
	<input type="hidden" name="pageQueryString" value="searchCnd=&amp;searchWrd=&amp;gubun=&amp;delCode=0&amp;useAt=&amp;replyAt=&amp;menuNo=500045&amp;sdate=&amp;edate=&amp;viewType=&amp;type=&amp;siteId=&amp;option1=&amp;option5=&amp;pageIndex=1">-->
            <span class="tl select_box">
                <select name="" id="" class="select_style_0">
	...
	<div class="col-12 sub_contents_view_calendar">
	    <div class="col-12 calc_wrap25">
	    	<div class="col-12 col-sm-4 sub_contents_view_calendar_list">
	            <a class="border_box" href="javascript:void(0)" data-for="sub_view_${paramVO.menuNo}v04">
	                <div class="img_box">
	        ...
	        <div class="col-12 col-sm-4 sub_contents_view_calendar_list">
	            <a class="border_box" href="javascript:void(0)" data-for="sub_view_${paramVO.menuNo}v01">
	                <div class="img_box">
	                    <div class="hidden_text_wrap">
	                        <div class="hidden_text_con">
	                            <div class="hidden_text">
	        ...
	        <div class="col-12 col-sm-4 sub_contents_view_calendar_list">
	            <a class="border_box" href="javascript:void(0)" data-for="sub_view_${paramVO.menuNo}v02">
	                <div class="img_box">
	                    <div class="hidden_text_wrap">
	                        <div class="hidden_text_con">
	                            <div class="hidden_text">
	        ...
	        <div class="col-12 col-sm-4 sub_contents_view_calendar_list">
	            <a class="border_box" href="javascript:void(0)" data-for="sub_view_${paramVO.menuNo}v03">
	                <div class="img_box">
	                    <div class="hidden_text_wrap">
	                        <div class="hidden_text_con">
	                            <div class="hidden_text">
...
$(function(){
	...
	var selClickView = ".sub_contents_view_calendar_list .border_box";
