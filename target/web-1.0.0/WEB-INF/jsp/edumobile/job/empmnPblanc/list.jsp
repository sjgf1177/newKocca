...
<!-- search Panel -->
<c:url value="/edumobile/job/empmnPblanc/list.do" var="searchUrl" >
...
<div class="schPanel">
	...
	<input type="hidden" name="pblancSn" value="${empty result.pblancSn ? 0 : result.pblancSn }" />
		<fieldset>
			...
			<div class="mb20">
				<table cellspacing="0" cellpadding="0" class="contents_insight_view contact_us_view work_tb">
...
<div class="col-12 sub_board_body">
	<table class="board_type_0 small job_recruit" style="word-break:break-all;">
		<caption>(콘텐츠아카데미) 채용정보 목록</caption>
		<colgroup>
			<col style="width:10%">
			<col style="width:15%">
		...
		<tbody>
			...
			<tr>
				...
				<td class="tal">
					<c:url var="url" value="/edumobile/job/${paramVO.programId}/view.do?pblancSn=${result.pblancSn}&" />
