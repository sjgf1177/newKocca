...
<ccc:constantsMap className="kr.co.unp.bbs.vo.SearchVO" var="SearchVO"/>
	...
	<div class="tab_style_1_con">
		<ul class="tab_style_1">
			<li class="active"><a href="/edumobile/bbs/B0000041/list.do?menuNo=600088"><span>현장스토리</span></a></li>
			<li><a href="/edumobile/bbs/B0000045/list.do?menuNo=600110"><span>멘토링 현장영상</span></a></li>
		</ul>
	</div>
	 -->
