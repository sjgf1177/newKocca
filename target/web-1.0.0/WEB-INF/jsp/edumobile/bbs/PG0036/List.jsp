			...
			<tbody>
				<c:forEach var="result" items="${resultList}" varStatus="status">
					<tr<c:if test="${result.nttType=='1'}"> class="notice_title"</c:if>>
						...
						<td style="text-align:center; white-space:inherit; overflow: hidden; text-overflow:ellipsis;">${result.option11 }</td>
						<td class="tal" style="color:#313131;">
							<a href="<c:out value='${result.option12 }' escapeXml='false'/>" target="_blank" title="새창열림" style="white-space:inherit;" >
