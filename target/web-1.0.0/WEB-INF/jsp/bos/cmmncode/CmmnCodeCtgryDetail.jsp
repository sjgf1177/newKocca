...
<!--
	 ...
	 ******************************************************** */
	function fnList() {
		location.href = "/bos/cmmncode/CmmnCodeCtgryList.do?menuNo=${param.menuNo}";
	}
	/* ********************************************************
	 * 수정화면으로  바로가기
	 ******************************************************** */
	function fnModify() {
		...
		varForm.action = "<c:url value='/bos/cmmncode/CmmnCodeCtgryModify.do?menuNo=${param.menuNo}'/>";
	...
	function fnDelete() {
		if (confirm("<spring:message code="common.delete.msg" />")) {
			var varForm = document.all["Form"];
			varForm.action = "<c:url value='/bos/cmmncode/CmmnCodeCtgryRemove.do?menuNo=${param.menuNo}'/>";
			varForm.codeId.value = "${result.codeId}";
			varForm.submit();
		}
	}
...
<form name="Form" action="" method="post">
	<input name="codeId" type="hidden"> <input name="cmd" type="hidden">
</form>
<div class="bdView">
	<table>
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<textarea class="textarea" cols="75" rows="14" style="width: 450px;" disabled="true">${result.codeIdDc}</textarea>
				</td>
			</tr>
			<tr>
...
<div class="btn_set">
	<a class="btn btn-primary" href="javascript:fnModify();">
		<span>수정</span>
	</a>
	<a class="btn btn-danger" href="javascript:fnDelete();">
		<span>삭제</span>
	</a>
	<a class="btn btn-primary" href="javascript:fnList();">
		<span>목록</span>
	</a>
</div>
