...
<form action="/bos/fcltyResve/schdul/list.do" name="hldyForm" id="hldyForm" method="get" class="form-inline">
	...
	<table class="table table-bordered">
		...
		<c:forEach var="result" items="${resultList}" varStatus="status">
			<tr>
				...
				<td><a href="/bos/fcltyResve/schdul/forUpdate.do?eventSn=<c:out value="${result.eventSn }" />&amp;menuNo=<c:out value="${param.menuNo }" />"><c:out value="${result.eventNm }" /></a></td>
...
<div class="btn_set"><a class="btn btn-primary" href="/bos/fcltyResve/schdul/forInsert.do?menuNo=<c:out value="${param.menuNo}"/>"><span>등록</span></a></div>
