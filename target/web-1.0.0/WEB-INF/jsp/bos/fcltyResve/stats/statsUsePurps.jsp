...
$(function() {
	...
	$("#excelBtn").click(function() {
		$("#statsForm").attr("action","/bos/fcltyResve/stats/downloadExcelStatsUsePurps.xls");
		$("#statsForm").submit();
		$("#statsForm").attr("action","/bos/fcltyResve/stats/statsUsePurps.do");
...
<!-- 게시판 게시물검색 -->
<form name="statsForm" id="statsForm" method="get" action="/bos/fcltyResve/stats/statsUsePurps.do">
