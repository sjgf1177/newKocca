...
$(function(){
	...
	$("#excelBtn").click(function() {
		$("#statsForm").attr("action","/bos/hkCultureResve/stats/downloadExcelStatsFclty.xls");
		$("#statsForm").submit();
		return false;
	});
});
...
<!-- 게시판 게시물검색 -->
<form name="statsForm" id="statsForm" method="get" action="/bos/hkCultureResve/stats/statsFclty.do">
		...
		<div class="shView">
			<table class="table">
				...
				<tbody>
					...
					<tr>
						<th scope="row" ><label for="ageSe">검색구분</label></th>
						<td>
