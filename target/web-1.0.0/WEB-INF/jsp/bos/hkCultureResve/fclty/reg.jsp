...
<c:if test="${empty result}">
	<c:set var="action" value="/bos/hkCultureResve/fclty/insert.do" />
	<c:set var="actTp" value="insert" />
</c:if>
<c:if test="${not empty result}">
	<c:set var="action" value="/bos/hkCultureResve/fclty/update.do" />
...
<div class="btnSet clear mt20">
	...
	<div class="row">
		<div class="col-md-12 tac"><a class="btn btn-primary" href="#self" id="regBtn"><span>확인</span></a>
			<a class="btn btn-default" href="/bos/hkCultureResve/fclty/list.do?${pageQueryString }"><span>취소</span></a>
		</div>
	</div>
</div>
