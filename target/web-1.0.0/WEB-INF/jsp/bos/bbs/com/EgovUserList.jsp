	...
	<table width="100%" cellpadding="8" class="table-line">
	 <thead>
	  <tr>
	    ...
	    <th class="title" width="8%" nowrap>번호</th>
	    <th class="title" width="12%" nowrap>사용자아이디</th>
	    <th class="title" width="13%" nowrap>사용자명</th>
	    <th class="title" width="35%" nowrap>주소</th>
	    <th class="title" width="12%" nowrap>이메일</th>
	    <th class="title" width="20%" nowrap>비고</th>
	  </tr>
	 </thead>
	 <tbody>
		    ...
		    <td class="lt_text3" nowrap>
		    	<c:choose>
		    		<c:when test="${result.useAt == 'Y'}">
		    			<input type="button" class="btn btn-default" value="탈퇴"  onClick="javascript:fn_egov_deleteUser('<c:out value="${result.uniqId}"/>')" />
		    			|<input type="button" class="btn btn-default" value="운영진등록" onClick="javascript:fn_egov_registManager('<c:out value="${result.uniqId}"/>');" />
		    		</c:when>
		    		<c:otherwise>
		    			|<input type="button" class="btn btn-default" value="재가입" onClick="javascript:fn_egov_reRegistUser('<c:out value="${result.uniqId}"/>');" />
		    		</c:otherwise>
		    	</c:choose>
		    </td>
		  </tr>
