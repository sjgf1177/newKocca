...
<form id="board" name="board" method="post" enctype="multipart/form-data" action="${action}">
	...
	<div class="bdView">
		<table summary="게시구분,게시기간,제목,작성자,전화번호,이메일,내용,첨부,등록일,조회수,답변상태  포함">
			...
			<c:if test="${result.bbsId eq 'B0000076'}">
				<tr>
			...
			<c:if test="${result.option2 eq '02'}">
				<tr>
					<th scope="row">참여사업명</th>
					<td>
						${result.option1}
					</td>
				</tr>
				...
				<c:if test="${masterVO.fileAtchPosblAt eq 'Y' && result.option2 eq '03'}">
					<tr>
