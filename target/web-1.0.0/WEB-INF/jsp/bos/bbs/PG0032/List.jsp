	...
	<div>
		<table class="table table-bordered table-striped table-hover">
			...
			<c:forEach var="result" items="${resultList}" varStatus="status">
				<c:set var="infoPageSize" value="9"/> 
				<tr><!-- ${paramVO.pageSize} ${paramVO.pageIndex} -->
					<td class="output">${result.nttType=='1' ? '진행중' : (resultCnt) - (infoPageSize * (paramVO.pageIndex-1))}</td>
					...
					<td class="tit">
		    	 	...
		    	 	<td class="output">${result.option2}
			    	</td>
