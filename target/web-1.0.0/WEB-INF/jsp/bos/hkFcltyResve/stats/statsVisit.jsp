...
$(function() {
	...
	$("#excelBtn").click(function() {
		$("#statsForm").attr("action","/bos/hkFcltyResve/stats/downloadExcelStatsVisit.xls");
		$("#statsForm").submit();
		$("#statsForm").attr("action","/bos/hkFcltyResve/stats/statsVisit.do");
...
<!-- 게시판 게시물검색 -->
<form name="statsForm" id="statsForm" method="get" action="/bos/hkFcltyResve/stats/statsVisit.do">
