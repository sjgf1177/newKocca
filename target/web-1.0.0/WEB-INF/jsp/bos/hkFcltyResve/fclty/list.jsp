...
<form id="fcltyForm" name="fcltyForm" method="get" action="/bos/hkFcltyResve/fclty/list.do">
	...
	<col />
		...
		<c:forEach var="result" items="${resultList}" varStatus="status">
			<tr>
				...
				<td><a href="/bos/hkFcltyResve/fclty/view.do?fcltySn=<c:out value="${result.fcltySn }" />&amp;${pageQueryString}"><c:out value="${result.spceNm }" />(<c:out value="${result.spceNmEn }" />)</a></td>
...
<div class="btn_set"><a class="btn btn-primary" href="/bos/hkFcltyResve/fclty/forInsert.do?${pageQueryString}"><span>등록</span></a></div>
