...
<c:if test="${empty result}">
	<c:set var="action" value="/bos/hkFcltyResve/hldy/insert.do" />
	<c:set var="actTp" value="insert" />
</c:if>
<c:if test="${not empty result}">
	<c:set var="action" value="/bos/hkFcltyResve/hldy/update.do" />
...
<div class="row clear mt20 tac">
	<div class="col-md-12">
		...
		<a class="btn btn-primary" href="/bos/hkFcltyResve/hldy/delete.do?hldyDe=<c:out value="${result.hldyDe }" />&amp;${pageQueryString }" id="delBtn"><span>삭제</span></a>
		</c:if>
		<a class="btn btn-default" href="/bos/hkFcltyResve/hldy/list.do?${pageQueryString }"><span>취소</span></a>
	</div>
</div>
