...
<div class="btnSet clear mt20">
	...
	<div class="row">
		<div class="col-md-10 tac"><a class="btn btn-primary" href="/bos/hkEtcResve/eqpmn/forUpdate.do?eqpmnSn=<c:out value="${result.eqpmnSn }" />&amp;${pageQueryString }"><span>수정</span></a>
			<a class="btn btn-default" href="/bos/hkEtcResve/eqpmn/delete.do?eqpmnSn=<c:out value="${result.eqpmnSn }" />&amp;${pageQueryString }" id="delBtn"><span>삭제</span></a>
		</div>
		<div class="col-md-2 tac"><a class="btn btn-primary" href="/bos/hkEtcResve/eqpmn/list.do?${pageQueryString }"><span>목록</span></a></div>
	</div>
</div>