...
<div class="row clear mt20 tac">
	<div class="col-md-12"><a href="/bos/hkEtcResve/resveSttus/list.do?menuNo=<c:out value="${param.menuNo }" />" class="btn btn-primary">확인</a></div>
</div>
