...
//]]>
	...
	<div id="header">
		<div class="gnbSet">
			<div class="logo"><a href="/ckl/main/main.do"> <img src="/ckl/images/main/logo.gif" alt=""> </a></div>
			<div id="gnb">
				<div id="gnbbg"></div>
			...
			<div class="globalSet">
				...
				<a href="#self" class="closePopup"> <img src="/ckl/images/main/closePopup_on.gif" width="62" height="60" alt=""> </a>
				<a href="#self" class="closePopupOpen"> <img src="/ckl/images/main/closePopup_off.gif" width="62" height="60" alt=""> </a>
				...
				<!-- //outLogin -->
				<a href="#self" class="login3Close"> <img src="/ckl/images/main/closeLogin.png" width="100" height="60" alt=""> </a>
				<!-- //login -->
