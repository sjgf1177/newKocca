...
$(function() {
	...
	crtfcPopup = function() { // 휴대폰 인증 팝업창
		...
		window.open("/ckl/userMember/crtfcPopup.do?viewType=BODY&authSe=02&val="+val+"&mode=CE", "crtfcPopup", "top=300, left=600, width=568, height=463, status=yes, resizable=yes, scrollbars=no");
	};
...
<div class="boxGray  mt40 mb40 pt30 pb30">
	<p class="mt20">
		아래 버튼을 클릭하여 이메일 및 휴대폰 인증을 하셔야 에듀코카에서 제공하는 서비스를 이용하실 수 있습니다.
	</p>
