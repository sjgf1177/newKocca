...
//<![CDATA[
	...
	$(function(){
		...
		crtfcPopup = function(authSe) { // 휴대폰 인증 팝업창
			...
			window.open("/ckl/userMember/crtfcPopup.do?viewType=BODY&authSe="+authSe+"&val="+val+"&mode=PE", "crtfcPopup", "top=300, left=600, width=568, height=463, status=yes, resizable=yes, scrollbars=no");
		};
...
<c:choose>
	<c:when test="${result.authSe eq '01'}">
		...
		<p class="bgn fs3 tac">비밀번호 입력이 5회 틀렸습니다. 비밀번호가 입력이 5회 틀린 경우 해당 아이디는 <span class="fcBlack">“잠김상태”</span>로 전환됩니다.</p>
	...
	<c:otherwise>
		...
		<div class="boxGray">
			<p class="bgn fs3 tac">비밀번호 입력이 <span class="text-danger">5회</span> 틀렸습니다.</p>
		</div>
		<div class="mt40 mb40 pt30 pb30">
			<p class="tac">
			비밀번호가 입력이 5회 틀린 경우 해당 아이디는 <span class="text-danger">“잠김상태”</span>로 전환됩니다.<br /><br />
