				...
				<div class="popupList">
					<ul>
						<c:forEach items="${mainPopupList}" var="result" varStatus="status">
							<li>
								<a href="<c:out value="${result.ntcnUrl}"/>" <c:if test="${result.popupAt eq 'Y'}">target="_blank"</c:if> title="새창열림">
...
<body style="margin:0;">
	<p style="margin: 0;"><img src="/upload/testbed/ckl_temp_20170901.jpg" alt="공사중" style="margin:0; width: 100%;" /></p>

	<%--
<ol>
	<li><a href="/bos/member/forLogin.do">관리자페이지</a><br/> </li>
	<li><a href="/edu/main/main.do">EDU 사용자  MAIN</a></li>
	<li><a href="/edu/main/main.do"><%=requestUri%></a></li>
	<li><a href="/edu/main/main.do"><%=debug%></a></li>
<!--
	<li><a href="/edu/main/contents.do?menuNo=500002">EDU 사용자 서브 페이지</a> </li>
	<li><a href="/ckl/main/main.do">CKL 사용자  MAIN</a></li>
	<li><a href="/ckl/main/contents.do?menuNo=200002">CKL 사용자 서브 페이지</a> </li>
	<li><a href="/edu/guide/main.html">EDU guide.html</a> </li>
	<li><a href="/ckl/guide/main.html">CKL guide.html</a> </li>
-->
</ol>
	--%>
</body>
