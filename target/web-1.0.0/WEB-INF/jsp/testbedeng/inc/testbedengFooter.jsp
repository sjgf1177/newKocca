                ...
                <div class="col-xl-4 col-lg-4 col-md-12 ml-auto">
                    ...
                    <div>
                        ...
                        <ul class="footer_util_link">
                            <li><a href="#none" onclick="markPopupI('2018-R049');" title="새창열림">
                            	<img src="http://www.eprivacy.or.kr/seal/mark_i.gif" alt="인터넷 사이트 안전마크(i-Safe, 개인정보보호, 시스템보안, 소비자 보호)">
                            </a></li>
                            <li><a href="#none" onclick="markPopupE('2018-R102');" title="새창열림">
                            	<img src="http://www.eprivacy.or.kr/seal/mark_e.gif" alt="개인정보보호우수사이트(ePrivacy) 인증마크">
                            </a></li>
                            ...
                            <li><a href="javascript:winMarkPopup('/contents/temp/internet_comunication_satisfaction_2020.html','','status=yes,scrollbars=no,width=430,height=575');" title="새창열림">
                           		<img src="/edu/images/bm/internet_comunication_satisfaction_logo_2018.png" alt="대한민국인터넷소통대상 (ICSI)인증마크">
                            </a></li>
