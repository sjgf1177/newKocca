	...
	<div id="content">
		...
		<div class="sh">
			...
			<legend>게시판 게시물검색</legend>
				...
				<label for="input2">
					<input type="submit" id="input2" name="input2" value="검색" class="btn btn-default" title="검색"/>
				</label>
			</fieldset>
		</div>
		<!-- 게시판 게시물검색 end -->
			...
			<c:forEach var="result" items="${resultList}" varStatus="status">
				...
				<tr>
					...
					<td class="output tac">
						...
						<a class="btn btn-primary" href="/bos/concert/concertUser/delete.do?userId=${result.userId}&${pageQueryString}" onclick="return confrm('정말로 삭제하시겠습니까?');"><span>삭제</span></a>
					</td>
