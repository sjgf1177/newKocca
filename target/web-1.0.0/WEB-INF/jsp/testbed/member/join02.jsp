	...
	<form name="agreeForm" id="agreeForm" action="/testbed/userMember/joinMember.do" method="post">
		...
		<div id="joinStep3" style="display: none;">
			...
			<div class="signup_write_con">
				...
				<table class="table_style_0">
					...
					<tr>
						...
						<td>
							<span class="board_type_1_input_con">
								<input type="text" id="user_name" class="input_style_0 size_40" name="userNm" id="userNm" value="" placeholder="홍길동" title="이름">
					...
					<tr>
						...
						<td>
							<span class="board_type_1_input_con">
								<input type="text" id="brthdy" name="brthdy" class="sdate input_style_0 size_40" style="width:125px" value="" title="생년월일 YYYYMMDD"/>
							</span>
							<hr class="calender_line">
							<span class="radio_box_con">
								<input type="radio" class="radio_style_0"  name="sex" value="M" id="sex1" title="성별선택 라디오 - 남자" <c:if test="${user.sex eq 'M'}">checked="checked" </c:if>>
								<label for="sex1">남자</label>
							</span>
							<span class="radio_box_con">
								<input type="radio" class="radio_style_0" name="sex" value="W" id="sex2" title="성별선택 라디오 - 여자" <c:if test="${user.sex eq 'W'}">checked="checked" </c:if>>
					...
					<tr>
						...
						<td>
							<div class="input_wrap">
								...
								<span class="board_type_1_input_con">
									<input type="text" name="userId" id="userId" value="" onkeyup="this.value=checkId(this.value)" style="margin-right:10px;" title="6~16자까지 영문자(소문자), 숫자 사용 가능합니다.">
							...
							<div class="input_wrap">
								<span class="board_type_1_input_con">
									<input type="password" class="input_style_0" name="password" id="password" value="" placeholder="******" onkeyup="this.value=checkPwd(this.value)" 
										title="9~15자까지 영문 대/소문자, 숫자, 특수문자중 3개 이상의 조합. 
				...
				<table class="table_style_0">
						...
						<td>
							<div class="input_wrap">
								<c:choose>
									...
									<span class="board_type_1_input_con">
										<input name="email1" id="email1" class="input_style_0 size_20" type="text" title="직접입력" value="" />
										<label for="email1">이메일 아이디</label>
									</span>
									<span class="table_text line">@</span>
									<span class="board_type_1_input_con">
										<input type="text" name="email2" id="email2" class="input_style_0 size_20" title="직접입력" value="" />
									...
									<span class="board_type_1_select_con">
										...
										<label for="email_address_select">이메일 주소 선택</label>
										<script type="text/javascript">
											//<![CDATA[
											jQuery(function(){
					...
					<tr>
						...
						<td>
							...
							<span class="table_text line">-</span>
							<span class="board_type_1_input_con">
								<input type="text" value="" id="mbtlnum2" name="mbtlnum2" class="input_style_0 size_15 phone" title="휴대폰 중간자리를 입력하세요." maxlength="4" onkeyup="this.value=check_txt(this.value)" style="width:100%;"/>
								<!-- <label for="mbtlnum2"></label> -->
							</span>
							<span class="board_type_1_input_con">
								<input type="text" class="input_style_0 size_15 phone" value="" id="mbtlnum3" name="mbtlnum3" class="w20p" title="휴대폰 끝자리를 입력하세요." maxlength="4" onkeyup="this.value=check_txt(this.value)" style="width:100%;"/>
				...
				<table class="table_style_0">
					...
					<tr>
						...
						<td>
							<span class="radio_box_con">
								<input type="radio" class="radio_style_0"  name="resdncSe" value="01" id="resdncSe1" title="거주지 선택 라디오 - 국내" <c:if test="${empty result}">checked="checked"</c:if>>
			...
			<div class="fl board_util_btn_con">
				<a href="javascript:void(0);" class="btn_style_0 blue left" id="joinPrevStep3">
					이전
				</a>
			</div>
			<div class="fr board_util_btn_con">
