...
$(function() {
	...
	if (mode == "i") {
		...
		$.post(
			"/testbed/userMember/reAgreRequest.json",
...
<ul class="list_style_3">
	...
	<ul class="list_style_4 color_gray">
		...
		<li>
			제1항에 따른 권리 행사는 개인정보의 오류 등에 대한 정정 또는 삭제를 요구한 경우에는 에듀코카는 정정 또는 삭제를 완료할 때까지 당해 개인정보를 이용하거나 제공하지 않습니다.
		</li>
		<li>
			기타('에듀코카‘)의 개인정보파일 등록사항 공개는 행정안전부 개인정보보호 종합지원 포털(<a href="http://www.privacy.go.kr" target="_blank" title="새창열림">www.privacy.go.kr</a>)
...
<c:if test="${param.mode eq 'i'}">
	...
	<div class="btnSet">
		...
		<a href="/testbed/userMember/secsn.do?menuNo=700120" class="btn btn-danger">서비스 탈퇴</a>
	</div>
</div>
