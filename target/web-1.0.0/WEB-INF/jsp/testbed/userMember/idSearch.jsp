...
$(function(){
	...
	$("#idSearchBtn").click(function(){
		...
		$.post(
			"/testbed/userMember/idSearchRequest.json",
        ...
        <form action="#" class="search_pw_form">
            <div class="input_wrap">
                ...
                <div class="input_style_2_con">
                    <input type="text" class="input_style_2" name="userNm" id="userNm" placeholder="이름을 입력해 주세요." title="이름을 입력해 주세요"/>
            ...
            <div id="findId" style="display: none;">
	            ...
	            <div class="input_style_1_con submit short">
	            	<a href="/testbed/userMember/pwdSearch.do?menuNo=700115" class="input_style_1">비밀번호 찾기</a>
	                <!-- 
...
<div class="btnSet tar">
	<a href="/testbed/userMember/pwdSearch.do?menuNo=500084" class="btn btn-info">비밀번호 찾기</a>
</div>
</div>
 --%>