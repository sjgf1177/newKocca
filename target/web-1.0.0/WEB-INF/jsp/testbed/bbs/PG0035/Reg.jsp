...
<div class="col-12 sub_board_body">
	...
	<tr>
		...
		<td>
			<span class="board_type_1_input_con">
				<input type="hidden" name="option1" id="option1" value="<c:out value='${result.option1}${paramVO.concertTitle }'/>" class="input_style_0" >
				${result.option1}${paramVO.concertTitle }
	...
	<tr>
		...
		<td>
			<span class="board_type_1_input_con">
				<input type="text" name="nttSj" id="nttSj" value="<c:out value='${result.nttSj}'/>" class="input_style_0" title="제목을 입력해 주세요">
	...
	<div class="board_util_btn_con center">
		...
		<a href="javascript:void(0);" onclick="javascript:history.back(0);return false;" class="btn_style_0 empty close_w">취소</a>
		<c:if test="${not empty result}" >
