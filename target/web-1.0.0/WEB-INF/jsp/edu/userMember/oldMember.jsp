				...
				if (data.resultCode == "success") {
					if (data.emailCnt > 0) {
						if (confirm("이미 등록된 이메일입니다. 아이디 찾기 페이지로 이동하시겠습니까?")) {
							location.href = "/edu/userMember/idSearch.do?menuNo=200057";
						}
						flag = false;
					}
				}
...
//]]>
	...
	<form id="frm" name="frm" method="post" action="/edu/userMember/insertOldMember.do" >
							...
							<tr>
								...
								<td>
									<div class="calendarzone">
										<div id="startDate-lry" class="calendarSLayer" style="    position: relative;">
											<iframe id="startDate-ifrm" name="startDate-ifrm" class="calendar-frame" src="/edu/html/incFrCalendar.html" title="시작 날짜입력 프레임" frameborder="0" scrolling="no"></iframe>
										</div>
									</div>
	...
	<div class="btnSet tar">
		...
		<a href="javascript:void(0);" onclick="javascript:history.back(0);return false;" class="btn btn-gray mr10">취소</a>
	</div>
...
<%--
	...
	<style>
	.calendarzone .calendarSLayer{ position : relative !important;}
	</style>
