...
<script type="text/javascript">
    ...
    $(function () {
        ...
        reAgre = function () {
            ...
            $.post(
                "/edu/userMember/reAgreRequest.json",
...
<div class="mw-1280 col-center" style="margin-top: 30px;">
    <c:choose>
        <c:when test="${user.agreAt eq 'N'}">
            <h2 class="fs5 tac">에듀코카의 개인정보 취급방침이 개정되었습니다.</h2>
            <div class="boxGray  mt20 mb20 pt10 pb10">
                <p class="tac">
                    에듀코카의 개인정보 취급방침 개정으로 인하여 개인정보처리방침에 대한 재동의를 받고 있습니다.
                </p>
                <p class="tac">
    ...
    <div class="msgBx">
        <div>
            ...
            <div tabindex="0" class="agreeScr">
                <div class="jf">
                    <h5>한국콘텐츠진흥원(에듀코카) 개인정보처리방침 (2018-10-01 시행)</h5>
                    <p class="h_desc5">
                        한국콘텐츠진흥원 에듀코카(<a href="https://edu.kocca.kr">'에듀코카'</a> 라 칭함)은 개인정보보호법에 따라
                    ...
                    <p class="list_style_3_desc">
                        에듀코카는 수집한 개인정보를 다음의 목적을 위해 활용되며, 이용 목적이 변경될 시에는 사전 동의를 구할 예정입니다.
                    </p>
                    ...
                    <p class="list_style_3_desc">
                        에듀코카는 개인정보보호법 제32조에 따라 등록 · 공개하는 개인정보파일의 수집항목은 다음과 같습니다.
                    </p>
                    <table class="table_style_1" summary="personal data referral">
                        ...
                        <tr>
                            <td>개인 회원명부</td>
                            <td style="text-align:left; padding-left:10px;">· 필수항목 : 이름, 생년월일, 성별, 아이디, 비밀번호, 이메일, 휴대폰,
                                <br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <li>
                            ...
                            <div class="list_style_4_desc">
                                <ul class="list_style_5">
                                    <li>에듀코카 홈페이지(회원가입, 문의하기, 시설예약, 온라인 신청)에서 정보주체의 동의를 얻어 수집합니다.</li>
                                    <li>강사, 튜터, 멘토, 멘티 등과 같은 경우 별도 오프라인으로 정보주제의 동의를 얻어 수집합니다.</li>
                                </ul>
                            </div>
                            <div class="list_style_4_caption">
                                홈페이지 회원은 한국콘텐츠진흥원에서 운영하는 "<a href="https://www.ckl.or.kr" target="_blank" title="새창열림">콘텐츠코리아랩-www.ckl.or.kr</a>"
                                와 통합으로 관리됩니다.
                            </div>
                        </li>
                        <li>
                    ...
                    <p class="list_style_3_desc">
                        에듀코카는 정보주체의 동의 없이는 수집ㆍ보유하고 있는 개인정보를 제3자에게 제공하지 않습니다. <br>
                    ...
                    <p class="list_style_3_desc">
                        에듀코카는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.
                    </p>
                    <table class="table_style_1" summary="personal data referral">
                    ...
                    <p class="list_style_3_desc">
                        에듀코카는 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체 없이 해당 개인정보를 파기합니다.
                    ...
                    <ul class="list_style_4">
                        <li>
                            파기절차
                            <div class="list_style_4_desc">
                                정보주체가 입력한 정보는 목적 달성 후 별도의 DB에 옮겨져(종이의 경우 별도의 서류) 내부 방침 및 기타 관련 법령에 따라 일정기간 저장된 후 혹은 즉시
                    ...
                    <p class="list_style_3_desc">
                        에듀코카의 정보주체는 개인정보주체로서 다음과 같은 권리를 행사할 수 있습니다.
                    </p>
                    <ul class="list_style_4 color_gray">
                        <li>
                            정보주체는 에듀코카에 대해 언제든지 다음 각 호의 개인정보 보호관련 권리를 행사할 수 있습니다.
                            <div class="list_style_4_desc">
                                <ul class="list_style_5">
                                    <li>개인정보 열람요구</li>
                        ...
                        <li>
                            제1항에 따른 권리 행사는 에듀코카에 대해 개인정보 보호법 시행규칙 별지 제8호 서식에 따라 서면,
                            전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 에듀코카는 이에 대해 지체 없이 조치하겠습니다.
                        </li>
                        <li>
                            정보주체가 개인정보의 오류 등에 대한 정정 또는 삭제를 요구한 경우에는 에듀코카는 정정 또는 삭제를 완료할 때까지 당해 개인정보를 이용하거나 제공하지 않습니다.
                        </li>
                        <li>
                            제1항에 따른 권리 행사는 개인정보의 오류 등에 대한 정정 또는 삭제를 요구한 경우에는 에듀코카는 정정 또는 삭제를 완료할 때까지 당해 개인정보를 이용하거나 제공하지
                            않습니다.
                        </li>
                        <li>
                            기타('에듀코카‘)의 개인정보파일 등록사항 공개는 행정안전부 개인정보보호 종합지원 포털(<a href="http://www.privacy.go.kr"
                                                                                target="_blank" title="새창열림">www.privacy.go.kr</a>)
                    ...
                    <p class="list_style_3_desc">
                        ...
                        에듀코카의 개인정보의 처리에 동의하지 않는 경우 동의를 거부하거나 가입 · 해지(회원탈퇴)를 요청하실 수 있습니다.
                    ...
                    <p class="list_style_3_desc">
                        에듀코카는 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.
                    </p>
                    <ul class="list_style_4">
                        <li>
                            개인정보 취급 직원의 최소화
                        ...
                        <li>
                            해킹 등에 대비한 기술적 대책
                            <div class="list_style_4_desc">
                                에듀코카는 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을 설치하고 주기적인
                    ...
                    <p class="list_style_3_desc">
                        에듀코카는 개인정보 처리에 관한 업무를 총괄해서 책임지고,
                    ...
                    <ul class="list_style_4">
                        ...
                        <li>
                            ...
                            <div class="list_style_4_desc">
                                ...
                                (아래의 기관은 진흥원과는 별개의 기관으로서, 진흥원의 자체적인 개인정보 불만처리, 피해구제 결과에 만족하지 못하시거나 보다 자세한 도움이 필요하시면 문의하여
                                주시기 바랍니다)
                                <ul class="list_style_5">
                    ...
                    <p class="list_style_3_desc">
                        본 에듀코카 개인정보처리방침은 시행일로부터 적용되며, 법령 및 방침에 따른 변경내용의 추가,
                    ...
                    <ul class="list_style_5 line_long">
                        ...
                        <li>
                            2014년 5월 20일 이전 내용<a href="/files/EDUprivacy20140527pre.pdf" title="새창열림" target="_blank"
                                                 class="prev_privacy_law_btn">보기</a>
                        </li>
                        <li>
                            2016년 1월 22일 이전 내용<a href="/files/edu_20151221Privacy.pdf" title="새창열림" target="_blank"
                                                 class="prev_privacy_law_btn">보기</a>
                        </li>
                        <li>
                            2016년 4월 26일 이전 내용<a href="/files/edu_20160115Privacy.pdf" title="새창열림" target="_blank"
                                                 class="prev_privacy_law_btn">보기</a>
                        </li>
                        <li>
                            2018년 10월 1일 이전 내용<a href="/files/edu_20160426Privacy.pdf" title="새창열림" target="_blank"
                                                 class="prev_privacy_law_btn">보기</a>
                        </li>
                    </ul>
                </div>
        ...
        <div style="margin-top: 30px;">
            ...
            <div tabindex="0" class="agreeScr" style="font-size: 1.2rem; line-height: 2.05rem;">
                에듀코카는 회원가입, 원활한 고객상담, 각종 서비스의 제공을 위해 최초 회원가입 당시 아래와 같은 최소한의 필수 정보와 선택정보를 수집합니다.
                <br><br>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;필수항목 : 이름, 생년월일, 성별, 아이디, 비밀번호, 이메일, 휴대폰, 인재캠퍼스 정보수신 여부, 콘텐츠문화광장 정보수신 여부,
                직업,<br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;거주지역, 소속, 14세 미만인 경우
                보호자의 이름, 휴대폰 번호<br>
                &nbsp;&nbsp;&nbsp;&nbsp;선택항목 : 거주지<br>
                ...
                <br><br>
                5. 동의 거부 시 불이익에 관한 사항 : 수집 &middot;이용에 관한 사항의 동의를 거부할 때에는 서비스의 이용이 제한됩니다. 단, 선택정보 사항을 획득하지 못한 사유로 인하여
                서비스 제공을 거부하지 않습니다.
            </div>
        </div>
        ...
        <c:if test="${param.mode eq 'i'}">
            ...
            <div class="bdView">
                <table class="table table-bordered">
                    ...
                    <tbody>
                    <tr>
                        <th scope="row"><span class="hide_star"><span class="sr-only">(필수입력)</span></span> <strong>정보수신
                            여부</strong></th>
                        <td>서비스 및 이벤트 소식을<br>
                            <label for="emailAt1"><input type="radio" name="emailAt" value="Y" id="emailAt1"
                                                         checked="checked"> Email로 수신하겠습니다. </label>
                            <label for="emailAt2"><input type="radio" name="emailAt" value="N" id="emailAt2"> Email로
                                수신하지 않겠습니다. </label><br>
                            <label for="smsAt1"><input type="radio" name="smsAt" value="Y" id="smsAt1"
                                                       checked="checked"> SMS로 수신하겠습니다. </label>
                            <label for="smsAt2"><input type="radio" name="smsAt" value="N" id="smsAt2"> SMS로 수신하지 않겠습니다.
                            </label><br><br>
