...
<div class="memberStep2">
	...
	<form name="frm" id="frm" action="/edu/progrm/applcnt/update.do?prgSn=<c:out value="${result.prgSn}"/>&amp;reqstSn=<c:out value="${info.reqstSn}"/>&amp;${pageQueryString}" method="post" enctype="multipart/form-data" >
		<div>
			<h3>기본정보입력</h3>
	...
	<div class="board_util_btn_con">
		...
		<a href="javascript:checkForm();" class="btn_style_0 full listBook">저장</a>
	</div>
</div>
