...
<table style="width: auto;" class="cal_mtable">
	...
	<c:forEach var="result" items="${calList }">
		...
		<tr>
			...
			<td class="${empty result.sun.day ? 'cal_blank' : sunClass}"><a data-value="<c:out value="${result.sun.day }" />" href="#self">${empty result.sun.day ? '<span class="sr-only">공백</span>' : result.sun.day}</a></td>
			...
			<td class="${empty result.mon.day ? 'cal_blank' : monClass}"><a data-value="<c:out value="${result.mon.day }" />" href="#self">${empty result.mon.day ? '<span class="sr-only">공백</span>' : result.mon.day}</a></td>
			...
			<td class="${empty result.tue.day ? 'cal_blank' : tueClass}"><a data-value="<c:out value="${result.tue.day }" />" href="#self">${empty result.tue.day ? '<span class="sr-only">공백</span>' : result.tue.day}</a></td>
			...
			<td class="${empty result.wed.day ? 'cal_blank' : wedClass}"><a data-value="<c:out value="${result.wed.day }" />" href="#self">${empty result.wed.day ? '<span class="sr-only">공백</span>' : result.wed.day}</a></td>
			...
			<td class="${empty result.thu.day ? 'cal_blank' : thuClass}"><a data-value="<c:out value="${result.thu.day }" />" href="#self">${empty result.thu.day ? '<span class="sr-only">공백</span>' : result.thu.day}</a></td>
			...
			<td class="${empty result.fri.day ? 'cal_blank' : friClass}"><a data-value="<c:out value="${result.fri.day }" />" href="#self">${empty result.fri.day ? '<span class="sr-only">공백</span>' : result.fri.day}</a></td>
			...
			<td class="${empty result.sat.day ? 'cal_blank' : satClass}"><a data-value="<c:out value="${result.sat.day }" />" href="#self">${empty result.sat.day ? '<span class="sr-only">공백</span>' : result.sat.day}</a></td>
		</tr>
	</c:forEach>
