...
<ccc:constantsMap className="kr.co.unp.bbs.vo.SearchVO" var="SearchVO"/>
	...
	<div class="col-12 sub_board_body">
		<table class="board_type_0">
			...
			<colgroup>
				<col width="10%" class="count_column">
				<col width="15%">
				<col width="auto">
			...
			<tbody>
				<c:forEach var="result" items="${resultList}" varStatus="status">
					<tr<c:if test="${result.nttType=='1'}"> class="notice_title"</c:if>>
						...
						<td style="text-align:center;">${result.option11 }</td>
						<td class="tal" style="color:#313131;">
							<a href="<c:out value='${result.option12 }' escapeXml='false'/>" target="_blank" title="새창열림" >
