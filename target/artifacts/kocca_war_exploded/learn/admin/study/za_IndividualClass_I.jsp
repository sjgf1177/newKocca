...
<%
  ...
  //DEFINED in relation to select START
    ...
    String v_subpage_gubun = "";
%>
<html>
<head>
<title>클래스 추가(개인별)</title>
<meta http-equiv="Content-Type" content="text/html; charset=euc-kr">
<link rel="stylesheet" href="/css/admin_style.css" type="text/css">
<script language="JavaScript">
<!--
function whenSelectClass() {
  document.form2.p_process.value='classInsertPage';
  document.form2.submit();
}
function goSubPage(p_subpage) {
  document.form2.p_process.value='classInsertPage';
  document.form2.p_subpage.value=p_subpage;
  document.form2.submit();
}
...
function whenUpdate() {
  ...
  document.form2.p_process.value='classInsert';
  document.form2.submit();
}
  ...
  <tr>
    <td align="center" valign="top"> 
                ...
                <td align="center" valign="middle"> 
                  <table cellspacing="0" cellpadding="0" width="99%" class=""form_table">
                    ...
                    <tr> 
                      ...
                      <td>: <%=(String)subjinfo.get("p_grseq")%>차</td>
                      <td>◈<b> 분류</b></td>
      ...
      <form name="form2" method="post" action="/servlet/controller.study.ClassServlet">
        ...
        <input type="hidden" name="p_subpage"    value="<%=v_subpage%>">
              ...
              <tr>
                <td> 
                  ...
                  <table cellpadding="1" cellspacing="0" width=100%>
                    <tr> 
                      <td width="826" height="20" valign="bottom">
                      ...
                      <td align="right" width="95"><a href="javascript:whenUpdate()"><img src="/images/admin/button/btn_save.gif" border="0"></a></td>
                  ...
                  <!----------------- 클래스명, 등록.리스트 버튼 끝 ----------------->
                  <!----------------- 개인별 시작 ----------------->
                  <table cellspacing="1" cellpadding="5" width=100% bgcolor="76ABE0">
                    <tr> 
...
<%  ArrayList  list = (ArrayList)request.getAttribute("ClassInsertList");
    if (v_subpage.equals("asgn_page")) { %>
                    <tr> 
                      ...
                      <td class="table_title"><b>사업부명</b></td>
                      <td class="table_title"><b>인원</b></td>
                      <td class="table_title"><b>클래스명</b></td>
                      <td class="table_title">&nbsp;</td>
                    </tr>
<%      ClassInsertData data = null;
        for (int i=0; i<list.size(); i++) {
            data = (ClassInsertData)list.get(i); %>
                    <tr> 
                      <td class="table_01"><%=String.valueOf(i+1)%></td>
                      <td class="table_02_1"><%=data.getCodenm()%></td>
                      <td class="table_02_1"><%=String.valueOf(data.getStudentcnt())%></td>
                      <td class="table_02_1"><%=data.getClassnm()%></td>
                      <td class="table_02_1"> 
                        <input type="checkbox" name="p_checks" value="<%=data.getCode()%>">
                      </td>
                    </tr>
<%      } 
                    ...
                    <tr> 
                      ...
                      <td class="table_title"><b>직군명</b></td>
                      <td class="table_title"><b>인원</b></td>
                      <td class="table_title"><b>클래스명</b></td>
                      <td class="table_title">&nbsp;</td>
                    </tr>
...
<%      } 
                    ...
                    <tr> 
                      <td class="table_title"><b>NO</b></td>
                      <td class="table_title"><b>직급명</b></td>
                      <td class="table_title"><b>인원</b></td>
                      <td class="table_title"><b>클래스명</b></td>
                      <td class="table_title">&nbsp;</td>
                    </tr>
...
<%      }
                  ...
                  <table cellspacing="1" cellpadding="5" width=100% bgcolor="76ABE0">
                    ...
                    <tr> 
                      <td width="48%" class="table_title"><b>강사</b></td>
                      <td class="table_title"><b>부강사명단</b></td>
                      <td class="table_title"><b>부강사지정</b></td>
                    </tr>
                    <tr> 
                      <td align="center" class="table_02_1" height="25">
...
<input type="hidden" name="p_call_url"   value="za_IndividualClass_I">
</form>  
</table>
