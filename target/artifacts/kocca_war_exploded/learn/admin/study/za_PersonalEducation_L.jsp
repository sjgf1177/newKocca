...
//  2. 프로그램명: za_PersonalEducation_L.jsp
//  3. 개      요: 개인 수강과정 리스트
//  4. 환      경: JDK 1.3
//  5. 버      젼: 1.0
//  6. 작      성: 박진희 2003. 7. 31
 ...
 <br>
                        <table class="box_table_out_1" cellspacing="1" cellpadding="5" width="940">
                          ...
                          <tr>
                            ...
                            <td class="table_title" width="4%" ><b>수료가능</b></td>
                          </tr>
                      </table>
...
*/
               ...
               <tr>
                 ...
                 <td class="table_02_1" width="5%" ><%=StringManager.cutZero(v_subjseq)%>차</td>
          ...
          if(i == 0){ %>
              <tr>
                <td class="table_02_1" colspan="13">등록된 내용이 없습니다</td>
              </tr>
         <%  } %>
                        </table>
                        <!----------------- 수강과정 끝 ----------------->
