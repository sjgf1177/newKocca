    ...
    <td align="center" valign="top"> 
      ...
      <table width="97%" border="0" cellspacing="0" cellpadding="0" class=page_title>
        ...
        <table class="table_out" cellspacing="1" cellpadding="5">
          ...
          <tr> 
            <td rowspan=2  class="table_title" width="10%"><b>과제유형</b></td>
            <td rowspan=2  class="table_title" width="5%"><a href="javascript:whenOrder('','a.userid')" class="e"><b>ID</b></a></td>
            <td rowspan=2  class="table_title" width="5%"><a href="javascript:whenOrder('','c.name')" class="e"><b>이름</b></a></td>

            <td rowspan=2  width="17%" class="table_title"><a href="javascript:whenOrder('','b.title')" class="e"><b>내용제목</b></a></td>                       
            <td rowspan=2  class="table_title" width="4%"><a href="javascript:whenOrder('','b.ldate')" class="e"><b>제출일</b></a></td>
            <td rowspan=2  class="table_title" width="5%"><a href="javascript:whenOrder('','resend')" class="e"><b>재제출<br>여부</b></a></td>             
            <td rowspan=2  class="table_title" width="4%"><a href="javascript:whenOrder('','b.score')" class="e"><b>평가<br>점수</b></a></td>
            <td rowspan=2  class="table_title" width="4%"><a href="javascript:whenOrder('','isret')" class="e"><b>반려<br>여부</b></a></td>
           
            <td rowspan=2 class="table_title" width="4%"><a href="javascript:whenOrder('','isret')" class="e"><b>채점일<br>(반려일)</b></a></td>
            <td rowspan=2 class="table_title" width="4%"><a href="javascript:whenOrder('','tname')" class="e"><b>강사명</b></a></td>            

            <td rowspan=2 class="table_title" width="3%"><img src='/images/user/common/bl_a2.gif' border=0 align=absmiddle><br><b>비교</b></td>                                    
            <td rowspan=2  class="table_title" width="5%"><a href="javascript:whenOrder('','b.realfile')" class="e"><b>첨부<br>파일</b></a></td>
            <td rowspan=2  class="table_title" width="5%"><a href="javascript:whenOrder('','b.upfilesize')" class="e"><b>파일<br>사이즈</b></a></td>
            <td rowspan=2  class="table_title" width="5%"><a href="javascript:whenOrder('','b.contentsbyte')" class="e"><b>내용<br>바이트수</b></a></td>
          ...
          <tr> 
            ...
            <td class="table_02_1" align="center"><%if(dbox.getInt("d_resend")>0){%><font color=blue>재제출</font><%}%></td> 
          ...
          if(i == 0){ %>
          <tr> 
            <td align="center" class="table_02_1" height="50" colspan="18">등록된 
              내용이 없습니다</td>
          </tr>
          <%  } %>
        </table>
