...
<!--
    ...
    // 교육후 평가 리스트 
    function projectEndList(subj,subjnm,year,subjseq,projseq,ordseq,title) {
        document.form1.action='/servlet/controller.study.ProjectAdminServlet';
        document.form1.p_process.value = 'ProjectEndSubmitList';
        document.form1.p_subj.value = subj;
        document.form1.p_subjnm.value = subjnm;
        document.form1.p_year.value = year;
        document.form1.p_subjseq.value = subjseq;
        document.form1.p_projseq.value = projseq;
        document.form1.p_ordseq.value = ordseq;
        document.form1.p_ptitle.value = title;   // 리포트제목
        document.form1.submit();
    } 
...
<body bgcolor="#FFFFFF" text="#000000" topmargin="0" leftmargin="0">
   <form name="form1" method="post" action="">
    ...
    <input type="hidden" name="p_ptitle">    
      ...
      <table width="97%" border="0" cellspacing="0" cellpadding="0" class=page_title>
          ...
          <tr>
            <td width="125" height="23" align="center" valign="middle">
              ...
              <table cellspacing="0" cellpadding="0" class="s_table">
                ...
                <tr>
                  <td class="blue_butt_middle">리포트 유형</td>
                </tr>
                <tr>
            ...
            <td width="125">
              ...
              <table cellspacing="0" cellpadding="0" class="s_table">
                ...
                <tr>
                  <td class="black_butt_middle"><a href="javascript:projectlist_selectAll()" class="c">전체 리포트</a></td>
                </tr>
                <tr>
        ...
        <table class="table_out" cellspacing="1" cellpadding="5">
          ...
          <tr> 
            ...
            <td width="9%" rowspan="2" class="table_title"><b>배정인원</b></td>
            <td width="9%" rowspan="2" class="table_title"><b>제출인원</b></td>
            <td colspan="2" class="table_title"><b>제출인원</b></td>
            <td width="9%" rowspan="2" class="table_title"><b>교육기간<br>완료후재제출</b></td>               
          </tr>
          <tr> 
            <td class="table_title" width="9%"><b>채점인원</b></td>
            <td class="table_title" width="10%"><b>미채점인원</b></td>
          ...
          <tr> 
			...
			<a href="javascript:alert('현재 배정된 학습자가 없습니다.');" class="b"><%=v_title%></a>			
			<% } else { %>
			<a href="javascript:projectDetailList('<%=v_subj%>','<%=v_subjnm%>','<%=v_year%>','<%=v_subjseq%>','<%=v_ordseq%>','<%=v_lesson%>','<%=v_reptype%>')"  class="b"><%=v_title%></a> 
			<% } %>
			</td>
            ...
            <a href="javascript:projectEndList('<%=v_subj%>','<%=v_subjnm%>','<%=v_year%>','<%=v_subjseq%>','<%=v_projseq%>','<%=v_ordseq%>', '<%=v_title%>')"  class="b"><img src='/images/admin/button/b_resend.gif' border=0></a>
            </td>			            
          </tr>
          <%}  
          if(i == 0){ %>
