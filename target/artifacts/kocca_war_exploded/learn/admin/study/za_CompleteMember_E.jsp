...
<BODY leftmargin="0" topmargin="0" bottommargin="0" marginwidth="0" marginheight="0" >
        ...
        <table cellspacing="0" cellpadding="0" class="table_out">
          <tr>
            <td>
                    <table border="0" cellspacing="1" cellpadding="5" class="box_table_out" border="1">
                      <tr>
                        ...
                        <td class="table_title">수료<br>여부</td>
                        ...
                        <td class="table_title">참여도 기준점수</td>
