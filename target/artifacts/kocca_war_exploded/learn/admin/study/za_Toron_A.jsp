      ...
      <table width="97%" border="0" cellspacing="0" cellpadding="0" class=page_title>
        ...
        <table class="table_out" cellspacing="1" cellpadding="5">
          ...
          <tr> 
              ...
              <td class="table_02_2" width="81%"><input size="90" maxlength="200" name="p_title" class="input"></td>
          </tr>
          <tr> 
          ...
          <tr> 
              ...
              <td class="table_02_2"><%= FormatDate.getDate("yyyy/MM/dd") %></td>
          </tr>
          <tr> 
              <td class="table_title"><b>의견내용</b></td>
              <td class="table_02_2"> 
<!--                <textarea name="p_adcontent" cols="90" rows="15" class="input"></textarea>-->
                <!-- 나모 Editor  -->
                <p align="center">
                <!-- 나모 액티브 스퀘어  시작 -->
        ...
        <table border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td>
            <a href="javascript:whenToronReply()"><img src="/images/admin/button/btn_apply.gif" border="0"></a></td>
			<td width=8></td>
            <td>
