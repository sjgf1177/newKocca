...
<%
    ...
    String  ss_usebook   = box.getString("s_usebook");   //교재
...
/*
    ...
    function whenChiefMail() {
      ...
      document.form1.target = "_self";
      document.form1.action='/servlet/controller.study.StudentStatusAdminServlet';
      document.form1.p_process.value = 'SendChiefMail';
      document.form1.submit();
    }
*/
	//폼메일 발송
...
%>
          ...
          <tr>
            <td width="125" height="23" align="center" valign="middle">
              ...
              <table cellspacing="0" cellpadding="0" class="s_table">
                ...
                <tr>
                  <td class="blue_butt_middle">학습진행자</td>
                </tr>
                <tr>
            ...
            <td width="125">
              ...
              <table cellspacing="0" cellpadding="0" class="s_table">
                ...
                <tr>
                  <td class="black_butt_middle"><a href="javascript:select_tab('2')" class="c">학습완료자</a></td>
                </tr>
                <tr>
      ...
      <table width="97%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <!--a href="javascript:whenChiefMail()"><img src="/images/admin/button/btn_absencemail.gif" border="0"></a-->
            </td>
            <td width=4></td>
            <td align="right" width="65">
		  ...
		  <!----------------- 학습진행자 시작 ----------------->
                    <table cellspacing="1" cellpadding="5" class="box_table_out">
                      ...
                      <tr>
                        ...
                        <td class="table_title" width="7%"><a href="javascript:whenOrder('membergubunnm')" class="e">회원구분<% out.print("membergugunnm".equals(v_orderColumn) ? (" asc".equals(v_orderType) ? "▲" : "▼") : ""); %></a></td>
