...
<!--
  ...
  //-->
                ...
                <%  for(int i_i = 1 ; i_i <= i_fileLimit ; i_i ++ ) {%>
                  ...
                  <table border="0" style="padding:0 0 0 0;"><tr>
                  <td >
                    <input type="text" name="tempFileText" id="tempFileText<%=i_i%>" class="inbox fl_l mg_r6" style="width:300px;" readonly/>
                  </td>
                  <td>
                    <input type="file" name="p_file<%=i_i%>" id="p_file<%=i_i%>" imageswap="true" imagesrc="/images/portal/btn/file_search.gif" onchange="document.getElementById('tempFileText<%=i_i%>').value=this.value;" style="vertical-align:7px;width:73px;cursor:pointer;"/>
