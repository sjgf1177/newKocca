...
//  2. 프로그램명 : za_CourseenterStudentGubun_L.jsp
...
function whenSelection(ss_action) {
	var process = 'selectEnterStudentGubunListPre';            //검색전
	...
	if (ss_action=="go")  {
		...
		//}
		top.ftop.setPam();
		process='selectEnterStudentGubunList';   //검색후
	}
...
function whenExcel() {
    ...
    document.form1.target = "_self";
    document.form1.action='/servlet/controller.course.CourseStateAdminServlet';
    document.form1.p_process.value = 'selectEnterStudentGubunListExcel';
...
function selectOption3(p) {
	var p_process;
	if( p == "PRI") {
		p_process = "selectEnterStudentSaleListPre";
	} else {
		p_process = "selectEnterStudentGubunListPre";
	}
	document.form1.target = "_self";  
	document.form1.action = "/servlet/controller.course.CourseStateAdminServlet";
	document.form1.p_action.value = "change";
  ...
  <tr>
    <td align="center" valign="top">
                  ...
                  <table border="0" cellspacing="0" cellpadding="0" width="99%" class="form_table">
                    ...
                    <tr>
                      ...
                      <td align="left" valign="middle">
				        ...
				        &nbsp;
		  		        <kocca_select:select name="s_option3" sqlNum="coursestatistics3"  param=" " onChange="selectOption3(this.value);" attr="통계구분3" selectedValue="<%= ss_option3 %>" isLoad="true" all="none" type="1" styleClass=""/>
                      </td>
      ...
      <table width="97%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="left" height="20">&nbsp;<b>수강생별 <%= stat_text %> 입과현황</b></td>
          <td align="right">
...
%>
        <tr class="table_02_1">
          ...
          <td class="table_02_1"><%= v_cnt %> 명</td>
          <td class="table_02_1"><%= v_rate %>%</td>
        </tr>
<%
        	}
			if (i == 0) {
...
<%			} else { %>
	    <tr class="table_02_3">
          ...
          <td class="table_02_3"><%= v_total %> 명</td>
