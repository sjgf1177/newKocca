...
<%
    ...
    int		v_sul_row1_cnt		= 0;
    int		v_sul_row2_cnt		= 0;
...
%>
 ...
 <%  	
        	...
        	for (i=0; i<list.size(); i++) {
		        ...
		        //v_grad_rate = v_grad_cnt*100.0 / v_user_cnt ;
		...
		%>
          ...
          <% if (v_rank == v_rowspantmp) { 
        	  ...
        	  v_total_sul_rate = (v_total_sul_rate / v_sul_row1_cnt);
        	  v_sul_row1_cnt = 0;
        	  
        	  if(v_total_sul_rate > 0){
        		  v_sul_row2_cnt += 1;
        	  }
        ...
        <tr class="table_02_3">
          ...
          <td class="table_02_3"><%= df.format(v_sum_sul_rate / v_sul_row2_cnt) %> </td>
        </tr>
        <% } %>
