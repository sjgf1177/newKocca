<%
//**********************************************************
//  1. 제      목: 과정운영 통계 - 차수별만족도
//  2. 프로그램명 : za_CourseSatiSulmun_L.jsp
//  3. 개      요: 차수별 만족도
//  4. 환      경: JDK 1.5
//  5. 버      젼: 1.0
//  6. 작      성: 2009.12.12
...
function whenSelection(ss_action) {
	var process = 'selectSatiSulmunListPre';            //검색전
	...
	if (ss_action=="go")  {
		...
		//}
		top.ftop.setPam();
		process='selectSatiSulmunList';   //검색후
	}
...
function whenExcel() {
    ...
    document.form1.target = "_self";
    document.form1.action='/servlet/controller.course.CourseStateAdminServlet';
    document.form1.p_process.value = 'selectSatiSulmunListExcel';
  ...
  <tr>
    <td align="center" valign="top">
                ...
                <td align="center">
                  <table border="0" cellspacing="0" cellpadding="0" width="99%" class="form_table">
                    ...
                    <tr>
                      ...
                      <td align="left" valign="middle">
                                                         통계구분
                        <kocca_select:select name="s_option1" sqlNum="coursestatistics1"  param=" " onChange="selectOption1(this.value);" attr="통계구분1" selectedValue="selectSatiSulmunListPre" isLoad="true" all="none" type="1" styleClass=""/>
                      </td>
                      <td align="left" valign="middle">
                      </td>
      ...
      <table width="97%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="left" height="20">&nbsp;<b>차수별 만족도 설문</b></td>
          <td align="right">
      ...
      <table class="table_out" cellspacing="1" cellpadding="5">		
        ...
        <tr>
          ...
          <td class="table_title"><b>만족도 점수</b></td>
        </tr>
...
<%
			if (v_rowspan != 0) {
%>
          <td class="table_02_1" rowspan="<%= v_rowspan %>"><%= v_gyear %>-<%= v_grseq %> <%= v_grseqnm %></td>
<%
			}
%>
<%
			if (v_rowspan2 != 0) {
%>
          <td class="table_02_1" rowspan="<%= v_rowspan2 %>"><%= v_middleclassname %></td>
<%
			}
%>
          <td class="table_02_2"><%= v_subjnm %></td>
          <td class="table_02_1"><%= v_distcode1_avg %>%</td>
        </tr>
<%
        	}
			if (i == 0) {
