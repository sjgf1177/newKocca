<%
//**********************************************************
//  1. 제      목: 과정운영 통계 - 입과현황 - 과정별 일반  현황
//  2. 프로그램명 : za_CourseEnterCourse_L.jsp
...
function whenSelection(ss_action) {
	var process = 'selectEnterCourseListPre';            //검색전
	...
	if (ss_action=="go")  {
		...
		//}
		top.ftop.setPam();
		process='selectEnterCourseList';   //검색후
	}
...
function whenExcel() {
    ...
    document.form1.target = "_self";
    document.form1.action='/servlet/controller.course.CourseStateAdminServlet';
    document.form1.p_process.value = 'selectEnterCourseListExcel';
  ...
  <tr>
    <td align="center" valign="top">
      ...
      <table width="97%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="left" height="20">&nbsp;<b>과정별 일반 입과현황</b></td>
          <td align="right">
...
<%			} else { %>
	    <tr class="table_02_3">
          ...
          <td class="table_02_3"><%= v_total_cnt %></td>
        </tr>
<%			}
		}
%>
