...
function whenSelection(ss_action) {
	var process = 'selectStudyListPre';            //검색전
  ...
  <tr>
    <td align="center" valign="top">
                ...
                <td align="center">
                  <table border="0" cellspacing="0" cellpadding="0" width="99%" class="form_table">
                    ...
                    <tr>
                      ...
                      <td align="left" valign="middle">
                                                         통계구분
                        <kocca_select:select name="s_option1" sqlNum="coursestatistics1"  param=" " onChange="selectOption1(this.value);" attr="통계구분1" selectedValue="selectStudyListPre" isLoad="true" all="none" type="1" styleClass=""/>
                      </td>
                      <td align="left" valign="middle">
                      </td>
      ...
      <table width="97%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="left" height="20">&nbsp;<b>학습현황</b></td>
          <td align="right">
      ...
      <table class="table_out" cellspacing="1" cellpadding="5">		
        ...
        <tr>
          ...
          <td class="table_title"><b>과정수</b></td>
          ...
          <td class="table_title"><b>설문 응시인원</b></td>
          <td class="table_title"><b>설문 응시율</b></td>
        </tr>
...
%>
          <td class="table_02_1" colspan="3">운영중</td>
<%
			}
%>
...
%>
	    <tr class="table_02_3">
          <td class="table_02_3" colspan="2"><%= v_gyear %>년 총계</td>
