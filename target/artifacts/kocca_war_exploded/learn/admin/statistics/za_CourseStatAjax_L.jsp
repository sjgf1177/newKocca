...
//-->
      ...
      <table width="97%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="left" height="20">&nbsp;<b>과정별검색</b></td>
          <td align="right">
      ...
      <form name = "form1" method = "post">
        <input type="hidden" name="p_process" value="selectCourseStat">
