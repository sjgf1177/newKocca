		...
		var newcate =  $("#ss_category").val();
		 ...
		 $.ajax({ type : "POST", 			
	   		...
	   		success: function(msg){ 
	   			...
	   			/* $('#ss_subjseq').bind('change', function(){
	   				var newsubjseq = $("#ss_subjseq").val();//.indexOf(',');
					alert(newsubjseq);
					
					 $.ajax({ type : "POST", 			
				   		url : "/servlet/controller.common.TagServlet", 
				   		data: "sqlNum=onlinecourselist&type=9&param="+newsubjseq, 
				   		//beforeSend: function(){ $('#s_list').html('<img src="/learn/user/contents/loading.gif" border="0"/>'); }, 
				   		success: function(msg){ 
          ...
          <div id="tabs_wrapper">
			<div id="tabs_container">
				<ul id="tabs">
					...
					<li class="active tabnavi"><a href="#">만족도 </a></li>
                  ...
                  <table id="cellp"  border="0" cellspacing="0" cellpadding="0" width="100%" class="form_table">
                    <tr>
                      ...
                      <td align="left" valign="middle">	
							<select name="ss_year" id="ss_year" multiple="multiple" style="width:250px">
                     ...
                     <td align="left" valign="middle">	
							<select name="ss_category" multiple="multiple" id="ss_category" style="width:250px">
						...
						<td align="left" valign="middle">	
							<select title="월선택" multiple="multiple" name="ss_month" id="ss_month" size="5" style="width:250px">
