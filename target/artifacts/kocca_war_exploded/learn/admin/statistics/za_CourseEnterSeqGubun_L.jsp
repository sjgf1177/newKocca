...
//  3. 개      요: 입과현황 - 차수별 회원구분별, 성별, 연령대별, 학력별, 문화산업종사자별, 비문화사업종사자별   현황
//  4. 환      경: JDK 1.5
//  5. 버      젼: 1.0
//  6. 작      성: 2009.12.10
//  7. 수      정:
...
function whenSelection(ss_action) {
	var process = 'selectEnterSeqGubunListPre';            //검색전
	...
	if (ss_action=="go")  {
		...
		//}
		top.ftop.setPam();
		process='selectEnterSeqGubunList';   //검색후
	}
...
function whenExcel() {
    ...
    document.form1.target = "_self";
    document.form1.action='/servlet/controller.course.CourseStateAdminServlet';
    document.form1.p_process.value = 'selectEnterSeqGubunListExcel';
  ...
  <tr>
    <td align="center" valign="top">
      ...
      <table width="97%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="left" height="20">&nbsp;<b>차수별 <%= stat_text %> 입과현황</b></td>
          <td align="right">
