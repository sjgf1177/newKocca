...
//-->
      ...
      <form name = "form1" method = "post" action="/servlet/controller.statistics.UserCountServlet">
        <input type="hidden" name="p_process" id="p_process" value="selectMonthStat">
 ...
 <%  	
        	...
        	for (i=0; i<list.size(); i++) {
			    ...
			    if (i!=0) v_chartdate += "\\n";
			    v_chartdate += v_month+"월;"+v_tot+";"+v_man_cnt+";"+v_woman_cnt;
...
<div class="chartbox">
	<table class="chartset" cellpadding="0" cellspacing="0">
		<tr>
			...
			<% } else { %>
			<td><div id="chartdiv2"></div><p>월별</p></td>
			<% } %>
		</tr>
	</table>
</div>    
