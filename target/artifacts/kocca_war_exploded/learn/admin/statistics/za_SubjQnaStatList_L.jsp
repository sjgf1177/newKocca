...
<script type="text/javascript"> 
 function view_Bbs(subj){
     ...
     $.ajax({ type : "POST", 			
	   		url : "/servlet/controller.statistics.VocStatusticServlet?p_process=selectSubjQnaBbsList", 
 ...
 function view_Tutor(tutorid){
     alert(tutorid);
     $.ajax({ type : "POST", 			
	   		url : "/servlet/controller.statistics.VocStatusticServlet?p_process=selectSubjQnaTutorList", 
	   		data: "&param2="+tutorid, 
	   		beforeSend: function(){ $('#bbslist').html('<img src="/learn/user/contents/loading.gif" border="0"/>'); },
	   		success: function(msg){ 
	   			//alert(msg);
...
%>
          ...
          <tr>
            ...
            <td class="table_title" width="4%">문의</td>
            <td class="table_title" width="4%">답변</td>
          </tr>
<%
...
%>
          <tr class="table_02_1">
           ...
           <td class="table_02_1"><%=dbox.getString("d_area")%></td>
            <td class="table_02_1"><a href="javascript:view_Bbs('<%=dbox.getString("d_subj")%>')"><%=dbox.getString("d_subjnm")%></a></td>
            <td class="table_02_1"><a href="javascript:view_Tutor('<%=dbox.getString("d_userid")%>')"><%=dbox.getString("d_name")%></a></td>
