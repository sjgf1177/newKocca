...
//-->
      ...
      <table width="97%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="left" height="20">&nbsp;<b>연령별 검색</b></td>
          <td align="right">
      ...
      <!----------------- 조회 시작 ----------------->
       <form name = "form1" method = "post">
        <input type="hidden" name="p_process" value="selectAgeStat">
 ...
 <%  	
		...
		%>
		 <tr class="table_02_1">
          ...
          <td class="table_02_1"><b><%= v_tot %></b></td>
      ...
      <% if (v_rank == v_rowspantmp) { 
          ...
          <% 
            ...
            v_sum_teens_cnt		+= v_total_teens_cnt;
          	v_sum_twenty_cnt	+= v_total_twenty_cnt;
          	v_sum_thirty_cnt	+= v_total_thirty_cnt;
          	v_sum_fourty_cnt	+= v_total_fourty_cnt;
          	v_sum_fifty_cnt		+= v_total_fifty_cnt;
          	v_sum_sixty_cnt		+= v_total_sixty_cnt;
          	v_sum_seventy_cnt	+= v_total_seventy_cnt;
          	v_sum_johndoe_cnt	+= v_total_johndoe_cnt;
          	v_sum_tot			+= v_total_tot;
		    
          	v_total_teens_cnt	= 0;
		    v_total_twenty_cnt	= 0;
		    v_total_thirty_cnt	= 0;
		    v_total_fourty_cnt	= 0;
		    v_total_fifty_cnt	= 0;
		    v_total_sixty_cnt	= 0;
		    v_total_seventy_cnt	= 0;
       ...
       <% } else { %>
	          ...
	          <td class="table_02_3"><%= v_sum_teens_cnt %></td>
	          <td class="table_02_3"><%= v_sum_twenty_cnt %></td>
	          <td class="table_02_3"><%= v_sum_thirty_cnt %></td>
	          <td class="table_02_3"><%= v_sum_fourty_cnt %></td>
	          <td class="table_02_3"><%= v_sum_fifty_cnt %></td>
	          <td class="table_02_3"><%= v_sum_sixty_cnt %></td>
	          <td class="table_02_3"><%= v_sum_seventy_cnt %></td>
...
<script type="text/javascript">
    ...
    var flashVars1 = 
    {
        ...
        chart_data: "10대;<%=v_sum_teens_cnt%>\n20대;<%=v_sum_twenty_cnt%>\n30대;<%=v_sum_thirty_cnt%>\n40대;<%=v_sum_fourty_cnt%>\n50대;<%=v_sum_fifty_cnt%>\n60대;<%=v_sum_sixty_cnt%>\n70대;<%=v_sum_seventy_cnt%>",
