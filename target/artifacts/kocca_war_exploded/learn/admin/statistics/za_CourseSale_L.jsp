...
function whenSelection(ss_action) {
	var process = 'selectSaleListPre';            //검색전
...
function whenExcel() {
    ...
    document.form1.target = "_self";
    document.form1.action='/servlet/controller.course.CourseStateAdminServlet';
    document.form1.p_process.value = 'selectSaleListExcel';
  ...
  <tr>
    <td align="center" valign="top">
                  ...
                  <table border="0" cellspacing="0" cellpadding="0" width="99%" class="form_table">
                    ...
                    <tr>
                      <td height="5" colspan="4"></td>
  		  		    ...
  		  		    <tr>
                      <td align="left" valign="middle">
                                                          결제기간&nbsp;<input name="s_startdate" id="s_startdate" value="<%=ss_startdate%>" type="text" class="datepicker_input1" size="10">&nbsp;
		  				  			~&nbsp;<input name="s_enddate" id="s_enddate" value="<%=ss_enddate%>" type="text" class="datepicker_input1" size="10">&nbsp;
                      </td>
                      <td align="left" valign="middle">
                                                         통계구분
                        <kocca_select:select name="s_option1" sqlNum="coursestatistics1"  param=" " onChange="selectOption1(this.value);" attr="분류" selectedValue="selectSaleListPre" isLoad="true" all="none" type="1" styleClass=""/>
                      </td>
                      <td align="left" valign="middle">
                                                          구분
		  		        <select name="s_option2">
		  				  <option value="ALL">전체</option>
		  				  <option value="CARD"   <%= "CARD".equals(ss_option2) ? " SELECTED" : "" %>>신용카드</option>
		  				  <option value="DIRECT" <%= "DIRECT".equals(ss_option2) ? " SELECTED" : "" %>>계좌이체</option>
						  <option value="VBANK"  <%= "VBANK".equals(ss_option2) ? " SELECTED" : "" %>>가상계좌</option>
						  <option value="BOOK"   <%= "BOOK".equals(ss_option2) ? " SELECTED" : "" %>>무통장입금</option>  			
				        </select>
                      </td>
      ...
      <table width="97%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="left" height="20">&nbsp;<b>매출현황</b></td>
          <td align="right">
      ...
      <table class="table_out" cellspacing="1" cellpadding="5">		
        ...
        <tr>
          ...
          <td class="table_title"><b>입금일자</b></td>
          <td class="table_title"><b>입금자명</b></td>
          <td class="table_title"><b>결제방법</b></td>
          <td class="table_title"><b>복수할인액</b></td>
          <td class="table_title"><b>실결제금액</b></td>
          <td class="table_title" width="5%"><b>계산서여부</b></td>
        </tr>
<%  	if (v_action.equals("go")) {
        	...
        	for (i=0; i<list.size(); i++) {
		        ...
		        v_userid			= dbox.getString("d_user"+"id");
...
%>
        <tr class="table_02_1">
          ...
          <td class="table_02_1"><%= v_inputname %></td>
...
%>
          <td class="table_02_1"><%= v_istaxyn %></td>
        </tr>
<%
        	}
			if (i == 0) {
...
<%			} else { %>
	    <tr class="table_02_3">
          ...
          <td class="table_02_3" colspan="4">합계</td>
