...
<%
    ...
    if ( v_action.equals("go") ) {
        list = (ArrayList)request.getAttribute("OneCnt");
        listsize = list.size();
    }
...
function whenSelection(p_action) {
  ...
  document.form1.p_process.value = 'selectOnetoOne';
      ...
      <table width="97%" border="0" cellspacing="0" cellpadding="0">
          ...
          <td width="12%">
           ...
           <!----------------- button 2 시작----------------->
        	<table cellspacing="0" cellpadding="0" class="s_table">
              ...
              <tr>
                <td class="blue_butt_middle">1:1</td>
              </tr>
              <tr>
        ...
        <!----------------- button 3 시작----------------->
              <table cellspacing="0" cellpadding="0" class="s_table">
                ...
                <tr>
                  <td class="black_butt_middle"><a href="javascript:select_tab('5')" class="c">지식팩토리</a></td>
                </tr>
                <tr>
                  <td class="black_butt_bottom"></td>
                </tr>              
