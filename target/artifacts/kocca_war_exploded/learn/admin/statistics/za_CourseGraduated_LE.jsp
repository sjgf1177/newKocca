...
<%	
	...
	response.setHeader("Content-Disposition", "inline; filename=za_CourseGraduated_LE.xls");
...
<%	
    ...
    ArrayList<DataBox> selectList = (ArrayList<DataBox>)request.getAttribute("selectCourseGraduatedLowDataList");
...
<body bgcolor="#FFFFFF" text="#000000" topmargin="0" leftmargin="0">
				...
				<table class="table_out" cellspacing="1" cellpadding="11" border="1">
	                <tr>
				        <td align="center" height="30" colspan="11"><font size="3"><b>정규 B2C 과정별 수료·만족도 LowData 통계</b></font></td>
				    </tr>
	                <tr>
				        <td align="center" height="30" colspan="11"><font size="3"><b>수강생의 과정 수료일 기준 : <%= searchStartDate %> ~ <%= searchEndDate %></b></font></td>
				    </tr>
	                <tr>
...
%>
					...
					<tr>
						...
						<td class="table_02_1" ><%=( "Y".equals(dbox.getString("d_isgraduated")) ? grad + " (수료일:"+dbox.getString("d_GRADUATEDDATE")+")":grad )%> </td>
