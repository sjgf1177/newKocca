	...
	<!----------------- tab 끝 ----------------->
        ...
        <table class="table_out" cellspacing="1" cellpadding="5">
	      ...
	      <tr>
            ...
            <td class="table_title" width="25%"><a href="javascript:whenOrder('scsubjnm')" class="e">과정</a></td>
            <td class="table_title" width="10%">차수</td>
			<td class="table_title" width="20%">교육기간</td>
            <td class="table_title" width="10%">수강인원</td>
            <td class="table_title" width="25%">매출액</td>
          </tr>
<%
    if ( v_action.equals("go") ) {
...
<%
			v_stucnt_total		+= v_stucnt_i;		//int 계산 합
			v_subjsales_total	+= v_subjsales;		//int 매출총계

			v_fmt_stucnt_tatal = fmt.format(v_stucnt_total);			//천단위로 표현
			v_fmt_subjsales_tatal = fmt.format(v_subjsales_total);		//천단위로 표현
...
%>
		  <tr> 
		    <td colspan="4" class="table_title">계</td>
