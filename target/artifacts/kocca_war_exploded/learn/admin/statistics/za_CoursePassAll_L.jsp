<%
//**********************************************************
//  1. 제      목: 과정운영 통계 - 수료현황  - 전체  현황
//  2. 프로그램명 : za_CoursePassAll_L.jsp
//  3. 개      요: 수료현황 - 전체  현황
//  4. 환      경: JDK 1.5
//  5. 버      젼: 1.0
//  6. 작      성: 2009.12.11
...
function whenSelection(ss_action) {
	var process = 'selectPassAllListPre';            //검색전
...
function whenExcel() {
    ...
    document.form1.target = "_self";
    document.form1.action='/servlet/controller.course.CourseStateAdminServlet';
    document.form1.p_process.value = 'selectPassAllListExcel';
  ...
  <tr>
    <td align="center" valign="top">
      ...
      <table width="97%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="left" height="20">&nbsp;<b>전체 수료현황</b></td>
          <td align="right">
      ...
      <table class="table_out" cellspacing="1" cellpadding="5">		
        ...
        <tr>
          ...
          <td class="table_title"><b>학습인원</b></td>
