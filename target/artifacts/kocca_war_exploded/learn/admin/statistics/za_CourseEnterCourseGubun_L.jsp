<%
//**********************************************************
//  1. 제      목: 과정운영 통계 - 입과현황 - 과정별 회원구분별, 성별, 연령대별, 학력별, 문화산업종사자별, 비문화사업종사자별  현황
//  2. 프로그램명 : za_CourseEnterCourseGubun_L.jsp
...
function whenSelection(ss_action) {
	var process = 'selectEnterCourseGubunListPre';            //검색전
	...
	if (ss_action=="go")  {
		...
		//}
		top.ftop.setPam();
		process='selectEnterCourseGubunList';   //검색후
	}
...
function whenExcel() {
    ...
    document.form1.target = "_self";
    document.form1.action='/servlet/controller.course.CourseStateAdminServlet';
    document.form1.p_process.value = 'selectEnterCourseGubunListExcel';
...
function selectOption3(p) {
	var p_process;
	if( p == "NOR") {
		p_process = "selectEnterCourseListPre";
	} else {
		p_process = "selectEnterCourseGubunListPre";
	}
	document.form1.target = "_self";  
	document.form1.action = "/servlet/controller.course.CourseStateAdminServlet";
	document.form1.p_action.value = "change";
  ...
  <tr>
    <td align="center" valign="top">
                ...
                <td align="center">
                  <table border="0" cellspacing="0" cellpadding="0" width="99%" class="form_table">
                    ...
                    <tr>
                      ...
                      <td align="left" valign="middle">
		  		        <kocca_select:select name="s_option2" sqlNum="coursestatistics2"  param=" " onChange="selectOption1(this.value);" attr="통계구분2" selectedValue="selectEnterCourseListPre" isLoad="true" all="none" type="1" styleClass=""/>
				        &nbsp;
      ...
      <table width="97%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="left" height="20">&nbsp;<b>과정별 <%= stat_text %> 입과현황</b></td>
          <td align="right">
      ...
      <table class="table_out" cellspacing="1" cellpadding="5">		
        <tr>
          <td colspan="<%= listGubun.size() + 3 %>" class="table_top_line"></td>
        </tr>
        <tr>
