<%
//**********************************************************
//  1. 제      목: 과정운영 통계 - 입과현황 - 분야별 일반  현황
//  2. 프로그램명 : za_CourseEnterField_L.jsp
...
function whenSelection(ss_action) {
	var process = 'selectEnterFieldListPre';            //검색전
	...
	if (ss_action=="go")  {
		...
		//}
		top.ftop.setPam();
		process='selectEnterFieldList';   //검색후
	}
...
function whenExcel() {
    ...
    document.form1.target = "_self";
    document.form1.action='/servlet/controller.course.CourseStateAdminServlet';
    document.form1.p_process.value = 'selectEnterFieldListExcel';
  ...
  <tr>
    <td align="center" valign="top">
      ...
      <table width="97%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="left" height="20">&nbsp;<b>분야별 일반 입과현황</b></td>
          <td align="right">
      ...
      <table class="table_out" cellspacing="1" cellpadding="5">		
        ...
        <tr>
          <td class="table_title" width="5%" rowspan="2"><b>No</b></td>
          <td class="table_title" colspan="2"><b>구분</b></td>
          <td class="table_title" rowspan="2"><b>개설과목(개)</b></td>
          <td class="table_title" colspan="2"><b>수강인원(명)</b></td>
          <td class="table_title" colspan="2"><b>수강생비율(%)</b></td>
        </tr>
        <tr>
          <td class="table_title"><b>분야</b></td>
          <td class="table_title"><b>난이도</b></td>
          <td class="table_title"><b>난이도별</b></td>
          <td class="table_title"><b>분야별</b></td>
          <td class="table_title"><b>난이도별</b></td>
          <td class="table_title"><b>분야별</b></td>
        </tr>
...
%>
          ...
          <td class="table_02_1"><%= v_class_cnt %></td>
<%
			if (v_rowspan != 0) {
%>
          <td class="table_02_1" rowspan="<%= v_rowspan %>"><%= v_middleclass_cnt %></td>
<%
			}
%>
          <td class="table_02_1"><%= v_lowerclass_rate %></td>
<%
			if (v_rowspan != 0) {
%>
          <td class="table_02_1" rowspan="<%= v_rowspan %>"><%= v_middleclass_rate %></td>
<%
			}
%>
        </tr>
...
<%			} else { %>
	    <tr class="table_02_3">
          ...
          <td class="table_02_3"><%= v_total_class_cnt %></td>
          <td class="table_02_3"><%= v_total_middleclass_cnt %></td>
          <td class="table_02_3" colspan="2">100%</td>
        </tr>
<%			}
		}
%>
