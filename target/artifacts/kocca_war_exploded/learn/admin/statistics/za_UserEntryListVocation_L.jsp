...
<%
    ...
    String[] v_usercnt     = new String[30];
    String[] v_vocation     = new String[30];
...
function whenSelection(p_action) {
  ...
  document.form1.p_process.value = 'selectVocationCnt';
  ...
  <table width="1000" border="0" cellspacing="0" cellpadding="0" height="663">
      ...
      <table width="97%" border="0" cellspacing="0" cellpadding="0">
        ...
        <!----------------- button 3 시작----------------->
              <table cellspacing="0" cellpadding="0" class="s_table">
                ...
                <tr>
                  <td class="black_butt_middle"><a href="javascript:select_tab('3')" class="c">지역별</a></td>
                </tr>
                <tr>
                  <td class="black_butt_bottom"></td>
                </tr>              
        ...
        <!----------------- button 3 시작----------------->
              ...
              <table cellspacing="0" cellpadding="0" class="s_table">
                ...
                <tr>
                  <td class="blue_butt_middle">직업별</td>
                </tr>
                <tr>
    ...
    <!----------------- tab 끝 ----------------->
        ...
        <table class="table_out" cellspacing="1" cellpadding="5">
          ...
          <tr>
            <td class="table_title" width="10%">직업</td>            
...
if ( v_action.equals("go") ) {    
    for ( int i=0; i<list.size(); i++ ) {
        ...
        v_vocation[i]   = dbox.getString("d_vocation");
...
%>
            <tr class="table_02_1">
            <td class="table_02_1"><%=v_vocation[i]%></td>           
...
$(function () {
	// data
	var data = [
		{ label: "<%=v_vocation[0]%>",  data: <%=v_usercnt[0]%>},
		{ label: "<%=v_vocation[1]%>",  data: <%=v_usercnt[1]%>},
		{ label: "<%=v_vocation[2]%>",  data: <%=v_usercnt[2]%>},
		{ label: "<%=v_vocation[3]%>",  data: <%=v_usercnt[3]%>},
		{ label: "<%=v_vocation[4]%>",  data: <%=v_usercnt[4]%>},
		{ label: "<%=v_vocation[5]%>",  data: <%=v_usercnt[5]%>},
		{ label: "<%=v_vocation[6]%>",  data: <%=v_usercnt[6]%>},
		{ label: "<%=v_vocation[7]%>",  data: <%=v_usercnt[7]%>},
		{ label: "<%=v_vocation[8]%>",  data: <%=v_usercnt[8]%>},
		{ label: "<%=v_vocation[9]%>",  data: <%=v_usercnt[9]%>},
		{ label: "<%=v_vocation[10]%>",  data: <%=v_usercnt[10]%>},
		{ label: "<%=v_vocation[11]%>",  data: <%=v_usercnt[11]%>},
		{ label: "<%=v_vocation[12]%>",  data: <%=v_usercnt[12]%>}
