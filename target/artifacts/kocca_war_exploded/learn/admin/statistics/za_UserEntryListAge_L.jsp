...
function whenSelection(p_action) {
  ...
  document.form1.p_process.value = 'selectAgeCnt';
  ...
  <table width="1000" border="0" cellspacing="0" cellpadding="0" height="663">
           ...
           <td width="12%">
             <!----------------- button 3 시작----------------->
              <table cellspacing="0" cellpadding="0" class="s_table">
                ...
                <tr>
                  <td class="blue_butt_middle">연령별</td>
                </tr>
                <tr>
    ...
    <!----------------- tab 끝 ----------------->
        ...
        <table class="table_out" cellspacing="1" cellpadding="5">
          ...
          <tr>
            <td class="table_title" width="10%">연령</td>            
...
if ( v_action.equals("go") ) {    
    for ( int i=0; i<list.size(); i++ ) {
        ...
        v_ages[i]   = dbox.getString("d_ages");
...
%>
            <tr class="table_02_1">
            <td class="table_02_1"><%=v_ages[i]%></td>           
...
$(function () {
	// data
	var data = [
		{ label: "<%=v_ages[0]%>",  data: <%=v_usercnt[0]%>},
		{ label: "<%=v_ages[1]%>",  data: <%=v_usercnt[1]%>},
		{ label: "<%=v_ages[2]%>",  data: <%=v_usercnt[2]%>},
		{ label: "<%=v_ages[3]%>",  data: <%=v_usercnt[3]%>},
		{ label: "<%=v_ages[4]%>",  data: <%=v_usercnt[4]%>},
		{ label: "<%=v_ages[5]%>",  data: <%=v_usercnt[5]%>},
		{ label: "<%=v_ages[6]%>",  data: <%=v_usercnt[6]%>},
		{ label: "<%=v_ages[7]%>",  data: <%=v_usercnt[7]%>},
		{ label: "<%=v_ages[8]%>",  data: <%=v_usercnt[8]%>}
