...
function whenDelete(i)
{
    var re=/[0-9]+/;
    var r=$("#tb1");

    var a=$("tr:eq("+i+")",r);
    var b=$("td:eq(2)",a).text();
    var num=re.exec(b)/1;
    if(num!=0)
    {
        alert("지정된 Lesson 갯수 : "+num + " 가(이) 존재 합니다. 삭제 할수 없습니다.");
        return;
    }
                ...
                <tr> 
                  ...
                  <br>
                    <table width="99%" border="0" cellpadding="0" cellspacing="0">
                      <tr> 
                        <td> <b><font color="blue">참고)</font></b> [Lesson]에서 OBJECT 지정 후 [Module]에서 모듈 수 변경시 [Lesson] -> OBJECT 지정 -> 저장 버튼을 클릭하여야 반영됩니다.
                        </td>
                      </tr>
                      <tr> 
                        <td height="3"></td>
                ...
                dbox  = (DataBox)list1.get(i); %>
                      <tr> 
                        ...
                        <td bgcolor="#F7F7F7" align="left">&nbsp;&nbsp;&nbsp;
                            ...
                            %>
                            <a href="javascript:whenDeleteModule('<%=dbox.getString("d_module")%>')"><img src="/images/admin/course/del1_butt.gif" border=0></a>
                            <%
                                }
                            %>
                        </td>
                        <td class="table_02_1"><font color=blue><b><%=dbox.getString("d_cnt_lesson")%></b></font> 개</td>
                        <td align="center"><a href="javascript:whenDelete('<%=i+1%>')"><img src="/images/admin/button/btn_del.gif" border=0></a></td>
                      </tr>
<%          }
