	        ...
	        <tr>
			  ...
			  <table border=0 cellspacing=0 cellpadding=0>
				...
				<td>
					...
					<script language='javascript'>object_ETNG_FTP('<%= conf.getProperty("ftp.server.ip")%>', '<%=conf.getProperty("ftp.server.id")%>', '<%= conf.getProperty("ftp.server.pw")%>','<%=d.getScolocate()%>' );</script>
