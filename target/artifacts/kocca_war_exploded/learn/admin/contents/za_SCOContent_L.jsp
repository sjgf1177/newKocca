          ...
          <td bgcolor="#C6C6C6" align="center">
            <table cellspacing="0" cellpadding="0" class="form_table_bg">
              ...
              <tr>
				...
				<!--  <OBJECT ID="ALEX_FTP"
CLASSID="CLSID:796DEC5E-5851-4EE8-91D3-72E69BD270BA"
CODEBASE="ALEX_FTP.CAB#version=1,0,0,3">
</OBJECT>-->
				 ...
				 <OBJECT ID="ETNG_FTP" CLASSID="CLSID:526A654F-760C-49DD-B971-5517ECB98B12"
						CODEBASE="/myclasses/ETNG_FTP.CAB#version=1,0,0,2" width="52" height="22">
								  ...
								  <param name="MainDir"     value="./contents/scobject/<%=d.getScolocate()%>">
											   </OBJECT>
      ...
      <table cellspacing="1" cellpadding="5" class="table_out">
        ...
        <tr>
          ...
          <td class="table_title" width="53%"><b>SCO 제목</b></td>
...
<% 
	...
	for (int i=0; i<list.size(); i++) {
			...
			if (d.getMasteryscore() == 0 ) {
				...
				v_objdelbutton		= "<a href=javascript:whenUpdate('"+d.getOid()+"','"+d.getScolocate()+"')><img src='/images/admin/button/b_modify.gif'  border='0'></a> <a href=javascript:whenDelete('"+d.getOid()+"','"+d.getScolocate()+"')> <img src='/images/admin/button/b_delete.gif' border='0'></a>";
...
<!--<% if ((d.getHighoid() != "" ) && (d.getMetalocation() != "")) { %>
          <% if( d.getMetadata() != 0 ) {  %>
          <td class="table_03_1"><a href="javascript:Meta_Add('<%=d.getOid()%>','<%=d.getMetalocation()%>','<%=d.getScolocate()%>')"><img src=/images/admin/button/b_view.gif border=0></a></td>
		  <% } else { %>
		   <td class="table_03_1"><a href="javascript:Meta_Add('<%=d.getOid()%>','<%=d.getMetalocation()%>','<%=d.getScolocate()%>')"><img src=/images/admin/button/b_regist.gif border=0></a></td>
		  <% } %>
<% } else { %>
           <td class="table_02_1"> - </td>         
<% } %>-->
          <td class="table_03_1"><%=v_objdelbutton%></td>
        </tr>
<%
	}
%>
