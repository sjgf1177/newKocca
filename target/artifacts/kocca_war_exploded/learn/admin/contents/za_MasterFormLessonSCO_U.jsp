...
function whenAssign(module,lesson){
    ...
    var url=document.f2.action;
    url +="?p_process=subjSCOObjectFsetPage&p_subj=<%=p_subj%>";
    window.open(url,"assignWin","width=900,height=700");
}
...
<body bgcolor="#FFFFFF" text="#000000" topmargin="0" leftmargin="0">
 ...
 <table width="970" border="0" cellspacing="0" cellpadding="0">
        ...
        <!--------------소제목 끝---------------------------->  <%@ include file="/learn/admin/contents/include_MasterFormAdmin.jsp" %> 
                    ...
                    <table width="99%" border="0" cellpadding="0" cellspacing="0">
                      <tr> 
                        ...
                        <td><a href="javascript:whenLessonCnt()"><img src="../../../images/admin/contents/go1_butt.gif" width="33" height="20" border="0"><a></td>-->
                         <td align="center"><a href="javascript:whenAssign()"><img src="/images/admin/button/btn_object.gif" border=0></a></td>
                      </tr>
                      <tr> 
                        <td height="10"></td>
                      </tr>
                      <tr> 
                        <td height="3">&nbsp;&nbsp; <font color="red">
                        주의 : 맛보기 Object 저장시 연결 Object의 2 Level단위로 체크하시기 바랍니다. 
                        단, 2 Level만 있는 경우는 1 Level만 체크하면 됨.</font> </td>
                      </tr>
                      <tr> 
                        <td height="3"></td>
                      </tr>
...
<%
                ...
                for(int j=0;j<ht.size();j++){
                    MfLessonDataSub ds = (MfLessonDataSub)ht.get(String.valueOf(j)); 
                        ...
                        for (int tmp=2;tmp<=ds.getScothelevel();tmp++) {
                            out.println("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
                        }

                    //  out.println(ds.getHighoid);
                        
                    if ( (ds.getStarting()==null || ds.getStarting().equals("")) ) { %>
                        <input type=checkbox name="p_previewobj" value="<%=ds.getOid()%>" <% if (ds.getIsPreviewed().equals("Y")) { %> checked <% } %>>
            <%      } else { %> 
...
%>
                ...
                <%  if(Integer.parseInt(data2.getLesson()) > Integer.parseInt(v_unchangableMaxLesson)){ %>                        
                            <a href="javascript:whenDelete('<%=data2.getLesson()%>')"><img src="../../../images/admin/course/del1_butt.gif" border=0></a>
                <%  }   %>
                        </td>-->
                      </tr>                 
<%          }  
