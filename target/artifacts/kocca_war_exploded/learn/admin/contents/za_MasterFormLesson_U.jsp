...
function excelAdd()
{
    window.self.name = "winInsertPage";     //      opener 객체에 name 을 지정한다3
                  ...
                  <br>
                    ...
                    <table width="99%" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td align="right"><img src="/images/admin/button/btn_fileplus.gif" alt="파일로추가" onclick="excelAdd()" style="CURSOR:POINTER"></td>
                      </tr>
                      <tr>
                        <td height="3"></td>
                      </tr>
                    ...
                    <table width="99%" border="0" cellspacing="1" cellpadding="5" id="tb1">
                      ...
                      <tr>
                        ...
                        <td class="table_title"><b>콘텐츠위치[/contents/분과코드/과정코드/차시번호/시작파일명]</b><br/><b>모바일 콘텐츠위치</b></td>                        
...
%>
                ...
                <%--<%  }   %>--%>
                      ...
                      <tr>
                      	<td colspan="6">
                      		<label for="p_subtitle_<%=i %>"><b><%=data2.getLesson() %>차시 자막</b></label><br />
...
<%          }
            ...
            for (int i=list_size;i<=v_cnt_lesson;i++){
            	if(sGrcode.equals("N000002")) {	//게임아카데미
...
%>
                      ...
                      <tr>
                      	<td colspan="6">
                      		<label for="p_subtitle_<%=i %>"><b><%=v_lesson%>차시 자막</b></label><br />
