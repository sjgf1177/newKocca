  ...
  <table width="1000" border="0" cellspacing="0" cellpadding="0" height="663">
    ...
    <td align="center" valign="top"> 
      ...
      <table width="97%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td background="../../../images/admin/contents/title_bg.gif"><img src="../../../images/admin/contents/contents_title4.gif" width="206" height="36" border="0"></td>
        </tr>
      </table>
        <!----------------- title 끝 ----------------->
        <br>
...
<%  		}  
			...
			for (int i=list_size;i<=v_cnt_lesson;i++){
				v_lesson = new DecimalFormat("00").format(i);
			%>
                      <tr> 
                      	<input type=hidden name="p_owner" value="">
                      	<input type=hidden name="p_starting" value="">
