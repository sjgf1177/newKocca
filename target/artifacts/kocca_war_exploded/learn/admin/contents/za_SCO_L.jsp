   ...
   타이틀 백업 끝------------------->
        ...
        <tr>
          <td bgcolor="#C6C6C6" align="center">
            <table cellspacing="0" cellpadding="0" class="form_table_bg">
                ...
                <td align="center" width="99%" valign="middle">
                  <table width="99%" cellspacing="0" cellpadding="0" class=""form_table">
                    <tr>
                      <td align=center>
                      사용과정 
                      <%=SCOBean.makeObcSubjSelect(s_subj,"")%>  
                      &nbsp;&nbsp;
                      검색어
	         ...
	         &nbsp; 
                      <a href="javascript:whenContentSelection()"><img src="/images/admin/button/btn_contentslist.gif" align="absmiddle" border=0></a>
					<%  }   %>
                      </td>
                    </tr>
                  </table>
      ...
      <table cellspacing="1" cellpadding="5" class="table_out">
        ...
        <tr>
          ...
          <td class="table_title" width="36%"><b>SCO 명</b></td>
          <td class="table_title" width="26%"><b>사용과정</b></td>
         <!-- <td class="table_title" width="8%"><b>메타데이타</b></td>-->
