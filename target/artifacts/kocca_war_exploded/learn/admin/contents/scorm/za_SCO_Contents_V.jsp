...
function initAPI(){	
	...
	ebody.document.location.href="/learn/admin/contents/scorm/za_SCO_Contents_L.jsp?oid=<%=oid%>&p_content=<%=p_content%>";
}
//-->
</SCRIPT>

<frameset rows="0,*" cols="*" border="1" FRAMESPACING="0" TOPMARGIN="0" LEFTMARGIN="0" MARGINHEIGHT="0" MARGINWIDTH="0" ONLOAD="initAPI();">
	<frame src="DummyApi.jsp"  name="etop" scrolling="NO" frameborder="0" BORDER="0">
