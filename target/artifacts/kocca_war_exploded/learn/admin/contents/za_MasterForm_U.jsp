...
<%
	...
	ArrayList		list1 = (ArrayList)request.getAttribute("MfMenuData");	
	ArrayList		list2 = (ArrayList)request.getAttribute("MfSubjData");
	DataBox			dbox1 = null;
	MfSubjData		data2 = null;	
...
<%						}								%>                        
                      ...
                      <tr> 
                        <td class="table_title" height="25"> 
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td align="center" class="table_title" >메뉴선택</td>
                            </tr>
                            <tr>
                              <td height="6"></td>
                            </tr>
					...
					<FORM name="ff">
                        <td bgcolor="#F7F7F7" colspan="<%=v_colspan%>"> 
            				<select name="sel" size=8 style="width:500;" onchange="whenSel();">
                      ...
                      <tr> 
                        ...
                        <td bgcolor="#F7F7F7" colspan="<%=v_colspan%>"> 
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                              <td width="67%"> 
            					<select multiple name="result" size=8 style="width:500;">
<%
									for (j=0; j<list2.size(); j++) {
        								data2  = (MfSubjData)list2.get(j);   %>
                						<option value="<%=data2.getMenu()%>"><%=data2.getIsrequiredTxt()%><%=data2.getMenunm()%></option>
<%  								}
									if (j == 0) {
%>
										<option value="96">Blank6</option>
										<option value="01">[Required]성적/목차</option>
										<option value="35">용어사전</option>
										<option value="34">Report(Project)</option>
										<option value="95">설문</option>
										<option value="91">평가</option>
										<option value="21">자료방1-게시판형</option>
										<option value="03">[Required]질문방</option>
										<option value="22">게시판</option>
										<option value="93">수강생 현황</option>
										<option value="94">강사소개</option>
<%									}    %>
								</select>
                              </td>
					</FORM>
                              <td width="33%"> 
                                <table width="80" border="0" cellspacing="0" cellpadding="0">
                                  <tr> 
                                    <td align="center"><a href="javascript:moveTo(-1)"><img src="/images/admin/button/up_b.gif"  border="0"></a></td>
                                  </tr>
                                  <tr> 
                                    <td height="5"></td>
                                  </tr>
                                  <tr> 
                                    <td align="center"><a href="javascript:moveTo(1)"><img src="/images/admin/button/down_b.gif"  border="0"></a></td>
                                  </tr>
                                  <tr> 
                                    <td height="20"></td>
                                  </tr>
                                  <tr> 
                                    <td align="center"><a href="javascript:dels()"><img src="/images/admin/button/btn_del.gif"  border="0"></a></td>
                                  </tr>
                                </table>
                              </td>
                            </tr>
