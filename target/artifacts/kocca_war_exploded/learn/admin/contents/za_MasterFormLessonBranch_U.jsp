...
<%          }  %>
            ...
            <table width="95%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="right" style="padding-top=10"><a href="javascript:whenSubmit()"><img src="/images/admin/button/btn_save.gif"  border="0"></a></td>
                <td align="right" style="padding-top=10" width="44"><a href="javascript:window.close()"><img src="/images/admin/contents/close1_butt.gif"  border="0"></a></td>
              </tr>
            </table>
            <!----------------- 저장, 닫기 버튼 끝 ----------------->
            <br>
