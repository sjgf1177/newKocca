...
<!-- 공통파일 끝-->
   ...
   <param name="connection.reportname" value="reports/re4_SubjCode.ozr">
   <param name="viewer.configmode" value="html">
   <param name="viewer.isframe" value="false">
   <param name="odi.odinames" value="re4_SubjCode">
   <param name="odi.re4_SubjCode.pcount" value="1">
   <param name="odi.re4_SubjCode.args1" value="param=<%=v_param%>">   
</OBJECT>
</body>
</html>
