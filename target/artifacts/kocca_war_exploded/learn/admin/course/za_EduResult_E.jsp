...
<!-- 공통파일 끝-->
   <param name="connection.reportname" value="reports/EduResult.ozr">
   <param name="viewer.configmode" value="html">
   <param name="viewer.isframe" value="false">   
   <param name="odi.odinames" value="EduResult">
   <param name="odi.EduResult.pcount" value="1">
   <param name="odi.EduResult.args1" value="param=<%=v_param%>">
</OBJECT>
</body>
</html>
