...
<form name="form1" method="post" action="/servlet/controller.course.ClassifySubjectServlet">
              ...
              <tr>
                <td height="26" class="table_02_1"><SPAN ID="upperclasslay" style="visibility:<%=(v_classtype.equals("upper") ? "hidden" : "visible")%>;">
                  * 대분류<% SelectParam param = new SelectParam("p_upperclass", "changeUpperclass()", false, 18, box.getHttpSession()); %><%=SelectionUtil.getUpperClass(v_upperclass, param)%></SPAN> <SPAN ID="middleclasslay" style="visibility:<%=(v_classtype.equals("lower") ? "visible" : "hidden")%>;">* 중분류<% param.setSelectname("p_middleclass"); param.setOnchange("");%><%=SelectionUtil.getMiddleClass(v_upperclass, v_middleclass, param)%></SPAN>
                </td>
              </tr>
              <tr>
