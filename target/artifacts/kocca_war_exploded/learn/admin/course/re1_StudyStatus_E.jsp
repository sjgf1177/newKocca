...
<!-- 공통파일 끝-->
   ...
   <param name="connection.reportname" value="reports/re1_StudyStatus.ozr">
   <param name="viewer.configmode" value="html">
   <param name="viewer.isframe" value="false">
   <param name="odi.odinames" value="re1_StudyStatus">
   <param name="odi.re1_StudyStatus.pcount" value="1">
   <param name="odi.re1_StudyStatus.args1" value="param=<%=v_param%>">   
</OBJECT>
</body>
</html>
