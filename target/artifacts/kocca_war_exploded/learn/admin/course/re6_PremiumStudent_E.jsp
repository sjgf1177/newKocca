...
//**********************************************************
//  1. 제      목: 성적우수자
//  2. 프로그램명: re6_PremiumStudent_E.jsp
//  3. 개      요: 교육결과
//  4. 환      경: JDK 1.3
//  5. 버      젼: 1.0
//  6. 작      성: 정은년 
...
<!-- 공통파일 끝-->
   ...
   <param name="connection.reportname" value="reports/re6_PremiumStudent.ozr">
   <param name="viewer.configmode" value="html">
   <param name="viewer.isframe" value="false">
   <param name="odi.odinames" value="re6_PremiumStudent">
   <param name="odi.re6_PremiumStudent.pcount" value="1">
   <param name="odi.re6_PremiumStudent.args1" value="param=<%=v_param%>">   
</OBJECT>
</body>
</html>
