...
<!-- 공통파일 끝-->
   ...
   <param name="connection.reportname" value="reports/re8_ToturList.ozr">
   <param name="viewer.configmode" value="html">
   <param name="viewer.isframe" value="false">
   <param name="odi.odinames" value="re8_ToturList">
   <param name="odi.re8_ToturList.pcount" value="1">
   <param name="odi.re8_ToturList.args1" value="param=<%=v_param%>">   
</OBJECT>
</body>
</html>
