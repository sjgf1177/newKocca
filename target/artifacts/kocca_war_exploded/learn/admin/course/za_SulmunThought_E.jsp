...
//**********************************************************
//  1. 제      목: 과정운영정보
//  2. 프로그램명: za_SulmunThought_E.jsp
//  3. 개      요: 과정운영정보 리스트
//  4. 환      경: JDK 1.3
//  5. 버      젼: 1.0
//  6. 작      성: 정은년 
...
<!-- 공통파일 끝-->
   <param name="connection.reportname" value="reports/SulmunThought.ozr">
   <param name="viewer.configmode" value="html">
   <param name="viewer.isframe" value="false">     
   <param name="odi.odinames" value="SulmunThought">
   <param name="odi.SulmunThought.pcount" value="1">
   <param name="odi.SulmunThought.args1" value="param=<%=v_param%>">
</OBJECT>
</body>
</html>
