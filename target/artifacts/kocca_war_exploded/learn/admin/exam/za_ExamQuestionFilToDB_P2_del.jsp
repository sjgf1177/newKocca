        ...
        try {
           ...
           connMgr.setAutoCommit(false);
            ...
            for (i=1; i < sheet.getRows() ; i++ ) {
                ...
                cell      = sheet.getCell(3,i);      // 과정seltext
                v_examtype  = cell.getContents();
                cell      = sheet.getCell(4,i);      // 과정isanswer
                v_examtext  = cell.getContents();
                cell      = sheet.getCell(5,i);      // 과정
                v_exptext  = cell.getContents();
                cell      = sheet.getCell(6,i);      // 과정
                v_levels  = cell.getContents();
                cell      = sheet.getCell(7,i);      // 과정
...
%>
        ...
        <tr>
          <td height="20">2. 엑셀파일 작성시 [<b><font color="#003AEA">사번</font></b>]의 순서로 만들 것.</td>
        </tr>
        <tr>
