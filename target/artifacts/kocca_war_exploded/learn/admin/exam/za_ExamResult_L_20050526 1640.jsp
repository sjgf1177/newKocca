...
function whenSetRetry(p_subj, p_year, p_subjseq, p_lesson, p_examtype, p_papernum, p_userid, p_username, p_jikwinm, p_retrycnt) {

  window.self.name = "winExamRetrySet";
  farwindow = window.open("", "openExamRetrySet", "toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes, resizable=yes,copyhistory=no, width=400, height=300, top=0, left=0");
  document.form3.target = "openExamRetrySet";
  document.form3.action = "/servlet/controller.exam.ExamUserServlet";
  ...
  document.form3.p_papernum.value= p_papernum; 
  document.form3.p_userid.value  = p_userid;
  document.form3.p_username.value  = p_username;
  document.form3.p_jikwinm.value  = p_jikwinm;
  document.form3.p_retrycnt.value  = p_retrycnt;
...
function whenExcel(p_action) {
    ...
    window.self.name = "ExamResult";     
    open_window("ExamResult","","100","100","700","400","yes","yes","yes","yes","yes");  
    document.form1.target = "openExcel";               
    document.form1.action="/servlet/controller.exam.ExamResultServlet";
    document.form1.p_process.value = 'ExamResultExcel';   
    document.form1.submit();
}
...
<!----------------- 평가점수 조회 시작 ----------------->    
      ...
      <table cellpadding="0" cellspacing="0" class="table1">
        <tr>
          <td align="right" height="20"><a href="javascript:whenExcel('go')"><img src="/images/admin/button/btn_excelprint.gif" border="0"></a></td>
        </tr>
        <tr>
          <td height="3"></td>
        </tr>
      ...
      <form name="form3" method="post" action="/servlet/controller.exam.ExamUserServlet">
        ...
        <input type="hidden" name="p_action"   value="">
			  ...
			  <input type="hidden" name="p_retrycnt"  value="">
			  
			  <input type="hidden" name="ss_grcode"  	  value="<%=ss_grcode%>">  		   
			  <input type="hidden" name="ss_gyear"        value="<%=ss_gyear%>">           
			  <input type="hidden" name="ss_grseq"        value="<%=ss_grseq%>">           
			  <input type="hidden" name="ss_upperclass"   value="<%=ss_upperclass%>">
			  <input type="hidden" name="ss_middleclass"  value="<%=ss_middleclass%>">
			  <input type="hidden" name="ss_lowerclass"   value="<%=ss_lowerclass%>">      
			  <input type="hidden" name="ss_subjcourse"   value="<%=ss_subjcourse%>">      
			  <input type="hidden" name="ss_subjseq"      value="<%=ss_subjseq%>">       
			  <input type="hidden" name="ss_lesson"   value="<%=ss_lesson%>">      
			  <input type="hidden" name="ss_papernum"      value="<%=ss_papernum%>">       
