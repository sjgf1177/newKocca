...
function chkData() {
  ...
  if (blankCheck(document.form2.p_lesson.value)) {
    document.form2.p_lesson.focus();
    alert('차시를 선택하세요.');
    return false;
  }
  ...
  <tr>
    <td align="center" valign="top">
      <!--<table width="97%" border="0" cellspacing="0" cellpadding="0" class=page_title>
        <tr>
          <td><img src="/images/admin/exam/tit_testman.gif" ></td>
      ...
      <table cellpadding="0" cellspacing="0" class="table1">
		...
		<td width="1%"><img src="/images/admin/common/icon.gif" ></td>
		  ...
		  [<%=GetCodenm.get_subjnm(v_subj)%>] 신규문제 등록<br>
		  <font color=blue>[문제나 항목을 이미지로 할려면 태그를 입력하세요]</font>
		  </td>
        </tr>
        <tr>
          <td height="3"></td>
      ...
      <form name="form2" method="post" enctype="multipart/form-data">
        ...
        <%if(v_ctype.equals("Y")){%>
		<tr>
          <td class="table_title">과정콘텐츠타입</td>
...
<SELECT name=p_lesson  >
 ...
 <option value=002>002</option>
		...
		<tr>
          ...
          <td class="table_02_1" valign="top" colspan="3">
            <textarea name="p_examtext" cols="70" rows="2"></textarea>
		  </td>
        </tr>
		<tr>
          <td class="table_title">문제해설</td>
          <td class="table_02_1" valign="top" colspan="3">
            <textarea name="p_exptext" cols="70" rows="2"></textarea>
		  </td>
        </tr>
	   </table>
