<%
/**
 * file name : za_ExamQuestion_U.jsp
 * date      : 2003/09/01
 * programmer:
...
<%
	...
	//out.println("v_ctypev_ctype"+v_ctype);
     ...
     <br>
      ...
      <table cellpadding="0" cellspacing="0" class="table1">
        <tr>
		  ...
		  [<%=GetCodenm.get_subjnm(v_subj)%>] [<%=dbox0.getString("d_examnum")%>번] 문제 수정<br>
...
<%
    for (int k=1; k <= 10; k++) {
       if (v_examtype.equals("1") && list.size() >= k ){
