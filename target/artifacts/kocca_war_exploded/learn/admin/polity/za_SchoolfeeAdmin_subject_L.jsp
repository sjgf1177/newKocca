...
<form name = "form1" method = "post">
	...
	<input type="hidden" name="isSubject" value="true">
...
%>
		...
		<table class="table_out" cellspacing="1" cellpadding="5">		
		  ...
		  <tr>
			...
			<td class="table_title"><b><kocca_select:select name="s_membergubun" sqlNum="0001"  param="0101"
	onChange="whenSelection('go');" attr="해당분야" selectedValue="<%= ss_membergubun %>" isLoad="true" all="true" type="3" styleClass="table_title"/></b></td>
			<td class="table_title"><b><a href="javascript:ordering('subjnm')" class="e">과정명</a></b></td>
	...
	onChange="whenSelection('go');" attr="결제상태" selectedValue="<%= ss_paystatus %>" isLoad="true" all="none" type="3" styleClass="table_title"/></b></td>
			...
			<td class="table_title"><b>할인율</b></td>
			<td class="table_title"><b><a href="javascript:ordering('a.price')" class="e">결제금액</a></b></td>
...
%>
			<tr class="table_02_1">
				...
				<td class="table_02_1"><%= dbox.get("d_areanm") %></td>
				<td class="table_02_2"><%= v_subjnm + "<br/>[" +  v_goodname %>]</td>
...
%>
				...
				<td class="table_02_1"><%= new java.text.DecimalFormat("###,###,##0").format(dbox.getDouble("d_discountpercent")) %>%</td>
				<td class="table_02_1"><%= new java.text.DecimalFormat("###,###,##0").format(v_price*(100-dbox.getDouble("d_discountpercent"))/100) %></td>
