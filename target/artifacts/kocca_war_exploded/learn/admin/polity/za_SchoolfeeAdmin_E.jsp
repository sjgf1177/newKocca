...
//**********************************************************
//  1. 제      목: 수강료결제 관리 엑셀
//  2. 프로그램명 : za_SchoolfeeAdmin_E.jsp
...
<%	
	...
	response.setHeader("Content-Disposition", "inline; filename=za_SchoolfeeAdmin_E.xls");
...
<table width="1000" border="0" cellspacing="0" cellpadding="0" height="663">
    <tr>
        <td align="center" height="30"><font size="3"><b>수강료결제 관리</b></font></td>
    </tr>
  <tr>
...
%>
            <tr>
                ...
                <td><%= v_codenm %></td>
                <td><%= v_goodname %></td>
                <td><%= FormatDate.getFormatDate(v_inputdate,"yyyy/MM/dd") %></td>
                <td><%= v_paystatus %></td>
