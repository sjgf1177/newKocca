<%
/**
 * file name : za_AccountAdmin_E.jsp
 * date      :
 * programmer:
...
<%	response.setHeader("Content-Disposition", "inline; filename=za_AccountAdmin_E.xls");
...
<table width="1000" border="1" cellspacing="0" cellpadding="0" height="663">
	<tr>
		<td align="center" height="30"><font size="3"><b>무통장 입금 관리 리스트</b></font></td>
	</tr>
  <tr>
    <td align="center" valign="top">
        ...
        <table class="table_out" cellspacing="1" cellpadding="5" border="1">
          <tr>
            ...
            <td class="table_title"><b>납부<br>금액</td>
            <td class="table_title"><b>입금자</td>
            <td class="table_title"><b>입금액</td>
            <td class="table_title"><b>입금일</td>
            <td class="table_title"><b>구분</td>
          </tr>
...
<%  
        ...
        for (i=0; i<list.size(); i++) {
			...
			if(v_paystat.equals("W")) { v_paystat = "미입금";}
			else if(v_paystat.equals("Y")) { v_paystat = "입금완료";}
			else if(v_paystat.equals("CY")) { v_paystat = "결제취소완료";}
			else if(v_paystat.equals("CW")) { v_paystat = ",결제취소대기중";}
%>
            <tr align="left">
                <td><%=(i + 1) %></td>
                ...
                <td><%=FormatDate.getFormatDate(v_paydate,"yyyy-MM-dd") %></td>
                <td><%=v_paystat%></td>
            </tr>
<%        
        }
