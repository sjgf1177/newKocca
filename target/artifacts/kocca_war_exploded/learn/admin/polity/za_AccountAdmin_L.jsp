<%
/**
 * file name : za_AccountAdmin_L.jsp
 * date      :
 * programmer:
 * function  : 무통장 신청 관리 리스트 조회화면
 */
%>
...
$(document).ready(function(){
	$("#s_accountstart").datepicker({defaultDate: new Date(),showOn: "both",showAnim: "blind",showOptions: {direction: 'horizontal'},duration: 200})
	$("#s_accountend").datepicker({defaultDate: new Date(),showOn: "both",showAnim: "blind",showOptions: {direction: 'horizontal'},duration: 200})
});
<!--
	...
	function whenSelection(p_action) {
	  ...
	  document.form1.action='/servlet/controller.polity.AccountAdminServlet';
	...
	function whenApprovalProcess(){
		...
		for(var i = 0; i < oTmp.length; i++)
		{
			if(oTmp[i].type == "checkbox" && oTmp[i].name != "p_chkeckall")
			{
				...
				{
					k++;
					ff.p_chkvalue.value += eval("document.getElementById('p_paydate" + j + "').value") + "," + eval("document.getElementById('p_paystat" + j + "').value") + "," + oTmp[i].value + "|";
				}
		...
		ff.action='/servlet/controller.polity.AccountAdminServlet';
		ff.p_process.value = "AccountAdminInsert";
		ff.submit();
	}
  ...
  <table width="1000" border="0" cellspacing="0" cellpadding="0" height="663">
    ...
    <td align="center" valign="top">
      ...
      <table width="97%" border="0" cellspacing="0" cellpadding="0" class=page_title>
        <tr>
          <td><img src="/images/admin/polity/tit_service_04.gif" ></td>
...
<form name = "form1" method = "post">
    ...
    <input type="hidden" name="p_returnurl"       value="/servlet/controller.polity.AccountAdminServlet">
                  ...
                  <table border="0" cellspacing="0" cellpadding="0" width="99%" class="form_table">
					...
					<tr>
						...
						<table cellspacing="0" cellpadding="0" width="100%">
							<tr>
								<td>
									신청일&nbsp;<input name="s_accountstart" id="s_accountstart" value="<%=ss_accountstart%>" type="text" class="datepicker_input1" size="10">&nbsp;
									~&nbsp;<input name="s_accountend" id="s_accountend" value="<%=ss_accountend%>" type="text" class="datepicker_input1" size="10">&nbsp;
									입금구분
									<select name="s_accountstat">
										<option value="ALL" <%if(ss_accountstat.equals("") || ss_accountstat.equals("ALL")) { %> selected <% } %>>전체</option>
										<option value="W" <%if(ss_accountstat.equals("W")) { %> selected <% } %>>미입금</option>
										<option value="Y" <%if(ss_accountstat.equals("Y")) { %> selected <% } %>>입금완료</option>
									</select></td>
								<td><%@ include file="/learn/admin/include/za_GoButton.jsp" %></div><!-- whenSelection('go') -->
								</td>
							</tr>
						</table>
...
<!---------------------////////////////////////////// 과정/차수정보 ////////////////////////////////-------------------------->
        ...
        <table class="table_out" cellspacing="1" cellpadding="5">		
          ...
          <tr>
            <td class="table_title" width="10%"><a href="javascript:ordering('userid')" class="e">신청인<br>(ID)</a></b></td>
            <td class="table_title" width="10%"><b><a href="javascript:ordering('subjnm')" class="e">신청<br>과목</a></b></td>
            <td class="table_title" width="5%"><b><a href="javascript:ordering('subjseq')" class="e">차수</a></b></td>
            <td class="table_title" width="10%"><b><a href="javascript:ordering('name')" class="e">교육기간</a></b></td>
            ...
            <td class="table_title"><b>납부<br>금액</a></td>
            <td class="table_title"><b>입금자</a></td>
            <td class="table_title"><b>입금액</a></td>
            <td class="table_title"><b>입금일</a></td>
            <td class="table_title"><b>입금<br>구분</a></td>
...
%>
            <tr class="table_02_1">
                ...
                <td class="table_02_1"><input type="text" name="p_paydate" id="p_paydate<%=i%>" size="10" value="<%=v_paydate %>"onkeydown="javascript:return numcheck(this)"></td>
                <td class="table_02_1">
					<select name="p_paystat" id="p_paystat<%=i%>">
						<option value="ALL" <%if(v_paystat.equals("") || v_paystat.equals("ALL")) { %> selected <% } %>>전체</option>
						<option value="W" <%if(v_paystat.equals("W")) { %> selected <% } %>>미입금</option>
						<option value="Y" <%if(v_paystat.equals("Y")) { %> selected <% } %>>입금완료</option>
					</select>
				</td>
                <td class="table_02_1">
