...
<%
    ...
    String  ss_settlementstart	= box.getString("s_settlementstart");//환불시작일
    String  ss_settlementend	= box.getString("s_settlementend");	//환불종료일
                  ...
                  <table border="0" cellspacing="0" cellpadding="0" width="99%" class="form_table">
					...
					<tr>
						...
						<table cellspacing="0" cellpadding="0" width="100%">
							<tr>
								<td>
									신청일&nbsp;<input name="s_settlementstart" id="s_settlementstart" value="<%=ss_settlementstart%>" type="text" class="datepicker_input1" size="10">&nbsp;
...
<!---------------------////////////////////////////// 과정/차수정보 ////////////////////////////////-------------------------->
        ...
        <table width="97%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td class=sub_title>카드 결제 관리</td>
        ...
        <table class="table_out" cellspacing="1" cellpadding="5">		
          ...
          <tr>
            ...
            <td class="table_title"><b>결제일</a></td>
            <td class="table_title"><b>결제번호</a></td>
            <td class="table_title"><b>승인번호</a></td>
            <td class="table_title"><b>결제금액</a></td>
            <td class="table_title"><b>승인<br>구분</a></td>
          </tr>
