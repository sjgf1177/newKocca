...
<%  } else {                        %>
		document.form1.p_process.value= "updateMainMenu";
<%  }                               %>
  ...
  <table cellSpacing="0" cellPadding="4" width="420" bgColor="#ffffff" border="0">
    <tr>
      <td height="30" align="center"> <table cellSpacing="0" cellPadding="0" width="400" border="0">
          ...
          <tr>
            <td><img src="/images/admin/templet/st_1.gif" ></td>
          </tr>
        </table></td>
    </tr>
    <tr id="htrMenuList">
...
%>
                      <option value="<%=v_m_gubun%>"><%=v_m_menuname%></option>
<% }   %>
                    </select>
                  </td>
                </tr>
...
<%
    for (int i=0; i<list2.size(); i++) {
        ...
        v_s_order    += v_s_gubun + "|";
%>
                      <option value="<%=v_s_gubun%>"><%=v_s_menuname%></option>
<% }   %>
                    </select>
                    </A> 
