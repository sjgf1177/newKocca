...
<%!
    private ArrayList<DataBox> selectWinnerPrizeList() throws Exception {
        ...
        try {
            ...
            sql.append("    ,   EMAIL                                           \n");
            sql.append("    ,   CASE WHEN WIN_LEVEL = 1 THEN '바나나 우유'      \n");
            sql.append("             WHEN WIN_LEVEL = 2 THEN 'CU 모바일 상품권' \n");
            sql.append("             WHEN WIN_LEVEL = 3 THEN '던킨도너츠 교환권'\n");
            sql.append("             WHEN WIN_LEVEL = 4 THEN 'CGV 주중예매권'   \n");
            sql.append("             WHEN WIN_LEVEL = 5 THEN 'iPad mini 32G'    \n");
