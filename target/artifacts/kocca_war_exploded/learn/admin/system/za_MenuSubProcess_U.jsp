...
//**********************************************************
//  1. 제      목: 프로세스 관리
//  2. 프로그램명 : za_MenuSubProcess_U.jsp
//  3. 개      요: 프로세스 수정
//  4. 환      경: JDK 1.3
//  5. 버      젼: 1.0
//  6. 작      성: 정상진 2003. 7. 8
        ...
        <table class="table_out" cellspacing="1" cellpadding="5">
          ...
          <tr> 
            ...
            <td height="25" class="table_02_2">
              <input type="radio" name="p_servlettype"  class="input" size="18" value='1' <% if(v_servlettype.equals("1")) {%>checked <%}%>>조회&nbsp;
			  <input type="radio" name="p_servlettype"  class="input" size="18" value='2' <% if(v_servlettype.equals("2")) {%>checked <%}%>>조회(쓰기액션있음)&nbsp;
			  <input type="radio" name="p_servlettype"  class="input" size="18" value='4' <% if(v_servlettype.equals("4")) {%>checked <%}%>>쓰기액션&nbsp;
            </td>
          </tr>
          <tr> 
            <td width="15%" height="26" class="table_title"><strong>함수명</strong></td>
            <td height="25" class="table_02_2"><input name="p_method" type="text" class="input" size="60" value="<%=v_method%>"> 
            </td>
          </tr>
        </table>
...
<%
            for(int i = 0; i < list.size(); i++) {
                MenuSubProcessData data1  = (MenuSubProcessData)list.get(i);
                v_processvalue     = data1.getProcess();
                v_servlettype      = data1.getServlettype();
                v_method           = data1.getMethod();
