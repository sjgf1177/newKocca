  ...
  <tr>
    <td align="center" valign="top">
        ...
        <tr>
          ...
          <td width="120" height="23" align="left" valign="middle">
            <table cellspacing="0" cellpadding="0" class="s_table">
              ...
              <tr>
                <td class="<%=v_tab_color1%>_butt_middle">메뉴별 접속통계</td>
              </tr>
              <tr>
          ...
          <td width="120" height="23" align="left" valign="middle">
            <table cellspacing="0" cellpadding="0" class="s_table">
              ...
              <tr>
                <td class="<%=v_tab_color3%>_butt_middle"><a href="javascript:changeTabpage('PREVIEW')" class="c">맛보기카운트</a></td>
              </tr>
              <tr>
                <td class="<%=v_tab_color3%>_butt_bottom"></td>
              </tr>
	  ...
	  <br>
        ...
        <table width="97%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="center"><font face="굴림" size="3.5">◈<b>메뉴별 접속통계</font></b></td>
          </tr>
        </table>
        <br>
        <!----------------- 시간대별 접속자수 끝 ----------------->
        <table width="97%" border="1" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td class="table_title" width="30%" height="25"><b>대메뉴</b></td>
            <td class="table_title" width="30%" height="25"><b>메뉴</b></td>
            <td class="table_title" width="20%" height="25"><b>접근횟수</b></td>
	      </tr>
...
<%
	...
	if( v_grcode.equals("N000002") ){	// 게임
		if(v_gubun.equals("0")){
			...
			v_gubunname = "나의공부방";
		}else if(v_gubun.equals("4")){
			v_gubunname = "Help Desk";
		}else if(v_gubun.equals("5")){
			v_gubunname = "Service";
		}

	}else if( v_grcode.equals("N000001") ){ // 문콘
		if(v_gubun.equals("0")){
			v_gubunname = "메인";
		}else if(v_gubun.equals("1")){
			v_gubunname = "과정소개";
...
%>
          ...
          <tr>
<%	if(!v_gubun1.equals(v_gubun)){%>           
			<td class="table_01" bgcolor="#1EEEEE" rowspan="<%=v_gubuncnt+1%>"><font color="blue"><b><%=v_gubunname%></b></font></td>
<%	}%>
            <td class="table_02_1" align="left"><%=v_menuname%></td>
			<td class='table_02_1'><%=v_cnt%></td>
          </tr>
<%	if(j==v_gubuncnt){%>
		  <tr>
            <td class="table_02_1"><b>총계<b></td>
			<td class='table_02_1'><%=v_gubuntot%></td>
		  </tr>
<%
		v_gubuntot = 0;
		j=0;
