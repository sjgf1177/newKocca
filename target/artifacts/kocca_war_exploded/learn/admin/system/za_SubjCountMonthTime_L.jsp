...
//**********************************************************
//  1. 제      목: 접속통계
//  2. 프로그램명 : za_CountMonthTime_L.jsp
//  3. 개      요: 접속통계 - 월시통계 리스트
//  4. 환      경: JDK 1.3
//  5. 버      젼: 1.0
//  6. 작      성: 정상진 2003. 7. 8
...
//select시 조회
    function whenSelection(p_action) {
        ...
        document.form1.action = "/servlet/controller.system.SubjCountServlet";
        document.form1.p_process.value = "selectMonthTime";
        document.form1.submit();
	}
//페이지 이동
  ...
  <tr>
    <td align="center" valign="top">
	  ...
	  <br>
        ...
        <table width="97%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="center"><font face="굴림" size="3.5">◈<b>접속통계 (월-시 통계) <%=v_year%>년 Total :<%=v_yearcount%></font></b></td>
          </tr>
        </table>
        <br>
        ...
        <table width="37%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td align="center"><img src="/images/admin/system/statistics3_butt.gif" width="76" height="20" border="0"></td>
...
%>
        ...
        <table width="97%" border="0" cellspacing="1" cellpadding="0">
          ...
          <tr>
            ...
            <td class="table_title"><b>[<%=v_year%>년 <%=v_month%>월]  시간대별 접속자수입니다.</b></td>
          </tr>
