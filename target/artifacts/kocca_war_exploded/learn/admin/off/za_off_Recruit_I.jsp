    ...
    <td align="center" valign="top">
      ...
      <!----------------- 과정 등록/수정/삭제/상세보기 (사이버) 시작 ----------------->
        <table cellspacing="1" cellpadding="5" class="table_out" border="0">
          ...
          <tr>
            <td class="table_01">과정코드<font color="red">(*)</font></td>
            <td class="table_02_2" ><input type="text" class="input" name="p_subj" size="10" maxlength="10" value="자동생성" readonly>
          ...
          <tr>
            ...
            function fnSearchBoxs_middleclass() {
                ...
                중분류 <kocca_select:select name="p_middleclass" sqlNum="off.0003"  param="<%= ss_upperclass %>"
                ...
                소분류 <kocca_select:select name="p_lowerclass" sqlNum="off.0004"  param="<%= ss_upperclass %>"  param2="<%= ss_middleclass %>"
...
-->
          ...
          <tr>
            ...
            <td class="table_02_2">
                ...
                <select name="p_edudaystype"  class="inputpsearch" tabindex=28>
                    <option value='Y' selected>년</option>
          ...
          <tr>
            ...
            <td class="table_02_2" >
              대규모기업(300명이상기업) : <input type="text" class="input" name="p_goyongpricemajor" size="15" maxlength="10" value="0" disabled tabindex=34> 원
              &nbsp;&nbsp;&nbsp;우선지원기업(중소기업) : <input type="text" class="input" name="p_goyongpriceminor" size="15" maxlength="10" value="0" disabled tabindex=34> 원
            </td>
          </tr>
          <tr>
      ...
      <table cellspacing="1" cellpadding="5" class="table_out">
        ...
        <tr>
          <td class="table_title"><b>메인화면이미지</b></td>
          <td class="table_02_2">
