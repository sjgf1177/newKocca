...
<%
    ...
    String  ss_gyear     = box.getStringDefault("s_gyear", FormatDate.getDate("yyyy"));         //년도
...
<%} %>
          ...
          <tr>
            ...
            <tr>
             ...
             <tr>
               ...
               <td class="table_02_2">
                <a name="#chk004"></a><input name="p_startcanceldate1" id="p_startcanceldate1" type="text" class="datepicker_input1" size="10" value="" onMouseover="if(this.value=='') this.value=p_propstart1.value"> 일&nbsp;&nbsp;
      ...
      <table cellspacing="1" cellpadding="5" class="table_out">
        <tr>
          <td width="16%" class="table_title"><b>수강신청 입력정보 111</b></td>
          <td width="81%" class="table_02_2">
                ...
                <script>
                    ...
                    <td align="right" width="60px"><a href="javascript:fnPreview();"><img style="border:none" src="/images/admin/button/btn_preview.gif" alt="입력양식 미리보기"/></a></td>
                    </tr>
                </table>
          </td>
        </tr>
