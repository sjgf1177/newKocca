...
<!--
	...
	function fnOffBillInfo(p_tid) {
		...
		document.form1.action='/servlet/controller.off.OffBillAdminServlet';
		document.form1.p_process.value = 'OffBillInfo';
		document.form1.submit();
		document.form1.target = window.self.name;	  
	}
...
<form name = "form1" method = "post">
    ...
    <input type="hidden" name="p_returnurl"       value="/servlet/controller.off.OffBillAdminServlet">
...
%>
        ...
        <table width="97%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td class=sub_title>수강료 납부 조회</td>
        ...
        <table class="table_out" cellspacing="1" cellpadding="5">		
          ...
          <tr>
			...
			<td class="table_title"><b><a href="javascript:ordering('a.goodname')" class="e">과정명</a></b></td>
...
%>
            <tr class="table_02_1">
                ...
                <td class="table_02_1"><a href="javascript:fnOffBillInfo('<%= v_tid %>')"><%= v_paystatus %></a></td>
