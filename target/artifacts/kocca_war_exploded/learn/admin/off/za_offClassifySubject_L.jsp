...
//    window.self.name = "winClassifySelectList";
    ...
    document.form2.action = "/servlet/controller.off.OffClassifySubjectServlet";
...
<table width="1000" border="0" cellspacing="0" cellpadding="0" height="663">
  <tr>
    <td align="center" valign="top">
      ...
      <!----------------- title 끝 ----------------->
      <br>
        <form name="form2" method="post" action="/servlet/controller.off.OffClassifySubjectServlet">
