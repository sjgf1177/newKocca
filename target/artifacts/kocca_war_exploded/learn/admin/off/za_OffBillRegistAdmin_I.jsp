...
//**********************************************************
//  1. 제      목: 수강료 납부 등록
//  2. 프로그램명: za_OffBillRegistAdmin_I
//  3. 개      요: 수강료 납부 등록(팝업)
//  4. 환      경: JDK 1.5
//  5. 버      젼: 1.0
//  6. 작      성: 2009.12.23
...
<%
	...
	DataBox dbox = (DataBox)request.getAttribute("subjseqInfo");
    if (dbox != null) {
...
function InsertOffBill() {
    ...
    document.form1.action = "/servlet/controller.off.OffBillRegistAdminServlet";
    document.form1.p_process.value = "offbillInsert";
    document.form1.submit();
}
    ...
    <input type="hidden" name="p_returnprocess"   value="selectList">
        ...
        <table class="box_table_out" cellspacing="1" cellpadding="5">
          ...
          <tr>
            ...
            <td class="table_02_2" ><input name="p_billreqnm" type="text" class="input" size="60" value=""/></td>
          </tr>
          <tr>
            <td class="table_title" ><b>수강료</b></td>
            <td class="table_02_2" ><input name="p_biyong" type="text" class="input" size="30" value="" onKeyDown=keyDownCheck('N'); onKeyPress=keyPressCheck('N') onFocus='SetNumObj(this)' onKeyUp='fnKeyUpCheck(this);' style='text-align:right;'/>원</td>
          </tr>
          <tr>
            <td class="table_title" ><b>실결제액</b></td>
            <td class="table_02_2" ><input name="p_realbiyong" type="text" class="input" size="30" value="" onKeyDown=keyDownCheck('N'); onKeyPress=keyPressCheck('N') onFocus='SetNumObj(this)' onKeyUp='fnKeyUpCheck(this);' style='text-align:right;'/>원</td>
          </tr>
          <tr>
            <td class="table_title" ><b>납부기간</b></td>
            <td class="table_02_2" ><input name="p_billbegindt" id="p_billbegindt" value="" type="text" class="datepicker_input1" size="10">&nbsp;
		  				  			~&nbsp;<input name="p_billenddt" id="p_billenddt" value="" type="text" class="datepicker_input1" size="10"></td>
          </tr>
          <tr>
            ...
            <td class="table_02_2" >
              ...
              <span id="spn_addstudent"></span>
              <span id="spn_addstudent_hidden"></span>
            </td>
          </tr>
          <tr>
            <td class="table_title" ><b>비고</b></td>
            <td class="table_02_2" ><textarea name="p_comments" cols="100" rows="3" tabindex=70></textarea></td>
          </tr>
        </table>
