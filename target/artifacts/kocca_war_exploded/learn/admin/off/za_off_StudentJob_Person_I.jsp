...
<form name = "form1" method = "post">
    ...
    <input type="hidden" name="p_employdate"    value="">
...
<!--                     <a href='javascript:searchComp()'><img src="/images/admin/button/search3_butt.gif" border=0 align="absmiddle"></a>
 -->                </td>
              ...
              <tr>
                ...
                <td class="table_02_2"  width="80%" colspan=3>
                <input type="text" name="p_depart" class="input" style="width:200;" />
                </td>
               ...
               <tr>
                ...
                <td class="table_02_2"  width="80%" colspan=3>
                <input type="text" name="p_position" class="input" style="width:200;" />
                </td>
              ...
              <tr>
                ...
                <td class="table_02_2"  width="80%" colspan=3 > 
                	<input type="radio" name="p_type" value="1" >정규직                
                    <input type="radio" name="p_type" value="2" >비정규직                
				</td>               
              </tr>
            <tr>
