...
<SCRIPT LANGUAGE="JavaScript"><!--
    ...
    function insert_check() {
        ...
        document.form1.action = "/servlet/controller.infomation.EduReviewAdminServlet";
  ...
  <table width="1000" border="0" cellspacing="0" cellpadding="0" height="663">
    ...
    <td align="center" valign="top"> 
      ...
      <table width="97%" border="0" cellspacing="0" cellpadding="0" class=page_title>
        <tr> 
          <td><img src="/images/admin/portal/s.1_11.gif" ></td>
        ...
        <table class="table_out" cellspacing="1" cellpadding="5">
          ...
          <tr>
            ...
            <td width="35%" height="25" class="table_02_2"><input type="text" name="p_name" class="input" maxlength="10" value="<%=s_username%>"></td>
            <td width="15%" class="table_title"><strong>소속/이름</strong></td>
            <td width="35%" height="25" class="table_02_2">
              <input type="text" name="p_position" style="width:300px;" class="input" maxlength="80">
            </td>
          </tr>
          <tr>
          ...
          <tr>
              ...
              <td colspan="3" width="81%" class="table_02_2">
                <%
                  int    i_fileLimit         = EduReviewBean.getFILE_LIMIT();              // 제한 첨부 파일수
                  %>
