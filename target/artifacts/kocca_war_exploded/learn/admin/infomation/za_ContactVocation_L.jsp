        ...
        <tr>
          ...
          <td width="120" height="23" align="left" valign="middle">
            <table cellspacing="0" cellpadding="0" class="s_table">
              ...
              <tr>
                <td class="black_butt_middle"><a href="/servlet/controller.infomation.ContactUsAdminServlet?p_process=selectListEtc" class="c">문의및제안</td>
              </tr>
              <tr>
                <td class="black_butt_bottom"></td>
              </tr>
          ...
          <td width="120" height="23" align="left" valign="middle">
            <table cellspacing="0" cellpadding="0" class="s_table">
              ...
              <tr>
                <td class="blue_butt_middle">취업신청</td>
              </tr>
              <tr>
          ...
          <tr>
            <td width="870" align="right">
              <select name="p_search" >
                <option value='COMPANY'     <% if (v_search.equals("company")) out.println("selected"); %>>회사</option>
                <option value='USER_NAME' <% if (v_search.equals("user_name")) out.println("selected"); %>>담당자</option>
              </select>
...
%>
          <tr> 
            ...
            <td class="table_02_2"><%= v_company %></td>
            <td class="table_02_1"><%= v_category %> </td>
