...
<%
    ...
    if ( v_action.equals("go") ) {
        list = (ArrayList)request.getAttribute("JobList");
    }
%>
<html>
<head>
...
function goExcel(p_action) {
    ...
    document.form1.p_process.value = 'jobExcelList';
    document.form1.submit();
}
...
function open_detailList(code, codenm) {
    window.self.name = "JobDetailList";     //opener 객체에 name 을 지정한다
    farwindow = window.open("", "openJobDetailList", "toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no, width = 690, height = 567, top=0, left=0");

    document.form1.target = "openJobDetailList";
    document.form1.action = "/servlet/controller.analysis.InclinationAdminServlet";
    document.form1.p_process.value = "jobDetailList";
...
<table width="1000" border="0" cellspacing="0" cellpadding="0" height="663">
  <tr>
    <td align="center" valign="top">
        ...
        <tr>
          <td width="85">
            <table cellspacing="0" cellpadding="0" class="s_table">
              ...
              <tr>
                <td class="<%=v_tab_color5%>_butt_middle">직업별</td>
              </tr>
              <tr>
          ...
          <td width="85" height="23" align="center" valign="middle">
            <table cellspacing="0" cellpadding="0" class="s_table">
              ...
              <tr>
                <td class="<%=v_tab_color3%>_butt_middle"><a href="javascript:changeTabpage('CARRER')" class="c">학력별</a></td>
              </tr>
              <tr>
          ...
          <td width="85" height="23" align="center" valign="middle">
            <table cellspacing="0" cellpadding="0" class="s_table">
              ...
              <tr>
                <td class="<%=v_tab_color2%>_butt_middle"><a href="javascript:changeTabpage('GENDER')" class="c">성별</a></td>
              </tr>
              <tr>
          ...
          <td width="85" height="23" align="center" valign="middle">
            <table cellspacing="0" cellpadding="0" class="s_table">
              ...
              <tr>
                <td class="<%=v_tab_color4%>_butt_middle"><a href="javascript:changeTabpage('AGE')" class="c">나이별</a></td>
              </tr>
              <tr>
      ...
      <tr>
        <td class="table_title" width="25%">직업</td>
...
%>
            <td class="table_02_1">
                <a href="javascript:open_detailList('<%=v_code%>', '<%=v_codenm%>')"><%= v_educnt %></a></td>
<%
    } else {
%>
...
<%if( i == 0  ){%>
                <tr class="table_01" height="35">
                    <td colspan="5">직업별 성향 분석결과가 없습니다.</td>
                </tr>
<%}%>
