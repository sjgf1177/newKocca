...
<%
    ...
    if ( v_action.equals("go") ) {
        list = (ArrayList)request.getAttribute("CarrerList");
    }
%>
<html>
<head>
...
function goExcel(p_action) {
    ...
    //window.self.name = "CarrerExcelList";
    ...
    document.form1.p_process.value = 'carrerExcelList';
    document.form1.submit();
}
...
function open_detailList(code, codenm) {
    window.self.name = "CarrerDetailList";     //opener 객체에 name 을 지정한다
    farwindow = window.open("", "openCarrerDetailList", "toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no, width = 690, height = 567, top=0, left=0");
    document.form1.target = "openCarrerDetailList";
    document.form1.action = "/servlet/controller.analysis.InclinationAdminServlet";
    document.form1.p_process.value = "carrerDetailList";
...
<table width="1000" border="0" cellspacing="0" cellpadding="0" height="663">
  <tr>
    <td align="center" valign="top">
        ...
        <tr>
          ...
          <td width="85" height="23" align="center" valign="middle">
            <table cellspacing="0" cellpadding="0" class="s_table">
              ...
              <tr>
                <td class="<%=v_tab_color5%>_butt_middle">학력별</a></td>
              </tr>
              <tr>
      ...
      <tr>
        <td class="table_title" width="25%">학력</td>
...
<%if( i == 0  ){%>
                <tr class="table_01" height="35">
                    <td colspan="5">학력별 성향 분석결과가 없습니다.</td>
                </tr>
<%}%>
      </table>
  </tr>
