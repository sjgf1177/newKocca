...
<%
    response.setHeader("Content-Disposition", "attachment; filename=AgeListEXE1.xls");
    ...
    ArrayList list = (ArrayList)request.getAttribute("AgeList");
    DataBox dbox = null;
...
<%
        String [] v_value = {"50","40","30","20","10"};
        String [] v_text =  {"50대", "40대", "30대", "20대", "10대"};
