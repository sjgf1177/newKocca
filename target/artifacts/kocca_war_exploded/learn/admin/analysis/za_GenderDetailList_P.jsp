...
<%
    ...
    String v_sex     = box.getString("p_code");
    ...
    list = (ArrayList)request.getAttribute("GenderDetailList");

%>
<html>
<head>
<title>성별 성향 분석</title>
...
function goExcel(p_action) {
    //window.self.name = "GenderDetailExcelList";
    ...
    document.form1.p_process.value = 'genderDetailExcelList';
...
<form name="form1" method="post" action="/servlet/controller.analysis.InclinationAdminServlet">
    ...
    <input type="hidden" name="p_code"       value="<%=v_sex%>">
...
<table width="667" border="0" cellspacing="0" cellpadding="0" height="663">
  <tr>
    ...
    <!--------------------닫기 버튼 시작---------------------------->
      ...
      <td align="right">
        <a href="javascript:javascript:self.close()"><img src="/images/user/kocca/button/btn_close.gif" border="0">
      </td>
      </table>
    <!---------------------닫기 버튼 끝------------------------------>
       ...
       <table class="table_out" cellspacing="1" cellpadding="5">
          ...
          <tr>
            <td width="15%" class="table_title"><strong>성별</strong></td>
