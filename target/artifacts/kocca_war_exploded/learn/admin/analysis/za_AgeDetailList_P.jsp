...
<%
    ...
    String v_age     = box.getString("p_code");
    ...
    list = (ArrayList)request.getAttribute("AgeDetailList");

%>
<html>
<head>
<title>나이별 성향 분석</title>
...
function goExcel(p_action) {
    //window.self.name = "AgeDetailExcelList";
    ...
    document.form1.p_process.value = 'ageDetailExcelList';
...
<form name="form1" method="post" action="/servlet/controller.analysis.InclinationAdminServlet">
    ...
    <input type="hidden" name="p_code"       value="<%=v_age%>">
  ...
  <tr>
    ...
    <!---------------------닫기 버튼 끝------------------------------>
       ...
       <table class="table_out" cellspacing="1" cellpadding="5">
          ...
          <tr>
            <td width="15%" class="table_title"><strong>나이</strong></td>
