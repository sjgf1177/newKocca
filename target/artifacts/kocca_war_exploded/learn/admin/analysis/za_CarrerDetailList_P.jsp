...
<%
    ...
    String v_degree    = box.getString("p_code");
    ...
    list = (ArrayList)request.getAttribute("CarrerDetailList");
...
function goExcel(p_action) {
    //window.self.name = "CarrerDetailExcelList";
    ...
    document.form1.p_process.value = 'carrerDetailExcelList';
...
<form name="form1" method="post" action="/servlet/controller.analysis.InclinationAdminServlet">
    ...
    <input type="hidden" name="p_code"       value="<%=v_degree%>">
  ...
  <tr>
    ...
    <!---------------------닫기 버튼 끝------------------------------>
       ...
       <table class="table_out" cellspacing="1" cellpadding="5">
          ...
          <tr>
            <td width="15%" class="table_title"><strong>학력</strong></td>
