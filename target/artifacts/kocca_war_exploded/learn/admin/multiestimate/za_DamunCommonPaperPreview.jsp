<%
/**
 * file name : za_DamunCommonPaperPreview.jsp
 * date      : 2003/09/12
 * programmer:
 * function  : 다면평가 미리보기
 */
...
function damunmunRight(){
  ...
  document.form2.action.value  = '/servlet/controller.multiestimate.DamunCommonRedamuntServlet';
...
<form name="form2" method="post" action="/servlet/controller.multiestimate.DamunCommonRedamuntServlet">
