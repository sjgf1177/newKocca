<%
/**
 * file name : za_DamunSubjPaperPool_I.jsp
 * date      : 2003/09/25
 * programmer:
 * function  : 평가 Pool 등록
 */
...
function InsertQuestion() {
  ...
  document.form2.p_process.value = 'DamunPaperInsertPool';
...
<%  
         ArrayList list = (ArrayList)request.getAttribute("DamunPaperPool");
...
%>
        <tr>
          ...
          <td class="table_02_1"><a href="javascript:PreviewPaper('<%=v_grcode%>','<%=dbox.getString("d_subj")%>','<%=String.valueOf(dbox.getInt("d_damunpapernum"))%>','<%=dbox.getString("d_damunpapernm")%>')"><img src="/images/admin/button/b_preview.gif" border="0"></a></td>
          <td class="table_02_1">
            <input type="radio" name="p_checks" value="<%=dbox.getString("d_subj")%>|<%=dbox.getString("d_damunpapernum")%>">
          </td>
        </tr>
<%  
      }  %>
