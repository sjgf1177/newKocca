<%
/**
 * file name : za_DamunCommonMemberFileToDB.jsp
 * date      : 2003/09/03
 * programmer:
...
function whenSelection(p_action) {
  document.form1.p_process.value = 'DamunCommonMemberFileToDB';
  ...
  <tr>
    <td align="center" valign="top">
          ...
          <tr> 
            <td align="center"> 
              <table width="21%" height="26" border="0" cellpadding="0" cellspacing="0">
                <tr> 
                  <td align="center"> 
                    <input name="p_file" type="FILE" class="input">
                  </td>
                </tr>
              </table>
      ...
      <table width="97%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="20" class=dir_txt >2. 엑셀파일 작성시 <font color="#A661D7">[<b>사번</b>]</font>의 순서로 만들 것.</td>
        </tr>
        <tr>
