...
<%
    ...
    String v_param = "http://10.40.37.65:9999/learn/admin/multiestimate/OZ_DamunCommonResult_L.jsp";
...
<!-- 공통파일 끝-->
   <param name="connection.reportname" value="damun/CommonResult.ozr">
   <param name="viewer.configmode" value="html">
   <param name="viewer.isframe" value="false">     
   <param name="odi.odinames" value="CommonResult">
   <param name="odi.CommonResult.pcount" value="2">
   <param name="odi.CommonResult.args1" value="param=<%=v_param%>">
   <param name="odi.CommonResult.args2" value="param_h=<%=v_param_h%>">
</OBJECT>
</body>
</html>
