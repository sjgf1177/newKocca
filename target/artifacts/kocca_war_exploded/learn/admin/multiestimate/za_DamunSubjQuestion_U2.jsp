<%
/**
 * file name : za_DamunSubjQuestion_U2.jsp
 * date      : 2003/08/20
 * programmer:
...
-->
		...
		<tr>
          ...
          <td class="table_02_1" valign="top">
            <textarea name="p_damuntext" cols="60" rows="12"><%=dbox0.getString("d_damuntext")%></textarea>
		  </td>
	   </table>
...
%>
      ...
      <table cellspacing="0" cellpadding="0">
        <tr>
          <td align="right" style="padding-top=10"><a href="javascript:UpdateQuestion();"><img src="/images/admin/button/btn_modify.gif" border="0"></a></td>
		  <td width=8></td>
          <td align="right" style="padding-top=10"><a href="javascript:DeleteQuestion();"><img src="/images/admin/button/btn_del.gif" border="0"></a></td>
		  <td width=8></td>
          <td align="right" style="padding-top=10"><a href="javascript:window.self.close();"><img src="/images/admin/button/btn_close02.gif" border="0"></a></td>
        </tr>
      </table>
      <!----------------- 등록 버튼 끝 ----------------->
      <br>
