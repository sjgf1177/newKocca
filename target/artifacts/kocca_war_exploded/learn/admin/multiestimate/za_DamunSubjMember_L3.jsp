<%
/**
 * file name : za_DamunSubjMember_L3.jsp
 * date      : 2003/09/03
 * programmer:
...
function changeTabpage(p_gubun) {
	...
	document.form1.p_process.value = 'DamunMemberListPage';
...
function InsertSubjMember() {
    ...
    document.form1.p_process.value = "SubjMemberTargetListPage";
    document.form1.p_action.value = "go";
    document.form1.p_flag.value = 1;
...
function InsertMember(p_damunpapernum) {
    ...
    farwindow = window.open("", "openWinInsert", "toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no, width = 1017, height = 700, top=0, left=0");
    document.form1.target = "openWinInsert"
    document.form1.p_process.value = "DamunMemberInsertPage";
    document.form1.p_action.value = "go";
...
function DeleteMember() {
  ...
  if(confirm('대상자를 삭제하면 대상자정보와 관찰자정보가 모두 삭제됩니다. \n그래도 삭제하시겠습니까?')) {
	  document.form1.p_process.value = 'DamunMemberDelete';
	  document.form1.p_action.value = "go";
	  document.form1.action = "/servlet/controller.multiestimate.DamunSubjMemberServlet";
	  document.form1.submit();
  }
...
function ObserverList ( p_asgnnm, p_jikupnm, p_cono, p_name, p_subjuserid) {
  ...
  window.self.name = "winInsertPage";     //      opener 객체에 name 을 지정한다
    farwindow = window.open("", "openWinInsert", "toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no, width = 800, height = 600, top=0, left=0");
  document.form1.target = "openWinInsert"
  document.form1.p_process.value = 'DamunOBMemberListPage';
  document.form1.p_action.value = "go";
  document.form1.p_asgnnm.value = p_asgnnm;
  document.form1.p_jikupnm.value = p_jikupnm;
  document.form1.p_cono.value = p_cono;
  document.form1.p_name.value = p_name;
  document.form1.p_subjuserid.value = p_subjuserid;
  document.form1.action = "/servlet/controller.multiestimate.DamunSubjMemberServlet";
  document.form1.submit();
...
function MailSend(v_mailgubun) {
    ...
    document.form1.target = "openWinInsert"
    document.form1.p_process.value = 'DamunMailPage';
...
function autoObserver(v_mailgubun) {
  ...
  if (chkSelected() < 1) {
    ...
    farwindow = window.open("", "openWinInsert", "toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no, width = 667, height = 700, top=0, left=0");
    document.form1.target = "openWinInsert"
    document.form1.p_process.value = 'AutoObserverInsertPage';
    document.form1.p_damunpapernum.value = document.form1.s_damunpapernum.options[document.form1.s_damunpapernum.selectedIndex].value;
    document.form1.p_grcode.value = document.form1.s_grcode.options[document.form1.s_grcode.selectedIndex].value;
    document.form1.p_subj.value = document.form1.s_subjcourse.options[document.form1.s_subjcourse.selectedIndex].value;
    document.form1.p_gyear.value = document.form1.s_gyear.options[document.form1.s_gyear.selectedIndex].value;
...
function ReloadPage() {
  ...
  document.form1.p_grcode.value = document.form1.s_grcode.options[document.form1.s_grcode.selectedIndex].value;
  document.form1.p_subj.value = document.form1.s_subjcourse.options[document.form1.s_subjcourse.selectedIndex].value;
  //document.form1.p_subjseq.value = document.form1.s_subjseq.options[document.form1.s_subjseq.selectedIndex].value;
  document.form1.p_gyear.value = document.form1.s_gyear.options[document.form1.s_gyear.selectedIndex].value;
  document.form1.submit();
}
        ...
        <tr>
          <td align="center">
            <table class="form_table_bg" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="center">
				  <table cellspacing="0" border=0 cellpadding="0" width="99%" class="form_table">
					<tr>
					  <td width="30%" colspan="2" align="left" valign="middle">
						<!------------------- 조건검색 시작 ------------------------->
					...
					<tr>
					  <td align="left" colspan="3">
						...
						<!--<%= SelectSubjBean.getSubjseq(box, true, true)%> -->
...
<%}%>
      ...
      <table cellspacing="1" cellpadding="5" class="table_out">
        ...
        <tr>
          ...
          <td class="table_title" rowspan="2">회사</td>
          <td class="table_title" rowspan="2">ID</td>
          <td class="table_title" rowspan="2">성명</td>
		  <td class="table_title" rowspan="2">부서</td>
...
<%
        ...
        <tr>
          ...
          <td class="table_02_1"><%=dbox2.getString("d_deptnm")%></td>
