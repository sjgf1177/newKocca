<%
/**
 * file name : za_DamunCommonResult_L2.jsp
 * date      : 2003/08/26
 * programmer:
 * function  : 객관식 설문결과조회
 */
...
// top.ftop.setPam();
    ...
    var v_param  = '?s_grcode='+v_grcode+'&s_gyear='+v_gyear+'&s_damunpapernum='+v_damunpapernum;
    
    window.self.name = "reporting";
    document.form1.target = "openExcel1";    
    open_window("openExcel1","","100","100","800","600","yes","yes","yes","yes","yes");                 
    document.form1.action='/learn/admin/multiestimate/CommonResult_E.jsp'+v_param;                 
    document.form1.submit();
}
-->
</script>
        ...
        <tr>
          <td width="85" height="23" align="center" valign="middle">
            <table cellspacing="0" cellpadding="0" class="s_table">
              ...
              <tr>
                <td class="black_butt_middle"><a href="javascript:changeTabpage('SUBJ')" class="c">과정평가</a></td>
              </tr>
              <tr>
          ...
          <td width="85" height="23" align="center" valign="middle">
            <table cellspacing="0" cellpadding="0" class="s_table">
              ...
              <tr>
                <td class="blue_butt_middle">일반평가</td>
              </tr>
              <tr>
            ...
            <table cellspacing="1" cellpadding="0" class="s_table">
              <tr>
                <td bgcolor="#FFFFFF" align="center" valign="top">
                  ...
                  <form name="form1" method="post" action="/servlet/controller.multiestimate.DamunCommonResultServlet">
