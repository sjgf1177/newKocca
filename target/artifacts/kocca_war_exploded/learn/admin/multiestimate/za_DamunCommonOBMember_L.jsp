...
function InsertCommonMember() {
    ...
    document.form2.p_process.value = "CommonOBMemberTargetListPage";
...
function InsertMember(p_damunpapernum) {
    ...
    farwindow = window.open("", "openWinInsert", "toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no, width = 1017, height = 700, top=0, left=0");
    document.form2.target = "openWinInsert"
    document.form2.p_process.value = "DamunOBMemberInsertPage";
    document.form2.p_action.value = "go";
...
function InsertFileToDB(p_damunpapernum) {
    ...
    farwindow = window.open("", "openWinInsert", "toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no, width = 1017, height = 700, top=0, left=0");
    document.form2.target = "openWinInsert"
    document.form2.p_process.value = "DamunOBMemberFileToDB";
    document.form2.p_action.value = "go";
    document.form2.p_damunpapernum.value = p_damunpapernum;
    document.form2.action = "/servlet/controller.multiestimate.DamunCommonMemberServlet";
	document.form2.submit();
                  ...
                  <table class="form_table" cellspacing="0" cellpadding="0" width="99%">
                    <tr>
                      <td>
                                   ...
                                   다면평가지<%= DamunCommonMemberBean.getDamunpaperSelect (ss_grcode, ss_gyear, "COMMON", "s_damunpapernum", ss_damunpapernum, "")%>
...
%>
        <tr align="right">
          ...
          <td>
            <a href="javascript:InsertMember('')"><img src="/images/admin/button/btn_gunadd.gif" border="0"></a></a>
            <a href="javascript:DeleteMember()"><img src="/images/admin/button/btn_gundel.gif" border="0"></a>
          ...
          <td>
            ...
            <a href="javascript:MemberList()"><img src="/images/admin/button/btn_people.gif" border="0"></a>
			<%}else if(v_update == 3){%>
		  </td>
          <td>
            <%=v_ing%>&nbsp;
...
<%}%>
          ...
          <td>
            <a href="javascript:InsertMember('')"><img src="/images/admin/button/btn_gunadd.gif" border="0"></a>
            <a href="javascript:DeleteMember()"><img src="/images/admin/button/btn_gundel.gif" border="0"></a>
            <a href="javascript:MemberList()"><img src="/images/admin/button/btn_people.gif" border="0"></a>
			<%}else if(v_update == 2){%>
		  </td>
...
<%}%>
        ...
        <tr>
          <td><b>대상자 : <%=v_asgnnm%>/<%=v_jikupnm%>/<%=v_cono%>/<%=v_name%></b></td>
        </tr>
      </table>
      <!----------------- 대상자추가, 대상자삭제 버튼 끝 ----------------->
...
<%
        ...
        <tr>
          ...
          <td class="table_02_1">
            <input type="checkbox" name="p_checks" value="<%=dbox2.getString("d_obuserid")%>|<%=dbox2.getString("d_name")%>">
          </td>
        </tr>
<%  }  %>
        </table>
