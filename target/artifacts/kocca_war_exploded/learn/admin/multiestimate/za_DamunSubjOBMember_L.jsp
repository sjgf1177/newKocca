...
function InsertSubjMember() {
    ...
    document.form2.p_process.value = "SubjOBMemberTargetListPage";
    ...
    <td align="center" valign="top">
     ...
     <table cellspacing="0" cellpadding="0" class="table1">
      ...
      <table cellpadding="0" cellspacing="0" class="table1">
        <tr>
		<td><img src="/images/admin/common/icon.gif" ><b>대상자 : <%=v_asgnnm%>/<%=v_jikupnm%>/<%=v_cono%>/<%=v_name%></b></td>
        </tr>
        <tr>
		<td height="7"></td>
        </tr>
...
%>
        <tr align="right">
          ...
          <td>
            ...
            <a href="javascript:DeleteMember()"><img src="/images/admin/button/btn_gundel.gif" border="0"></a></a>
...
<%}%>
          ...
          <td>
            ...
            <a href="javascript:DeleteMember()"><img src="/images/admin/button/btn_gundel.gif" border="0"></a></a>
            <a href="javascript:MemberList()"><img src="/images/admin/button/btn_peoplelist.gif" border="0"></a></a>
			<%}else if(v_update == 2){%>
		  </td>
          <td>
            <%=v_ing%>&nbsp;
