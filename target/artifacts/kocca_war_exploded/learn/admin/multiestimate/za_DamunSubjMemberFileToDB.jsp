<%
/**
 * file name : za_DamunSubjMemberFileToDB.jsp
 * date      : 2003/09/03
 * programmer:
 * function  : 다면평가  일괄처리
 */
    ...
    <td align="center" valign="top">
      ...
      <table cellpadding="0" cellspacing="0" class="heed_table">
        <tr>
          ...
          <td valign="bottom" class=sub_title>대상자파일추가</td>
        </tr>
      </table>	
        <br>
        <!----------------- 찾아보기 시작 ----------------->
        ...
        <table width="97%" border="0" cellpadding="0" cellspacing="0">
          <tr> 
            <td width="900" height="20" align="right"><a href="javascript:insert_check('insertFileToDB')"><img src="/images/admin/button/btn_apply.gif" border="0"></a></td>
			<td width=7></td>
      ...
      <table width="97%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><img src="/images/admin/multiestimate/Sample_DamunMember.gif" border="0"></td>
        </tr>
      </table>
    </td>
  </tr>
