<%
/**
 * file name : za_DamunCommonPaper_U.jsp
 * date      : 2003/08/20
 * programmer:
...
<%
    ...
    ArrayList list1 = (ArrayList)request.getAttribute("DamunCommonQuestionList");
    ArrayList list2 = (ArrayList)request.getAttribute("DamunCommonPaperQuestionList");
	DataBox dbox0 = (DataBox)request.getAttribute("DamunPaperData");
	String v_d_gubun = dbox0.getString("d_d_gubun");

	String table1 = "";
	String table2 = "";
	if(v_d_gubun.equals("1")){
	   table1 = "display:";
	   table2 = "display:none";
	}else if(v_d_gubun.equals("2")){
	   table1 = "display:none";
	   table2 = "display:";
	}
%>
...
<table width="1000" border="0" cellspacing="0" cellpadding="0" height="663">
 ...
 <table width="970" border="0" cellspacing="0" cellpadding="0">
      ...
      <form name="form2" method="post" action="/servlet/controller.multiestimate.DamunCommonPaperServlet">
        ...
        <input type="hidden" name="p_d_gubun"      value="1">
                        ...
                        <table width="99%" cellspacing="0" cellpadding="0" class="form_table">
						  <tr>
		    			    <td valign="bottom" align="left">
              				 평가지명 : <input name="p_damunpapernm1" type="text" class="input" value="<%=v_damunpapernm%>" size="40"></td>
						  </tr>
                          <tr>
                            <td valign="bottom" align="left" colspan="3">
                              기간 : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="p_fdamunstart_view1" id="p_fdamunstart_view1" type="text" class="datepicker_input1" value="<%=FormatDate.getFormatDate(dbox0.getString("d_fdamunstart"),"yyyy-MM-dd")%>" size="10">
                              -<input name="p_fdamunend_view1" id="p_fdamunend_view1" type="text" class="datepicker_input1" value="<%=FormatDate.getFormatDate(dbox0.getString("d_fdamunend"),"yyyy-MM-dd")%>" size="10">
                            </td>
                          </tr>
                        </table>
                      </td>
