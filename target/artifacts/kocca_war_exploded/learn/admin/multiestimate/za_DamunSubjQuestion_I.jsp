    ...
    <td align="center" valign="top">
     <br>
      ...
      <form name="form2" method="post" action="/servlet/controller.multiestimate.DamunSubjQuestionServlet">
        ...
        <input type="hidden" name="p_fscalecode"  value="">
        <input type="hidden" name="p_sscalecode"  value="">
...
-->
		...
		<tr>
          <td class="table_title" width="15%">문제분류</td>
          <td class="table_02_1">
		  <SELECT name="p_damuntype" onchange="display();"> 
		...
		<tr>
          <td class="table_title" width="15%">문제</td>
          <td class="table_02_1" valign="top">
            <textarea name="p_damuntext" cols="60" rows="12"></textarea>
		  </td>
	   </table>
...
<% } %>
	  ...
	  <table cellspacing="1" cellpadding="5" class="table_out" ID="damuntype2" STYLE="display:none">
		...
		<tr>
    	  <td class="table_title" width="15%">복수 선택수</td>
          <td class="table_02_1">
...
<% } %>
      ...
      <table cellspacing="1" cellpadding="5" class="table_out" ID="damuntype5" STYLE="display:none">
		...
		<tr>
    	  <td class="table_title" width="15%">척도명</td>
          <td class="table_01" colspan="3" align="left">
		  <%=ScaleBean.getScaleCodeSelect ("5", v_grcode, "D", "p_fscalecode5", 0, "onchange=changeScale('1')")%>
		  </td>
		</tr>
		<tr>
		  <td></td>
...
<% } %>
      ...
      <table cellspacing="1" cellpadding="5" class="table_out" ID="damuntype6" STYLE="display:none">
		...
		<tr>
    	  <td class="table_title" width="15%">척도명</td>
          <td class="table_01" colspan="3" align="left">
		  <%=ScaleBean.getScaleCodeSelect ("7", v_grcode, "D", "p_fscalecode6", 0, "onchange=changeScale('2')")%>
		  </td>
		</tr>
		<tr>
		  <td></td>
...
<% } %>
      ...
      <table cellspacing="1" cellpadding="5" class="table_out" ID="damuntype7" STYLE="display:none">
		...
		<tr>
    	  <td class="table_title" width="15%">제1척도명</td>
          <td class="table_01" colspan="3" align="left">
		  <%=ScaleBean.getScaleCodeSelect ("5", v_grcode, "D", "p_fscalecode7", 0, "onchange=changeScale('3')")%>
		  </td>
		</tr>
		<tr>
		  <td></td>
...
<% } %>
		<tr>
    	  <td class="table_title" width="15%">제2척도명</td>
          <td class="table_01" colspan="3" align="left">
		  <%=ScaleBean.getScaleCodeSelect ("5", v_grcode, "D", "p_sscalecode7", 0, "onchange=changeScale('4')")%>
		  </td>
		</tr>
		<tr>
		  <td></td>
