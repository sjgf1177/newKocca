                  ...
                  <table class="form_table" cellspacing="0" cellpadding="0" width="99%">
                    <tr>
                      <td>
                                   ...
                                   다면평가지<%= DamunCommonMemberBean.getDamunpaperSelect (ss_grcode, ss_gyear, ss_subjcourse, "s_damunpapernum", ss_damunpapernum, "onchange=javascript:whenSelection('change')")%>
                                   구분<%= DamunCommonMemberBean.getDamunGubunSelect (ss_grcode, ss_gyear, ss_subjcourse, ss_damunpapernum, "s_mailgubun", ss_mailgubun, "")%>
