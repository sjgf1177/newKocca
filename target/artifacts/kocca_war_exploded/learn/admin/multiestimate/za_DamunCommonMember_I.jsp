<%
/**
 * file name : za_DamunCommonMember_I.jsp
 * date      : 2003/09/25
 * programmer:
...
function InsertDamunCommonMember() {
  ...
  <tr>
    <td align="center" valign="top">
	    ...
	    <table width="95%" border="0" cellspacing="0" cellpadding="0">
	      ...
	      <tr> 
	        <td background="/images/admin/multiestimate/open_title_bg.gif"><img src="/images/admin/multiestimate/m_title08.gif" width="151" height="36" border="0"></td>
	      </tr>
	    </table>
	    <!----------------- title 끝 ----------------->
	    <br>
        ...
        <tr> 
          <td width="85"> 분류 
            <select name="s_searchtype" class="input">
              <option value="2" <% if (ss_searchtype.equals("2")) { %>selected<% } %>>사번</option>
      ...
      <table cellspacing="1" cellpadding="5" class="open_table_out">
        ...
        <tr> 
          ...
          <td width="13%" class="table_title">사번</td>
          <td width="13%" class="table_title">성명</td>
          <td width="13%" class="table_title">직위</td>
		  <td width="13%" class="table_title">소속</td>
		  <td width="13%" class="table_title">본부</td>
		  <td width="13%" class="table_title">근무지</td>
		  <td width="12%" class="table_title">재직여부</td>
...
<%  
       if(!v_process.equals("DamunMemberInsertPage")){
         ArrayList list = (ArrayList)request.getAttribute("MemberCommonList");
        ...
        <tr>
		  ...
		  <td class="table_02_1"><%=dbox.getString("d_divinam")%></td>
          <td class="table_02_1"><%=dbox.getString("d_work_plcnm")%></td>
		  <td class="table_02_1"><%=((dbox.getString("d_office_gbn")).equals("N")) ? "퇴직": "재직"%></td>
          <td class="table_02_1">
...
%>
      ...
      <table cellspacing="0" cellpadding="0" class="table1">
        <tr> 
          <td align="right" style="padding-top=10"><a href="javascript:InsertDamunCommonMember('')"><img src="/images/admin/multiestimate/record1_butt.gif" width="37" height="18" border="0"></a></td>
        </tr>
      </table>
      <!----------------- 등록, 닫기 버튼 끝 ----------------->
      <br>
