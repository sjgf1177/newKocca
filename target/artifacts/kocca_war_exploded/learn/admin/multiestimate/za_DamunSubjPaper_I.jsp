<%
/**
 * file name : za_DamunSubjPaper_I.jsp
 * date      : 2003/08/20
 * programmer:
 * function  : 다면평가지 등록 페이지
 */
%>
...
<%
    ...
    String  v_gyear        = box.getStringDefault("s_gyear", box.getString("p_gyear"));
...
$(document).ready(function(){
	$("#p_fdamunstart_view1").datepicker({defaultDate: new Date(),showOn: "both",showAnim: "blind",showOptions: {direction: 'horizontal'},duration: 200})
	$("#p_fdamunend_view1").datepicker({defaultDate: new Date(),showOn: "both",showAnim: "blind",showOptions: {direction: 'horizontal'},duration: 200})
});
<!--
...
function InsertPaper() {
	...
	document.form2.p_process.value = "DamunPaperInsert";
...
function chkData() {
  ...
  if (v_d_gubun == 1){
  if (blankCheck(document.form2.p_damunpapernm1.value)) {
    alert('다면평가지명을 입력하십시요.');
    document.form2.p_damunpapernm1.focus();
    return false;
  }
  if (blankCheck(document.form2.p_fdamunstart_view1.value)) {
    alert('평가기간을 입력하십시요.');
    return false;
  }
  if (blankCheck(document.form2.p_fdamunend_view1.value)) {
    alert('평가기간을 입력하십시요.');
    return false;
  }
  
  form2.p_damunpapernm.value = form2.p_damunpapernm1.value;

  var v_date = make_date(form2.p_fdamunstart_view1.value);
  form2.p_fdamunstart.value = v_date;
  v_date = make_date(form2.p_fdamunend_view1.value);
  form2.p_fdamunend.value = v_date;
  if (form2.p_fdamunend.value < form2.p_fdamunstart.value) {
    alert('평가종료기간을 수정하십시요.');
    return false;  
  }
...
<table width="1000" border="0" cellspacing="0" cellpadding="0" height="663">
  <tr>
    <td align="center" valign="top">
      ...
      <!----------------- 다면평가지명, 등록버튼 시작 ----------------->
      <table cellpadding="0" cellspacing="0" class="heed_table" width="97%">
                    ...
                    <tr>
                      <td align="center">
                        <table width="99%" cellspacing="0" cellpadding="0" class="form_table">
						  <tr>
		    			    <td valign="bottom" align="left" width=10%>&nbsp;&nbsp;<font color=#E0448E><b>평가지 분류 : </font></b></td>
							 <td align="left" ><SELECT name="p_d_gubun" onchange="display();"> 
                               <option value=1>사전/사후 동시</option> 
                               <option value=2>사전/사후 분리</option> 
                             </SELECT>
							 <script>document.form2.p_d_gubun.value = <%=v_d_gubun%>;</script></td>
						  </tr>
                        </table>
                      </td>
                    </tr>
                        ...
                        <table width="99%" cellspacing="0" cellpadding="0" class="form_table">
						  <tr>
		    			    <td valign="bottom" align="left">
              				 평가지명 : <input name="p_damunpapernm1" type="text" class="input" value="" size="40"></td>
						  </tr>
                          <tr>
                            <td valign="bottom" align="left" colspan="3">
                              기간 : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="p_fdamunstart_view1" id="p_fdamunstart_view1" type="text" class="datepicker_input1" value="" size="10">
                              -<input name="p_fdamunend_view1" id="p_fdamunend_view1" type="text" class="datepicker_input1" value="" size="10">
                            </td>
                          </tr>
                        </table>
                      </td>
    ...
    <br><br><br><br><br>
      ...
      <!----------------- 다면평가지명,  등록버튼 끝 ----------------->
      <!----------------- 다면평가지 관리 시작 ----------------->
      <table cellspacing="1" cellpadding="5" class="table_out" width="90%">
        ...
        <tr>
          <td class="table_02_1">
            <table width="75%" cellspacing="0" cellpadding="0" class="form_table">
              <tr>
                <td align="center"><select name="p_questions" size="20" style="width:430;" onchange="ChooseQuestion();">
<%  ArrayList list1 = (ArrayList)request.getAttribute("DamunPaperInsertPage");
    if (list1 == null) {
        list1 = new ArrayList();
    }
    DataBox dbox  = null;
...
<%  }  %>
          ...
          <td class="table_02_1">
            <table width="75%" cellspacing="0" cellpadding="0" class="form_table">
              <tr>
                <td align="center"> <select name="p_choosed" size="20" style="width:430;">
                 </select>
                </td>
                <td>
