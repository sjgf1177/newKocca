...
function chkData() {
  ...
  if (v_d_gubun == 2){
  if (blankCheck(document.form2.p_damunpapernm2.value)) {
    alert('다면평가지명을 입력하십시요.');
    document.form2.p_damunpapernm2.focus();
    return false;
  }
  ...
  form2.p_damunpapernm.value = form2.p_damunpapernm2.value;
                    ...
                    <tr>
                      <td align="center">
                        <table width="99%" cellspacing="0" cellpadding="0" class="form_table">
						  <tr>
		    			    <td valign="bottom" align="left">
              				 평가지명 : <input name="p_damunpapernm2" type="text" class="input" value="" size="40"></td>
						  </tr>
                          <tr>
                            <td valign="bottom" align="left" colspan="3">
                              1차 기간 : &nbsp;<input name="p_fdamunstart_view2" id="p_fdamunstart_view2" type="text" class="datepicker_input1" value="" size="10">
                              -<input name="p_fdamunend_view2" id="p_fdamunend_view2" type="text" class="datepicker_input1" value="" size="10">
                            </td>
                            <td valign="bottom" align="left" colspan="3">
                              2차 기간 : &nbsp;<input name="p_sdamunstart_view2" id="p_sdamunstart_view2" type="text" class="datepicker_input1" value="" size="10">
                              -<input name="p_sdamunend_view2" id="p_sdamunend_view2" type="text" class="datepicker_input1" value="" size="10">
                            </td>
                          </tr>
                        </table>
                      </td>
