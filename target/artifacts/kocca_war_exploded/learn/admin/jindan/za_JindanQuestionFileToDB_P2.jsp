<%
/**          
 * file name : za_JindanQuestionFileToDB_P2.jsp
 * date      : 
 * programmer:
 * function  : 진단테스트 문제 일괄등록,미리보기 (p_select=2)
 */         
 %> 
...
<html>
<head>
<title>진단테스트 문제 - 일괄등록 미리보기</title>
...
<%
        ...
        try {
           ...
           connMgr.setAutoCommit(false);
            ...
            sql1 = "select jindannum from TZ_JINDANSEL";
            sql1+=  " where subj = ? and jindannum = ? and selnum = ? "; 
            pstmt1 = connMgr.prepareStatement(sql1);   
            
            sql2 =  "insert into TZ_JINDANSEL(subj, jindannum, selnum, seltext, isanswer, luserid, ldate) ";
            sql2+=  " values (?, ?, ?, ?, ?, ?, ?)";
            pstmt2 = connMgr.prepareStatement(sql2);

			System.out.println("sheet.getRows():"+sheet.getRows());

//과정코드	문제번호	보기번호	보기TEXT	정답유무
//000019	2	1	보기 1 	
//000019	2	2	보기 2 	Y
//000019	2	3	보기 3 	
//000019	2	4	보기 4 	
...
%>
        <tr>
          <td align="left" height=25>
            <%= i + " 번째  : " + v_subj  + ", " + v_jindannum  + ", " + v_selnum  + ", " + v_seltext  + ", " + v_isanswer%>
          </td>
        </tr>
<%
	            }
...
System.out.println("v_jindannum:"+v_jindannum);
System.out.println("v_selnum:"+v_selnum);
System.out.println("v_seltext:"+v_seltext);
System.out.println("v_isanswer:"+v_isanswer);
...
%>
          <tr> 
            <td align="left"> 
            <%= (i-1) + " 번째  : " + v_subj  + ", " + v_jindannum  + ", " + v_selnum  + ", " + v_seltext  + ", " + v_isanswer%>는 정상적으로 등록되었습니다.
            </td>
          </tr>
<%    
	            } else {
...
%>
          <tr> 
            <td align="left"> 
            <%= (i-1) + " 번째  : " + v_subj  + ", " + v_jindannum  + ", " + v_selnum  + ", " + v_seltext  + ", " + v_isanswer%>는 이미 등록 되어 있습니다.
            </td>
          </tr>
<%   
						}
