<%
/**
 * file name : za_JindanQuestionFileToDB.jsp
 * date      : 
 * programmer:
 * function  : 진단테스트 문제 일괄처리
 */
%>
                            ...
                            <td align="center">
                              <table width="99%" cellspacing="0" cellpadding="0" class="form_table">
                                <tr>
                                  ...
                                  <td align="center" colspan="2"><input name="p_file" type="FILE" class="input" size=60></td>
                                </tr>
                              </table>
                            </td>
                          </tr>
