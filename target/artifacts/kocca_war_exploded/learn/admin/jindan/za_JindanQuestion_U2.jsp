<%
/**
 * file name : za_JindanQuestion_U2.jsp
 * date      : 
 * programmer:
 * function  : 진단테스트문제관리 - 수정페이지
 */
%>
...
<%
	...
	String v_examtype = box.getStringDefault("p_jindantype", dbox0.getString("d_jindantype"));
      ...
      <form name="form2" method="post" enctype="multipart/form-data">
        ...
        <tr>
		  ...
		  <SELECT name="p_jindantype" onchange="display();"> 
			...
			<script>document.form2.p_jindantype.value = <%=v_examtype%>;</script>
          </SELECT> 
          </td>
		</tr>
		<tr>
