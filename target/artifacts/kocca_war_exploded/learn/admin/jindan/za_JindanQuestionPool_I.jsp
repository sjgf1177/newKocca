...
<table width="1000" border="0" cellspacing="0" cellpadding="0" height="663">
 ...
 <table width="970" border="0" cellspacing="0" cellpadding="0">
      ...
      <form name="form2" method="post" action="/servlet/controller.jindan.JindanQuestionServlet">
...
<%  
         ArrayList list = (ArrayList)request.getAttribute("ExamQuestionPool");
            for (int i=0; i<list.size(); i++) {
				...
				int s_jinnum = dbox.getInt("d_jinnum");
				String s_jintype = dbox.getString("d_jintype");
               
%>
        <tr>
          <td class="table_01"><%=i+1%></td>
          <td class="table_02_2"><%=dbox.getString("d_subjnm")%></td>
          <td class="table_02_2"><a href="javascript:previewQuestion('<%=s_subj%>','<%=s_jinnum%>','<%=s_jintype%>')"><%=dbox.getString("d_jintext")%></a></td>
          <td class="table_02_1"><%=dbox.getString("d_levelsnm")%></td>
          <td class="table_02_1"><%=dbox.getString("d_jintypenm")%></td>
          <td class="table_02_1">
            <input type="checkbox" name="p_checks" value="<%=dbox.getString("d_subj")%>|<%=dbox.getString("d_jinnum")%>">
          </td>
        </tr>
<%  
      }  %>
