        ...
        <tr>
          ...
          <table width="97%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <span style="background:grey;">사용내역</span>
              </td>
            </tr>
          </table>
            <table width="515" class="table_out" cellspacing="1" cellpadding="0">
                ...
                <tr>
                  <td width="20%" class="table_title"><b>사용일자</b></td>
                  <td width="20%" class="table_title"><b>사용포인트</b></td>
                  <td width="20%" class="table_title"><b>사용내역</b></td>
...
<%
            for(i = 0; i < list.size(); i++) {
                ...
                v_getdate       =  dbox.getString("d_usedate");
                v_title         =  dbox.getString("d_title");
                v_getpoint      =  s_fmt.format(dbox.getInt("d_usepoint"));
