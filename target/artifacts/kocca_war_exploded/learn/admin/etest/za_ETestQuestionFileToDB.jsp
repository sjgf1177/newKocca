  ...
  <tr>
    <td align="center" valign="top">
      ...
      <table width="97%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="20" class=dir_txt >5. <font color="#E60873">필드 구성</font> (그룹코드, 문제번호, 문제분류, 객/주관식, 문제TEXT, 설명TEXT, 난이도, 보기갯수)
          <br> &nbsp;&nbsp;  ※문제분류는 코드값으로 입력
          </td>
        </tr>        
      </table>
      ...
      <table width="97%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="20" class=dir_txt >&nbsp;&nbsp;5. 샘플 파일을 참고할 것. ( <a href = '/servlet/controller.library.DownloadServlet?p_savefile=Sample_ETestQuestionSel.xls&p_realfile=Sample_ETestQuestionSel.xls'><b>문제보기 샘플파일</b></a>)</td>
        </tr>
		<br>
		<tr>
