...
%>
        <tr>
          <td align="left">
            <%= (i-1) + " 번째  : " + v_etestsubj  + ", " + v_etestnum  + ", " + v_etesttype  + ", " + v_etesttext  + ", " + v_exptext  + ", " + v_levels  + ", " + v_selcnt%>
          </td>
        </tr>
<%
	            }
...
%>
          <tr> 
            <td align="left"> 
            <%= (i-1) + " 번째  : " + v_etestsubj  + ", " + v_etestnum  + ", " + v_etesttype  + ", " + v_etesttext  + ", " + v_exptext  + ", " + v_levels  + ", " + v_selcnt%>는 정상적으로 등록되었습니다.
            </td>
          </tr>
<%    
	            } else {
...
%>
          <tr> 
            <td align="left"> 
            <%= (i-1) + " 번째  : " + v_etestsubj  + ", " + v_etestnum  + ", " + v_etesttype  + ", " + v_etesttext  + ", " + v_exptext  + ", " + v_levels  + ", " + v_selcnt%>는 이미 등록 되어 있습니다.
            </td>
          </tr>
<%   
						}
...
%>
        ...
        <tr>
          <td height="20" class=dir_txt >4. 샘플 파일을 참고할 것. ( <a href = '/servlet/controller.library.DownloadServlet?p_savefile=Sample_ETestQuestionSel.xls&p_realfile=Sample_ETestQuestionSel.xls'><b>문제보기 샘플파일</b></a>)</td>
        </tr>
        </table>
        <!----------------- 주의사항 끝 ----------------->
