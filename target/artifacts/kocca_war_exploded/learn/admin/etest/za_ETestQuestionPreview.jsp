  ...
  <tr>
	...
	<!----------------- title 시작 ----------------->
     ...
     <br>
      ...
      <!----------------- 과정명 끝 ----------------->
      <!----------------- 문제등록 시작 ----------------->
      <table cellspacing="1" cellpadding="5" class="table_out" align=center>
...
<!-- 문제관련 이미지, 음성, 동영상 파일 끝 -->
		<tr>
          ...
          <td class="table_02_1"><%=dbox0.getString("d_etestgubunnm")%></td>
          <td class="table_title_01">난이도</td>
          <td class="table_02_1"><%=dbox0.getString("d_levelsnm")%></td>
          <td class="table_title_01">문제타입</td>
          <td class="table_02_1"><%=dbox0.getString("d_etesttypenm")%></td>          
		</tr>
		<tr>
          <td class="table_title_01">문제</td>
          <td class="table_02_1" valign="top" colspan="5"><%=dbox0.getString("d_etesttext")%></td>
        </tr>
		<tr>
          <td class="table_title_01">문제해설</td>
          <td class="table_02_1" valign="top" colspan="5"><%=dbox0.getString("d_exptext")%></td>
        </tr>
	   </table>
...
%>
        <tr>
          ...
          <td class="table_02_1"><%=dbox.getString("d_seltext")%></td>
          <td class="table_02_1" width="10%">
          <% if(dbox.getString("d_isanswer").equals("Y")) { %>정답<% } %>
          </td>
        </tr>
<%
 }
