<%
/**
 * file name : za_SulmunCommonQuestion_I2.jsp
 * date      : 2003/08/20
 * programmer:
...
-->
		...
		<tr>
          ...
          <td class="table_02_1"><%=CodeConfigBean.getCodeGubunSelect (SulmunCommonBean.DIST_CODE, "", 1, "p_distcode", box.getString("p_distcode"), "", 0)%></td>
