...
<%
        ...
        try {
           ...
           connMgr.setAutoCommit(false);
			...
			sql3 = "select userid from tz_member where userid = ?";
...
%>
        ...
        <table width="97%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td align="center" ><a href="javascript:history.go(-1)"><img src="/images/admin/button/btn_list.gif" border="0"></a></td>
          </tr>
        </table>
        <!----------------- 등록, 미리보기 버튼 끝 ----------------->
      ...
      <table width="97%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="20" class=dir_txt >4. 샘플 파일을 참고할 것. ( <a href = '/servlet/controller.library.DownloadServlet?p_savefile=Sample_SulmunMember.xls&p_realfile=Sample_SulmunMember.xls'><b>샘플파일</b></a>)</td>
        </tr>
      </table>
      <!----------------- 주의사항 끝 ----------------->
      <br>
