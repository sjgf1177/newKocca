<%
/**
 * file name : za_SulmunContentsPaper_U.jsp
 * date      : 2003/08/20
 * programmer:
          ...
          <td>
            <table cellpadding="0" cellspacing="0" class="table1">
              ...
              <tr> 
               ...
               설문지명 : <input name="p_sulpapernm" type="text" class="input" value="가입경로설문" size="40"></td>
...
<%  ArrayList list1 = (ArrayList)request.getAttribute("SulmunPaperInserPage");
    if (list1 == null) {
        list1 = new ArrayList();
    }
    DataBox dbox  = null;
