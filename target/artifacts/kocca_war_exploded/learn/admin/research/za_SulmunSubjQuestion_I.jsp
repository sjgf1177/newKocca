<%
/**
 * file name : za_SulmunSubjQuestion_I.jsp
 * date      : 2003/08/20
 * programmer:
...
-->
		...
		<tr>
          ...
          <td class="table_02_1"><%=CodeConfigBean.getCodeGubunSelect (SulmunSubjBean.DIST_CODE, "", 1, "p_distcode", "", "", 0)%></td>
...
%>
        <tr>
          ...
          <td class="table_02_1">
			 ...
			 <input type="hidden" name="p_selcount1"  value="0">	
...
%>
        <tr>
          ...
          <td class="table_02_1">
			 ...
			 <input type="hidden" name="p_selcount2"  value="0">
...
<% } %>
      ...
      <table cellspacing="1" cellpadding="5" class="table_out" ID="sultype3" STYLE="display:none">
		...
		<input type="hidden" name="p_selcount3"  value="0">	
...
%>
        <tr>
          ...
          <td class="table_02_1">
			 ...
			 <input type="hidden" name="p_selcount4"  value="0">
...
%>
        <tr>
          ...
          <td class="table_02_1">
			 ...
			 <input type="hidden" name="p_selcount5"  value="0">	
...
%>
        <tr>
          ...
          <td class="table_02_1">
			 ...
			 <input type="hidden" name="p_selcount6"  value="0">	
...
<% } %>
      ...
      <table cellspacing="0" cellpadding="0" >
        <tr>
          <td><a href="javascript:InsertQuestion()"><img src="/images/admin/button/btn_add.gif" border="0"></a></td>
        </tr>
      </table>
      <!----------------- 등록 버튼 끝 ----------------->
      <br>
