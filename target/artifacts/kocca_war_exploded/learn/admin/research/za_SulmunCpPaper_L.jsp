...
//**********************************************************
//  1. 제      목: 설문
//  2. 프로그램명: za_SulmunCpPaper_L.java
//  3. 개      요: 전체설문 - 설문지관리
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
//  6. 작      성: 정은년 2005. 6. 30
...
<%
    ...
    String  v_grcode       = SulmunCpBean.DEFAULT_GRCODE;        //교육그룹
    String  v_gyear        = "ALL";
        ...
        <tr>
          ...
          <td width="85" height="23" align="center" valign="middle">
            <table cellspacing="0" cellpadding="0" class="s_table">
              ...
              <tr>
                <td class="<%=v_tab_color1%>_butt_middle"><a href="javascript:changeTabpage('ALL')" class="c">전체설문</a></td>
              </tr>
              <tr>
                <td class="<%=v_tab_color1%>_butt_bottom"></td>
              </tr>
          ...
          <td width="85" height="23" align="center" valign="middle">
            <table cellspacing="0" cellpadding="0" class="s_table">
              ...
              <tr>
                <td class="<%=v_tab_color5%>_butt_middle">업체설문</td>
              </tr>
              <tr>
                ...
                <td bgcolor="#FFFFFF" align="center" valign="top">
                  ...
                  <table cellspacing="1" cellpadding="5" class="table_out">
                    ...
                    <tr>
					  ...
					  <td width="12%" class="table_title">업체지정</td>
...
%>
                    <tr>
                      ...
                      <td class="table_02_1"><a href="javascript:mappCpseq('<%=dbox.getString("d_subj")%>', '<%=v_grcode%>', '<%=dbox.getString("d_year")%>', '<%=dbox.getString("d_subjseq")%>', '<%=dbox.getString("d_sulpapernum")%>')">지정(<%=dbox.getInt("d_cpcnt")%>)</a></td>
