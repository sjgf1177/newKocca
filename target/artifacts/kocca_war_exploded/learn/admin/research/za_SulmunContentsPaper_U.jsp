<%
/**
 * file name : za_SulmunContentsPaper_I.jsp
 * date      : 2003/08/20
 * programmer:
...
<%
    ...
    ArrayList list1 = (ArrayList)request.getAttribute("SulmunContentsQuestionList");
    ArrayList list2 = (ArrayList)request.getAttribute("SulmunContentsPaperQuestionList");
