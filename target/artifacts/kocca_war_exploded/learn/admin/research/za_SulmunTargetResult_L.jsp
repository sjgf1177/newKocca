...
//**********************************************************
//  1. 제      목: 설문
//  2. 프로그램명: za_SulmunTargetResult_L.java
//  3. 개      요: 대상자설문 - 설문결과조회
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
//  6. 작      성: lyh
...
function goExcel(p_action) {
    ...
    if (p_action=="go") {
        if (document.form2.s_sulpapernum.value==""){
            alert("설문지를 선택하세요");
            return;
        }	
    }
    ...
    document.form2.action='/learn/admin/research/TargetResult_E.jsp'+v_param;                 
    document.form2.submit();
}
...
<table width="1000" border="0" cellspacing="0" cellpadding="0" height="663">
  <tr>
    <td align="center" valign="top">
      ...
      <table class="form_table_out" cellspacing="0" cellpadding="0">
        <tr>
          <td bgcolor="#636563">
            <table cellspacing="1" cellpadding="0" class="s_table">
              <tr>
                <td bgcolor="#FFFFFF" align="center" valign="top">
                  ...
                  <form name="form2" method="post" action="/servlet/controller.research.SulmunTargetResultServlet">
					...
					<tr>
                      <td bgcolor="#C6C6C6" align="center">
                        <table cellspacing="0" cellpadding="0" class="form_table_bg" >
                          ...
                          <tr>
                            <td align="center">
                              <table cellspacing="0" cellpadding="1" width="99%" class="form_table">
                                <tr>
                                  <td>&nbsp; <font color="red">★</font> 
                                   ...
                                   &nbsp; <font color="red">★</font> 설문지<%= SulmunTargetMemberBean.getSulpaperSelect (v_grcode, v_gyear, v_subj, "s_sulpapernum", v_sulpapernum, "")%>
                  ...
                  <table cellspacing="1" cellpadding="0" class="box_table_out">
                    ...
                    <tr>
                      <td colspan="5" class="table_title_02">총응답자수 : <%=v_replycount%>명 / 전체대상자 : <%=v_studentcount%>명 / 설문응시율 : <%=df.format(v_replyrate)%>%</td>
                    </tr>
<%  ArrayList    list = (ArrayList)request.getAttribute("SulmunResultList");
    ...
    for (int i=0; i < list.size(); i++) {
        ...
        if (data.getSultype().equals(SulmunTargetBean.OBJECT_QUESTION) || data.getSultype().equals(SulmunTargetBean.MULTI_QUESTION)) { %>        
                    <tr>
...
<%           }    
		   ...
		   for (int j=1; j <= data.size(); j++) {
                ...
                if (subdata != null) { 
					...
					d +=  (subdata.getReplycnt()) * subdata.getSelpoint();
					person += subdata.getReplycnt();
					out.println(subdata.getReplycnt()+"|"+subdata.getSelpoint());
				}
            }	
		  v_point = d / person;	 
%>
