     ...
     <br>
      ...
      <form name="form2" method="post" action="/servlet/controller.research.SulmunQuestionServlet">
		...
		<tr>
		  ...
		  <%=CodeConfigBean.getCodeGubunSelect (SulmunQuestionBean.DIST_CODE, "", 0, "p_distcode", data.getDistcode(), "", 0)%>
		  </td>
		</tr>
      ...
      <table cellspacing="1" cellpadding="5" class="table_out">
        ...
        <tr>
          ...
          <td class="table_02_1"> 
             <input name="p_seltext5" type="text" class="input" size="60" value='<%=StringManager.replace(data.getSeltext(1), "`", "'")%>' readonly>
          </td>
        ...
        <tr>
          ...
          <td class="table_02_1"> 
             <input name="p_seltext5" type="text" class="input" size="60" value='<%=StringManager.replace(data.getSeltext(2), "`", "'")%>' readonly>
          </td>
        ...
        <tr>
          ...
          <td class="table_02_1"> 
             <input name="p_seltext5" type="text" class="input" size="60" value='<%=StringManager.replace(data.getSeltext(3), "`", "'")%>' readonly>
          </td>
        ...
        <tr>
          ...
          <td class="table_02_1"> 
             <input name="p_seltext5" type="text" class="input" size="60" value='<%=StringManager.replace(data.getSeltext(4), "`", "'")%>' readonly>
          </td>
        ...
        <tr>
          ...
          <td class="table_02_1"> 
             <input name="p_seltext5" type="text" class="input" size="60" value='<%=StringManager.replace(data.getSeltext(5), "`", "'")%>' readonly>
          </td>
...
<% } %>
      ...
      <table cellspacing="1" cellpadding="5" class="table_out" ID="sultype6" STYLE="<%=table6%>">
        ...
        <tr>
          <td class="table_01">1번</td>
          <td class="table_02_1"> 
             <input name="p_seltext6" type="text" class="input" size="60" value='<%=StringManager.replace(data.getSeltext(1), "`", "'")%>' readonly>
          </td>
		  <td class="table_02_1"><%=sdata.getSelpoint(1)%>점</td>
        </tr>
        <tr>
          <td class="table_01">2번</td>
          <td class="table_02_1"> 
             <input name="p_seltext6" type="text" class="input" size="60" value='<%=StringManager.replace(data.getSeltext(2), "`", "'")%>' readonly>
          </td>
		  <td class="table_02_1"><%=sdata.getSelpoint(2)%>점</td>
        </tr>
        <tr>
          <td class="table_01">3번</td>
          <td class="table_02_1"> 
             <input name="p_seltext6" type="text" class="input" size="60" value='<%=StringManager.replace(data.getSeltext(3), "`", "'")%>' readonly>
          </td>
		  <td class="table_02_1"><%=sdata.getSelpoint(3)%>점</td>
        </tr>
        <tr>
          <td class="table_01">4번</td>
          <td class="table_02_1"> 
             <input name="p_seltext6" type="text" class="input" size="60" value='<%=StringManager.replace(data.getSeltext(4), "`", "'")%>' readonly>
          </td>
		  <td class="table_02_1"><%=sdata.getSelpoint(4)%>점</td>
        </tr>
        <tr>
          <td class="table_01">5번</td>
          <td class="table_02_1"> 
             <input name="p_seltext6" type="text" class="input" size="60" value='<%=StringManager.replace(data.getSeltext(5), "`", "'")%>' readonly>
          </td>
		  <td class="table_02_1"><%=sdata.getSelpoint(5)%>점</td>
        </tr>
        <tr>
          <td class="table_01">6번</td>
          <td class="table_02_1"> 
             <input name="p_seltext6" type="text" class="input" size="60" value='<%=StringManager.replace(data.getSeltext(6), "`", "'")%>' readonly>
          </td>
        ...
        <tr>
          <td class="table_01">7번</td>
          <td class="table_02_1"> 
             <input name="p_seltext6" type="text" class="input" size="60" value='<%=StringManager.replace(data.getSeltext(7), "`", "'")%>' readonly>
          </td>
      ...
      <table cellspacing="0" cellpadding="0" class="table1">
        <tr>
          <td align="right" style="padding-top=10"><a href="javascript:UpdateQuestion('2');"><font color="black">수정</font></a></td>
          <td align="right" style="padding-top=10"><a href="javascript:DeleteQuestion();"><font color="black">삭제</font></a></td>
          <td align="right" style="padding-top=10"><a href="javascript:window.self.close();"><font color="black">닫기</font></a></td>
        </tr>
      </table>
