...
//**********************************************************
//  1. 제      목: 설문지관리
//  2. 프로그램명: za_SulmunAllPaper_U.java
//  3. 개      요: 전체설문 - 설문지수정
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
//  6. 작      성: 정은년 2005. 6. 30
...
<%
    ...
    ArrayList list1 = (ArrayList)request.getAttribute("SulmunAllQuestionList");
    ArrayList list2 = (ArrayList)request.getAttribute("SulmunAllPaperQuestionList");
          ...
          <td>
            <table cellpadding="0" cellspacing="0" class="table1">
              ...
              <tr> 
               ...
               설문지명 : <input name="p_sulpapernm" type="text" class="input" value="<%=v_sulpapernm%>" size="60" >
			                  &nbsp;&nbsp;제한 진도율 : <input name="p_progress" type="text" class="input" value="<%=v_progress%>" size="3" maxlength="3">
			   </td>
