...
//**********************************************************
//  1. 제      목: 설문
//  2. 프로그램명: za_SulmunCpQuestion_L.java
//  3. 개      요: 콘텐츠설문 리스트
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
//  6. 작      성: 이창훈 2005. 8. 30
                            ...
                            <td align="center">
                              <table width="99%" cellspacing="0" cellpadding="0" class="form_table">
                                <tr>
                                  ...
                                  설문분류<%=CodeConfigBean.getCodeGubunSelect(SulmunCpBean.DIST_CODE, "", 1, "s_distcode", ss_distcode, "javascript:whenSelection('change')", 2)%>
...
<%  
    ...
    for (int i=0; i<list.size(); i++) {
        ...
        v_apptarget = dbox.getString("d_apptarget");
        
        if(v_apptarget.equals("1")){
          v_apptarget = "외주업체";
        }else{
          v_apptarget = "AES";
        }
...
%>
                    <tr>
                      ...
                      <td class="table_02_1"><%=v_apptarget%></td>
                    </tr>
<%  } %>
                  </table>
				  <br>
