<%
/**
 * file name : za_SulmunSubjPaper_U.jsp
 * date      : 2003/08/20
 * programmer:
 * function  : 설문지 수정 페이지
 */
...
//ErrorManager.systemOutPrintln(box);
    ...
    int     v_progress  = box.getInt("s_progress");//out.println("v_progress" + v_progress);out.println("v_progress" + box.getString("p_progress"));
            ...
            <table cellpadding="0" cellspacing="0" class="table1">
              ...
              <tr> 
                <td valign="bottom" align="left">
		         과정명 : [<%=v_subjnm%> <%=v_subjseqgr%>차] &nbsp; 설문지명 : <input name="p_sulpapernm" type="text" class="input" value="<%=v_sulpapernm%>" size="40">&nbsp;&nbsp;제한 진도율 : <input name="p_progress" type="text" class="input" value="<%=v_progress%>" size="3" maxlength="3"></td>
				 <td width=4></td>
...
<%  ArrayList list1 = (ArrayList)request.getAttribute("SulmunSubjQuestionList");
    ArrayList list2 = (ArrayList)request.getAttribute("SulmunSubjPaperQuestionList");
    if (list1 == null) {
        list1 = new ArrayList();
    }
    if (list2 == null) {
...
<%  }  %>
        ...
        <tr>
          <td class="table_02_1" colspan="2" align="right"><a href="javascript:CancelChoosedQuestion()"><img src="/images/admin/research/del2_butt.gif" width="58" height="18" border="0"></a></td>
        </tr>
      </form>
      </table>
      <!----------------- 설문지 관리 끝 ----------------->
