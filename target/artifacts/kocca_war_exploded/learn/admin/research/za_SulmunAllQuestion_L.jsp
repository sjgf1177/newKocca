...
//**********************************************************
//  1. 제      목: 과정설문
//  2. 프로그램명: za_SulmunAllQuestion_L.java
//  3. 개      요: 리스트페이지
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
//  6. 작      성: lyh
...
<%
	...
	String v_tem_grcode = box.getSession("tem_grcode");		// 교육주관 - 세션 그룹구분값    
...
<!--
    ...
    function changeTabpage(p_gubun) {
        ...
        if (p_gubun == "TARGET") {
            ...
            document.form2.s_grcode.value = "<%=v_grcode%>";            	
                ...
                <tr>
                    ...
                    <td width="85" height="23" align="center" valign="middle">
                        <table cellspacing="0" cellpadding="0" class="s_table">
                            ...
                            <tr>
                                <td class="<%=v_tab_color2%>_butt_middle"><a href="javascript:changeTabpage('REGIST')" class="c">가입경로</a></td>
                            </tr>
                            <tr>
                                <td class="<%=v_tab_color2%>_butt_bottom"></td>
                            </tr>
                                                            ...
                                                            <table width="99%" cellspacing="0" cellpadding="0" class="form_table">
                                                                <tr>
                                                                    <td><font color="red">★</font> 교육그룹
                                                                        ...
                                                                        설문분류<%=CodeConfigBean.getCodeGubunSelect(SulmunAllBean.DIST_CODE, "", 1, "s_distcode", ss_distcode, "javascript:whenSelection('change')", 2)%>
