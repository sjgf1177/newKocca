     ...
     <br>
      ...
      <form name="form2" method="post" action="/servlet/controller.research.SulmunQuestionServlet">
		...
		<tr>
          ...
          <td class="table_02_1" valign="top" colspan="3"><%=CodeConfigBean.getCodeGubunSelect (SulmunQuestionBean.DIST_CODE, "", 0, "p_distcode", box.getString("p_distcode"), "", 0)%></td>
		</tr>
...
-->
		...
		<tr>
          ...
          <td class="table_02_1"><%=CodeConfigBean.getCodeGubunSelect (SulmunQuestionBean.DIST_CODE, "", 1, "p_distcode", box.getString("p_distcode"), "", 0)%></td>
...
<% if (v_gubun.equals("COMMON")) { %>     
		<tr>
		  ...
		  <SELECT name="p_sulreturn"> 
			...
			<script>document.form2.p_sulreturn.value = <%=box.getString("p_sulreturn")%>;</script>
          </SELECT> 
		  </td>
		</tr>
<% } %>
      ...
      <table cellspacing="1" cellpadding="5" class="table_out" ID="sultype6" STYLE="display:none">
        ...
        <tr>
          <td class="table_01">1번</td>
          <td class="table_02_1"> 
             <input name="p_seltext6" type="text" class="input" size="60" value='<%=StringManager.replace(sdata.getSeltext(1), "`", "'")%>' readonly>
          </td>
		  <td class="table_02_1"><%=sdata.getSelpoint(1)%>점</td>
        </tr>
        <tr>
          <td class="table_01">2번</td>
          <td class="table_02_1"> 
             <input name="p_seltext6" type="text" class="input" size="60" value='<%=StringManager.replace(sdata.getSeltext(2), "`", "'")%>' readonly>
          </td>
		  <td class="table_02_1"><%=sdata.getSelpoint(2)%>점</td>
        </tr>
        <tr>
          <td class="table_01">3번</td>
          <td class="table_02_1"> 
             <input name="p_seltext6" type="text" class="input" size="60" value='<%=StringManager.replace(sdata.getSeltext(3), "`", "'")%>' readonly>
          </td>
		  <td class="table_02_1"><%=sdata.getSelpoint(3)%>점</td>
        </tr>
        <tr>
          <td class="table_01">4번</td>
          <td class="table_02_1"> 
             <input name="p_seltext6" type="text" class="input" size="60" value='<%=StringManager.replace(sdata.getSeltext(4), "`", "'")%>' readonly>
          </td>
		  <td class="table_02_1"><%=sdata.getSelpoint(4)%>점</td>
        </tr>
        <tr>
          <td class="table_01">5번</td>
          <td class="table_02_1"> 
             <input name="p_seltext6" type="text" class="input" size="60" value='<%=StringManager.replace(sdata.getSeltext(5), "`", "'")%>' readonly>
          </td>
		  <td class="table_02_1"><%=sdata.getSelpoint(5)%>점</td>
        </tr>
        <tr>
          <td class="table_01">6번</td>
          <td class="table_02_1"> 
             <input name="p_seltext6" type="text" class="input" size="60" value='<%=StringManager.replace(sdata.getSeltext(6), "`", "'")%>' readonly>
          </td>
        ...
        <tr>
          <td class="table_01">7번</td>
          <td class="table_02_1"> 
             <input name="p_seltext6" type="text" class="input" size="60" value='<%=StringManager.replace(sdata.getSeltext(7), "`", "'")%>' readonly>
          </td>
