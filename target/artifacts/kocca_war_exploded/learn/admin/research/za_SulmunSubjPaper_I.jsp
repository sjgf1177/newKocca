<%
/**
 * file name : za_SulmunSubjPaper_I.jsp
 * date      : 2003/08/20
 * programmer:
 * function  : 설문지 등록 페이지
 */
            ...
            <table cellpadding="0" cellspacing="0" class="table1">
              ...
              <tr> 
               <td valign="bottom" align="left">
			     과정명 : [<%=GetCodenm.get_subjnm(ss_subjcourse)%> <%=v_subjseqgr%>차] &nbsp; 설문지명 :
			      <input name="p_sulpapernm" type="text" class="input" value="" size="40">
			      &nbsp;&nbsp;제한 진도율 : <input name="p_progress" type="text" class="input" value="80" size="3" maxlength="3"></td>
