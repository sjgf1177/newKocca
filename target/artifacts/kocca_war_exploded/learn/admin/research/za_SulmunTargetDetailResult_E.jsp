<%
/**
 * file name : za_SulmunTargetDetailResult_E.jsp
 * date      : 2003/09/03
 * programmer:
...
<% 
	response.setHeader("Content-Disposition", "inline; filename=za_SulmunTagetResult.xls"); 
...
<form name="form1" method="post" action="/servlet/controller.multiestimate.SulmunTargetMailServlet">
...
<%    
		String point = dbox2.getString("d_selpoint2");//System.out.println("fpoint" + fpoint);
