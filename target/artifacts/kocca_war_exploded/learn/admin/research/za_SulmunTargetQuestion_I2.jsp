<%
/**
 * file name : za_SulmunTargetQuestion_I2.jsp
 * date      : 2003/08/20
 * programmer:
...
-->
		...
		<tr>
          ...
          <td class="table_02_1"><%=CodeConfigBean.getCodeGubunSelect (SulmunTargetBean.DIST_CODE, "", 1, "p_distcode", box.getString("p_distcode"), "", 0)%></td>
