    ...
    <td align="center" valign="top">
                ...
                <td align="center">
                  <table border="0" cellspacing="0" cellpadding="0" width="99%" class="form_table">
                    ...
                    <tr>
                      ...
                      설문지&nbsp;&nbsp;&nbsp;<%= SulmunAllPaperBean.getSulPaperSelect2 (v_grcode, v_gyear, v_grseq, "s_sulpapernum", v_sulpapernum, "")%>
                      </td>
      ...
      <table cellspacing="1" cellpadding="0" class="box_table_out">
          ...
          <tr>
            ...
            <td class="table_title" width="6%">과정코드</td>
            <td class="table_title" width="*">과정명</td>
            <td class="table_title" width="8%">아이디</td>
            <td class="table_title" width="8%">성명</td>
            <td class="table_title" width="14%">소속</td>
            <td class="table_title" width="6%">설문지<br/>코드</td>
            <td class="table_title" width="10%">설문지</td>
            <td class="table_title" width="8%">설문일자</td>
            <td class="table_title" width="16%">답안</td>
            <td class="table_title" width="6%">평균</td>
          </tr>
<%
