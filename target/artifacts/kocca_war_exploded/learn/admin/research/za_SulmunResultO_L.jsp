<%
/**
 * file name : za_SulmunResultO_L.jsp
 * date      : 2003/08/26
 * programmer:
 * function  : 객관식 설문결과조회
 */
...
function whenSelection(p_action) {
  ...
  document.form2.p_process.value = 'OResultPage';
...
function goExcel() {
  ...
  document.form2.p_process.value = 'OResultExcelPage';   
  document.form2.submit();
}
...
<%    String v_title_img = ""; 
      ...
      <br>
      <br>
<%  if (s_gadmin.startsWith("K")) { v_f_gubun = "WHOLE";
          String v_tab_color = "";%>
...
<%  } else if (v_f_gubun.equals("WHOLE")) {  %>
                    <input type="hidden" name="p_grcode"   value="<%=v_grcode%>">
                                    년도     <% param.setSelectname("p_sulyear"); param.setAll(false); %><% vec=SelectionUtil2.getWholeSulyearR(v_grcode, v_sulyear, param); v_sulyear=(String)vec.get(1); %><%=(String)vec.get(0)%>
      ...
      if (v_f_gubun.equals("COMMON")) {
        ...
        v_text = "전체설문";
                  ...
                  <table cellspacing="1" cellpadding="0" class="box_table_out">
                    ...
                    <tr>
                      <td colspan="5" class="table_title_02">총응답자수 : <%=v_replycount%>명 / 전체수강자 : <%=v_studentcount%>명 / 설문응시율 : <%=v_replyrate%>% / 설문지번호 : <%=v_sulpapernum%></td>
                    </tr>
