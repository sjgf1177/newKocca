...
//**********************************************************
//  1. 제      목: 설문
//  2. 프로그램명: za_SulmunContentsResult_L.jsp
//  3. 개      요: 콘텐츠설문 - 설문결과조회
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
//  6. 작      성: 정은년 2005. 6. 30
...
function changeTabpage(p_gubun) {
	...
	if (p_gubun == "TARGET") {
      ...
      document.form2.action = "/servlet/controller.research.SulmunSubjResultServlet";
	} else if (p_gubun == "ALL") {
      document.form2.action = "/servlet/controller.research.SulmunSubjResultServlet";   	
	} 
            ...
            <table cellspacing="1" cellpadding="0" class="s_table">
              <tr>
                <td bgcolor="#FFFFFF" align="center" valign="top">
                  ...
                  <form name="form2" method="post" action="/servlet/controller.research.SulmunContentsResultServlet">
...
-->
            		  <!--<td class="table_title" width='10%'>과정만족도</td>
            		  <td class="table_title" width='10%'>성취도</td>
            		  <td class="table_title" width='10%'>강사만족도</td>  -->
           ...
           %>
                  <tr> 
                      ...
                      <td class="table_02_1" align="center"><%//=data1.getString("d_compnm")%>회원분류</td>          
            		  <td class="table_02_1" align="center">
					  <a href="javascript:UserPage('ALL', 'ALL', '1', '<%=data1.getString("d_name")%>', '<%=data1.getString("d_userid")%>', '<%=data1.getString("d_answers")%>');" class="a"><%=data1.getString("d_userid")%></a>
				      </td>     
...
-->
                      <!--<td class="table_02_1" align="center"><%=data1.getInt("d_distcode1")%> 점 </td>  
                      <td class="table_02_1" align="center"><%=data1.getInt("d_distcode2")%> 점</td>  
                      <td class="table_02_1" align="center"><%=data1.getInt("d_distcode3")%> 점</td>   --> 					  
