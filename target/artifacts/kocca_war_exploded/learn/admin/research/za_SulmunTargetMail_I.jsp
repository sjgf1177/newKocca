     ...
     <br>
      ...
      <table cellpadding="0" cellspacing="0" class="table1">
        <tr>
          ...
          <td class=sub_title>설문 조사</td>
        </tr>
		<tr>
		  <td></td>
          <td>설문지명 : <%=dbox0.getString("d_sulpapernm")%></td>
		  
        </tr>
		<tr>
		  <td></td>
          <td>설문기간 : <%=FormatDate.getFormatDate(dbox0.getString("d_sulstart"),"yyyy-MM-dd")%> ~ <%=FormatDate.getFormatDate(dbox0.getString("d_sulend"),"yyyy-MM-dd")%></td>
        </tr>
        <tr>
		  <td height="3"></td>
          <td height="3"></td>
