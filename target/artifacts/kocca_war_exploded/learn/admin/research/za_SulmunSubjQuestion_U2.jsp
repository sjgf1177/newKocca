<%
/**
 * file name : za_SulmunSubjQuestion_U2.jsp
 * date      : 2003/08/20
 * programmer:
...
-->
		...
		<tr>
          ...
          <td class="table_02_1">
		  <%=CodeConfigBean.getCodeGubunSelect (SulmunSubjBean.DIST_CODE, "", 1, "p_distcode", dbox0.getString("d_distcode"), "", 0)%>
		  </td>
...
%>
      ...
      <table cellspacing="0" cellpadding="0" >
        <tr>
		  ...
		  <td width=8></td>
          <td align="right" style="padding-top=10"><a href="javascript:window.self.close();"><img src="/images/admin/button/btn_close.gif" border="0"></a></td>
        </tr>
      </table>
      <!----------------- 등록 버튼 끝 ----------------->
      <br>
