<%
/**
 * file name : za_SulmunTargetPaper_I.jsp
 * date      : 2003/08/20
 * programmer:
 * function  : 설문지 등록 페이지
 */
                        ...
                        <table width="99%" cellspacing="0" cellpadding="0" class="form_table">
                          ...
                          <tr>
                            <td valign="bottom" align="left" colspan="3">
                              기간 : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="p_sulstart_view" id="p_sulstart_view" type="text" class="datepicker_input1" value="" size="10">
                              -<input name="p_sulend_view" id="p_sulend_view" type="text" class="datepicker_input1" value="" size="10">
                            </td>
                          </tr>
                          <tr>
                            <td valign="bottom" align="left" colspan="3">
<!--
                              종류 : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="p_sulmailing" type="radio" class="input" value="Y" checked> 메일링용 <input name="p_sulmailing" type="radio" class="input" value="N"> 홈페이지용 <input name="p_sulmailing" type="radio" class="input" value="C"> 메일링+홈페이지
-->
                              <!-- 홈페이지용으로만 사용-->
