<%
/**
 * file name : za_SulmunResultList.jsp
 * date      : 2003/09/12
 * programmer:
 * function  : 설문결과등록
 */
...
<table cellspacing="0" cellpadding="0" class="open_board_table_out1" align="center">
  <tr>
		<td align="right">
<% if (v_f_gubun.equals(SulmunBean.WHOLE_SULMUN)) { %>
		<a href="javascript:javascript:window.close()"><img src="/images/admin/exam/close1_butt.gif" width="37" height="18" border="0"></a>
<% } else { %>
		<a href="javascript:javascript:top.etop.goExNext()"><img src="/images/admin/exam/close1_butt.gif" width="37" height="18" border="0"></a>
<% }  %>
		</td>
	</tr>
