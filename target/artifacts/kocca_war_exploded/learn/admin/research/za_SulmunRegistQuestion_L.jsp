...
//**********************************************************
//  1. 제      목: 설문
//  2. 프로그램명: za_SulmunRegistQuestion_L.jsp
//  3. 개      요: 콘텐츠설문 리스트
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
//  6. 작      성: lyh
...
//      window.self.name = "winSelectView";
        farwindow = window.open("", "openWinQuestion", "toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no, width = 685, height = 700, top=0, left=0");
...
//     window.self.name = "winScaleView";
        farwindow = window.open("", "openWinScale", "toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no, width = 685, height = 562, top=0, left=0");
            ...
            <table cellspacing="1" cellpadding="0" class="s_table">
              <tr>
                <td bgcolor="#FFFFFF" align="center" valign="top">
                  <br>
                  <input type="hidden" name="s_distcode" value="ALL">    
                  <!----------------- form 시작 ----------------->
                  ...
                  <table cellpadding="0" cellspacing="0">
					<tr>
					  ...
					  <td width=810></td>
					  <td align="right"><a href="javascript:insertRegistSulmun()" class="c"><img src="/images/admin/button/btn_add.gif"border="0"></a></td>
                    </tr>
					<tr>
                        <td height=8></td>
                        <td height=8></td>
