...
//**********************************************************
//  1. 제      목: 설문
//  2. 프로그램명: za_SulmunRegistPaper_L.java
//  3. 개      요: 가입경로설문 - 설문지관리
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
//  6. 작      성: lyh
...
%>
                    <tr> 
                      ...
                      <td class="table_02_1"><a href="javascript:UpdatePaperPage('<%=String.valueOf(dbox.getInt("d_sulpapernum"))%>','','REGIST')"><%=dbox.getString("d_sulpapernm")%></a></td>
...
<form name="form3" method="post" action="/servlet/controller.research.SulmunRegistPaperServlet">
