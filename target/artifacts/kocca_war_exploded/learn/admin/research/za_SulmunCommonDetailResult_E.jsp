<%
/**
 * file name : za_SulmunCommonDetailResult_E.jsp
 * date      : 2003/09/03
 * programmer:
...
<% 
	response.setHeader("Content-Disposition", "inline; filename=za_SulmunCommonResult.xls"); 
...
<%
    ...
    ArrayList list = (ArrayList)request.getAttribute("SulmunDetailResultExcelPage");
...
<table width="1000" border="1" cellspacing="1" cellpadding="0" height="663">
        <tr>
          <td class="table_02_1" rowspan="1">사번</td>
          <td class="table_02_1" rowspan="1">성명</td>
		  <td class="table_02_1" rowspan="1">지역</td>
          <td class="table_02_1" rowspan="1">연령</td>
          <td class="table_02_1" rowspan="1">성별</td>
		 <%--<td class="table_02_1" colspan="<%=dbox0.getInt("d_totcnt")%>">설문</td> --%>
		</tr>
<%--
		<tr>
<%  
        for (int k=0; k<dbox0.getInt("d_totcnt"); k++) {	%>
			<td class="table_02_1">문제<%=k+1%></td>
<%    } %>
        </tr>
--%>
<%
...
%>
        <tr>
		  ...
		  <td class="table_02_1"><%=dbox2.getString("d_addr")%></td>
		  <td class="table_02_1"><%=dbox2.getString("d_age")%></td>
          <td class="table_02_1"><%=dbox2.getString("d_sex").equals("1")?"남":"여" %></td>
<%--
<%
