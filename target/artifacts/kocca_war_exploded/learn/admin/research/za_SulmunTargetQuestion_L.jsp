...
//**********************************************************
//  1. 제      목: 설문
//  2. 프로그램명: za_SulmunTargetQuestion_L.java
//  3. 개      요: 대상자설문 리스트
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
//  6. 작      성: lyh
...
<form name="form2" method="post" action="/servlet/controller.research.SulmunTargetQuestionServlet">
                            ...
                            <td align="center">
                              <table width="99%" cellspacing="0" cellpadding="0" class="form_table">
                                <tr>
								  ...
								  설문분류<%=CodeConfigBean.getCodeGubunSelect (SulmunTargetBean.DIST_CODE, "", 1, "s_distcode", ss_distcode, "javascript:whenSelection('change')", 2)%>
