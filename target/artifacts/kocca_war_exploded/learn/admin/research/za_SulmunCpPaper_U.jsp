<%
/**
 * file name : za_SulmunCpPaper_U.jsp
 * date      : 2003/08/20
 * programmer:
...
<%
    ...
    ArrayList list1 = (ArrayList)request.getAttribute("SulmunCpQuestionList");
    ArrayList list2 = (ArrayList)request.getAttribute("SulmunCpPaperQuestionList");
          ...
          <td>
            <table cellpadding="0" cellspacing="0" class="table1">
              ...
              <tr> 
               ...
               설문지명 : <input name="p_sulpapernm" type="text" class="input" value="<%=v_sulpapernm%>" size="40" readonly></td>
