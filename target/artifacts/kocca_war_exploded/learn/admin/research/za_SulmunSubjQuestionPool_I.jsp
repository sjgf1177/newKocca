<%
/**
 * file name : za_SulmunQuestionPool_I.jsp
 * date      : 2003/09/25
 * programmer:
 * function  : 설문문제 Pool에서 등록
 */
%>
...
function InsertQuestion() {
  ...
  document.form2.p_process.value = 'SulmunQuestionInsertPool';
 ...
 <table width="970" border="0" cellspacing="0" cellpadding="0">
      ...
      <form name="form2" method="post" action="/servlet/controller.research.SulmunSubjQuestionServlet">
        ...
        <tr> 
          ...
          <td valign="middle"><a href="javascript:MemberSearch('go')" class="c"><img src="/images/admin/button/btn_inquiry.gif" border="0"></a></td>
		</tr>
        <tr> 
          <td height="7"></td>
        </tr>
...
<%  
         ArrayList list = (ArrayList)request.getAttribute("SulmunQuestionPool");
...
%>
        <tr>
          ...
          <td class="table_02_1"><%=dbox.getString("d_sultext")%></td>
          <td class="table_02_1"><%=dbox.getString("d_distcodenm")%></td>
          <td class="table_02_1"><%=dbox.getString("d_sultypenm")%></td>
          <td class="table_02_1">
            <input type="checkbox" name="p_checks" value="<%=dbox.getString("d_subj")%>|<%=dbox.getString("d_sulnum")%>">
          </td>
        </tr>
<%  
      }  %>
