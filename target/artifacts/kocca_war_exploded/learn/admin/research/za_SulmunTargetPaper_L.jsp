...
//**********************************************************
//  1. 제      목: 설문
//  2. 프로그램명: za_SulmunTargetPaper_L.java
//  3. 개      요: 대상자설문 - 설문지관리
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
//  6. 작      성: lyh
...
<%
    ...
    String  v_gubun        = box.getStringDefault("p_gubun",  "TARGET");
...
function GotoMemberList(p_sulpapernum) {
  document.form2.p_process.value = 'SulmunMemberListPage';
  document.form2.s_sulpapernum.value = p_sulpapernum;
  document.form2.p_sulpapernum.value = p_sulpapernum;
...
function PreviewPaper(p_grcode, p_subj, p_gyear, p_sulpapernum, p_sulpapernm) {
//  window.self.name = "winSelectView";
  farwindow =   window.open("", "openWinQuestion", "toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes, resizable=yes,copyhistory=no, width=670, height=600, top=0, left=0");
...
<form name="form2" method="post" action="/servlet/controller.research.SulmunTargetPaperServlet">
	...
	<input type="hidden" name="s_sulpapernum" value="">
        ...
        <tr> 
          ...
          <td width="85" height="23" align="center" valign="middle">
            <table cellspacing="0" cellpadding="0" class="s_table">
              ...
              <tr>
                <td class="<%=v_tab_color2%>_butt_middle">대상자설문</td>
              </tr>
              <tr>
		  ...
		  <td width="85">
           <table cellspacing="0" cellpadding="0" class="s_table">
              ...
              <tr>
                <td class="<%=v_tab_color4%>_butt_middle"><a href="javascript:changeTabpage('CP')" class="c">업체설문</a></td>
              </tr>
              <tr>
                <td class="<%=v_tab_color4%>_butt_bottom"></td>
              </tr>
...
%>
                  ...
                  <tr> 
                    ...
                    <tr> 
                      ...
                      <td width="10%" class="table_title">대상자</td>
...
%>
                    <tr> 
                      ...
                      <td class="table_02_1">
					  <a href="javascript:UpdatePaperPage('<%=String.valueOf(dbox.getInt("d_sulpapernum"))%>','','TARGET')"><%=dbox.getString("d_sulpapernm")%></a></td>
                      ...
                      <td class="table_02_1"><a href="javascript:GotoMemberList('<%=String.valueOf(dbox.getInt("d_sulpapernum"))%>')"><b><%=dbox.getInt("d_membercount")%>명</b></a></td> 
                      <td class="table_03_1">
                      <a href="javascript:PreviewPaper('<%=v_grcode%>','<%=dbox.getString("d_subj")%>','<%=dbox.getString("d_year")%>', '<%=String.valueOf(dbox.getInt("d_sulpapernum"))%>','<%=dbox.getString("d_sulpapernm")%>')"><img src="/images/admin/button/b_preview.gif" border="0"></a>
                      </td>
                    </tr>
<%   
        } 
