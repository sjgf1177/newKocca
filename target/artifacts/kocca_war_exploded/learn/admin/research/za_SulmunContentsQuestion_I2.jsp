<%
/**
 * file name : za_SulmunContentsQuestion_I2.jsp
 * date      : 2003/08/20
 * programmer:
     ...
     <br>
      ...
      <form name="form2" method="post" action="/servlet/controller.research.SulmunContentsQuestionServlet">
		...
		<tr>
          ...
          <td class="table_02_1" valign="top" colspan="3"><%=CodeConfigBean.getCodeGubunSelect (SulmunContentsBean.DIST_CODE, "", 0, "p_distcode", box.getString("p_distcode"), "", 0)%></td>
		</tr>
