<%
/**
 * file name : za_SulmunTargetQuestion_U2.jsp
 * date      : 2003/08/20
 * programmer:
...
-->
		...
		<tr>
          ...
          <td class="table_02_1">
		  <%=CodeConfigBean.getCodeGubunSelect (SulmunTargetBean.DIST_CODE, "", 1, "p_distcode", dbox0.getString("d_distcode"), "", 0)%>
		  </td>
...
%>
	  ...
	  <table cellspacing="1" cellpadding="5" class="table_out" ID="sultype2" STYLE="<%=table2%>">
	    ...
	    <input type="hidden" name="p_selpoint2"  value="">	
		<tr>
