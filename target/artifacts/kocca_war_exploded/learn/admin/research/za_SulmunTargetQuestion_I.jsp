<%
/**
 * file name : za_SulmunTargetQuestion_I.jsp
 * date      : 2003/08/20
 * programmer:
...
-->
		...
		<tr>
          ...
          <td class="table_02_1"><%=CodeConfigBean.getCodeGubunSelect (SulmunTargetBean.DIST_CODE, "", 1, "p_distcode", "", "", 0)%></td>
...
<% } %>
      ...
      <table cellspacing="0" cellpadding="0" class="table1">
        <tr>
          <td align="right" style="padding-top=10"><a href="javascript:InsertQuestion()"><img src="/images/admin/button/btn_apply.gif" border="0"></a></td>
        </tr>
      </table>
      <!----------------- 등록 버튼 끝 ----------------->
      <br>
