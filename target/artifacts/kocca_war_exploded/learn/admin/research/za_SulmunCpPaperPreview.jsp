...
<%              }
        ...
        } else if (dbox.getString("d_sultype").equals(SulmunCpBean.MULTI_QUESTION)) {  // 복수선택
            for (int j=0; j < list.size(); j++) {
                dbox  = (DataBox)list.get(j); 
                if (dbox != null) { %>
        <tr> 
...
<%              } 
        ...
        } else if (dbox.getString("d_sultype").equals(SulmunCpBean.SUBJECT_QUESTION)) {  // 서술형  %>
        <tr> 
...
<%
		} else if (dbox.getString("d_sultype").equals(SulmunCpBean.COMPLEX_QUESTION)) {  // 복합형
            for (int j=0; j < list.size(); j++) {
                dbox  = (DataBox)list.get(j); 
                if (dbox != null) { %>
        <tr> 
...
<%				
        ...
        } else if (dbox.getString("d_sultype").equals(SulmunCpBean.FSCALE_QUESTION)) {  // 5점척도
            for (int j=0; j < list.size(); j++) {
                dbox  = (DataBox)list.get(j); 
                if (dbox != null) { %>
        <tr> 
...
<%          
        ...
        } else if (dbox.getString("d_sultype").equals(SulmunCpBean.SSCALE_QUESTION)) {  // 7점척도
            for (int j=0; j < list.size(); j++) {
                dbox  = (DataBox)list.get(j); 
                if (dbox != null) { %>
        <tr> 
