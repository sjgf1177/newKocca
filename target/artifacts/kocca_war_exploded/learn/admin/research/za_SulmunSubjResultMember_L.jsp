...
//**********************************************************
//  1. 제      목: 설문
//  2. 프로그램명: za_SulmunSubjResultMember_L.jsp
//  3. 개      요: 과정설문 개인별 보기
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
//  6. 작      성: 정은년 2005. 6. 30
             ...
             <table cellspacing="0" cellpadding="0" class="open_board_table_out1" align="center">
                ...
                <tr> 
                  ...
                  <td><table width="540" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td width="408" class="table_title"> <b> 이름 :  <%=v_name%> &nbsp;&nbsp;&nbsp; ID : <%=v_userid%>   </b></td>
                      </tr>
                      <tr > 
...
<% 
    String[] arr_answers = v_answers.split("\\,");  // 답변
...
<%      if (dbox.getString("d_sultype").equals(SulmunCommonBean.OBJECT_QUESTION)) {   // 단일선택 
        ...
        <tr> 
          <td class="board_text4"> 
            ...
            <%if(dbox.getInt("d_selnum") == Integer.parseInt(arr_answers[i])){out.println("checked");}%> 
...
<%              }
        ...
        <tr> 
          <td class="board_text4"> 
            <input type="checkbox" name="<%=dbox.getInt("d_sulnum")%>" value="<%=dbox.getInt("d_selnum")%>"
            <%if(dbox.getInt("d_selnum") == Integer.parseInt(arr_answers[i])){out.println("checked");}%> 
            ><%=dbox.getInt("d_selnum")%>. <%=dbox.getString("d_seltext")%></td>
        </tr>
<%              } 
...
%>
        <tr> 
          <td class="board_text3"> 
            <textarea name="<%=dbox.getInt("d_sulnum")%>" cols="90" rows="15" class="input"><%=arr_answers[i]%></textarea>
          </td>
        </tr>
<%
...
<%          
        ...
        <tr> 
          <td class="board_text4"> 
            <input type="radio" name="<%=dbox.getInt("d_sulnum")%>" value="<%=dbox.getInt("d_selnum")%>" 
            <%if(dbox.getInt("d_selnum") == Integer.parseInt(arr_answers[i])){out.println("checked");}%> ><%=dbox.getInt("d_selnum")%>. <%=dbox.getString("d_seltext")%></td>
        </tr>
<%          
                }
           } 
