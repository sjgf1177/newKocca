...
function changeRepStatus(){
    ...
    if (bRtn) {
        document.form1.action = "/servlet/controller.homepage.QnaAdminServlet";
        document.form1.p_process.value = "updateCourseRepStatus";
        document.form1.p_action.value = "go";
			...
			<!----------------- 내용보기 시작 ----------------->
						...
						<table cellspacing="1" cellpadding="5" class="table_out">
                          		...
                          		if( v_realfileVector != null ) {
                          			for(int i = 0; i < v_realfileVector.size(); i++) {      //     첨부파일 갯수에 따라
                          				...
                          				if(v_realfile != null && !v_realfile.equals("")) {  %>
                          					&nbsp;<a href = '/servlet/controller.library.DownloadServlet?p_savefile=<%= v_savefile%>&p_realfile=<%= v_realfile%>&p_subj=<%=v_subj%>&p_year=<%=v_year%>'>
                          ...
                          <tr>
                              ...
                              <td class="table_02_2" colspan="3"><%= v_inuserid %>(<%=v_name %>)</td>
...
%>
						...
						<table width="97%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							...
							<td align="right">
		                    	<%if(!(("Y".equals(v_okyn1))&&("Y".equals(v_okyn2)))){%>
		                    	<a href="javascript:editRepPage('<%=v_repseq%>','<%=v_repkind%>')"><img src="/images/admin/button/btn_modify.gif" border="0"></a>
		                    	<a href="javascript:deleteRepAction('<%=v_repseq%>','<%=v_repkind%>')"><img src="/images/admin/button/btn_del.gif" border="0"></a>
		                    	<%}%>
		                    </td>
						  </tr>
						  <tr>
