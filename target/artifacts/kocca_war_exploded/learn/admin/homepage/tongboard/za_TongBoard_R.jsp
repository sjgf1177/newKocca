<%
//**********************************************************
// 1. 프로그램명: 아카데미 이야기 상세보기 화면
// 2. 파  일  명: za_TongBoard_R.jsp
// 3. 개      요: 아카데미 이야기 상세보기 화면
// 4. 환      경: JDK 1.?
// 5. 저      자: saderaser
// 6. 생  성  일: 2014-08-21
// 7. 변 경 내 역:
...
<html>
<head>
<title>상세화면 | 아카데미 이야기 | 홈페이지 | 관리자 | 한국콘텐츠아카데미</title>
...
<form id="oTongBoardForm" name="tongBoardForm" method="post">
    ...
    <tr>
        <td align="center" valign="top">
            ...
            <table width="97%" height="26" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="250" style="font-weight:bold; font-size:11pt;">아카데미 이야기 게시물 상세</td>
                </tr>
                <tr>
                    <td height="3"></td>
                </tr>
