<%
//**********************************************************
// 1. 프로그램명: 아카데미 이야기 목록조회
// 2. 파  일  명: za_TongBoard_L.jsp
// 3. 개      요: 아카데미 이야기 목록조회
// 4. 환      경: JDK 1.?
// 5. 저      자: saderaser
// 6. 생  성  일: 2014-08-21
...
<%
    ...
    ArrayList tongBoardList = (ArrayList)request.getAttribute("tongBoardList");
...
<html>
<head>
<title>목록조회 | 아카데미 이야기 | 홈페이지 | 관리자 | 한국콘텐츠아카데미</title>
...
<!--
    ...
    function goPage(pageNum) {
         $("#oPageNo").val(pageNum);
         $("#oProcess").val("list");
         $("#oTongBoardForm").attr("action", "/servlet/controller.homepage.TongBoardAdminServlet");
...
<form id="oTongBoardForm" name="tongBoardForm" method="get" action="/servlet/controller.homepage.TongBoardAdminServlet" onsubmit="return fnSearch();">
