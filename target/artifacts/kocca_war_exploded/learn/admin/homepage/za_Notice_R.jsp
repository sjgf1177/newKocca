...
<!--
     ...
     * 공지사항 수정 화면으로 이동
     */
    function fnGoToModifyNoticePage() {
  ...
  <tr>
      <td align="center" valign="top"> 
        ...
        <table class="table_out" cellspacing="1" cellpadding="5">
          ...
          <tr class="table_02_2">
            <td height="25" class="table_title" ><strong>공지사항 구분</strong></td>
        ...
        <table width="16%" border="0" cellspacing="0" cellpadding="0">
          ...
          <%if(v_gadmin.equals("A") || v_gadmin.equals("B") || ( s_userid.equals(v_aduserid) && (v_gadmin.equals("H") || v_gadmin.equals("K"))) ){%>
            <td align="center"><a href="javascript:fnGoToModifyNoticePage();"><img src="/images/admin/button/btn_modify.gif" border="0"></a>&nbsp;</td>
            <td align="center"><a href="javascript:fnDeleteNotice();"><img src="/images/admin/button/btn_del.gif" border="0"></a>&nbsp;</td>
          <%}%>
            <td align="center"><a href="javascript:fnGoToNoticeList();"><img src="/images/admin/button/btn_list.gif" border="0"></a>&nbsp;</td>
          </tr>
        </table>
        <!----------------- 수정, 삭제, 리스트 버튼 끝 ----------------->
