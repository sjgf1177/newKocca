<%
//**********************************************************
// 1. 파일명 : za_UpdateMainCategoryDetailPage.jsp
...
<style>
    .coursePopup { display:none; width:800px; height:500px; background:#fff; color:#000; position:fixed; top:100px; left:100px; text-align:center; border:2px solid #000; }
    #oClosePopup { position:absolute; top:6px; left:755px; width:24px; cursor:pointer; border:1px solid #000; font-weight:bold;}
    ...
    .td_selected {background-color:#cdcdcd; color:#000;}
</style>
...
<!--
    ...
    function fnSearchSubj() {
        ...
        if ($("#oSearchSubjArea").val() == "" && $("#oSearchSubjNm").val() == "" ) {
            alert("과정(강좌)분류 혹은 과정(강좌)명 중 하나 이상을 입력하거나 선택하세요.");
            return false;
        } else  {
...
<table width="1000" border="0" cellspacing="0" cellpadding="0" height="663">
    <tr>
        <td align="center" valign="top">
            ...
            <h3 style="text-align:left; padding-left:16px">* 하위 과정 수정</h3>
...
%>
                        <table id="oLayoutTable" cellspacing="12" cellpadding="4">
                            ...
                            <tbody>
                                <tr>
                                    <td id="oPosition1" <%= mainCategoryDetailInfo.getInt("d_position_num") == 1 ? "style=\"background-color:#cdcdcd; color:#000;\"" : ""%>>1</td>
                                    <td id="oPosition2" <%= mainCategoryDetailInfo.getInt("d_position_num") == 2 ? "style=\"background-color:#cdcdcd; color:#000;\"" : ""%>>2</td>
                                    <td id="oPosition5" <%= mainCategoryDetailInfo.getInt("d_position_num") == 5 ? "style=\"background-color:#cdcdcd; color:#000;\"" : ""%> rowspan="2">5</td>
                                </tr>
                                <tr>
                                    <td id="oPosition3" <%= mainCategoryDetailInfo.getInt("d_position_num") == 3 ? "style=\"background-color:#cdcdcd; color:#000;\"" : ""%>>3</td>
                                    <td id="oPosition4" <%= mainCategoryDetailInfo.getInt("d_position_num") == 4 ? "style=\"background-color:#cdcdcd; color:#000;\"" : ""%>>4</td>
                                </tr>
                            </tbody>
                        </table>
<%
...
%>
                ...
                <tr>
                    ...
                    <td class="table_02_2" colspan="3">
                        <input type="text" id="oItemNm" name="itemNm" style="width:474px;" onkeypress="return false;" value="<%= mainCategoryDetailInfo.getString("d_item_nm") %>" />
                        <a href="#" class="board_btn2"><span>찾아보기</span></a><br/>
                        <input type="hidden" id="oItemUrl" name="itemUrl" value="<%= mainCategoryDetailInfo.getString("d_item_url") %>" />
                    </td>
                </tr>
                <tr>
...
%>
                            <option value="<%= i %>" <%= mainCategoryDetailInfo.getInt("d_position_num") == i ? "selected=\"selected\"" : "" %>><%= i %></option>
<%
        }
%>
                        </select>
                    ...
                    <td class="table_02_2">
                        <label><input type="radio" id="oUseYnY" name="useYn" value="Y" <%= mainCategoryDetailInfo.getString("d_use_yn").equals("Y") ? "checked=\"checked\"" : "" %> /> 사용</label>
                        <label><input type="radio" id="oUseYnN" name="useYn" value="N" <%= mainCategoryDetailInfo.getString("d_use_yn").equals("N") ? "checked=\"checked\"" : "" %> /> 미사용</label>
                    </td>
                </tr>
                <tr>
                    <th class="table_title">썸네일</th>
                    <td class="table_02_2" colspan="3">
                        <input type="file" id="oThumbFileNm" name="p_thumbFileNm" style="width:474px;" />
                        <a href="<%= mainCategoryDetailInfo.getString("d_thumb_file_nm") %>" target="_blank">썸네일 보기</a>
                        <br/>
