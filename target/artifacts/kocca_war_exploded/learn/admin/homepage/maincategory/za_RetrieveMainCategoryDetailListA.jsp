<%
//**********************************************************
// 1. 파일명 : za_RetrieveMainCategoryDetailListA.jsp
// 2. 프로그램명 : 홈페이지 메인화면 인기/추천 항목의 하위 등록 과정 목록 조회
// 3. 설명 : 홈페이지 메인화면 인기/추천 영역에 표시되는 카테고리의 하위 등록 과정 목록을 조회한다. 정규과정, 열린강좌만 조회 및 관리한다.
// 4. 환경 : JDK 1.5
// 5. 버젼 : 1.0
// 6. 작성 : 2015-02-03
// 7. 수정 이력 :
//      7.1. 2015-02-03 최초 작성
//***********************************************************
%>
...
<table width="1000" border="0" cellspacing="0" cellpadding="0" height="663">
    <tr>
        <td align="center" valign="top">
            ...
            <br/>
            <h3 style="text-align:left; padding-left:16px">* 하위 과정 목록 - 정규과정/열린강좌 유형</h3>
            ...
            <table class="table1" cellspacing="1" cellpadding="5">
                <tr>
                    <td style="width:100%; text-align:right;">
                        ...
                        <a class="board_btn" onclick="fnGoToRegisterPage();"><span style="font-size:12px;">과정추가</span></a>
                    </td>
                </tr>
            </table>
            <!-- 과정추가 버튼 끝 //-->
