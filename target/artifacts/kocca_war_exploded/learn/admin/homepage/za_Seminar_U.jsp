...
<%
    ...
    DataBox dbox = (DataBox)request.getAttribute("selectSeminar");
    ...
    if (dbox != null) {
        ...
        v_propend1     = dbox.getString("d_propend");
      ...
      <table width="97%" border="0" cellspacing="0" cellpadding="0" class="page_title">
        ...
        <table class="table_out" cellspacing="1" cellpadding="5">
          ...
          <tr class="table_02_2">
            ...
            <td height="25" class="table_02_2">
              <kocca_select:select name="p_seminargubun" sqlNum="seminar.list1"  param=" "              
                onChange="" attr=" " selectedValue="<%=v_seminargubun %>" isLoad="true" all="Y" />
            </td>
          </tr>
          <tr>
            <td width="15%" class="table_title"><strong>워크샵 기간</strong></td>
            <td height="25" class="table_02_2">
              <input name="p_sdate1" id="p_sdate1" class="datepicker_input1" type="text" size="10" value='<%=FormatDate.getFormatDate(v_startdate, "yyyy-MM-dd") %>'>
              <select name="p_shour">
                ...
                <% String sI = "";
                    for(int i = 1 ; i <=24 ; i++) { 
                        sI = i < 10 ? "0"+i : ""+i;    
                %>
                      <option value="<%=sI %>" <%=v_shour.equals(sI) ? "selected" : "" %>><%=i %></option>
                <%   }%>
               </select>
               시
              ~
              <input name="p_edate1" id="p_edate1" class="datepicker_input1" type="text" size="10" value='<%=FormatDate.getFormatDate(v_enddate, "yyyy-MM-dd") %>'>
              <select name="p_ehour">
                <option value="">선택</option>
                <% for(int i = 1 ; i <=24 ; i++) { sI = i < 10 ? "0"+i : ""+i;   %>
                      <option value="<%=sI%>" <%=v_ehour.equals(sI) ? "selected" : "" %>><%=i %>시</option>
                <%   }%>
               </select>
               시
            </td>
          ...
          <tr>
            ...
            <td height="25" class="table_02_2">
              <input name="p_propsdate" id="p_propsdate" class="datepicker_input1" type="text" size="10" value='<%=FormatDate.getFormatDate(v_propstart1, "yyyy-MM-dd") %>'>
              ~
              <input name="p_propedate" id="p_propedate" class="datepicker_input1" type="text" size="10" value='<%=FormatDate.getFormatDate(v_propend1, "yyyy-MM-dd") %>'>
            </td>
          </tr>
          <tr>
            <td width="15%" class="table_title"><strong>인원</strong></td>
            <td height="25" class="table_02_2">
              <input type="text" name="p_limitmember" size = 3 class="input" maxlength="3" value="<%=v_limitmember %>">명
            </td>
          </tr>
          <tr>
            ...
            <td height="25" class="table_02_2">
              <kocca_select:select name="p_target" sqlNum="seminar.list3"  param=" "              
                onChange="" attr=" " selectedValue="<%=v_target %>" isLoad="true" all="Y" />  
            </td>
          </tr>
          <tr>
            <td width="15%" class="table_title"><strong>강의명</strong></td>
            <td height="25" class="table_02_2"><input type="text" name="p_seminarnm" size = 100 class="input" maxlength="80" value="<%=v_seminarnm %>"></td>
          </tr>
          <tr>
            <td width="15%" class="table_title"><strong>담당교수</strong></td>
            <td height="25" class="table_02_2"><input type="text" name="p_tname" size = 10 class="input" maxlength="80" value="<%=v_tname %>"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td height="25" class="table_02_2">
              <input type="radio" name="p_use" value='Y' class="input" <%=v_use.equals("Y") ? "checked" : "" %>>사용&nbsp;
              <input type="radio" name="p_use" value='N' class="input" <%=v_use.equals("N") ? "checked" : "" %>>미사용&nbsp;
            </td>
          </tr>
        </table>
        <!----------------- 공지사항 관리 끝 ----------------->
