...
//    String  v_comp    = box.getString("p_comp");
    ...
    String  v_grcodecd  ="";
    String  v_onoffgubun = "";  // 온라인 오프라인
    String v_community_yn = "";
    ...
    if (dbox != null) {
        ...
        v_community_yn  = dbox.getString("d_community_yn");
    }
...
<!--
    ...
    $(document).ready(function(){
        $("#p_sdate").datepicker(
            {
                onSelect: function() {
                    if( $("#p_sdate").datepicker("isDisabled") ) {
                        alert("팝업여부를 Y로 설정한 후 다시 선택하십시오.");
                        return false;
                    }
                },
  ...
  //팝업미리보기
    ...
    function whenPopupSelect(){
        if(document.form1.p_popup[0].checked == true) { //Y
            ...
            $(".ui-datepicker-trigger").attr("style", "display:;");
...
<form name="form1" method="post" enctype = "multipart/form-data" method = "post">
    ...
    <input type= "hidden" name= "p_adcontent"  id= "p_adcontent"  value= "<%=StringUtil.convertHtmlchars(v_adcontent)%>">
  ...
  <tr>
    <td align="center" valign="top">
      ...
      <table width="97%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td background="/images/admin/homepage/title_bg.gif"><img src="/images/admin/homepage/homepage_title1.gif"  border="0"></td>
        </tr>
      </table>
        <!----------------- title 끝 ----------------->
        ...
        <tr>
            ...
            <td height="25" class="table_02_2">
                <select name="p_gubun" id="oGubun">
                    <option value="N" <%= v_gubun.equals("N") ? "selected=\"selected\"" : "" %>>공지</option>
                    <option value="I" <%= v_gubun.equals("I") ? "selected=\"selected\"" : "" %>>정보</option>
                    <option value="G" <%= v_gubun.equals("G") ? "selected=\"selected\"" : "" %>>안내</option>
                </select>
            </td>
          </tr>
          ...
          <tr class="table_02_2">
            ...
            <td height="25" class="table_02_2">
            <iframe name="grcodeFrame" width="850" height="160"  frameborder="0"  src="/servlet/controller.homepage.NoticeAdminServlet?p_process=grcodelist&p_grcodecd=<%=v_grcodecd%>&p_loginyn=<%=v_loginyn%>"></iframe>
            </td>
          </tr>
          <%}else{%>
              <input type="hidden" name="p_login"  value='Y' >
              <iframe name="grcodeFrame" width="0" height="0"  frameborder="0"  src="/servlet/controller.homepage.NoticeAdminServlet?p_process=grcodelist&p_grcodecd=<%=v_grcodecd%>&p_loginyn=<%=v_loginyn%>"></iframe>
          <%}%>

          <tr id="divonoff">
            <td height="25" class="table_title" ><strong>온/오프 구분</strong></td>
            <td height="25" class="table_02_2">
              <input type="radio" name="p_onoff" value='C'  <%if (v_onoffgubun.equals("C")){%>checked<%}%>>온라인&nbsp;
              <input type="radio" name="p_onoff" value='S' <%if (v_onoffgubun.equals("S")){%>checked<%}%>>오프라인&nbsp;
            </td>
          </tr>
          ...
          <tr>
            <td width="15%" class="table_title"><strong>커뮤니티사용 유무</strong></td>
            <td height="25" class="table_02_2">
              사용<input type="radio" name="p_community_yn" value='Y' class="input" <%if (v_community_yn.equals("Y")){%>checked<%}%>>&nbsp;
              미사용<input type="radio" name="p_community_yn" value='N' class="input" <%if (v_community_yn.equals("N")){%>checked<%}%>>&nbsp;
            </td>
          </tr>
          <tr>
