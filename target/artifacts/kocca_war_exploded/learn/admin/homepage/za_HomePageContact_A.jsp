<%
//**********************************************************
//  1. 제      목: 홈페이지 운영자에게 관리 답변 화면
//  2. 프로그램명: za_HomePageContact_A.jsp
//  3. 개      요: 홈페이지 운영자에게 관리 답변 화면
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
...
v_jikwin = dbox.getString("d_jikwinm"); 
	...
	<table width="970" border="0" cellspacing="0" cellpadding="0" class=page_title>
      ...
      <table width="970"  border="0"  cellpadding="0" cellspacing="1" class="table_out">
        ...
        <tr> 
		  ...
		  <TEXTAREA NAME="p_anscontent" ROWS="20"  COLS="55"><%= v_anscontent %></textarea></td>
        </tr>
      </table>
