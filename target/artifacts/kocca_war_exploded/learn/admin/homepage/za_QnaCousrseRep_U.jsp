...
//**********************************************************
//  1. 제      목: Qna 답변
//  2. 프로그램명:  za_QnaCousrseRep_U.jsp
//  3. 개      요: Qna 답변 입력화면
//  4. 환      경: JDK 1.3
//  5. 버      젼: 1.0
//  6. 작      성: 2005. 10. 9 이창훈
...
<%
	...
	int    v_upfilecnt  = dbox.getInt("d_upfilecnt");
...
function listpage() {
    ...
    function update() {
        ...
        document.form1.action = "/servlet/controller.homepage.QnaAdminServlet";
        document.form1.p_process.value = "repcourseupdate";
        document.form1.submit();
    }
...
<input type="hidden" name="p_repkind"  value="<%=v_repkind%>">
