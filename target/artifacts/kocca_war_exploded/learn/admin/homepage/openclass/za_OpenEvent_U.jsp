...
<!--
    ...
    //이벤트 수정
    function whenUpdate(){
    	if("<%=info.getString("d_update_stat")%>" == "N"){
    		if(!confirm("이미 진행중이거나 완료된 이벤트입니다.\n정말 수정하시겠습니까?")){
    			return;
    		}
    	}
				...
				<td align="center" valign="top">
					...
					<table cellspacing="1" cellpadding="5" class="table_out">
						...
						<tr>
							...
							<td class="table_02_2">
								<input type="text" class="input" id="p_event_title" name="p_event_title" value="<%=info.getString("d_event_title")%>" style="width:80%;"/>
							</td>
						</tr>
						<tr>
							<td class="table_title"><b>이벤트기간</b></td>
							<td class="table_02_2">
								<input type="text" id="p_start_date" name="p_start_date" value="<%=info.getString("d_start_date")%>" class="input date" readonly="readonly" maxlength="10" size="12" /> 
								~ 
								<input type="text" id="p_end_date" name="p_end_date" value="<%=info.getString("d_end_date")%>" class="input date" readonly="readonly" maxlength="10" size="12" />
							</td>
						</tr>
						<tr>
							<td class="table_title"><b>당첨대상 강좌수</b></td>
							<td class="table_02_2">
								<input type="text" class="input" id="p_study_limit" name="p_study_limit" value="<%=info.getString("d_study_limit")%>"/>
							</td>
						</tr>
						<tr>
							<td class="table_title"><b>사용여부</b></td>
							<td class="table_02_2">
								<input type="radio" id="p_use_y" name="p_use_yn" value="Y" <%="Y".equals(info.getString("d_use_yn")) ? "checked" : ""%>/><label for="p_use_y">Y</label>
								<input type="radio" id="p_use_n" name="p_use_yn" value="N" <%="N".equals(info.getString("d_use_yn")) ? "checked" : ""%>/><label for="p_use_n">N</label>
							</td>
						</tr>
					</table>
					<br/>
