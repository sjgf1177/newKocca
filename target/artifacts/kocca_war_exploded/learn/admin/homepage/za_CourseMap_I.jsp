    ...
    <td align="center">
      ...
      <table width="970"  border="0"  cellpadding="0" cellspacing="1" class="table_out">
		...
		<tr>
          ...
          <td class="table_02_2"><input type="text" class="input" name = "p_tabseqname" value="" size="50" maxlength ="50"></td>
        </tr>
        <tr>
          <td class="table_title">pdf 파일명</td>
          <td class="table_02_2"><input type="file" name="p_pdffile" size="45" class="input"></td>
        </tr>
        <tr>
          <td class="table_title">작은이미지파일명</td>
          <td class="table_02_2"><input type="file" name="p_sfile" size="45" class="input"><b> 표준이미지사이즈 : 623*369</b></td>
        </tr>
        <tr>
          <td class="table_title">큰이미지파일명</td>
          <td class="table_02_2"><input type="file" name="p_lfile" size="45" class="input"></td>
        </tr>
      </table>
