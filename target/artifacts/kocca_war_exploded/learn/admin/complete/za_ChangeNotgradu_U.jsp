...
//**********************************************************
//  1. 제      목: 미수료사유변경
//  2. 프로그램명: za_ChangeNotgradu.jsp
//  3. 개      요: 미수료사유변경
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
//  6. 작      성: 노희성 2004-12-25
//  7. 수      정:
//***********************************************************
%>
          ...
          <tr> 
            <td align="center" bgcolor="#FFFFFF"> 
              ...
              <table class="table_out" cellspacing="1" cellpadding="5">
                ...
                <tr> 
                  <td colspan="2" height="25" class="table_01"><b>미수료 사유변경</b></td>
                </tr>
                <tr> 
                  <td width="20%" height="25" class="table_title"><b>사번</b></td>
                  <td class="table_02_2"><%=v_userid%></td>
                </tr>
                <tr> 
                  <td class="table_title" height="25"><b>성명</b></td>
                ...
                <tr> 
                  <td class="table_title" height="25"><b>소속</b></td>
                  <td class="table_02_2"><%=v_compnm%></td>
                </tr>
                <tr> 
                  <td class="table_title" height="25"><b>사유</b></td>
                  <td class="table_02_2"><%=CodeConfigBean.getCodeGubunSelect ("0028", "", 1, "p_notgraducd", v_notgraduetc, "", 1)%></td>
                </tr>
              </table>
