...
//  2. 프로그램명: za_FinishStudent_L1.java
...
<%
    ...
    String  v_stolddate     = box.getString("p_stolddate");
...
function whenExcel() {
  ...
  document.form1.p_process.value = 'FinishStudentList'; 
  document.form1.submit();	
...
function ReRating() {
   ...
   document.form1.p_studentlist.value = "1";   //subjectSelect
...
function whenChangeGradu() {
    ...
    if (document.form1.cchk != null)
    {
        if (document.form1.cchk.length != null){
            ...
            if (document.form1.cchk.checked == true )
            {   
				p_wdata = document.form1.cchk.value+"^";
            }
        }

        if(p_wdata==""){
            alert("사유변경 대상을 선택하세요.");return;
        }
        
		document.form1.p_notgraducds.value = p_wdata;
...
<body bgcolor="#FFFFFF" text="#000000" topmargin="0" leftmargin="0">
      <form name="form1" method="post" action="/servlet/controller.complete.FinishServlet">
		...
		<input type="hidden" name="p_rprocess"    value="subjectSelect">
        ...
        <input type="hidden" name="p_notgraducds"><!--미사유대상-->
   ...
   <input type="hidden" name="p_orderColumn" value="<%=v_orderColumn%>">
		...
		<input type="hidden" name="p_studentlist">
    ...
    <td align="center" valign="top">
      ...
      <br>
        ...
        <table  cellspacing="1" cellpadding="5" class="table_out" >
          ...
          <tr> 
            <td class="table_title" rowspan="6"><b> 수료기준</b></td>
          ...
          <tr> 
            ...
            <!----------------- 교육기간, 수료기준 시작 ----------------->
                        <table cellspacing="1" cellpadding="5" class="table_out" >
                          ...
                          <tr> 
                            <td rowspan="4" class="table_title"><b>수료기준</b></td>
                            <td width="11%" height="25" class="table_02_2">점수</td>
                            <td width="24%" class="table_02_2"><%=dbox2.getInt("gradscore")%>점</td>
...
/*
	           ...
	           if (v_studentcnt==v_stoldcnt) {
	           		...
	           		v_Approval = "<a href=\"javascript:alert('수료처리하지 않은 학습자가 있습니다. 확인해 주세요.');\"><img src='/images/admin/button/btn_galjeshangshin.gif' border=0></a>&nbsp;";
	           }
*/
	           ...
	           //버튼 결재 종료          
	            ...
	            //버튼제어 시작
	          	...
	          	//out.print("v_isoutsrc===>>>"+v_isoutsrc);
	          	...
	          	if (v_isoutsrc.equals("Y")) {
	          			...
	          			if (v_iscpresult.equals("Y")) {
	          				...
	          				if (v_isclosed.equals("N")) {
	          		          	...
	          		          	//1.1.1.2 수료처리를 한 경우
	          					//		  수료처리 취소, 결재상신
	          					if(!v_stolddate.equals("")){
		          					if ( Integer.parseInt(v_stolddate) >= Integer.parseInt(v_date) ){ 
		          					  out.print(v_Cancel);
		          					}
	          					}
      ...
      <!----------------- 수료처리 시작 ----------------->
		...
		<td width="1%"><img src="/images/admin/common/icon.gif" ></td>
		  <td align="left" class=sub_title>학습자 명단</td>
        </tr>      
        </table>
        <table width="97%" border=0  cellspacing="0" cellpadding="0"><tr><td align=right>
        <a href="javascript:whenExcel()"><img src="/images/admin/button/btn_excelprint.gif"  border="0"></a>&nbsp;
        <a href="javascript:whenChangeGradu();"><img src="/images/admin/button/b_sayouchangeall.gif" border="0"></a> 
        </td></tr></table>
        <table cellspacing="1" cellpadding="5" class="table_out">
          <tr> <!--회사 과정 ID 성명 부서 직위 차수 구분 -->
            <td rowspan="2" width="27" class="table_title">NO</td>
            <td rowspan="2" class="table_title" width="90px"><a href="javascript:whenOrder('compnm')" class="e">회원분류</a></td>
...
-->
            ...
            <td width="40" rowspan="2" class="table_title"><a href="javascript:whenOrder('a.score')" class="e">총점</a></td>
            <td width="40" rowspan="2" class="table_title"><a href="javascript:whenOrder('samtotal')" class="e">삼진<br>아웃</a></td>
            <td width="40" rowspan="2" class="table_title"><a href="javascript:whenOrder('a.isgraduated')" class="e">수료<br>처리</a></td>
            <td width="60" rowspan="2" class="table_title"><a href="javascript:whenOrder('a.isgraduated')" class="e">수료증<br/>출력</a></td>
           <td width="70" rowspan="2" class="table_title">미수료<br>
              사유변경</td>             
          </tr>
          <tr> 
            <td width="47" class="table_title">구분</td>
            <% if (v_isonoff.equals("OFF")) { %>
            <td width="47" class="table_title"><a href="javascript:whenOrder('a.tstep')" class="e">출석률</a></td>
            <td width="42" class="table_title"><a href="javascript:whenOrder('a.ftest')" class="e">평가</a></td>
            <td width="42" class="table_title"><a href="javascript:whenOrder('a.report')" class="e">리포트</a></td>
            <td width="38" class="table_title"><a href="javascript:whenOrder('a.etc1')" class="e">기타</a></td>
            <% } else  { %>
            <td width="47" class="table_title"><a href="javascript:whenOrder('a.tstep')" class="e">진도율</a></td>
            <td width="42" class="table_title"><a href="javascript:whenOrder('a.mtest')" class="e">중간평가</a></td>
            <td width="42" class="table_title"><a href="javascript:whenOrder('a.ftest')" class="e">최종평가</a></td>
            <td width="38" class="table_title"><a href="javascript:whenOrder('a.htest')" class="e">형성평가</a></td>
            <td width="35" class="table_title"><a href="javascript:whenOrder('a.report')" class="e">리포트</a></td>
            <td width="25" class="table_title"><a href="javascript:whenOrder('a.etc1')" class="e">참여도</a></td>
            <td width="30" class="table_title"><a href="javascript:whenOrder('a.etc2')" class="e">기타</a></td>
            <% } %>
          </tr>
          <% if (list.size()==0) { %>
          <!--tr> 
          ...
          <tr> 
            ...
            <td rowspan="2" class="table_02_1"><%//=dbox.getString("d_companynm")%>일반회원</td>
...
-->
            ...
            <td rowspan="2" class="table_03_1" >

	            <%--<% if (v_isclosed.equals("Y") || v_isoutsrc.equals("Y") || v_isgradated.equals("Y")) {--%>
	            <%		if (v_isgradated.equals("Y"))  { %>
                            <a href="javascript:whenChangeIsGradu('<%=dbox.getString("d_userid")%>','N')" class="e">수료</a>
                            
                        <% } else { %>
                            <a href="javascript:whenChangeIsGradu('<%=dbox.getString("d_userid")%>','Y')" class="e">미수료</a>
                        <%} %>
<%--                    }--%>
<%--                    else { %>--%>
<%--                        <a href="javascript:whenChangeIsGradu('<%=dbox.getString("d_userid")%>','Y')" class="e">미처리</a>--%>
<%--                    <%}%>--%>

                        <%--if (v_isoutsrc.equals("N") ) { // 위탁교육이 아닌경우 직무일때만.. %>--%>
	            				<%--<a href="javascript:whenChangeIsGradu('<%=dbox.getString("d_userid")%>','N')">수료</a>--%>
	            			<%--<%	} else { --%>
	            					<%--out.print("수료");--%>
	            				<%--}--%>
	               		<%--} else { --%>
	               			 <%--if (v_isoutsrc.equals("N")) {   %>--%>
	               				<%--<a href="javascript:whenChangeIsGradu('<%=dbox.getString("d_userid")%>','Y')">미수료</a>--%>
	               		<%--<%	} else { --%>
	               				<%--out.print("미수료");--%>
	               			<%--}--%>
			...
			<td  rowspan="2" class="table_03_1">
			<%		if (v_isgradated.equals("Y"))  { %>
                         <a href="javascript:suRoyJeung('<%=dbox.getString("d_subj")%>','<%= dbox.getString("d_year") %>','<%= dbox.getString("d_subjseq") %>','<%= dbox.getString("d_userid") %>','1','<%= dbox.getString("d_asp_gubun") %>');">수료증출력</a>
                     <% }  %>
			</td>
            <td  rowspan="2" class="table_03_1"> 
	            ...
	            <% if (v_isclosed.equals("Y") || v_isoutsrc.equals("Y")) {
	            		if (v_isgradated.equals("Y"))  {
	            			...
	            			<%	} else { 
	               			 ...
	               			 if (v_isoutsrc.equals("N")) {   %>
	               			    <input type="checkbox" name='cchk' value='<%=dbox.getString("d_userid")%>'><br>
	               				...
	               				<!--<a href="javascript:whenChangeGradu('<%=dbox.getString("d_userid")%>','<%=dbox.getString("d_name")%>','<%=dbox.getString("d_jikwinm")%>','<%=dbox.getString("d_compnm")%>','<%=dbox.getString("d_notgraduetc")%>')"><img src="/images/admin/button/b_sayouchange.gif" border="0"></a> -->
	               		<%	} else { 
	               				out.print("&nbsp;");
	               			}
	               		}	 %>
