...
function whenSelection(ss_action){
	...
	if (document.form1.p_edustart.value > ff.p_eduend.value) {
...
<tr>
    <td align="center">
	  ...
	  <table width="970" border="0" cellspacing="0" cellpadding="0" class=page_title>
        <tr>
          <td><img src="/images/admin/course/tit_dataview.gif" ></td>
                ...
                <td>
                  <table  border="0" cellspacing="0" cellpadding="0">
                    <tr>
					  ...
					  교육기간 : <input type="text" name="p_edustart1" id="p_edustart1" value="<%=p_edustart1%>" class="datepicker_input1" size="10"> - 
					  <input type="text" name="p_eduend1" id="p_eduend1" value="<%=p_eduend1%>" class="datepicker_input1" size="10">
