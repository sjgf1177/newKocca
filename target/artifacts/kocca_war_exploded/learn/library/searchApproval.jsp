...
%>
            <% if(i == 0){ %>
                    <tr>
                      <td height='40' colspan="7" class="table_text1">검색된 회사가 없습니다</td>
                    </tr>
                    <tr> 
                      <td colspan="7" class="table_line2"></td>
                    </tr>
