...
<!--
    ...
    function selectSubj(subj , subjnm, tmp1, tmp2, tmp3) {
        opener.receiveSubjseq(subj , subjnm, tmp1, tmp2, tmp3);
        self.close();
    }
    ...
    function search() {
         ...
         document.form1.p_process.value = "subjseq";
        ...
        <tr>
          <td align="center" valign='top' bgcolor="#FFFFFF">
            ...
            <table width="510" border="0" cellspacing="1" cellpadding="0">
              ...
              <tr>
                <td width="30px" height="26" class="table_title">&nbsp;</td>
                <td class="table_title"><b>과목명</b></td>
                <td width="110px" class="table_title"><b>교육그룹</b></td>
                <td width="70px" class="table_title"><b>신청시작</b></td>
                <td width="70px" class="table_title"><b>교육시작</b></td>
              </tr>
<%
            int i;
            for(i = 0; i < list.size(); i++) {
                ...
                v_subj      = data.getTmp1();
                v_year=data.getTmp2();
                v_subjseq=data.getTmp3();
                v_subjnm    = data.getTmp4();
                v_propstart=data.getTmp5();
                v_edustart=data.getTmp6();
                v_grcodenm    = data.getTmp7();
                v_totalpage = data.getTotalpagecount();

%>
              <tr>
                <td height="26" class="table_01"> <input type="radio" name="no" value="<%=v_subj%>" onClick="javascipt:selectSubj('<%=v_subj%>' ,'<%=v_subjnm%>','<%=v_key2%>','<%=v_year%>','<%=v_subjseq%>')"></td>
                <%--<td class="table_02_1"><%=(i+1)%></td>--%>
                <td class="table_02_1" style="text-align:left"><%=v_subjnm%></td>
                <td class="table_02_1" style="text-align:left"><%=v_grcodenm%></td>
                <td class="table_02_1"><%=v_propstart%></td>
                <td class="table_02_1"><%=v_edustart%></td>
              </tr>
<%
          }
%>
            <% if(i == 0){ %>
              <tr>
                <td  height='40' colspan="5" class="table_02_1">검색된 과정이 없습니다</td>
              </tr>
            <% } %>
            </table>
