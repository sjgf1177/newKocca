<%
//**********************************************************
//  1. 제      목: Sample 자료실에서의 등록화면
//  2. 프로그램명: bulletin_i.jsp
//  3. 개      요: Sample 자료실에서의 등록화면
//  4. 환      경: JDK 1.3
//  5. 버      젼: 1.0
//  6. 작      성: 이정한 2003. 4. 9
//  7. 수      정: 이정한 2003. 4. 9
							...
							<td width = "710" valign = "top">
								<table cellspacing = "1" cellpadding = "2" border = "0" width = "100%" class = "table_out"> 
									<tr>
										...
										name = "p_title" size = "50" maxlength = "100" value = ""></td>
									</tr>
									<tr>
										<td class = "table-title" width = "20%" align = "center">작성자</td>
										<td class = "table-content" width = "80%" align = "left"><%//= ss_usernm %></td>
									</tr>
									<tr>
										<td class = "table-title" width = "20%" align = "center">등록일</td>
										<td class = "table-content" width = "80%" align = "left"><%= FormatDate.getDate("yyyy/MM/dd") %></td>
									</tr>
									<tr>
										<td class = "table-title" width = "20%" align = "center">내용</td>
										<td class = "table-content" width = "80%" align = "left">
											<textarea  onFocus = "this.style.background = '#FFFAE1'" onBlur = "this.style.background='#ffffff'" 
											name='p_content' align = "left" cols='80' rows='20' wrap='hard' style = "width: 100%; height: 200;">
											</textarea></td>
									</tr>
								<%  if(box.getBoolean("p_isUpload")) {    //    파일첨부 여부 %>
									...
									<tr>
										<td class = "table-title" width = "20%" align = "center">동영상첨부</td>
										<td class = "table-content" width = "80%" align = "left">
											<input type = "file" onFocus = "this.style.background = '#FFFAE1'" onBlur = "this.style.background='#ffffff'" name = "p_motion">
										</td>
									</tr>
								<%  }   %>
								</table>
								<table border = "0" cellpadding = "0" cellspacing = "0" width = "100%">      
									...
									<tr>
										<td align = "right" height = "30" valign = "bottom">
											...
											<img src = "/learn/sample/images/save.gif" border = "0"></a>&nbsp;
											<a href = "javascript:cancel();"><img src = "/learn/sample/images/list.gif" border = "0"></a>
										</td>
									</tr>
								</table>
							</td>
