...
function goPage(pageNum) {
	...
	document.form1.action = "/servlet/controller.study.MyClassServlet";
	document.form1.p_process.value = "StudyHistoryOffListSyuro";
	document.form1.submit();
  ...
  <input type = "hidden" name = "p_pageno"		value = "<%= v_pageno %>">
	...
	<div class="content">
		...
		<div class="concept a08">
			...
			<ul class="pagetab">
				<li><a href="/servlet/controller.study.MyClassServlet?p_process=StudyHistoryListSyuro" tabindex="171" title="회원님께서 그동안 정상적으로 수료하신 온라인 교육과정 수료증을 인쇄할 수 있습니다"><img src="/images/2012/sub/page1/tabmenu/online_off.png" alt="온라인과정"></a></li>
				<li><img src="/images/2012/sub/page1/tabmenu/offline_on.png" alt="오프라인과정"></li>
			</ul>
		</div>
		<div class="myclass">
			<div class="listbar">
				<table class="listrable" cellpadding="0" cellspacing="0" summary="수료증 출력이 가능한 과정 목록입니다">
					<colgroup><col width="50"><col width="*"><col width="150"><col width="80"></colgroup>
					<tr class="listhead">
						<th>번호</th>
						<th>과정명</th>
						<th>학습기간</th>
					...
					<tr class="listmiddle" onmouseover="this.style.background='#fbfbfb'" onmouseout="this.style.background=''">
						...
						<td>
							...
							<button type="button" tabindex="<%=i+200%>" onclick="javascript:suRoyJeung('<%=v_subj%>','<%=v_year%>','<%=v_subjseq%>','<%=v_user_id%>')" class="btn_small_gray" title="클릭하시면 수료증을 인쇄할 수 있습니다">인쇄</button>
							<%}else{%>
							  -
							<%}%>
						</td>
					...
					<% } %>
					<%	if(i == 0){	 %>
			    <tr><td colspan="4" align="center">학습중인 과정이 없습니다.</td></tr>
			    <% } %>
				</table>
			</div>
			<div class="pageset">
