...
function goPage(pageNum) {
	...
	document.form1.action = "/servlet/controller.study.MyClassServlet";
	document.form1.p_process.value = "StudyHistoryListSyuro";
	document.form1.submit();
	...
	<div class="content">
		<table class="pageinfo" cellpadding="0" cellspacing="0" summary="현재 보고계신 콘텐츠의 위치입니다">
			<tr>
				...
				<td class="pagenavi"><img src="/images/2012/sub/icon_home.gif" alt="홈"> 홈 > 나의강의실 ><u>수료증 출력</u></td>
			</tr>
		</table>
		<div class="concept a08">
			<div class="titlemsg"><img src="/images/2012/sub/page1/title/diploma_print.gif" alt="수료증 출력"></div>
			<ul class="pagetab">
				<li><img src="/images/2012/sub/page1/tabmenu/online_on.png" alt="온라인과정"></li>
				<li><a href="/servlet/controller.study.MyClassServlet?p_process=StudyHistoryOffListSyuro" tabindex="171" title="회원님께서 그동안 정상적으로 수료하신 오프라인 교육과정 수료증을 인쇄할 수 있습니다"><img src="/images/2012/sub/page1/tabmenu/offline_off.png" alt="오프라인과정"></a></li>
			</ul>
		</div>
		<div class="myclass">
			<div class="listbar">
				<table class="listrable" cellpadding="0" cellspacing="0">
					<colgroup><col width="50"><col width="125"><col width="*"><col width="150"><col width="80"></colgroup>
					<tr class="listhead">
						<th>번호</th>
						<th colspan="2">과정명</th>
						<th>학습기간</th>
					 ...
					 <%    
							for(i = 0; i < list.size(); i++) {
					            ...
					            if (v_introducefilenamenew.equals("")) {
					            	v_introducefilenamenew = "/images/2012/common/not_image.gif";
								} else {
									v_introducefilenamenew = "http://edu.kocca.or.kr/upload/bulletin/"+v_introducefilenamenew;
								}
					...
					<tr class="listmiddle" onmouseover="this.style.background='#fbfbfb'" onmouseout="this.style.background=''">
						...
						<td class="courseimg"><img src="<%=v_introducefilenamenew%>" class="course" alt="<%= v_subjnm %>"></td>
						<td class="title courselist">
							<%= v_subjnm %>
							<br>
						...
						<td>
							...
							<button type="button" tabindex="<%=i+200%>" onclick="javascript:suRoyJeung('<%= v_subj %>','<%= v_year %>','<%= v_subjseq %>','<%= v_user_id %>','<%= v_kind %>','<%= v_subjgrcode %>')" class="btn_small_gray" title="클릭하시면 수료증을 인쇄할 수 있습니다">인쇄</button>
							<%}else{%>
							  -
							<%}%>
						</td>
					...
					<% } %>
					<%	if(i == 0){	 %>
					<tr><td colspan="4" align="center" class="linefirst">학습중인 과정이 없습니다.</td></tr>
					<% } %>
				</table>
			</div>
			<div class="pageset">
