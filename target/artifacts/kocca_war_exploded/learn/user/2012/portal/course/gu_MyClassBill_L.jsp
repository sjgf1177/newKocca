	...
	<div class="content">
		...
		<div class="concept a04">
			...
			<ul class="pagetab">
				...
				<li><a href="/servlet/controller.study.MyClassBillServlet?p_process=MyOffClassBillListPage" tabindex="171" title="회원님의 오프라인 과정 결제 조회 및 결제를 진행할 수 있습니다"><img src="/images/2012/sub/page1/tabmenu/offline_off.png" alt="오프라인과정"></a></li>
			</ul>
		</div>
		<div class="myclass">
			<div class="listbar">
				<table class="listrable" cellpadding="0" cellspacing="0" summary="온라인과정 수강료 결제관리 목록입니다">
					...
					<tr class="listmiddle" onmouseover="this.style.background='#fbfbfb'" onmouseout="this.style.background=''">
						<!-- <td class="linefirst courseimg"> 온라인 </td>   -->
						...
						<td><%= v_inputdate %></td>
						<td><%= "Y".equals(v_cancelyn) ? "환불완료" : "결제완료" %></td>
						<td id="btxtfocus<%=i+1%>">
							<% if (v_price==0 || v_paymethod.equals("무료결제")) {%><%= v_pgauthdate %>
              ...
              <%}%>
						...
						<td>
						<% if (v_price==0 || v_paymethod.equals("무료결제")) {%>무료
            <% } else { %>
            ...
            <%}%>
					...
					<%} %>
						<%	if(i == 0){	 %>
					    <tr><td colspan="8" align="center" class="linefirst">해당하는 데이타가  없습니다.</td></tr>
					    <% } %>	
					<%}%>
				</table>
			</div>
