...
<%
	...
	String needinput = dbox.get("d_needinput", "100000000");
...
<% if(i < token.length && token[i++] == '1') { %>
            ...
            <tr>
				...
				<td style="padding-left:10px;padding-right:0" colspan="3" class="end"><textarea rows="5" cols="90" name="p_intro" id="p_selfintro" onkeyup="textareaLength('p_intro','p_selfintroLbael');"></textarea>
                * 최소 300Byte, 최대 4000Byte 작성 바랍니다. (한글,특수문자 2byte 나머지 1Byte)
            ...
            <tr>
				...
				<td style="padding-left:10px;padding-right:0" colspan="3" class="end"><textarea rows="5" cols="90" name="p_motive" id="p_support" onkeyup="textareaLength('p_motive','p_motiveLbael');"></textarea>
                * 최소 300Byte, 최대 4000Byte 작성 바랍니다. (한글,특수문자 2byte 나머지 1Byte)
...
<%	}if(i < token.length && token[i++] == '1') {	%>
			...
			<table class="write">
			<colgroup><col width="16%" /><col width="32%" /><col width="14%" /><col width="38%" /></colgroup>
			<tr>
				<th>학교명</th>
