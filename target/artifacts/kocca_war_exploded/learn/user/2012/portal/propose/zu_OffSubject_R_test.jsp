	...
	<div class="content">
		...
		<div class="concept c01">
			...
			<ul class="coursesearch">
				<li class="insert"><input type="text" name="s_subjnm" class="insearch" onfocus="this.style.background=''" title="검색할 과정을 입력해주세요"></li>
				<li class="output"><a href="javascript:subjSearch();"><img src="/images/2012/sub/page2/btn_course_search.gif" title="검색어를 입력 후 클릭해주세요" alt="과정검색"></a></li>
			</ul>
			<ul class="pagetabC">
				<li><a href="javascript:selectArea('004','');"  title="3D 입체콘텐츠 전문인력양성 부문을 확인합니다"><img src="/images/2012/sub/page3/tabmenu/3dsolid_<%=sub1_toggle%>.png" alt="3D 입체콘텐츠 전문인력양성"></a></li>
				<li><a href="javascript:selectArea('001','');" title="산업계 직무 재교육 부문을 확인합니다"><img src="/images/2012/sub/page3/tabmenu/industry_<%=sub2_toggle%>.png" alt="산업계 직무 재교육"></a></li>
				<li><a href="javascript:selectArea('002','');" title="차세대 인재양성교육 부문을 확인합니다"><img src="/images/2012/sub/page3/tabmenu/talent_<%=sub3_toggle%>.png" alt="차세대 인재양성교육"></a></li>
				<li><a href="javascript:selectArea('003','');" title="수탁교육 부문을 확인합니다"><img src="/images/2012/sub/page3/tabmenu/brokerage_<%=sub4_toggle%>.png" alt="수탁교육"></a></li>
			</ul>
		</div>
		<div class="onlinecourse">
			<div class="listback"><button type="button" onclick="javascript:whenSubjList();" class="btn_small_gray" title="과정목록으로">목록으로</button></div>
			...
			<table class="coursedetailheader" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td>
						...
						<div class="offlinecourseoption">
							...
							<a href="javascript:whenSubjPropose()" title="이 과정에 대해 수강신청을 할 수 있습니다"><img src="/images/2012/common/btn_request.gif" alt="수강신청"></a>
							<% } %>
						</div>
					</td>
				</tr>
			</table>
			<table class="learningcontent" cellspacing="0" cellpadding="0">
