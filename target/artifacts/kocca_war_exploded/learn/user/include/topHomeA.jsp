...
function goSiteBanner(grcode,seq,loginCheck) {
	...
	window.open("/learn/user/homepage/zu_LinkSite_action.jsp?grcode="+grcode+"&seq="+seq, "SiteLink", "toolbar=yes,location=yes,directories=yes,status=yes,menubar=yes,scrollbars=yes,resizable=yes,width=700,height=480,left=80,top=100");
}
//-->
</script>
</head>
      ...
      <table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="18" height="30" class="mlcolor1">&nbsp;</td>
            ...
            <!----------------- top left menu 시작 ----------------->
            <%@ include file="/learn/user/include/leftmenuHomeA.jsp"%>
            <!-----------------  top left menu 끝 ------------------>
