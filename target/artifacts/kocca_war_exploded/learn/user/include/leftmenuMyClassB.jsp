<%@ page import = "com.credu.templet.*" %>
            ...
            <td width="152" valign="top" bgcolor="#FFFFFF"><img src="/images/user/myclass/type2/lm_tit.gif" width="152" height="54" >
<%
...
%>
            <a href="javascript:menuForward('<%=topmenu%>', '<%=lmenu_menuid%>', '<%=lmenu_orders%>')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2<%=m%>','','/images/user/myclass/<%=lmenu_menuoverimg%>',1)"><img src="/images/user/myclass/<%=lmenu_selmenuimg%>" name="Image2<%=m%>" border="0"></a><%if(lmenu_menuid.equals("04")){%><a href="javascript:menuForward('<%=topmenu%>', '<%=lmenu_menuid%>', '<%=lmenu_orders%>')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image45','','/images/user/myclass/lm_041_on.gif',1)">
...
<a href="/servlet/controller.homepage.KnowBoardUserServlet?p_process=PopListPage" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image46','','/images/user/myclass/lm_042_on.gif',1)">
