<%@ page import = "com.credu.templet.*" %>
            ...
            <td width="152" valign="top" bgcolor="#FFFFFF"><img src="/images/user/support/type2/lm_tit.gif" width="152" height="54" >
<%
...
%>
            <a href="javascript:menuForward('<%=topmenu%>', '<%=lmenu_menuid%>', '<%=lmenu_orders%>')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2<%=m%>','','/images/user/support/<%=lmenu_menuoverimg%>',1)"><img src="/images/user/support/<%=lmenu_selmenuimg%>" name="Image2<%=m%>" border="0"></a>
<%
    }
%>
          </td>
