...
<div id="div_attachMain">
	...
	%>
		<div id="file_list" name="file_list" class="file_list">
			<a href='/servlet/controller.library.DownloadServlet?p_savefile=<%=v_savefile%>&p_realfile=<%=v_realfile%>'><%=v_realfile%></a>&nbsp;<a href="javascript:void(0);" id="span_del" name="span_del" onclick="fnFileDel(this)" >[삭제]</a>
