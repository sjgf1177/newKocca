...
<tr valign="top">
<td background="/images/user/game/member/<%=tem_subimgpath%>/<%=tem_subbg7%>" bgcolor="#f6f6f6">
	...
	<td align="right">
      <!-----------------  left menu 시작 ----------------->
      <%@ include file="/learn/user/game/include/leftmenuMemberA.jsp"%>
      <!-----------------  left menu 끝 ------------------>
	</td>
	<td background="/images/user/game/member/type1/conbg.gif" align="center">
		<img src="/images/user/game/member/<%=tem_subimgpath%>/<%=tem_subtopimg7%>"><br>