            ...
            <table width="216" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><img src="/images/user/game/helpdesk/type2/lm_tit.gif"></td>
              </tr>
            </table>
<%
...
%>
            ...
            <table width="216" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td valign="top"><a href="javascript:menuForward('<%=topmenu%>', '<%=lmenu_menuid%>', '<%=lmenu_orders%>')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2<%=m%>','','/images/user/game/helpdesk/type2/<%=lmenu_menuoverimg%>',1)"><img src="/images/user/game/helpdesk/type2/<%=lmenu_selmenuimg%>" name="Image2<%=m%>" border="0"></a></td>
              </tr>
            </table>
