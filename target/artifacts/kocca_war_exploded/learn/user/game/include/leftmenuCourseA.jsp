        ...
        <tr height="114">
            <td align="right"  valign="bottom" >
                <img src="/images/user/game/course/type1/lm_tit.gif" ><br></td>
        </tr>
        <tr bgcolor=white>
            <td align="right" valign="top" background="/images/user/game/course/type1/lm_bg.gif"> 
<%
...
<%	}
%>
                <img src="/images/user/game/course/type1/lm_bo.gif" ><br>
          <img src="/images/user/game/course/type1/lm_bot.gif" width="223" height="1"><br></td>
        </tr>
        </table>
        <!-- //Left Menu -->