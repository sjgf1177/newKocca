		...
		%>
		<a href="<%=v_indexURLGLB%>"><img src="/images/user/game/homepage/type1/topmn_home.gif"></a>
<%if(box.getSession("userid").equals("")){%>
<%}else{%><a href="/servlet/controller.homepage.LoginServlet?p_process=gologout"><img src="/images/user/game/homepage/type1/topmn_logout.gif"></a>
<%}%>
<!--a href="/servlet/controller.homepage.HomePageSiteMapServlet"><img src="/images/user/game/homepage/type1/topmn_sitemap.gif"></a--><a href="/servlet/controller.homepage.HomePageContactServlet?p_process=insertPage"><img src="/images/user/game/homepage/type1/topmn_dearadmin.gif"></a><%if (s_tem_grcodeGLB.equals("N000002")) {%><a href="javascript:CommunityOpenPage();"><img src="/images/user/game/homepage/type1/topmn_community.gif"></a><%}%>
