        ...
        <tr height="114">
            <td align="right"  valign="bottom" >
                <img src="/images/user/game/book/type1/lm_tit.gif" ><br></td>
        </tr>
        <tr bgcolor=white>
            <td align="right" valign="top" background="/images/user/game/book/type1/lm_bg.gif"> 
<%
...
%>
                ...
                <a href="javascript:menuForward('<%=topmenu%>', '<%=lmenu_menuid%>', '<%=lmenu_orders%>')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2<%=m%>','','/images/user/game/book/type1/<%=lmenu_menuoverimg%>',1)"><img src="/images/user/game/book/type1/<%=lmenu_selmenuimg%>" name="Image2<%=m%>" border="0"></a><br>
                <!--  <%=lmenu_menuname%> table end -->
<%  }
%>
                <img src="/images/user/game/book/type1/lm_bo.gif" ><br>
          <img src="/images/user/game/book/type1/lm_bot.gif" width="223" height="1"><br></td>
        </tr>
        </table>
        <!-- //Left Menu -->