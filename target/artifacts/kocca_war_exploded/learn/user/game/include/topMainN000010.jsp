...
<tr valign="top">
<td style="background-image:url(<%=tem_imgpath%><%=tem_mainbg%>);background-repeat:repeat-x;">
	<!-- KEY VISUAL FLASH -->
	<!-- //KEY VISUAL FLASH -->
	<table border=0 cellpadding="0" cellspacing="0" width="1000" height="245">
	<tr>
	<td>
<comment id=__NSID__>
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="1000" height="241">
  <param name="movie" value="/images/user/homepage/type1/N000010/N000010_main_flash.swf">
  <param name="quality" value="high">
  <param name="wmode" value="transparent">
  <embed src="/images/user/homepage/type1/N000010/N000010_main_flash.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="1000" height="241"></embed></object></comment>
