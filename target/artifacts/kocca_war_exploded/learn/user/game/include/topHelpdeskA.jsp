...
<tr valign="top">
<td background="/images/user/game/helpdesk/<%=tem_subimgpath%>/<%=tem_subbg4%>" bgcolor="#f6f6f6">
	...
	<td align="right">
      <!-----------------  left menu 시작 ----------------->
      <%@ include file="/learn/user/game/include/leftmenuHelpdeskA.jsp"%>
      <!-----------------  left menu 끝 ------------------>
	</td>
	<td background="/images/user/game/helpdesk/type1/conbg.gif"  align="center">
		<img src="/images/user/game/helpdesk/<%=tem_subimgpath%>/<%=tem_subtopimg4%>"><br>
