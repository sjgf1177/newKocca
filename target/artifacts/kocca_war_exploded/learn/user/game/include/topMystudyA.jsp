...
<tr valign="top">
<td background="/images/user/game/mystudy/<%=tem_subimgpath%>/<%=tem_subbg3%>" bgcolor="#f6f6f6">
	...
	<td align="right">
      <!-----------------  left menu 시작 ----------------->
      <%@ include file="/learn/user/game/include/leftmenuMystudyA.jsp"%>
      <!-----------------  left menu 끝 ------------------>
	</td>
	<td background="/images/user/game/mystudy/type1/conbg.gif"  align="center">
		<img src="/images/user/game/mystudy/<%=tem_subimgpath%>/<%=tem_subtopimg3%>"><br>
