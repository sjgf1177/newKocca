...
<tr valign="top">
<td background="/images/user/game/aboutus/<%=tem_subimgpath%>/<%=tem_subbg1%>" bgcolor="#f6f6f6">
	...
	<td align="right">
      <!-----------------  left menu 시작 ----------------->
      <%@ include file="/learn/user/game/include/leftmenuAboutusA.jsp"%>
      <!-----------------  left menu 끝 ------------------>
	</td>
	<td background="/images/user/game/aboutus/type1/conbg.gif"  align="center">
		<img src="/images/user/game/aboutus/<%=tem_subimgpath%>/<%=tem_subtopimg1%>"><br>
