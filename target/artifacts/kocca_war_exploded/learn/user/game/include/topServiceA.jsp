...
<tr valign="top">
<td background="/images/user/game/service/<%=tem_subimgpath%>/<%=tem_subbg8%>" bgcolor="#f6f6f6">
	...
	<td align="right" >
      <!-----------------  left menu 시작 ----------------->
      <%@ include file="/learn/user/game/include/leftmenuServiceA.jsp"%>
      <!-----------------  left menu 끝 ------------------>
	</td>
	<td background="/images/user/game/service/type1/conbg.gif"  align="center">
		<img src="/images/user/game/service/<%=tem_subimgpath%>/<%=tem_subtopimg8%>"><br>
