...
<BODY background="/images/user/game/apply/<%=tem_subimgpath%>/<%=tem_subbg2%>" <%=onLoad%>>
      ...
      <table width="1000" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="216" valign="top">
            <!-----------------  left menu 시작 ----------------->
            <%@ include file="/learn/user/game/include/leftmenuApplyB.jsp"%>
            <!-----------------  left menu 끝 ------------------>
          </td>
          <td width="784" valign="top" background="/images/user/game/apply/type2/conbg.gif">
          <table width="784" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td  valign="top" class="submargin">
                  <table width="720" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td><img src="/images/user/game/apply/<%=tem_subimgpath%>/<%=tem_subtopimg2%>"></td>
                    </tr>
                  </table>
