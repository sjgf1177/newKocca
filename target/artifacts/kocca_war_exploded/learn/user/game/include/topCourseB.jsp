...
<BODY background="/images/user/game/course/<%=tem_subimgpath%>/<%=tem_subbg1%>" <%=onLoad%>>
      ...
      <table width="1000" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="216" valign="top">
            <!-----------------  left menu 시작 ----------------->
            <%@ include file="/learn/user/game/include/leftmenuCourseB.jsp"%>
            <!-----------------  left menu 끝 ------------------>
          </td>
          <td width="784" valign="top" background="/images/user/game/course/type2/conbg.gif">
          <table width="784" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td  valign="top" class="submargin">
                  <table width="720" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td><img src="/images/user/game/course/<%=tem_subimgpath%>/<%=tem_subtopimg1%>"></td>
                    </tr>
                  </table>
