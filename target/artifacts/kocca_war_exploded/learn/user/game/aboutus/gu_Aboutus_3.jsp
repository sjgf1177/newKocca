...
<!------- 상단 로고,메뉴,유저정보 파일 끝  ------------->
                  ...
                  <table width="720" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="35" width="720" align="right"  background="/images/user/game/aboutus/<%=tem_subimgpath%>/tit_03.gif" class="location"><img src="/images/user/game/common/location_bl.gif"> HOME > aboutus > 원장인사말</td>
                    </tr>
                    <tr>
                      <td height="20">&nbsp;</td>
                    </tr>
