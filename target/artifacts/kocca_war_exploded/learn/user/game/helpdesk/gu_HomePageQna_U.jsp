...
<table width="720" border="2" cellspacing="0" 
  ...
  <tr> 
    ...
    <td colspan="5" class="tbl_bleft">
        <input name="p_title" type="text" class="input" size="70" value="<%=v_title%>">
    </td>
  </tr>
  <tr> 
  ...
  <tr> 
    ...
    <td align="right" valign="bottom"><table width="208" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td><a href="javascript:selectList();"><img src="/images/user/game/button/btn_cancel.gif" border="0"></td>
        </tr>
      </table></td>
  </tr>
  <tr> 
