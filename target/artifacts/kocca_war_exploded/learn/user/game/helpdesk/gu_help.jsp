...
<table width="720" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td valign="top" class="font_ex">동영상 재생시 문제가 있으시다면, 현재 사용 중인 인터넷 회선의 연결속도를 
      확인해 주세요.<br>
  ...
  <tr> 
    <td valign="top"><table width="720" border="2" cellspacing="0" 
        ...
        <tr> 
          ...
          <td width="550" align="center" bgcolor="#E7F7FE"><strong>최소 인터넷 회선속도</strong></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td height="26" class="tbl_dbtit1">Game Academy동영상</td>
          <td height="26" align="center" >최소 500 Kbps ~ 700 Kbps</td>
        </tr>
      </table></td>
  </tr>
  <tr> 
    ...
    <td valign="top" style="PADDING-LEFT: 35px"><SPAN id=menu1 
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="95%" 
        ...
        <TBODY>
          ...
          <TR> 
            <TD height=38>3. [품질테스트]를 선택하시면 별도의 프로그램을 설치하게 되는데, → 이때 <font color="#ff5400">설치</font>를 
              선택하여 주세요. <br>
          ...
          <TR> 
            <TD height=38>4. 현재 접속상태의 종류, 현재 위치입력 란의 서비스 종류, 위치등의 옵션을 선택하시고, <BR>
              측정자 이름과 전자우편을 모두 기입하신 후 <FONT color=#ff5400>Test Start</FONT> 버튼을 
              클릭합니다. </TD>
          </TR>
          <TR> 
    ...
    <td style="PADDING-LEFT: 12px"><span id=menu2 
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="95%" 
        ...
        <TBODY>
          ...
          <TR> 
            <TD height=60>- 왕복지연율 : 10ms 이하 정상, 20ms ~ 30ms 이상 훨씬 크게 초과될 경우가 지속적으로 
              발생한다면 인터넷 회선업체에 문의해 주시기 바랍니다 <BR>
              - 손실율 : 0.00% 정상, 손실율이 지속적으로 발생할 경우 인터넷 회선업체에 문의해 주시기 바랍니다. </TD>
          </TR>
          <TR> 
            <TD>&nbsp;</TD>
          </TR>
          <TR> 
            <TD height=60>3. Bandwidth Gaugea에서 인터넷 <FONT 
              ...
              속도를 비교합니다.<BR>
              사용자 측정값이 인터넷 회선업체 평균값의 70~80% 미만일 경우에는 인터넷 회선업체에 문의 바랍니다.</TD>
          </TR>
          <TR> 
