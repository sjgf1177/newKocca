...
<img src="/images/user/game/course/grp_btn_0402.gif">
			...
			<table border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td background="/images/user/game/course/bg.gif" height="100%">
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="240" valign="top" style="padding-left:10;padding-top:0"><img src="/images/user/game/course/grp_title04.gif"></td>
								<td width="388">
								<!--리스트-->
									<table border="0" cellpadding="0" cellspacing="0" width="388">
										...
										<tr height="24">
											<td style="padding-left:10px"><img src="/images/user/game/course/num_10.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('004302','게임캐릭터디자인2(new)','ON','G01','게임아카데미')">게임캐릭터디자인2(new)</a></td>
										...
										<tr height="24">
											<td style="padding-left:10px"><img src="/images/user/game/course/num_11.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('000097','3D 모션캡쳐와 응용','ON','G01','게임아카데미')">3D 모션캡쳐와 응용</a></td>
											<td width="168px"><img src="/images/user/game/course/common_icon02.gif" align="absmiddle"></td>
										</tr>
										<tr>
											<td colspan="2"><img src="/images/user/game/course/point_bg.gif"></td>
										...
										<tr height="24">
											<td style="padding-left:10px"><img src="/images/user/game/course/num_12.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('000096','컨셉디자인2','ON','G01','게임아카데미')">컨셉디자인2</a></td>
											<td width="168px"><img src="/images/user/game/course/common_icon02.gif" align="absmiddle"></td>
										</tr>
										<tr>
											<td colspan="2"><img src="/images/user/game/course/point_bg.gif"></td>
										...
										<tr height="24">
											<td style="padding-left:10px"><img src="/images/user/game/course/num_13.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('004201','게임캐릭터디자인1(new)','ON','G01','게임아카데미')">게임캐릭터디자인1(new)</a></td>
											<td width="168px"><img src="/images/user/game/course/common_icon02.gif" align="absmiddle"></td>
										</tr>
										<tr>
											<td colspan="2"><img src="/images/user/game/course/point_bg.gif"></td>
										...
										<tr height="24">
											<td style="padding-left:10px"><img src="/images/user/game/course/num_14.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('000065','게임아키텍처의 이해1','ON','G01','게임아카데미')">게임아키텍처의 이해1</a></td>
											<td width="168px"><img src="/images/user/game/course/common_icon02.gif" align="absmiddle"></td>
										</tr>
										<tr>
											<td colspan="2"><img src="/images/user/game/course/point_bg.gif"></td>
