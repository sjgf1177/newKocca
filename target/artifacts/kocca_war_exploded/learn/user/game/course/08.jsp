...
<img src="/images/user/game/course/dgn_btn_0302.gif">
			...
			<table border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td background="/images/user/game/course/bg.gif" height="100%">
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="240" valign="top" style="padding-left:10;padding-top:0"><img src="/images/user/game/course/dgn_title03.gif"></td>
								<td width="388">
								<!--리스트-->
									<table border="0" cellpadding="0" cellspacing="0" width="388">
										...
										<tr height="24">
											<td style="padding-left:30px"><img src="/images/user/game/course/num_01.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('003103','기획자가 알아야 할 2D 게임그래픽(new)','ON','G01','게임아카데미')">기획자가 알아야 할 2D 게임그래픽</a></td>
											<td></td>
										</tr>
										<tr>
											<td align="right" colspan="2"><img src="/images/user/game/course/point_bg01.gif"></td>
										...
										<tr height="24">
											<td style="padding-left:30px"><img src="/images/user/game/course/num_02.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('003207','기획자가 알아야 할 3D 게임그래픽(new)','ON','G01','게임아카데미')">기획자가 알아야 할 3D 게임그래픽</a></td>
											<td></td>
										</tr>
										<tr>
											<td align="right" colspan="2"><img src="/images/user/game/course/point_bg01.gif"></td>
										...
										<tr height="24">
											<td style="padding-left:30px"><img src="/images/user/game/course/num_01.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('003205','스토리보드(new)','ON','G01','게임아카데미')">스토리보드</a></td>
											<td></td>
										</tr>
										<tr>
											<td align="right" colspan="2"><img src="/images/user/game/course/point_bg01.gif"></td>
										...
										<tr height="24">
											<td style="padding-left:30px"><img src="/images/user/game/course/num_03.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('000067','영상 제작론','ON','G01','게임아카데미')">영상 제작론</a></td>
											<td></td>
										</tr>
										<tr>
											<td align="right" colspan="2"><img src="/images/user/game/course/point_bg01.gif"></td>
										...
										<!--3-->
										<tr height="30" style="padding-top:20px;padding-bottom:5px">
											<td colspan="2"><img src="/images/user/game/course/common_icon03.gif" align="absmiddle"> <b>게임기획자를 위한 게임마케팅</b></td>
										</tr>
										<tr height="24">
											<td style="padding-left:30px"><img src="/images/user/game/course/num_01.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('003100','게임구매자행동론','ON','G01','게임아카데미')">게임구매자행동론</a></td>
											<td></td>
										</tr>
										<tr>
											<td align="right" colspan="2"><img src="/images/user/game/course/point_bg01.gif"></td>
										...
										<tr height="24">
											<td style="padding-left:30px"><img src="/images/user/game/course/num_02.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('000051','게임마케팅연구','ON','G01','게임아카데미')">게임마케팅연구</a></td>
											<td></td>
										</tr>
										<tr>
											<td align="right" colspan="2"><img src="/images/user/game/course/point_bg01.gif"></td>
