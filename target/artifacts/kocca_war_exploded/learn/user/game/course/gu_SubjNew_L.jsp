...
<!--
 function whenSelect(){
     ...
     document.form1.p_process.value = 'SubjNewList';
...
function whenSubjInfo(subj,isonoff){
    ...
    document.form1.p_rprocess.value = 'SubjNewList';
...
<table width="720" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="35" align="right"  background="/images/user/game/course/<%=tem_subimgpath%>/tit_newedu.gif" class="location" ><img src="/images/user/game/common/location_bl.gif"> HOME > 과정안내 > 신규과정</td>
  </tr>	
  <tr> 
    <td height="20"></td>
  </tr>
...
%>
  <tr> 
    ...
    <td class="tbl_grc"><a href="javascript:whenSubjInfo('<%=v_subj%>','<%=v_isonoff%>')"><img src="/images/user/game/button/btn_into_view.gif" width="67" height="19"></a></td>
  </tr>
<%
        }
