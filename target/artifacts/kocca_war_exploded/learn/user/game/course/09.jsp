...
<img src="/images/user/game/course/dgn_btn_0402.gif">
</td>
  </tr>
</table>
<!-- 1 -->
			...
			<table border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td background="/images/user/game/course/bg.gif" height="100%">
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="240" valign="top" style="padding-left:10;padding-top:0"><img src="/images/user/game/course/dgn_title04.gif"></td>
								<td width="388">
								<!--리스트-->
									<table border="0" cellpadding="0" cellspacing="0" width="388">
										...
										<!--2-->
										<tr height="30" style="padding-top:20px;padding-bottom:5px">
											<td><img src="/images/user/game/course/common_icon03.gif" align="absmiddle"> <b>게임운영</b></td>
										</tr>
										<tr height="24">
											<td style="padding-left:30px" colspan="2"><img src="/images/user/game/course/num_01.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('003202','게임 QA를 위한 테스팅 이론 및 실무','ON','G01','게임아카데미')">게임 QA를 위한 테스팅 이론 및 실무</a></td>
										</tr>
										<tr>
											<td align="right" colspan="2"><img src="/images/user/game/course/point_bg01.gif"></td>
										</tr>
										<tr height="24">
											<td style="padding-left:30px"><img src="/images/user/game/course/num_02.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('000106');">온라인 게임운영과 고객서비스</a></td>
											<td></td>
										</tr>
										<tr>
											<td align="right" colspan="2"><img src="/images/user/game/course/point_bg01.gif"></td>
