...
<img src="/images/user/game/course/pgm_btn_0302.gif" border="0"></a>
			...
			<table border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td background="/images/user/game/course/bg.gif" height="100%">
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="240" valign="top" style="padding-left:10;padding-top:0"><img src="/images/user/game/course/pgm_title03.gif"></td>
								<td width="388">
								<!--리스트-->
									<table border="0" cellpadding="0" cellspacing="0" width="388">
										...
										<tr height="24">
											<td style="padding-left:10px"><img src="/images/user/game/course/num_06.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('002210','DirectX1(new)','ON','G01','게임아카데미')">DirectX1(new)</a></td>
											<td></td>
										</tr>
										<tr>
											<td colspan="2"><img src="/images/user/game/course/point_bg.gif"></td>
										...
										<tr height="24">
											<td style="padding-left:10px"><img src="/images/user/game/course/num_07.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('002205','DirectX2(new)','ON','G01','게임아카데미')">DirectX2(new)</a></td>
											<td></td>
										</tr>
										<tr>
											<td colspan="2"><img src="/images/user/game/course/point_bg.gif"></td>
										...
										<tr height="24">
											<td style="padding-left:10px"><img src="/images/user/game/course/num_08.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('000049','객체지향 프로그래밍2','ON','G01','게임아카데미')">객체지향프로그래밍2</a></td>
											<td></td>
										</tr>
										<tr>
											<td colspan="2"><img src="/images/user/game/course/point_bg.gif"></td>
										...
										<tr height="24">
											<td style="padding-left:10px"><img src="/images/user/game/course/num_09.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('002212','게임수학(new)','ON','G01','게임아카데미')">게임수학(new)</a></td>
											<td></td>
										</tr>
										<tr>
											<td colspan="2"><img src="/images/user/game/course/point_bg.gif"></td>
										...
										<tr height="24">
											<td style="padding-left:10px"><img src="/images/user/game/course/num_10.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('002206','3D프로그래밍1(new)','ON','G01','게임아카데미')">3D프로그래밍1(new)</a></td>
											<td></td>
										</tr>
										<tr>
											<td colspan="2"><img src="/images/user/game/course/point_bg.gif"></td>
										...
										<tr height="24">
											<td style="padding-left:10px"><img src="/images/user/game/course/num_11.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('000090','3D 프로그래밍2','ON','G01','게임아카데미')">3D 프로그래밍 2 </a></td>
											<td></td>
										</tr>
										<tr>
											<td colspan="2"><img src="/images/user/game/course/point_bg.gif"></td>
										...
										<tr height="24">
											<td style="padding-left:10px"><img src="/images/user/game/course/num_12.gif" align="absmiddle"> &nbsp; <a href="cursor:hand" onClick="javascript:whenSubjInfo('001006','3D Data Exporting Techniques','ON','G01','게임아카데미')">3D Data Exporting Techniques</a></td>
											<td></td>
										</tr>
										<tr>
											<td colspan="2"><img src="/images/user/game/course/point_bg.gif"></td>
										...
										<tr height="24">
											<td style="padding-left:10px"><img src="/images/user/game/course/num_13.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('002207','게임툴프로그래밍1(new)','ON','G01','게임아카데미')">게임 툴 프로그래밍</a></td>
											<td></td>
										</tr>
										<tr>
											<td colspan="2"><img src="/images/user/game/course/point_bg.gif"></td>
										...
										<tr height="24">
											<td style="padding-left:10px"><img src="/images/user/game/course/num_14.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('002302','게임툴프로그래밍 설계방법론(new)','ON','G01','게임아카데미')">게임툴프로그래밍 설계방법론</a></td>
											<td></td>
										</tr>
										<tr>
											<td colspan="2"><img src="/images/user/game/course/point_bg.gif"></td>
										...
										<tr height="24">
											<td style="padding-left:10px"><img src="/images/user/game/course/num_15.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('000045','컴파일러','ON','G01','게임아카데미')">컴파일러</a></td>
											<td width="168px"><img src="/images/user/game/course/common_icon.gif" align="absmiddle"></td>
										</tr>
										<tr>
											<td colspan="2"><img src="/images/user/game/course/point_bg.gif"></td>
										...
										<tr height="24">
											<td style="padding-left:10px"><img src="/images/user/game/course/num_16.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('001005','스크립트 언어','ON','G01','게임아카데미')">스크립트 언어</a></td>
											<td width="168px"><img src="/images/user/game/course/common_icon.gif" align="absmiddle"></td>
										</tr>
										<tr>
											<td colspan="2"><img src="/images/user/game/course/point_bg.gif"></td>
										...
										<tr height="24">
											<td style="padding-left:10px"><img src="/images/user/game/course/num_17.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('000063','인공지능','ON','G01','게임아카데미')">인공지능</a></td>
											<td width="168px"><img src="/images/user/game/course/common_icon.gif" align="absmiddle"></td>
										</tr>
										<tr>
											<td colspan="2"><img src="/images/user/game/course/point_bg.gif"></td>
