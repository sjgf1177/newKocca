...
<td>
	...
	<col width="1"><col width="999"><col width=""><!--070703-->
	<tr>
...
<tr valign="top">
<td background="/images/user/game/apply/<%=tem_subimgpath%>/<%=tem_subbg2%>" bgcolor="#f6f6f6">
	...
	<td align="right">
      <!-----------------  left menu 시작 ----------------->
      <%@ include file="/learn/user/game/include/leftmenuApplyA.jsp"%>
      <!-----------------  left menu 끝 ------------------>
	</td>
	<td background="/images/user/game/apply/type1/conbg.gif"  align="center">
		<img src="/images/user/game/apply/<%=tem_subimgpath%>/<%=tem_subtopimg2%>"><br>
