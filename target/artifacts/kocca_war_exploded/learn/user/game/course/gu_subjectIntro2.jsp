							...
							<tr>
								...
								<!--리스트-->
									<table border="0" cellpadding="0" cellspacing="0" width="388">
										...
										<tr height="24">
											<td style="padding-left:30px"><img src="/images/user/game/course/num_03.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('000095','게임아키텍처의 이해2','ON','G01','게임아카데미')">게임인공지능연구</a></td>
											<td></td>
										</tr>
										<tr>
											<td align="right" colspan="2"><img src="/images/user/game/course/point_bg01.gif"></td>
