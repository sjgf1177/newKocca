...
<table width="720" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr style="padding-top:15px;padding-right:25px"> 
    <td align="right">
    <img src="/images/user/game/course/grp_btn_0102.gif">
...
<a href="/learn/user/game/course/17.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image108','','/images/user/game/course/grp_btn_0802.gif',1)"><img src="/images/user/game/course/grp_btn_0801.gif" name="Image108" border="0"></a>
			...
			<table border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td background="/images/user/game/course/bg.gif" height="100%">
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="240" valign="top" style="padding-left:10;padding-top:0"><img src="/images/user/game/course/grp_title01.gif"></td>
								<td width="388">
								<!--리스트-->
									<table border="0" cellpadding="0" cellspacing="0" width="388">
										...
										<tr height="24">
											<td style="padding-left:10px"><img src="/images/user/game/course/num_10.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('000030','배경디자인1','ON','G01','게임아카데미')">배경디자인1</a></td>
											<td width="168px"><img src="/images/user/game/course/common_icon02.gif" align="absmiddle"></td>
										</tr>
										<tr>
											<td colspan="2"><img src="/images/user/game/course/point_bg.gif"></td>
										</tr>
										<tr height="24">
											<td style="padding-left:10px"><img src="/images/user/game/course/num_11.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('000056','배경디자인2','ON','G01','게임아카데미')">배경디자인2</a></td>
											<td width="168px"><img src="/images/user/game/course/common_icon02.gif" align="absmiddle"></td>
										</tr>
										<tr>
											<td colspan="2"><img src="/images/user/game/course/point_bg.gif"></td>
										...
										<tr height="24">
											<td style="padding-left:10px"><img src="/images/user/game/course/num_12.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('004302','게임캐릭터디자인2(new)','ON','G01','게임아카데미')">게임캐릭터디자인2(new)</a></td>
											<td width="168px"><img src="/images/user/game/course/common_icon02.gif" align="absmiddle"></td>
										</tr>
										<tr>
											<td colspan="2"><img src="/images/user/game/course/point_bg.gif"></td>
										...
										<tr height="24">
											<td style="padding-left:10px"><img src="/images/user/game/course/num_13.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('000107','디자인 매니지먼트','ON','G01','게임아카데미')">디자인 매니지먼트</a></td>
											<td width="168px"><img src="/images/user/game/course/common_icon02.gif" align="absmiddle"></td>
										</tr>
										<tr>
											<td colspan="2"><img src="/images/user/game/course/point_bg.gif"></td>
										...
										<tr height="24">
											<td style="padding-left:10px"><img src="/images/user/game/course/num_14.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('004202','디지털 드로잉2(new)','ON','G01','게임아카데미')"">디지털 드로잉2(new)</a></td>
											<td width="168px"><img src="/images/user/game/course/common_icon02.gif" align="absmiddle"></td>
										</tr>
										<tr>
											<td colspan="2"><img src="/images/user/game/course/point_bg.gif"></td>
										...
										<tr height="24">
											<td style="padding-left:10px"><img src="/images/user/game/course/num_15.gif" align="absmiddle"> &nbsp; <a href="javascript:whenSubjInfo('000096','컨셉디자인2','ON','G01','게임아카데미')">컨셉디자인2</a></td>
											<td width="168px"><img src="/images/user/game/course/common_icon02.gif" align="absmiddle"></td>
										</tr>
										<tr>
											<td colspan="2"><img src="/images/user/game/course/point_bg.gif"></td>
