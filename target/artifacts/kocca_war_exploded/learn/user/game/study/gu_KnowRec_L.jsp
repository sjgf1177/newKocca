...
//**********************************************************
//  1. 제      목: 지식공유 인기지식
//  2. 프로그램명 : gu_KnowRec_L.jsp
//  3. 개      요: 지식공유 인기지식 - 최다추천
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
//  6. 작      성: 이나연 06.01.05
//  7. 수      정:
...
//-->
          ...
          <input type="hidden" name="p_gubun"      value = "2">
...
<table width="720" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="1">&nbsp;</td>
    <td width="104">
        <a href="javascript:MoveList('PopListPage');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image31','','/images/user/game/mystudy/tab_qu01_on.gif',1)"><img src="/images/user/game/mystudy/tab_qu01.gif" name="Image31" border="0"></a></td>
    <td width="104">
        <img src="/images/user/game/mystudy/tab_qu02_on.gif"></td>
    <td width="104">
        <a href="javascript:MoveList('ComListPage');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image30','','/images/user/game/mystudy/tab_qu03_on.gif',1)"><img src="/images/user/game/mystudy/tab_qu03.gif" name="Image30" border="0"></a></td>
    <td width="178"></td>
    <td width="91"><img src="/images/user/game/mystudy/text_catagory_01.gif"></td>
    <td width="138" align="center">
        <select name="p_cateSelect" onchange="cateSelectList(2);">
...
<table width="720" border="0" cellspacing="0" cellpadding="0">
  ...
  %>
    ...
    <td width="525" class="tbl_gleft05">[최다추천지식] <%=dbox.getString("d_title")%></td>
        <td width="80"><div align="right">
            <a href="javascript:select('<%=dbox.getInt("d_seq")%>','<%=dbox.getInt("d_filecnt")%>','<%=dbox.getString("d_inuserid")%>','<%=dbox.getString("d_types")%>')">
            <img src="/images/user/game/button/btn_moreview.gif"></a>
        </div></td>
    </tr>
    <tr>
...
<%}else{%>
  ...
  <tr>
    <td colspan="13" align=center valign=top>등록 된 질문이 없습니다.</td>
  </tr>
<%}%>
</table>
