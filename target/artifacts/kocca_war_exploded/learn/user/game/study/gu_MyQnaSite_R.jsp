<%
//**********************************************************
//  1. 제      목: 나의질문방 - 사이트관련 상세보기
//  2. 프로그램명 : gu_MyQnaSite_R.jsp
//  3. 개      요: 나의질문방
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
//  6. 작      성: 이나연 05.12.26
...
<%
    ...
    DataBox dbox        = (DataBox)request.getAttribute("MyQnaSiteViewPage");
	...
	if( dbox != null){
		...
		v_filecount			= v_realfileVector.size();
		System.out.println("jsp v_filecount : "+v_filecount);
	}
...
<table width="720" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr> 
    <td width="101"><a href="/servlet/controller.study.MyQnaServlet?p_process=MyQnaStudyListPage" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image37','','/images/user/game/mystudy/tab_quest02_on.gif',1)"><img src="/images/user/game/mystudy/tab_quest02.gif" name="Image37"></td>
	<td width="3"></td> 
	<td width="101"><img src="/images/user/game/mystudy/tab_quest01_on.gif"></td>
    <td width="515"></td>
  </tr>
  <tr> 
...
<table width="720" border="2" cellspacing="0" 
   ...
   <tr> 
    <td width="79" class="tbl_grc"><img src="/images/user/game/mystudy/text_t_subject02.gif"></td>
    <td width="1"valign="bottom"><img src="/images/user/game/mystudy/vline.gif"></td>
    <td width="298" bgcolor="F8F7EF" class="tbl_bleft"><%=v_title%></td>
    <td width="1" valign="bottom"><img src="/images/user/game/mystudy/vline.gif"></td>
    <td width="82" class="tbl_grc"><img src="/images/user/game/mystudy/text_number.gif"></td>
    <td width="1" valign="bottom" ><img src="/images/user/game/mystudy/vline.gif"></td>
    <td width="260" class="tbl_grc"><%=v_cnt%></td>
  </tr>
  <tr> 
  ...
  <tr> 
    ...
    <td colspan="5" class="tbl_gleft">
		...
		%>
			<tr bgcolor="#F5F8EF"><td><a href ='/servlet/controller.library.DownloadServlet?p_savefile=<%=v_savefile%>&p_realfile=<%=v_realfile%>'> 
				<%=v_realfile%></a>&nbsp;</td>
			<input type = "hidden" name = "p_savefile"  value = <%=v_savefile%>> 
		<%			}else{%>
			 <tr bgcolor="#F5F8EF"><td>첨부된 파일이 없습니다 <td>
		<%			}
				}
			}
		%> 			
...
<table width="720" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr> 
    ...
    <td align="right" valign="bottom"><a href="/servlet/controller.study.MyQnaServlet?p_process=MyQnaSiteListPage"><img src="/images/user/game/button/btn_list.gif" border="0"></a></td>
  </tr>   
  <tr> 
    <td height="5" colspan="2" ></td>
  </tr><tr> 
