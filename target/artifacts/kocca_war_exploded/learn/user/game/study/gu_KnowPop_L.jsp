...
//**********************************************************
//  1. 제      목: 지식공유 인기지식
//  2. 프로그램명 : gu_KnowPop_L.jsp
//  3. 개      요: 지식공유 인기지식 - 최다조회 리스트
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
//  6. 작      성: 이나연 06.01.03
//  7. 수      정:
...
<%
    ...
    String  v_listgubun      = box.getString("p_listgubun");
...
<table width="720" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="1">&nbsp;</td>
    <td width="104">
        <img src="/images/user/game/mystudy/tab_qu01_on.gif" name="Image28" border="0">
    </td>
    <td width="104">
        <a href="javascript:MoveList('RecListPage');" onMouseOut="MM_swapImgRestore()" onMouseOver= "MM_swapImage('Image29', '', '/images/user/game/mystudy/tab_qu02_on.gif',1)"><img src="/images/user/game/mystudy/tab_qu02.gif" name="Image29" border="0"></a>
    </td>
    <td width="104">
        <a href="javascript:MoveList('ComListPage');" onMouseOut="MM_swapImgRestore()" onMouseOver= "MM_swapImage('Image30', '', '/images/user/game/mystudy/tab_qu03_on.gif',1)"><img src="/images/user/game/mystudy/tab_qu03.gif" name="Image30" border="0"></a>
    </td>
    <td width="178"></td>
    <td width="91">
        <img src="/images/user/game/mystudy/text_catagory_01.gif">
    </td>
    <td width="138" align="center">
        <select name="p_cateSelect" onchange="cateSelectList(1);">
...
<table width="720" border="0" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td width="525" class="tbl_gleft05">[최다조회지식] <%=dbox.getString("d_title")%></td>
        <td width="80"><div align="right"><a href="javascript:select('<%=dbox.getInt("d_seq")%>', '<%=dbox.getInt("d_filecnt")%>', '<%=dbox.getString("d_inuserid")%>', '<%=dbox.getString("d_types")%>')"><img src="/images/user/game/button/btn_moreview.gif"></a></div></td>
    </tr>
    <tr>
...
<%}else{%>
  ...
  <tr>
    <td colspan="13" align=center valign=top>등록된 내용이 없습니다.</td>
  </tr>
<%}%>
