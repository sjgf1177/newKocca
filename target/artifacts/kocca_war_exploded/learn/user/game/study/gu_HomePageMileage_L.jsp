...
<script>
	...
	{
		document.form1.action = "/servlet/controller.homepage.KHomePageMileageServlet?p_process=mileageList";
...
<table width="720" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
	...
	<table width="511" border="0" cellpadding="0" cellspacing="0" bgcolor="E0EBE4">
        ...
        <tr> 
          <td colspan="2" valign="bottom"><img src="/images/user/game/mystudy/mile_boxbo.gif" border="0"></td>
        </tr>
      </table></td>
  </tr>
	<tr>
		<td colspan="2" align="right"><a href="javascript:mileageList()"><img src="/images/user/game/button/btn_list.gif"></a></td>
	</tr>
  <tr> 
...
<!--img src="/images/user/game/mystudy/mile_guide.jpg" width="720" height="174"-->
