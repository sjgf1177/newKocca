...
<%
    ...
    ArrayList blist2 = (ArrayList)request.getAttribute("MyQnaSiteListPage");  // 학습관련
...
<table width="720" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr> 
    <td width="101" onClick="showTab();" style="cursor:hand;" ><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image37','','/images/user/game/mystudy/tab_quest02_on.gif',1)" ><img src="/images/user/game/mystudy/tab_quest02.gif" name="Image37"></td>
	<td width="3"></td> 
    ...
    <td width="712" align="center" valign="bottom" background="/images/user/game/mystudy/ba_bg02.gif"> 
      <table width="710" height="23" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td width="112" align="center"  ><img src="/images/user/game/mystudy/text_t_bun.gif"></td>
          <td width="1" valign="bottom" ><img src="/images/user/game/mystudy/vline.gif"></td>
          <td width="295" align="center" ><img src="/images/user/game/mystudy/text_t_subject.gif"></td>
          <td width="1" valign="bottom"  ><img src="/images/user/game/mystudy/vline.gif"></td>
          <td width="82" align="center"  ><img src="/images/user/game/mystudy/text_write_day.gif"></td>
          <td width="1" valign="bottom" ><img src="/images/user/game/mystudy/vline.gif"></td>
          <td width="48" align="center"  ><img src="/images/user/game/mystudy/text_add_file.gif"></td>
          <td width="1" valign="bottom"  ><img src="/images/user/game/mystudy/vline.gif"></td>
          <td width="46" align="center"  ><img src="/images/user/game/mystudy/text_number.gif"></td>
        </tr>
      </table></td>
...
%>      
  <tr> 
    ...
    <td width="112" class="tbl_grc"><%=dbox.getString("d_codenm")%></td>
    <td width="294" class="tbl_bleft">
...
<table width="720" border="0" cellspacing="0" cellpadding="0" align="center" align="center">
  ...
  <tr> 
    ...
    <td width="105"> <div align="left">
        <input name = "p_searchtext" type="text" class="input2" size="15" maxlength="30"  value = "" onkeypress="press_enter(event)">
      </div></td>
