...
<form name = "form1" enctype = "multipart/form-data" method = "post">
    ...
    <table width="720" border="0" cellspacing="0" cellpadding="0">
      <tr> 
        <td width="720" height="35" align="right"  background="/images/user/game/service/<%=tem_subimgpath%>/tit_tomaster.gif" class="location" ><img src="/images/user/game/common/location_bl.gif"> 
          HOME > 서비스 > 운영자에게</td>
      </tr>
      <tr> 
        <td height="20">
    ...
    <table width="720" border="0" cellspacing="0" cellpadding="0">
      <tr> 
        <td valign="top"><img src="/images/user/game/service/text_tomaster.gif"></td>
      </tr>
      <tr> 
        <td>&nbsp;</td>
      </tr>
    ...
    <table width="720" border="2" cellspacing="0" 
      ...
      <tr> 
        <td class="tbl_grc"><img src="/images/user/game/service/text_subject02.gif" width="37" height="11"></td>
        <td width="7" valign="bottom" ><img src="/images/user/game/service/vline.gif"></td>
        <td class="font_specialroom_list"><input name="p_title" type="text" class="input" style="width:300px" value=""></td>
      </tr>
      <tr> 
        <td class="tbl_grc"><img src="/images/user/game/service/text_writer02.gif" width="37" height="11"></td>
    ...
    <table width="720" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr> 
        ...
        <td align="right" valign="bottom"><a href="javascript:insert()"><img src="/images/user/game/button/btn_confirm.gif" border="0"></a>&nbsp;<a href="javascript:cancel()"><img src="/images/user/game/button/btn_cansle_01.gif" border="0"></a></td>
      </tr>
      <tr> 
        <td height="5" colspan="2" ></td>
      </tr>
