...
<table width="720" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td width="720" height="35" align="right"  background="/images/user/game/service/<%=tem_subimgpath%>/tit_notice.gif" class="location" ><img src="/images/user/game/common/location_bl.gif">
      HOME > 서비스 > 공지사항</td>
  </tr>
  <tr>
    <td height="20">
...
<table width="720" border="2" cellspacing="0"
  ...
  <tr>
    ...
    <td name="p_adtitle" colspan="10" class="font_specialroom_list"><%=v_adtitle%></td>
  </tr>
  <tr>
...
<%	if( v_userid == null || v_userid ==""){ %>
	<a href="/servlet/controller.homepage.HomeNoticeServlet?p_process=moreNotice"><img src="/images/user/game/button/btn_list.gif" border="0"></a></td>
<%}else{%>
