...
<form name="frmbook" method="post">
    ...
    <input type = "hidden" name="p_bookcode"   value = "">
          ...
          <table cellpadding="0" cellspacing="0" width="190">
            ...
            <tr><td background="/images/user/game/homepage/type1/textbook_mid.gif" align="center"><a href="javascript:menuForward('6', '01', '1')"><img src="/images/user/game/homepage/type1/tit_textbook.gif" border="0"></a></td></tr>            
            <tr valign="top">
