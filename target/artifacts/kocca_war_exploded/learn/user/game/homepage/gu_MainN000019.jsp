...
<%
    ...
    String v_tem_url = "/learn/user/game/include/topMainN000019.jsp";
...
<%	//if(v_tem_url.equals("")) {	%>
<%@ include file="/learn/user/game/include/topMainN000019.jsp"%>
<!------- 글로벌메뉴, 상단 로고,메뉴 끝  ------------->
...
<table border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td><img src="/images/user/game/homepage/type1/N000017_banner_top.gif"></td>
	</tr>
	<tr>
		<td><a href="http://www.kepad.or.kr/" target="_blank"><img src="/images/user/game/homepage/type1/N000017_banner_01.gif" border="0"></a></td>
	</tr>
	<tr>
		<td><a href="http://digital.kepad.or.kr/" target="_blank"><img src="/images/user/game/homepage/type1/N000017_banner_02.gif" border="0"></a></td>
	</tr>
	<tr>
		<td><a href="http://www.worktogether.or.kr/" target="_blank"><img src="/images/user/game/homepage/type1/N000017_banner_03.gif" border="0"></a></td>
	</tr>
	<tr>
		<td height=200>&nbsp;</td>
	</tr>
