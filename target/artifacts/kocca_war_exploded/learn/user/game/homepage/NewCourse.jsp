...
<%
    ...
    ArrayList list = bean.selectSubjTopNewList(box);
%>
...
<!--            <table cellpadding="0" cellspacing="0" width="256" style="table-layout:fixed;" border="0">
            <col width="121"><col width="107"><col width="28">
              <tr height="28"><td colspan="3"><a href="javascript:menuForward('1', '07', '7')"><img src="/images/user/game/homepage/type1/tit_new.gif" border="0"></a></td></tr>
<%!
