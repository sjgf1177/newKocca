<%
/**
 * file name : za_ETestUserPaperResult.jsp
 * date      : 2003/09/07
 * programmer:
...
<table cellspacing="0" cellpadding="0" class="open_table_out" align="center">
  <tr>                 
      <td background="/images/user/research/b_title_dot.gif"><img src="/images/user/study/controller_exam_title1.gif" alt="개인변 평가결과 조회" width="240" height="37" border="0"></td>
  </tr>
...
<table cellspacing="0" cellpadding="0" class="open_board_table_out1" align="center">
  <tr>                
    <td align="right"><a href="javascript:ETestClose()"><img src="/images/user/study/close_butt.gif" alt="닫기" border="0"></td>
  </tr>
</table>
<!----------------- 닫기 버튼 끝 ----------------->
<br>
