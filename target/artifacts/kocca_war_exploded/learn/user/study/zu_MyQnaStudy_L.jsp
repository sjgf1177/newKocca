              ...
              <tr> 
                <td align="center" valign="top"> 
                  ...
                  <table width="675" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td width="98" valign="top"><img src="/images/user/myclass/tab_study_on.gif" alt="학습관련">
                      </td>
                      <td width="98" valign="top" style="cursor:hand;" onClick="showTab();" >
                      <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image37','','/images/user/myclass/tab_site_on.gif',1)"><img src="/images/user/myclass/tab_site.gif" alt="사이트관련" name="Image37" border="0"></a>
                      </td>
                  ...
                  <table width="675" border="0" cellspacing="0" cellpadding="0">
                    <tr align="top"> 
                      ...
                      <table width="675" border="0" cellpadding="0" cellspacing="0" background="/images/user/myclass/class_tb_bg.gif">
                          <tr> 
                            <td width="8"><img src="/images/user/myclass/class_tb_head.gif"></td>
                            <td width="39" align="center" valign="bottom"><img src="/images/user/myclass/class_tb_num.gif"></td>
                            <td width="100" align="center" valign="bottom"><img src="/images/user/myclass/class_tb_class.gif" ></td>
                            <td width="100" align="center" valign="bottom"><img src="/images/user/myclass/class_tb_eduday.gif"></td>                           
...
%>                    
                    <tr> 
                      ...
                      <%=FormatDate.getFormatDate(v_edustart, "yyyy/MM/dd")%>~<br><%=FormatDate.getFormatDate(v_eduend, "yyyy/MM/dd")%></td>                      
...
%>
          ...
          <td width="260">&nbsp; <A HREF="javascript:selectList()"><IMG src="/images/user/button/btn_search.gif" alt="검색" border="0"></A> 
          </td>
                    </tr>
                    <tr> 
                      <td height="5" colspan="4"></td>
