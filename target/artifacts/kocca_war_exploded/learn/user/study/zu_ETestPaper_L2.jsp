		    ...
		    <table width="730" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td height="20" align="center" valign="top" class="location"> 
                  HOME &gt; 나의 강의실 &gt; E-test</td>
              </tr>
              <tr> 
                <td align="center" valign="top"> 
                  <table width="675" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td valign="top"><img src="../../../images/user/myclass/<%=tem_subimgpath%>/tit_etest.jpg"></td>
                    </tr>
                    <tr> 
                      <td height="20"></td>
                    </tr>
                  ...
                  <table width="675" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td width="585" valign="top"><img src="../../../images/user/myclass/st_test1.gif" > 
                      </td>
                        ...
                        <table width="675" border="2" cellspacing="0" 
                         cellpadding="3"   style="border-collapse:collapse;" bordercolor="#ededed"  frame="hsides">
                          ...
                          <tr> 
                            ...
                            <td width="78"  class="tbl_ptit2">응시횟수</td>                            
                          </tr>
<%
		int v_trycnt =0;
		int v_retrycnt =0;
...
%>
                    ...
                    <tr> 
                      <td><img src="../../../images/user/myclass/st_test2.gif" width="210" height="16"></td>
                      <td align="right">&nbsp;</td>
                    </tr>
                    <tr> 
                      <td height="5" colspan="2"></td>
                    ...
                    <tr> 
                      <td valign="top" class="font_ex">테스트명을 클릭하시면 테스트 결과를 조회 하실 수 있습니다. 운영자가 
                        채점을 해야 결과가 조회됩니다.</td>
                      <td align="right">
						  <A HREF="/servlet/controller.etest.ETestUserServlet?p_process=ETestUserListPage"><img src="../../../images/user/button/btn_m_result.gif" alt="결과리스트조회" border=0></a>
					  </td>
                    </tr>
                    <tr> 
                      <td height="5" colspan="2"></td>
...
%>
 <form name="form2" method="post" action="/servlet/controller.etest.ETestUserServlet">
		...
		<input type="hidden" name="p_print"  value="1"><!--분류별 통계 인쇄-->
</form>
                    <tr> 
                      <td colspan="2"> 
                        <!-- 학습예정과정 -->
                        <table width="675" border="2" cellspacing="0" 
                         cellpadding="3"   style="border-collapse:collapse;" bordercolor="#ededed"  frame="hsides">
                          ...
                          <tr> 
                            ...
                            <td width="70" class="tbl_ptit2">분류별<br>통계</td>
                          </tr>
<%
