                ...
                <td align="center" valign="top"> 
                  ...
                  <table width="675" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <table width="675" border="0" cellpadding="0" cellspacing="0" background="/images/user/myclass/pe_box_bg.gif">
                          ...
                          <tr> 
                            <td align="center"><table width="630" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="96" rowspan="3" align="center" valign="top"><img src="/images/user/myclass/pe_img.gif" alt="개인정보"></td>
                    ...
                    <tr> 
                      ...
                      <td width="201" align="right" valign="top"><a href="javascript:whenExcel()"><img src="/images/user/button/btn_print.gif" alt="출력하기" border="0"></a></td>
                    </tr>
                    <tr> 
...
%>
                          <tr> 
                            ...
                            <td class="tbl_grc">
                            <%if (!v_subj.equals("")) {  %>
                                <a href="javascript:whenEdulist('<%=v_subjnm%>','Y','<%=v_edulist_value%>')"><img src="/images/user/button/btn_m_sungview.gif" alt="성적" border="0"></a>
                            <%}else{%>
                              -
                            <%}%>
                            </td>
                            ...
                            <%if(!v_subj.equals("") && v_isgraduated.equals("이수")){%>
                              <a href="javascript:suRoyJeung('<%=v_subj%>','<%=v_year%>','<%=v_subjseq%>','<%=v_user_id%>','<%=v_kind%>')"><img src="/images/user/button/btn_m_print.gif" alt="출력하기" border="0"></a>
                            <%}else{%>
                              -
                            <%}%>
                            </td>
