...
//**********************************************************
//  1. 제      목: 지식공유
//  2. 프로그램명: zu_KnowPop_L.jsp
//  3. 개      요: 지식공유 인기 리스트 - 최다조회
//  4. 환      경: JDK 1.3
//  5. 버      젼: 1.0
//  6. 작      성: 정은년 2005. 9. 1
//  7. 수      정:
...
<%
    ...
    ArrayList list = (ArrayList)request.getAttribute("PopListPage");     
...
function goPage(pageNum) {
	...
	document.form1.action = "/servlet/controller.homepage.KnowBoardUserServlet";
	document.form1.p_process.value = "PopListPage";
	document.form1.submit();
              ...
              <tr> 
                <td align="center" valign="top"> 
                  ...
                  <table width="675" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td width="98" valign="top"><img src="/images/user/myclass/tab_view_on.gif" alt="최다조회"></td><!--최다조회-->
                      <td width="98" valign="top" ><a href="javascript:MoveList('RecListPage');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image53','','/images/user/myclass/tab_recom_on.gif',1)"><img src="/images/user/myclass/tab_recom.gif" alt="최다추천" name="Image53" border="0"></a></td>
                          ...
                          <tr> 
							...
							<table width="630" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  ...
                                  <td align="right" ><a href="javascript:select('<%=dbox.getInt("d_seq")%>','<%=dbox.getInt("d_filecnt")%>','<%=dbox.getString("d_inuserid")%>','<%=dbox.getString("d_types")%>')"><img src="/images/user/button/btn_m_sview.gif" border="0"></a></td>
                                </tr>
                                <tr> 
