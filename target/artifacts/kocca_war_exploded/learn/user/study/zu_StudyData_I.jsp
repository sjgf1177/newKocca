...
<br>
            <!----------------- 타이틀 시작 ----------------->
  				<table cellspacing="0" cellpadding="0" class="open_table_out" align="center">
    				<tr> 
      					<td><img src="/images/user/study/data_title.gif" alt="자료방"></td>
                ...
                <td> 
                  <table cellspacing="1" cellpadding="1" class="table2">
                    ...
                    <tr> 
					  ...
					  <script language='javascript'>object_namopatch('560','360');</script>
            ...
            <table width="150" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr> 
                <td align="center">
                <a href="javascript:insert()"><img src="/images/user/button/btn_save.gif" alt="저장" border="0"></a></td>
                <td align="center"><a href="javascript:cancel()"><img src="/images/user/button/btn_list.gif" alt="목록" border="0"></a></td>
              </tr>
            </table>
            <!----------------- 저장, 목록 버튼 끝 ----------------->
            <br>
