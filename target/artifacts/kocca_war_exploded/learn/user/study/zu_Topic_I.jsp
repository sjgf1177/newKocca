...
<%	} %>
				...
				<div class="content">
					...
					<tr class="bo">
						...
						<th class="th">토론기간</th>
						<td class="td">
                   			<!-- <input name="p_sdate" id="p_sdate" type="text" class="inbox " style="width:65px;" value=""  OnClick="MiniCalById('p_sdate')" readonly /> <a href="javascript:MiniCalById('p_sdate')"><img src="/images/portal/ico/ico_calendar.gif" class="va_m"/></a>-->
                   			<input name="p_sdate" id="p_sdate" type="text" class="datepicker_input1" style="width:65px;" value="">
                            <select name="p_stime" style="vertical-align:-2px;">
                   			...
                   			~
                    		<!-- <input name="p_ldate" id="p_ldate" type="text" class="inbox " style="width:65px;" value=""  OnClick="MiniCalById('p_ldate')" readonly /> <a href="javascript:MiniCalById('p_ldate')"><img src="/images/portal/ico/ico_calendar.gif" class="va_m"/></a> -->
                    		<input name="p_ldate" id="p_ldate" type="text" class="datepicker_input1" style="width:65px;" value="">
					...
					<tr>
						<th class="th">제목</th>
						<td class="td" colspan="5"><input type="text" class="inbox" style="width:590px;" name="p_title" /></td>
					</tr>
					<tr>
						<td colspan="6" class="td con">
		                    <textarea  id="p_adcontent" name="p_adcontent" style="display:none;"></textarea>
					...
					<p class="list_btn"><a href="javascript:whenTopicInsert()" class="btn_gr"><span>발의내용 저장</span></a><a href="javascript:cancel()" class="btn_gr"><span>취소</span></a></p>
