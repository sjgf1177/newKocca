		    ...
		    <table width="730" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                ...
                <table width="675" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><img src="/images/user/myclass/type1/tit_knowledge.jpg"></td>
                    </tr>
                    <tr>
                      <td height="20"></td>
                    </tr>
		...
		%>                      
				  ...
				  <table width="675" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td width="257" align="right"> <a href="javascript:InsertRecommend('<%=v_seq%>');"><img src="/images/user/button/btn_recom.gif" border="0"></a></td>
                    </tr>
                  </table>                    
