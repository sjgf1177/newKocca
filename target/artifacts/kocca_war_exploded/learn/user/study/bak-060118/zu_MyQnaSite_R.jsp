              ...
              <tr> 
                <td align="center" valign="top"> 
                  ...
                  <table width="675" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td width="98" valign="top" ><a href="/servlet/controller.study.MyQnaServlet?p_process=MyQnaStudyListPage" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image37','','/images/user/myclass/tab_study_on.gif',1)"><img src="/images/user/myclass/tab_study.gif" name="Image37" border="0"></a></td>
                      <td width="98" valign="top"><img src="/images/user/myclass/tab_site_on.gif"> 
                      </td>                      
		...
		%> 				  
                  ...
                  <table width="675" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td width="257" align="right"> <a href="/servlet/controller.study.MyQnaServlet?p_process=MyQnaSiteListPage"><img src="/images/user/button/btn_list.gif" border="0"></a></td>
                    </tr>
                  </table></td>
              </tr>
              <tr>
