...
<table width="560" border="0" cellspacing="0" cellpadding="0" align=center>
  ...
  <tr> 
    ...
    <td width="510"><img src="/images/user/myclass/notice_top_title.gif"></td>
  ...
  <tr> 
    ...
    <td height="35"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="right"><img src="/images/user/button/btn_close.gif" border="0" onclick="doCancel();" style="cursor:hand;"></td>
        </tr>
      </table></td>
    <td height="35">&nbsp;</td>
  </tr>
