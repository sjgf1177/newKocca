              ...
              <tr> 
                <td align="center" valign="top"> 
                  ...
                  <table width="675" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td width="98" valign="top"><img src="/images/user/myclass/tab_view_on.gif"></td><!--최다조회-->
                      <td width="98" valign="top" ><a href="javascript:MoveList('RecListPage');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image53','','/images/user/myclass/tab_recom_on.gif',1)"><img src="/images/user/myclass/tab_recom.gif" name="Image53" border="0"></a></td>
