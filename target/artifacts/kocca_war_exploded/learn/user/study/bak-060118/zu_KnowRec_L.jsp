              ...
              <tr> 
                <td align="center" valign="top"> 
                  ...
                  <table width="675" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> <!--최다추천-->
                      <td width="98" valign="top"><a href="javascript:MoveList('PopListPage');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image55','','/images/user/myclass/tab_view_on.gif',1)"><img src="/images/user/myclass/tab_view.gif" name="Image55" width="98" height="22" border="0"></a> 
                      </td>
                      <td width="98" valign="top" ><img src="/images/user/myclass/tab_recom_on.gif"></td>
                      <td width="98" valign="top" ><a href="javascript:MoveList('ComListPage');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image52','','/images/user/myclass/tab_comment_on.gif',1)"><img src="/images/user/myclass/tab_comment.gif" name="Image52"  border="0"></a></td>
