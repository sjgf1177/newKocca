                ...
                <td>
                  <table cellspacing="1" cellpadding="3" class="table2">
                    ...
                    <tr>
                      ...
                      <td class="board_title_bg3" width="28%"><%= FormatDate.getFormatDate(v_indate, "yyyy/MM/dd") %></td>
...
%>
                ...
                <a href="javascript:reply_StudyData()"><img src="/images/user/button/btn_answer.gif" border="0"></a></td>
<%
      }
    }
%>
<%  if(BulletinManager.isAuthority(box, box.getString("p_canModify"))) {    //    수정 여부 %>
                ...
                <a href="javascript:modify_StudyData()"><img src="/images/user/button/btn_mod.gif"  border="0"></td>
<%
    }
...
%>
                <td width="51" align="center">
                <a href="javascript:delete_StudyData()"><img src="/images/user/button/btn_del.gif" border="0"></a></td>
<%  }  %>
                <td width="53" align="center"><a href="javascript:list_StudyData()"><img src="/images/user/button/btn_list.gif"  border="0"></a></td>
              </tr>
            </table>
            ----------------- 답변, 삭제, 수정, 목록 버튼 끝 ---------------->
              ...
              <table cellspacing="0" cellpadding="0" class="open_board_table_out1">
                ...
                <td background="/images/user/study/study_dot1.gif" height="3"></td>
                </tr>
                <tr>
                  <td height="5"></td>
                </tr>
