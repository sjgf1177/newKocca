                ...
                <td align="right"> 
                  <table width="245" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td>
                      <a href = "javascript:selectList();"><img src="/images/user/button/btn_j.gif" border="0"></a></td>
                    </tr>
                  </table>
                </td>
              </tr>
              ...
              <tr> 
                <td> 
                  <table cellspacing="1" cellpadding="3" class="table2">
                    <tr> 
                      <td width="6%" class="board_title_bg1" >번호</td>
                      <td class="board_title_bg1">제 목</td>
                      <td width="10%" class="board_title_bg1">등록일</td>
                      <td class="board_title_bg1" width="7%">첨부</td>
                      <td width="10%" class="board_title_bg1">작성자</td>
            ...
            <table cellspacing="0" cellpadding="0"  class="open_board_table_out1">
              <tr> 
                ...
                <%  if(BulletinManager.isAuthority(box, box.getString("p_canAppend"))) {    //    쓰기 여부 %>
                    <a href = "javascript:insertPage();"><img src="/images/user/button/btn_write.gif" border="0"></a><%  }   %></td>
				<td witdh=5%></td>
