...
//**********************************************************
//  1. 제      목: 지식공유
//  2. 프로그램명: zu_KnowCom_L.jsp
//  3. 개      요: 지식공유 인기 리스트 - 최다댓글
//  4. 환      경: JDK 1.3
//  5. 버      젼: 1.0
//  6. 작      성: 정은년 2005. 9. 1
//  7. 수      정:
                ...
                <td align="center" valign="top"> 
                  ...
                  <table width="675" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      ...
                      <td width="98" valign="top" ><a href="javascript:MoveList('RecListPage');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image56','','/images/user/myclass/tab_recom_on.gif',1)"><img src="/images/user/myclass/tab_recom.gif" alt="최다추처" name="Image56" width="98" height="22" border="0"></a></td>
                      <td width="98" valign="top" ><img src="/images/user/myclass/tab_comment_on.gif" alt="최다댓글" width="98" height="22"></td>
                    ...
                    <tr valign="top"> 
                      <td colspan="7"> <table width="675" border="0" cellpadding="0" cellspacing="0" background="/images/user/myclass/class_tb_bg.gif">
                          <tr> 
                            ...
                            <td width="40" align="center" valign="bottom"><img src="/images/user/myclass/class_tb_comment.gif"></td>
...
%>
                    ...
                    <tr> 
                      ...
                      <td width="51" align="center"><% if( v_upfilecnt>0){ %>
							...
							<%}else{%>
							<%}%></td>
                      <td width="50" class="tbl_br"><%//v_cnt%><%=dbox.getInt("d_commentcnt")%></td>
                    </tr>
                    <tr> 
