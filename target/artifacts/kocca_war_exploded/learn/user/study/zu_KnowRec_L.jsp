...
//**********************************************************
//  1. 제      목: 지식공유
//  2. 프로그램명: zu_KnowRec_L.jsp
//  3. 개      요: 지식공유 인기 리스트 - 최다추천
//  4. 환      경: JDK 1.3
//  5. 버      젼: 1.0
//  6. 작      성: 정은년 2005. 9. 1
//  7. 수      정:
...
<%
    ...
    ArrayList list = (ArrayList)request.getAttribute("RecListPage");     
...
function goPage(pageNum) {
	...
	document.form1.action = "/servlet/controller.homepage.KnowBoardUserServlet";
	document.form1.p_process.value = "RecListPage";
	document.form1.submit();
		    ...
		    <table width="730" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td align="center" valign="top"> 
                  ...
                  <table width="675" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td width="675" height="5" colspan="4"><img src="/images/user/myclass/st_know_pop.gif"></td>
                    </tr>
                  </table>
                  <table width="675" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                    ...
                    <tr> <!--최다추천-->
                      <td width="98" valign="top"><a href="javascript:MoveList('PopListPage');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image55','','/images/user/myclass/tab_view_on.gif',1)"><img src="/images/user/myclass/tab_view.gif" alt="최다조회" name="Image55" width="98" height="22" border="0"></a>
                      </td>
                      <td width="98" valign="top" ><img src="/images/user/myclass/tab_recom_on.gif"></td>
                      <td width="98" valign="top" ><a href="javascript:MoveList('ComListPage');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image52','','/images/user/myclass/tab_comment_on.gif',1)"><img src="/images/user/myclass/tab_comment.gif" alt="최다댓글"  name="Image52"  border="0"></a></td>
                      <td width="282" align="right" ><!--<img src="/images/user/myclass/cate_text.gif" width="86" height="21">--></td>
                      <td width="99" align="right" > 
                          <!--<select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
                            <option selected>교육정보</option>
                            <option>자동차</option>
                            <option>회사일반</option>
                            <option>정보화</option>
                            <option>매너/에티켓</option>
                            <option>기타</option>
                          </select>-->
                       </td>
                    </tr>
					  ...
					  <table width="675" border="0" cellpadding="0" cellspacing="0" background="/images/user/myclass/pe_box_bg.gif">
                          ...
                          <tr> 
							...
							<table width="630" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="96" rowspan="3" align="center" valign="top"><img src="/images/user/myclass/know_img.jpg" ></td>
                                  <td width="457" class="tbl_ble"><%=dbox.getString("d_title")%></td>
                                  <td align="right" ><a href="javascript:select('<%=dbox.getInt("d_seq")%>','<%=dbox.getInt("d_filecnt")%>','<%=dbox.getString("d_inuserid")%>','<%=dbox.getString("d_types")%>')"><img src="/images/user/button/btn_m_sview.gif" alt="자세히보기" border="0"></a></td>
                                </tr>
                                <tr> 
                                  <td height="4" colspan="2" background="/images/user/myclass/stu_box_vline2.gif"></td>
                                </tr>
                                <tr> 
                                  <td colspan="3" class="tbl_gleft"><%=dbox.getString("d_contents")%></td>
                                </tr>
                              </table></td>
                          </tr>
                          <tr> 
                    ...
                    <tr valign="top"> 
                      <td colspan="7"> <table width="675" border="0" cellpadding="0" cellspacing="0" background="/images/user/myclass/class_tb_bg.gif">
                          <tr> 
                            ...
                            <td width="40" align="center" valign="bottom"><img src="/images/user/myclass/class_tb_recom.gif"></td>
...
%>
                    ...
                    <tr> 
                      ...
                      <td width="51" align="center"><% if( v_upfilecnt>0){ %>
							...
							<%}else{%>
							<%}%></td>
                      <td width="50" class="tbl_br"><%//v_cnt%><%=dbox.getInt("d_recommend")%></td>
                    </tr>
                    <tr> 
				  ...
				  <table width="675" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
					  ...
					  <img src="/images/user/button/btn_know_resi.gif" alt="지식등록" border="0"></a></td>
                ...
                name = "p_searchtext" value = "<%=v_searchtext %>" size = "25" maxlength = "30"></td>
                      <td width="260"><A HREF="javascript:selectList()"><IMG src="/images/user/button/btn_search.gif" alt="검색" border="0"></A></td>
                    </tr>
                    <tr> 
                      <td height="5" colspan="4"></td>
                    </tr>
