...
%>
              <tr> 
                ...
                <td class="tbl_grc"><% if(v_isonoff.equals("ON")){ %>
                  <a href="javascript:whenEdulist('<%=v_subjnm%>','<%=v_ieduurl%>','','<%=v_edulist_value%>')"><img src="/images/user/button/btn_m_studyview.gif" alt="학습현황" border="0"></a>
                  <%}else{%>
                  -
                  <%}%></td>
                <td class="tbl_grc">
                <% if(v_isonoff.equals("ON")){ %>
                    <% if (v_controlstudy >0) {         %>
                          <a href="javascript:controlstudy()"><img src="/images/user/button/btn_m_studydo.gif" alt="학습하기" width="60" height="17" border="0"></a>
                    <% } else {                         %>
                          <a href="javascript:studyOpen('<%=v_eduurl%>','<%=v_ieduurl%>')"><img src="/images/user/button/btn_m_studydo.gif" alt="학습하기" width="60" height="17" border="0"></a>
...
%>
              <tr> 
                ...
                <td class="tbl_grc"><% if (v_hasPreviewObj.equals("Y")) { %>
                  <a href="javascript:studyOpen1('/servlet/controller.contents.EduStart?p_subj=<%=v_subj%>&p_year=2000&p_subjseq=0001&p_ispreview=Y', '<%=v_subj%>')" onfocus=this.blur()><img src="/images/user/button/btn_m_preview.gif" alt="맛보기" border="0"></a>
                  <% } else { %>
                  <% if(!v_preurl.equals("")){ %>
                  <a href="javascript:whenPreShow('<%=v_preurl%>', '<%=v_subj%>')" onfocus=this.blur()><img src="/images/user/button/btn_m_preview.gif" alt="맛보기" border="0"></a>
                  <%}%>
                  <% } %></td>
              </tr>
              <%
...
%>
              <tr> 
                ...
                <%}%>
                <td class="tbl_grc">
				  <a href="javascript:whenEdulist('<%=v_subjnm%>','<%=v_ieduurl%>','Y','<%=v_edulist_value%>')"><img src="/images/user/button/btn_m_sungview.gif" alt="성적" border="0"></a>
				</td>
                <td class="tbl_grc">
				<%if(v_isablereview.equals("Y")){%> 
				  <a href="javascript:studyOpen('<%=v_eduurl%>','<%=v_ieduurl%>')"><img src="/images/user/button/btn_m_exdo.gif" alt="복습"  border="0"></a>
                  <%}%> </td>
                <td class="tbl_grc">
<%            if (v_isgraduated.equals("Y")) {    %>
<%              if (v_kind.equals("2")) {    %>
                <a href="javascript:suRoyJeung('<%=v_pkey%>','<%=v_year%>','<%=v_subjseq%>','<%=v_user_id%>','2')"><img src="/images/user/button/btn_m_print.gif" alt="출력" border="0"></a>
<%              } else {                     %>
                <a href="javascript:suRoyJeung('<%=v_subj%>','<%=v_year%>','<%=v_subjseq%>','<%=v_user_id%>','1')"><img src="/images/user/button/btn_m_print.gif" alt="출력" border="0"></a>
<%              }                            %>
<%            }                            %>
                </td>
              </tr>
