...
<%	} %>
				...
				<div class="content">
					...
					<tr>
						<th class="th">제목</th>
						<td class="td" colspan="3"><input type="text" class="inbox" style="width:590px;" name="p_title" /></td>
					</tr>
					<tr>
					...
					<p class="list_btn"><a href="javascript:whenToronInsert()" class="btn_gr"><span>의견작성</span></a><a href="javascript:cancel()" class="btn_gr"><span>취소</span></a></p>
