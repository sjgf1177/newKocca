...
//**********************************************************
//  1. 제      목: 지식공유
//  2. 프로그램명 :zu_KnowMenuCategory_L.jsp
...
<%
    ...
    String   v_scriptAry = "";
    //ArrayList list  = (ArrayList)request.getAttribute("MenuCategoryList");
    ...
    if(v_returncatecd.equals("")){
        ...
        for (int k=0; k<knowlist.size(); k++){
            ...
            if(v_returncatecd.equals(subjclass)){
                classname = "<b><u>"+kdbox.getString("d_classname")+"</u></b>";
            }
       ...
       if (isEndNode(index) ){
          ...
          if (ITEM[index].open == false ){
                 if (ITEM[index].dir == true ){ // 하위가 있으면
                    ...
                    temp += "<IMG border=0 src=" + IMG_PATH + OPEN + "  width=" + IMG_WIDTH + " height=" + IMG_HEIGHT + ">";
                 }
...
<table width="140" border="0" cellspacing="1" cellpadding="2">
  <tr> 
    <td valign=top align="left"><div id="TREE" ></td>
  </tr>
  <tr> 
  </tr>
</table>
