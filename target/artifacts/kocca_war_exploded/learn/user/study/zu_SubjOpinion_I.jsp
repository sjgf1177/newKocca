...
<%
//**********************************************************
//  1. 제      목: SUBJ OPINION INSERT
//  2. 프로그램명: zu_SubjOpinion_I.jsp
//  3. 개      요: 과정 학습자 의견보기  등
//  4. 환      경: JDK 1.5
//  5. 버      젼: 1.0
//  6. 작      성: 정은년 2003. 9. 8
  ...
  function insert_opinion() {
	    ...
	    */
        ...
        document.form1.action = "/servlet/controller.study.SubjOpinionServlet";
      	document.form1.p_process.value = "SubjOpinionInsert";
...
<form name="form1" method="post" action="/servlet/controller.study.SubjOpinionServlet" enctype = "multipart/form-data">
    <input type="hidden" name="p_process"    value="<%=v_process%>"/>
        ...
        <input type="hidden" name="p_contets" />
				...
				<div class="content">
					...
					<tr>
						<td colspan="4" class="td con">
		                    <textarea  id="p_contents" name="p_contents" style="display:none;"></textarea>
                    ...
                    <p class="list_btn"><a href="javascript:insert_opinion()" class="btn_gr"><span>등록</span></a><a href="javascript:list_opinion()" class="btn_gr"><span>취소</span></a></p>
