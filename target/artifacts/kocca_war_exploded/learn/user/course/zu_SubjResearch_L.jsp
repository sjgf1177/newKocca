...
%>
                ...
                <td width=12></td>
				<td  width=60><%= SelectSubjBean.getSubj(box, true, false)%><!-- getSubj(RequestBox, isChange, isALL)    과정  --></td>
                <td width=12></td>
                <td  width=60><%= SelectSubjBean.getSubjseq(box, true, false)%><!-- getSubj(RequestBox, isChange, isALL)    과정  --></td>
                <td width=6></td>
		...
		<tr> 
          <td><table width="735" border="0" cellspacing="1" cellpadding="2" class=boardskin1_out>
              <tr> 
                ...
                <td width="180" class=boardskin1_textn_l><%if(v_point >=0){%><%=v_point%>점<%}%></td>
              </tr>
            </table></td>
        </tr>
<%
