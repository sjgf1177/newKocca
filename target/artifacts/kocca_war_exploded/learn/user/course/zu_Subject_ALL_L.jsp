            ...
            <table width="730" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                ...
                <table width="675" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <table width="675" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><img src="/images/user/apply/st_totallec.gif"></td>
                    </tr>
                    <tr> 
                      <td height="5"></td>
                    </tr>
...
//v_isnew = "Y";v_ishit="Y";v_isrecom="Y";
                      if(v_isnew.equals("Y"))    v_imgNew = "&nbsp;<img src='/images/user/button/btn_snew.gif'>";
                      else                       v_imgNew = "";
                      if(v_ishit.equals("Y"))    v_imgHit = "&nbsp;<img src='/images/user/button/btn_shit.gif'>";
                      else                       v_imgHit = "";
                      if(v_isrecom.equals("Y"))  v_imgRecom = "&nbsp;<img src='/images/user/button/btn_srecom.gif'>";
                      else                       v_imgRecom = "";
