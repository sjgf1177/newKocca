...
<table align="center" width="720" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="35" align="right"  background="/images/user/game/course/type1/tit_opencourse.gif" class="location" ><img src="/images/user/game/common/location_bl.gif"> 
      HOME > 수강신청 > 수강신청</td>
  </tr>
  <tr> 
    <td height="20"></td>
  ...
  <tr> 
    <td><table width="300" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="100"><a href="javascript:select()"><img src="/images/user/game/button/btn_j.gif" alt="조회"></a><td>
        </tr>
      </table></td>
  </tr>
  <tr> 
  ...
  <tr> 
    ...
    <td width="357" class="tbl_bleft"><a href="javascript:selectView('<%=v_seq%>','<%=v_userid%>')"><%=v_title%></a>
		<% if(FormatDate.getDate("yyyyMMdd").equals(FormatDate.getFormatDate(v_indate, "yyyyMMdd"))){          %>
                 &nbsp;&nbsp;<img src = "/images/user/course/btn_new.gif" alt="new" align = "absmiddle" border = "0">
        <% }                                                                                                   %> 
	</td>
