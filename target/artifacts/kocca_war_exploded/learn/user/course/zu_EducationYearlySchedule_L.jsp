<%
//**********************************************************
//  1. 제      목: EDUCATION YEARLY SCHEDULE
//  2. 프로그램명: zu_EducationYearlySchedule_L.jsp
//  3. 개      요: 연간 교육 일정
//  4. 환      경: JDK 1.3
//  5. 버      젼: 1.0
//  6. 작      성: 2004.1.27
                  ...
                  <table width="675" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="115" align="right" valign="top"><table width="114" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="46"><img src="/images/user/apply/text_01.gif" alt="검색년도" width="46" height="13"></td>
                            <td width="68">
<%
                      ...
                      <td>
                        <table width="675" border="2" cellspacing="0"
                         cellpadding="3"   style="border-collapse:collapse;" bordercolor="#ededed"  frame="hsides">
                          ...
                          <tr>
                            <td width="219" class="tbl_gtit">과정명</td>
                            <td width="35" class="year_textb"><a href="javascript:selectMonth('01')">1월</a></td>
                            <td width="35" class="year_textb"><a href="javascript:selectMonth('02')">2월</a></td>
                            <td width="35" class="year_textb"><a href="javascript:selectMonth('03')">3월</a></td>
                            <td width="35" class="year_textb"><a href="javascript:selectMonth('04')">4월</a></td>
                            <td width="35" class="year_textb"><a href="javascript:selectMonth('05')">5월</a></td>
                            <td width="35" class="year_textb"><a href="javascript:selectMonth('06')">6월</a></td>
                            <td width="35" class="year_textb"><a href="javascript:selectMonth('07')">7월</a></td>
                            <td width="35" class="year_textb"><a href="javascript:selectMonth('08')">8월</a></td>
                            <td width="35" class="year_textb"><a href="javascript:selectMonth('09')">9월</a></td>
                            <td width="35" class="year_textb"><a href="javascript:selectMonth('10')">10월</a></td>
                            <td width="35" class="year_textb"><a href="javascript:selectMonth('11')">11월</a></td>
                            <td width="35" class="year_textb"><a href="javascript:selectMonth('12')">12월</a></td>
                          </tr>
                        </table>
                      </td>
                    </tr>
...
//System.out.println(li1+",  "+li2+",  "+li3);
                ...
                //연간 그래프 관련 END
                    ...
                    if ( !v_Bsubj.equals(v_subj) ) {
                        if ( v_chk != 0 ) { //과정중 처음인지 여부 처음이 아닌 경우 실행
%>
