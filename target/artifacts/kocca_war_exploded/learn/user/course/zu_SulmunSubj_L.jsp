...
function select(p_subj, p_subjseq, p_grcode, p_gyear, p_sulpapernum) {
  document.form.target = "_self";
  document.form.p_process.value = "SubjResearch";
  document.form.p_subj.value = p_subj;
  document.form.p_subjseq.value = p_subjseq;
  document.form.p_grcode.value = p_grcode;
  document.form.p_gyear.value = p_gyear;
  document.form.p_sulpapernum.value = p_sulpapernum;
  document.form.action = "/servlet/controller.research.SulmunSubjResultServlet";
  document.form.submit();
}
//-->
        ...
        <input type = "hidden" name = "p_row"    value = "<%=v_row%>">
										...
										<tr height="35">
											<td bgcolor="F7F3EF" style="padding-left:5">
												<TABLE cellpadding="0" cellspacing="0" border="0">
														<tr>
														<td><IMG src="/images/user/course/tab_sulmun01_on.gif"  alt="과정설문" border="0"></td>
														<td><IMG src="/images/user/myhome/myhome_img07.gif" border="0"></td>
														<td><A HREF="javascript:changeTabpage('CONTENTS')"><IMG src="/images/user/course/tab_sulmun02.gif"  alt="콘텐츠평가" border="0" name="img33" onMouseOver="document.all.img33.src='/images/user/course/tab_sulmun02_on.gif'" onMouseOut="document.all.img33.src='/images/user/course/tab_sulmun02.gif'"></A></td>
														</tr>
												</TABLE>
											</td>
										</tr>
                      ...
                      <td align="left"> <TABLE  border="0" cellpadding="0" cellspacing="0">
                          <tr>
						    <td width=10></td> 
						    <td class=boardtitle>연도</td>
							<td style="padding-left:6">
				  <select name="s_gyear" style='border-style:solid;border-width: 1px 1px 1px 1px;border-color:cccccc;color:333333;font-size:9pt;background-color:none;width : 65px;height:19px;font-size:9pt;' onchange='whenSelection();'>
<%
...
%>
				  ...
				  <script>document.form.s_gyear.value = <%=v_gyear%>;</script>
							</td>
                          </tr>
                        </TABLE></td>
										</tr>
											...
											<td>
												...
												<TABLE cellpadding="0" cellspacing="0" border="0" width="735">
													<tr align="center">
														...
														<td class="boardbgimg" width="50"><span class=boardtitle>번호</span></td>
														<td class="boardbgimg" width="1"></td>
                            							<td class="boardbgimg" width="217" ><span class=boardtitle>과정설문 제목</span></td>
														<td class="boardbgimg" width="1"></td>
														<td class="boardbgimg" width="70" ><span class=boardtitle>참여인원</span></td>
														<td class="boardbgimg" width="1"></td>
														<td class="boardbgimg" width="169"><span class=boardtitle>과정운영기간</span></td>
														<td class="boardbgimg" width="1"></td>
														<td class="boardbgimg" width="148" ><span class=boardtitle>과정명</span></td>
...
<%
		for(i = 0; i < list.size(); i++) {
			...
			String v_sulpapernum    = dbox.getString("d_sulpapernum");
		...
		if (!v_searchtext.equals("")) {
			if (v_searchtype.equals("1")) {
				v_sulpapernm = StringManager.replace(v_sulpapernm, v_searchtext, "<font color=\"red\">" + v_searchtext + "</font>"); 
			} else if (v_searchtype.equals("2")) {
...
%>
													...
													<tr align="center">
														...
														<td class="<%=v_class2%>" align="left" style="padding-left:7">
														<%if(Integer.parseInt(v_replycount)>0){%>
														<a href="javascript:select('<%=v_subj%>','<%=v_subjseq%>', '<%=v_grcode%>', '<%=v_year%>', '<%=v_sulpapernum%>')"><%=v_sulpapernm%></a>
														<%}else{%>
														<%=v_sulpapernm%>
														<%}%>
														</td>
														<td width="1"><IMG src="/images/board/board_ml.gif" border="0"></td>
														<td class="<%=v_class1%>"><%=v_replycount%></td>
														<td width="1"><IMG src="/images/board/board_ml.gif" border="0"></td>
														<td class="<%=v_class1%>"><%=FormatDate.getFormatDate(v_edustart,"yyyy-MM-dd")%> ~ <%=FormatDate.getFormatDate(v_eduend,"yyyy-MM-dd")%></td>
														<td width="1"><IMG src="/images/board/board_ml.gif" border="0"></td>
														<td class="<%=v_class1%>" align="left" style="padding-left:7"><%=v_subjnm%></td>
														<td></td>
													</tr>
													<tr height="1">
														<td bgcolor="E5E5E5" colspan="13"></td>
													</tr>
<%  } if(i == 0){   %>    
                    <tr align="center">
                      <td style="padding-left:7" colspan="13" align="center">해당 내용이 존재하지 않습니다.</td>
                    </tr>    
<%    } %>
													<tr height="8">
														<td background="/images/board/board_bottom.gif" colspan="13"></td>
													</tr>
												</TABLE>
												<!-- 게시판 끝 -->
												<!-- 페이징&검색 시작 -->
												<TABLE cellpadding="0" cellspacing="0" border="0" width="735">
													...
													<tr>
														...
														<TABLE cellpadding="0" cellspacing="5" border="0">
															<tr>
																<td>
                                                                  <select name="s_searchtype" style='border-style:solid;border-width: 1px 1px 1px 1px;border-color:cccccc;color:333333;font-size:9pt;background-color:none;width : 90px;height:19px;font-size:9pt;'>
                                                                    <option value="1" <% if (v_searchtype.equals("1")) { %>selected<% } %>>설문제목</option>
                                                                    <option value="2" <% if (v_searchtype.equals("2")) { %>selected<% } %>>과정명</option>
                                                                 </select>

																</td>
																<td><input type="text" name="s_searchtext" style="width:188" class="input" value="<%=v_searchtext%>"></td>
																<td><A HREF="javascript:whenSelection()"><IMG src="/images/user/course/bt_c_search2.gif"  alt="검색" border="0"></A></td>
															</tr>
														</TABLE>
														<!-- 검색 끝 -->
														</td>
