<%
/**
 * file name : za_SulmunCommonUserPaper_I.jsp
 * date      : 2003/09/12
 * programmer:
 * function  : 설문 응시
 */
...
<table cellspacing="0" cellpadding="0" class="open_board_table_out1" align="center">
	<tr> 
		...
		<td><b>설문지명 : <%=v_sulpapernm%> / 연도 : <%=v_gyear%></b></td>
	</tr>
  <tr> 
    <td height="5"></td>
  </tr>
...
%>
        <tr> 
		  ...
		  <%if (dbox.getString("d_sultype").equals(SulmunCommonBean.MULTI_QUESTION)){%>(<%=dbox.getString("d_selmax")%>개까지 선택 가능)<%}%>
		  </td>
        </tr>
