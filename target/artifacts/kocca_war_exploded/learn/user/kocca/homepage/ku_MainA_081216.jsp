...
PopCookieWindow = window.open('/learn/user/kocca/pop/pop081227.html','kocca_open','scrollbars=no, //left=0, top=0,width=350,height=440');
PopCookieWindow.opener = self;
}

//팝업창에서 만들어진 쿠키 PopCookie 의 값이 done 이 아니면(즉, 체크하지 않으면,)
//if ( getCookie( "kocca_event" ) != "done" ) { // 새창(pop.htm)을 띄웁니다
//PopCookieWindow = window.open('/learn/user/kocca/pop/pop081206.html','kocca_event','scrollbars=no,// left=0, top=0,width=400,height=625');
//PopCookieWindow.opener = self;
}
...
<table border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td><script language = "javascript" src = "/script/user_patch.js"></script>
			<script language='javascript'>
			setParam1('/images/user/kocca/homepage/type1/mainflash_080901.swf');
			setParam2('916');
			setParam3('220');
			//alert("1111");
			object_patch('leftmenuB');
					...
					<td background="/images/user/kocca/homepage/new_img/curri_bg.gif" style="background-repeat:no-repeat;padding:26 0 0 60" valign="top">
						...
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td width="74"><img src="/images/user/kocca/homepage/new_img/icon02.gif" align="absmiddle"> <a href="javascript:menuForward('1', '03', '2')" class="curri">개별과정</a></td>
										...
										<tr bgcolor="#F1FBEB">
											<td align="center">
												...
												<table width="199" border="0" cellpadding="0">
													...
													<tr>
														<td width="50">
														<img src="/upload/bulletin/Subject_introducefile_200812031655561_lee1.jpg" width="44" height="44">
														...
														<td width="149">
															...
															<table border="0" cellpadding="0" cellspacing="0">
																<tr>
																	<td><strong><a href="javascript:whenSubjInfo('ash002','1')"><span class="new_main_contents_title_text">

																	  <font color="#41970C">2008 문화예술특강 문소리..</font>
																	  </span></a></strong></td>
																</tr>
																<tr>
																	<td height="2"></td>
													...
													<tr>
														<td width="50">
														<img src="/upload/bulletin/Subject_introducefile_200812151107351_lee1.jpg" width="44" height="44">
														...
														<td width="149">
															...
															<table border="0" cellpadding="0" cellspacing="0">
																<tr>
																	<td><strong><a href="javascript:whenSubjInfo('001177','3')"><span class="new_main_contents_title_text">

																	  <font color="#41970C">new 미디어와 뮤직비즈니스</font>
																	  </span></a></strong></td>
																</tr>
																<tr>
																	<td height="2"></td>
																...
																<tr>
																	<td class="main_contents02" style="letter-spacing:-1px">
																	  ...
																	  세계 음악산업의 특성과 현황을 한 눈에 파악할 수...</td>
																</tr>
															</table>
