										...
										<tr bgcolor="#F1FBEB">
											<td align="center">
												...
												<%  int resize = (recolist.size());
													...
													<!-- SET START -->
													<tr>
														<td width="50"><%if( !v_savefile.equals("") ){
															v_savefile = conf.getProperty("url.upload") + "bulletin/" + v_savefile;%>
														<img src="<%=v_savefile%>" width="44" height="44">
														<%}else{
														...
														<td width="149">
															...
															<table border="0" cellpadding="0" cellspacing="0">
																<tr>
																	<td><strong><a href="javascript:whenSubjInfo('<%=v_subj%>','<%=v_sphere%>')"><span class="new_main_contents_title_text">
																	  <%if(v_subjnm.length() > 10){
																		  	v_subjnm = v_subjnm.substring(0,10)+"...";
																		  }%>
																	  <font color="#41970C"><%=v_subjnm%></font>
																	  </span></a></strong></td>
																</tr>
																<tr>
																	<td height="2"></td>
													...
													<%if (recolist.size() == 0) { %>
															<tr>
															  <td height="10" colspan="2"> 추천된 강좌가 없습니다.</td>
															</tr>
													<%	}	%>
