...
<%
        ...
        try
        {
            ...
            s = " Select C.subj,C.subjnm,C.subjseq,";
						...
						s += " b.jikup, ( select * from ( select rownum rnum, codenm from tz_code d where d.gubun = '0070' and d.levels=1 and d.code = b.jikup ) ";
            ...
            s += " and C.gyear = "+SQLString.Format("2006");
						...
						//s += " and A.appdate <= '20071231' ";
						s += " and A.userid=B.userid and A.subj=C.subj and A.year=C.year and A.subjseq=C.subjseq ) where rnum < 2";
