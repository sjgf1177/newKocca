...
//PopCookieWindow = window.open('/learn/user/kocca/pop/pop20080426.jsp','kocca_open','scrollbars=no, //left=0, //top=0,width=400,height=500');
//PopCookieWindow.opener = self;
//}

// 팝업창에서 만들어진 쿠키 PopCookie 의 값이 done 이 아니면(즉, 체크하지 않으면,)
//if ( getCookie( "kocca_event" ) != "done" ) { // 새창(pop.htm)을 띄웁니다
//PopCookieWindow = window.open('/learn/user/kocca/pop/open_event.jsp','kocca_event','scrollbars=no, left=0, top=0, //width=310,height=230');
//PopCookieWindow.opener = self;
//}
...
<table border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td><script language = "javascript" src = "/script/user_patch.js"></script>
			<script language='javascript'>
			setParam1('/images/user/kocca/homepage/type1/new_mainflash.swf');
			setParam2('916');
			setParam3('220');
			//alert("1111");
			object_patch('leftmenuB');
...
<%	}	%>
			...
			<table width="470" border="0" cellspacing="0" cellpadding="0">
				<tr height="63">
					<td background="/images/user/kocca/homepage/new_img/curri_bg.gif" style="background-repeat:no-repeat;padding:26 0 0 60" valign="top">
						...
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="74"><img src="/images/user/kocca/homepage/new_img/icon02.gif" align="absmiddle"> <a href="javascript:menuForward('1', '07', '3')" class="curri">입문과정</a></td>
								<td width="74"><img src="/images/user/kocca/homepage/new_img/icon02.gif" align="absmiddle"> <a href="javascript:menuForward('1', '03', '4')" class="curri">개별과정</a></td>
										...
										<tr bgcolor="#F1FBEB">
											<td align="center">
												...
												<table width="199" border="0" cellpadding="0">
													...
													<tr>
														<td width="50">
														<img src="/upload/bulletin/Subject_introducefile_200712141435161_lee1.jpg" width="44" height="44">
														...
														<td width="149">
															...
															<table border="0" cellpadding="0" cellspacing="0">
																<tr>
																	<td><strong><a href="javascript:whenSubjInfo('001159','4')"><span class="new_main_contents_title_text">

																	  <font color="#41970C">사례로 보는 계약과...</font>
																	  </span></a></strong></td>
																</tr>
																<tr>
																	<td height="2"></td>
													...
													<tr>
														<td width="50">
														<img src="/upload/bulletin/Subject_introducefile_200605111125371_lee1.JPG" width="44" height="44">
														...
														<td width="149">
															...
															<table border="0" cellpadding="0" cellspacing="0">
																<tr>
																	<td><strong><a href="javascript:whenSubjInfo('cul001','2')"><span class="new_main_contents_title_text">

																	  <font color="#41970C">콘텐츠소스로서의 세...</font>
																	  </span></a></strong></td>
																</tr>
																<tr>
																	<td height="2"></td>
				...
				<tr>
					<td background="/images/user/kocca/homepage/new_img/st_power_interview_bg.gif" align="center">
						...
						<table width="450" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td><a href="javascript:view(19)" width="95"><img src="http://contents.connect.or.kr/upload/bulletin/KOpenPowerAdmin_file1_200712051036141_lee1.jpg"></td>
		...
		<td width="226" valign="top" style="padding-top:19">
			...
			<table border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td><a href="/servlet/controller.homepage.KHomePageHelpServlet?p_process=Help"><img src="/images/user/kocca/homepage/new_img/kocca_guide.gif"></a></td>
			    </tr>
			    <tr>
					<td height="6"></td>
				</tr>
				...
				<tr>
					<td><a href="/servlet/controller.homepage.KOpenOfflineServlet?p_process=OpenOfflineList"><img src="/images/user/kocca/homepage/new_img/r_bnoff.gif"></a></td>
				</tr>
				<tr>
					<td height="6"></td>
				</tr>
