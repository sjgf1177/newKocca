...
//PopCookieWindow = window.open('/learn/user/kocca/pop/pop090627.html','kocca_open','scrollbars=no, left=0, top=0,width=400,height=468');
//PopCookieWindow.opener = self;
//}

//팝업창에서 만들어진 쿠키 PopCookie 의 값이 done 이 아니면(즉, 체크하지 않으면,)
//if ( getCookie( "kocca_event" ) != "done" ) { // 새창(pop.htm)을 띄웁니다
//PopCookieWindow = window.open//('/learn/user/kocca/pop/pop090608.html','kocca_event','scrollbars=no,// left=0, //top=0,width=400,height=515');
//PopCookieWindow.opener = self;
//}

// 팝업창에서 만들어진 쿠키 PopCookie 의 값이 done 이 아니면(즉, 체크하지 않으면,)
//if ( getCookie( "kocca_invitation" ) != "done" ) { // 새창(pop.htm)을 띄웁니다
//PopCookieWindow = window.open('/learn/user/kocca/pop/open_invitation.jsp','kocca_invitation','scrollbars=no, left=0, top=0, //width=400,height=515');
//PopCookieWindow.opener = self;
//}
...
<style type="text/css">
<!--
#right_banner_090701 {	position:absolute;
	left:930px;
	top:319px;
	width:96px;
	height:120px;
										...
										<tr bgcolor="#F1FBEB">
											<td align="center">
												...
												<table width="199" border="0" cellpadding="0">
													...
													<tr>
														<td width="50">
														<img src="/upload/bulletin/Subject_introducefile_200905141624221_lee1.jpg" width="44" height="44">
														...
														<td width="149">
															...
															<table border="0" cellpadding="0" cellspacing="0">
																<tr>
																	<td><strong><a href="javascript:whenSubjInfo('ash009','1')"><span class="new_main_contents_title_text">

																	  <font color="#41970C">문화특강 - 최범석 디자이너</font>
																	  </span></a></strong></td>
																</tr>
																<tr>
																	<td height="2"></td>
...
<div id="right_banner_090701"><a href="http://contents.connect.or.kr/contents/manage/expert13_event.html" target="_blank"><img src="/images/user/kocca/homepage/new_img/ban_event.gif" width="96" height="120" border="0"></a></div>
...
<map name="copy02">
	...
	<area shape="rect" coords="170,0,262,28" href="/servlet/controller.homepage.KMemberJoinServlet?p_process=personal" onFocus="this.blur()">
	<area shape="rect" coords="262,0,320,28" href="/servlet/controller.homepage.KMemberJoinServlet?p_process=user" onFocus="this.blur()">
	<area shape="rect" coords="559,25,579,43" href="mailto:cyber02@kocca.or.kr" onFocus="this.blur()">
</map>
</BODY>
<HTML>
