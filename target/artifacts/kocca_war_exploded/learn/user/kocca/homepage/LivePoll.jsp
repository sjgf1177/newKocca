...
%>
        ...
        farwindow = window.open("", "openWin", "toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,copyhistory=no, width = 693, height = 285, top=0, left=0");
        document.pform1.target = "openWin"
        
        document.pform1.p_process.value = "insertPoll";
        document.pform1.p_seq.value = "<%=v_seq%>";
        document.pform1.action = "/servlet/controller.homepage.KPollServlet";
...
<input type="hidden" name="p_seq" value="">
	...
	<table width="223" border="0" cellspacing="0" cellpadding="0" >
	  ...
	  <tr> 
		...
		<td width="203" class="tbl_bleft4"><%=v_title%></td>
	  </tr>
	  <tr > 
...
<%}%>
	  ...
	  <tr> 
		<td height="20" colspan="2"><div align="center" valign="bottom">
