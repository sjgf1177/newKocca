...
<%
        ...
        try
        {
            ...
            s = " Select C.subj,C.subjnm,C.subjseq,";
						...
						s += " b.jikup, ( select * from ( select rownum rnum, codenm from tz_code d where d.gubun = '0070' and d.levels=1 and d.code = b.jikup) where rnum < 2) ";
            ...
            s += " and C.gyear >= "+SQLString.Format("2005");
