	...
	<tr> 
				...
				<tr height="108">
					<td valign="top" style="padding-left:4">
						...
						<table width="466" border="0" cellspacing="0" cellpadding="0">
							<tr height="19"> 
								<td name="p_seq" class="notice" value=""><img src="/images/user/kocca/homepage/new_img/icon.gif" align="absmiddle"> <a href="javascript:selectView(112)">[수강신청]1월 상시 경영과정 수강생 모집안내</td>
			...
			<table width="470" border="0" cellspacing="0" cellpadding="0">
				<tr height="63">
					<td background="/images/user/kocca/homepage/new_img/curri_bg.gif" style="background-repeat:no-repeat;padding:26 0 0 62" valign="top">
						...
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="74"><img src="/images/user/kocca/homepage/new_img/icon02.gif" align="absmiddle"> <a href="#" class="curri">입문과정</a></td>
								<td width="74"><img src="/images/user/kocca/homepage/new_img/icon02.gif" align="absmiddle"> <a href="#" class="curri">개별과정</a></td>
								<td width="80"><img src="/images/user/kocca/homepage/new_img/icon02.gif" align="absmiddle"> <a href="#" class="curri">전문과과정</a></td>
								<td width="80"><img src="/images/user/kocca/homepage/new_img/icon02.gif" align="absmiddle"> <a href="#" class="curri">워크숍과정</a></td>
								<td width="74"><img src="/images/user/kocca/homepage/new_img/icon02.gif" align="absmiddle"> <a href="#" class="curri">학점인증과정</a></td>
							</tr>
						</table>
												...
												<table width="199" border="0" cellpadding="0">
													<tr> 
														...
														<td width="149">
															...
															<table border="0" cellpadding="0" cellspacing="0">
																<tr>
																	<td><strong><a href="javascript:whenSubjInfo('cbu001','ALL')" ><span class="new_main_contents_title_text">문화콘텐츠와 비즈니스 모델</span></a></strong></td>
																</tr>
																<tr>
																	<td height="5"></td>
																</tr>
																<tr>
																	<td class="main_contents02">본 과정은 문화콘텐츠 비즈니스의 체계와 구조를...</td>
																</tr>
															</table>
												...
												<table width="199" border="0" cellpadding="0">
													<tr> 
														...
														<td width="149">
															...
															<table border="0" cellpadding="0" cellspacing="0">
																<tr>
																	<td><strong><a href="javascript:whenSubjInfo('cbu001','ALL')" ><span class="new_main_contents_title_text02">문화콘텐츠와 비즈니스 모델</span></a></strong></td>
																</tr>
																<tr>
																	<td height="5"></td>
																</tr>
																<tr>
																	<td class="main_contents02">1.본 과정은 문화콘텐츠</td>
																</tr>
																<tr>
																	<td class="main_contents02">1.본 과정은 문화콘텐츠</td>
																</tr>
						...
						<table width="450" border="0" cellspacing="0" cellpadding="0">
							<tr> 
								...
								<td class="tbl_gleft_small" width="355">				
									...
									<table border="0" cellpadding="0" cellspacing="0">
										<tr height="20">
											<td><img src="/images/user/kocca/homepage/new_img/icon03.gif" align="absmiddle"> 문화콘텐츠 장르별 과정의 베스트 튜터 김형준 튜터님</td>
										</tr>
										<tr height="20">
											<td><img src="/images/user/kocca/homepage/new_img/icon03.gif" align="absmiddle"> 문화콘텐츠 장르별 과정의 베스트 튜터 김형준 튜터님</td>
										</tr>
		...
		<td width="226" valign="top" style="padding-top:19">
			...
			<table border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td height="24" bgcolor="#F6FBFB" style="padding-left:11"><img src="/images/user/kocca/homepage/new_img/icon04.gif" align="absmiddle"> <a href="javascript:viewLoad()" class="curri">일반인 대상</a></td>
				</tr>
				<tr>
					<td height="1" background="/images/user/kocca/homepage/new_img/dot.gif"></td>
				</tr>
				<tr>
					<td height="24" bgcolor="#F6FBFB" style="padding-left:11"><img src="/images/user/kocca/homepage/new_img/icon04.gif" align="absmiddle"> <a href="javascript:viewLoad()" class="curri">직장 및 취업희망자</a></td>
				</tr>
				<tr>
					<td height="1" background="/images/user/kocca/homepage/new_img/dot.gif"></td>
				</tr>
				<tr>
					<td height="24" bgcolor="#F6FBFB" style="padding-left:11"><img src="/images/user/kocca/homepage/new_img/icon04.gif" align="absmiddle"> <a href="javascript:viewLoad()" class="curri">문화콘텐츠산업 재직자</a></td>
				</tr>
				<tr>
					<td height="7"></td>
				</tr>
