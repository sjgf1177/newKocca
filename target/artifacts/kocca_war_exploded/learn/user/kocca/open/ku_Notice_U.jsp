	...
	<input type = "hidden" name = "p_seq"		 value = "<%=v_seq %>">
                        ...
                        <table width="680" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr> 
                            ...
                            <td width="605" class="tbl_gleft01" height="25"><input name="p_title" type="text" size="50" class="input2" value="<%=v_adtitle%>"></td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td width="75" class="tbl_gleft03" height="25">수정일</td>
                          ...
                          <tr>
                            <td height="27" class="linecolor_notice">
							  <table width="108" border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td align="right"><a href="javascript:listnotice()"><img src="/images/user/kocca/button/btn_list.gif" border="0"></a>&nbsp;<a href="javascript:update(<%=v_seq %>)"><img src="/images/user/kocca/button/btn_ok.gif"></a>&nbsp;&nbsp;</td>
                                </tr>
                              </table></td>
                          </tr>
                          <tr> 
