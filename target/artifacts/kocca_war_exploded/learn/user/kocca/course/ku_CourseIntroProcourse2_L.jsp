...
//**********************************************************
//  1. 제      목: SUBJECT LIST
//  2. 프로그램명:  ku_CourseIntroProcourse2_L.jsp
//  3. 개      요: 전문가 과정
//  4. 환      경: JDK 1.3
//  5. 버      젼: 1.0
//  6. 작      성: 2004.01.12
    ...
    <input type='hidden' name='p_subj'     value="">
                        ...
                        <table width="680" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td width="3">&nbsp;</td>
                            <td width="82"><img src="/images/user/kocca/course/tab_market_on.gif" name="Image9" width="81" height="30" border="0"  id="Image9"></td>
                            <td width="3">&nbsp;</td>
                        ...
                        <table width="680" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td width="144"><div align="center"><img src="/images/user/kocca/course/text_sub_maket01.gif" ></div></td>
                            <td width="1" class="tbl_bleft5"><img src="/images/user/kocca/course/vline.gif" ></td>
                            <td class="tbl_bleft5"><img src="/images/user/kocca/course/text_sub_maket02.gif" ></td>
                          </tr>
                          <tr> 
                        ...
                        <table width="680" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr> 
                                  ...
                                  <td><table width="631" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr> 
                                        ...
                                        <td width="554"><img src="/images/user/kocca/course/im_market.gif" ></td>
                                      </tr>
                                    </table>
                                    ...
                                    <table width="631" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr> 
                                        ...
                                        <td width="480"><strong>문화콘텐츠와 비즈니스모델</strong> 
                                        </td>
                                        <td width="76"><div align="right"></div></td>
                                        <td width="58"><!--a href="#"><img src="/images/user/kocca/course/i_sample_class.gif" border="0"></a--></td>
                                      </tr>
                                                  ...
                                                  <tr> 
                                                    ...
                                                    <td width="95"><table width="86" border="0" cellpadding="0" cellspacing="3" bgcolor="#e7e7e7">
                                                        <tr> 
                                                          <td bgcolor="#FFFFFF"><table width="80" border="0" cellpadding="0" cellspacing="2" bgcolor="#cccccc">
                                                              <tr> 
                                                                <td><img src="/images/user/kocca/course/ssm.jpg"></td>
                                                              </tr>
                                                            </table></td>
                                                        </tr>
                                                      </table></td>
                                                    <td width="1"><img src="/images/user/kocca/course/vline.gif"></td>
                                                    <td width="150" class="tbl_grc">심상민<br>
                                                      (성신여자대학교)</td>
                                                    <td width="1"><img src="/images/user/kocca/course/vline.gif" ></td>
                                                    <td>&nbsp;</td>
                                                    <td width="360" bgcolor="#F7F1C5"  class="tbl_gleft"><p>문화콘텐츠 비즈니스의 체계와 구조를 이해하여 성공적인 비즈니스를 창출한다</p></td>
                                                    <td>&nbsp;</td>
                                                  </tr>
                                                  <tr> 
                                                    <td height="7" colspan="8"></td>
                                    ...
                                    <table width="631" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr> 
                                        ...
                                        <td width="480"><strong>글로벌 마케팅</strong></td>
                                        <td width="76"><div align="right"></div></td>
                                        <td width="58"><!--a href="#"><img src="/images/user/kocca/course/i_sample_class.gif" border="0"></a--></td>
                                      </tr>
                                      <tr> 
                                                  ...
                                                  <tr> 
                                                    ...
                                                    <td width="95"><table width="86" border="0" cellpadding="0" cellspacing="3" bgcolor="#e7e7e7">
                                                        <tr> 
                                                          <td bgcolor="#FFFFFF"><table width="80" border="0" cellpadding="0" cellspacing="2" bgcolor="#cccccc">
                                                              <tr> 
                                                                <td><img src="/images/user/kocca/course/kjh.jpg"></td>
                                                              </tr>
                                                            </table></td>
                                                        </tr>
                                                      </table></td>
                                                    <td width="1"><img src="/images/user/kocca/course/vline.gif" ></td>
                                                    <td width="150" class="tbl_grc">김주헌<br>
                                                      (숙명여자대학교)</td>
                                                    <td width="1"><img src="/images/user/kocca/course/vline.gif" ></td>
                                                    <td>&nbsp;</td>
                                                    <td width="360" bgcolor="#F7F1C5"  class="tbl_gleft"><p>국제경영 환경 변화의 중요성을 인식하고, 그에 따른 변화에 능동적으로 대응할 수 있는 국제경영과 국제마케팅에 대해 이해한다.</p></td>
                                                    <td>&nbsp;</td>
                                                  </tr>
                                                  <tr> 
                                                    <td height="7" colspan="8"></td>
                         ...
                         cellpadding="3"   style="border-collapse:collapse;" bordercolor="#DFDFE0"  frame="hsides">
                                            ...
                                            <tr> 
                                              ...
                                              <td rowspan="4" bgcolor="#E6EACA" class="tbl_grc"><font color="#000000">문화콘텐츠 
                                                와<br>
                                                비지니스모델 </font></td>
                                            ...
                                            <tr> 
                                              ...
                                              <td rowspan="4" bgcolor="#ECF2E3" class="tbl_grc"><font color="#000000">글로벌마케팅</font></td>
