...
<form name="form1" method="post" >
    ...
    <input type='hidden' name='p_subjtype'    value="alway">
                        ...
                        <table width="680" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td  class="location" > HOME > 과정소개 > 입문과정</td>
                          </tr>
                        </table>
                        <table width="680" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><img src="/images/user/kocca/course/<%=tem_subimgpath%>/tit_course_beginner.gif"></td>
                          </tr>
                          <tr>
                            <td height="20"></td>
                          </tr>
                        ...
                        <table width="680" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td><img src="/images/user/kocca/course/si_beginner.jpg" ></td>
                          </tr>
                          <tr> 
                            <td height="19"></td>
                          </tr>
                        ...
                        <table width="680" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
							...
							<% } else {                                             %>
							<img src="/images/user/kocca/course/text_sub_alw<%=v_img_type%>_01.gif" >
							<% }                                                    %>
							</td>
                          </tr>
                          <tr> 
...
%>
                                    ...
                                    <table width="625" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr bgcolor="#F9F7E8"> 
										...
										<b>개강일</b> : 매월 1일<br>
										<b>교육기간</b> : 1개월<br>
										<b>모집방법</b> : 1인2강좌 제한, 온라인 선착순 모집<br>
										<b>수강정원</b> : 200명
