...
//**********************************************************
//  1. 제      목: SUBJECT LIST
//  2. 프로그램명:  ku_CourseIntroProcourse4_L.jsp
//  3. 개      요: 전문가 과정
//  4. 환      경: JDK 1.3
//  5. 버      젼: 1.0
//  6. 작      성: 2004.01.12
...
<body onload="MM_preloadImages('/images/user/kocca/course/tab_project_on.gif','/images/user/kocca/course/tab_market_on.gif','/images/user/kocca/course/tab_copyright_on.gif','/images/user/kocca/course/tab_story_on.gif','/images/user/kocca/course/tab_ct_on.gif','/images/user/kocca/course/tab_pd_on.gif')">
    ...
    <input type='hidden' name='p_subj'     value="">
                        ...
                        <table width="680" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td width="3">&nbsp;</td>
                            <td width="82"><img src="/images/user/kocca/course/tab_location_on.gif" name="Image11" width="81" height="30" border="0"  id="Image11"></td>
                            <td>&nbsp;</td>
                        ...
                        <table width="680" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td width="144"><div align="center"><img src="/images/user/kocca/course/text_sub_location01.gif" ></div></td>
                            <td width="1" class="tbl_bleft5"><img src="/images/user/kocca/course/vline.gif" ></td>
                            <td class="tbl_bleft5"><img src="/images/user/kocca/course/text_sub_location02.gif" ></td>
                          </tr>
                          <tr> 
                        ...
                        <table width="680" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr> 
                                  ...
                                  <td><table width="631" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr> 
                                        ...
                                        <td width="554"><img src="/images/user/kocca/course/im_location.gif"></td>
                                      </tr>
                                    </table>
                                    ...
                                    <table width="631" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr> 
                                        ...
                                        <td width="479"><strong>일본 문화콘텐츠 산업의 이해</strong></td>
                                            ...
                                            <tr> 
                                              <td><table width="627" border="0" cellspacing="0" cellpadding="0">
                                                  ...
                                                  <tr> 
                                                    ...
                                                    <td width="1"><img src="/images/user/kocca/course/vline.gif" ></td>
                                                    <td>&nbsp;</td>
                                                    <td width="360" bgcolor="#F7F1C5"  class="tbl_gleft"><p>일본의 사회적, 경제적, 문화적 특성 및 문화콘텐츠 전반에 대한 이해를 바탕으로 문화콘텐츠 산업의 특성을 살펴봄으로써, 향후 일본 문화콘텐츠시장 진출을 위한 토대를 마련한다. </p></td>
                                                    <td>&nbsp;</td>
                                                  </tr>
                                                  <tr> 
                                                    <td height="7" colspan="8"></td>
                                    ...
                                    <table width="631" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr> 
                                        ...
                                        <td width="480"><strong>중국 문화콘텐츠 산업의 이해 </strong> 
                                        </td>
                                        <td width="76"><div align="right"></div></td>
                                        <td width="58"><!--a href="#"><img src="/images/user/kocca/course/i_sample_class.gif" border="0"></a--></td>
                                      </tr>
                                                  ...
                                                  <tr> 
                                                    ...
                                                    <td width="95"><table width="86" border="0" cellpadding="0" cellspacing="3" bgcolor="#e7e7e7">
                                                        <tr> 
                                                          <td bgcolor="#FFFFFF"><table width="80" border="0" cellpadding="0" cellspacing="2" bgcolor="#cccccc">
                                                              <tr> 
                                                                <td><img src="/images/user/kocca/course/bsc.jpg"></td>
                                                              </tr>
                                                            </table></td>
                                                        </tr>
                                                      </table></td>
                                                    <td width="1"><img src="/images/user/kocca/course/vline.gif" ></td>
                                                    <td width="150" class="tbl_grc">박승찬<br>
                                                      (한국 정보통신수출진흥센터전문위원)</td>
                                                    <td width="1"><img src="/images/user/kocca/course/vline.gif"></td>
                                                    <td>&nbsp;</td>
                                                    <td width="360" bgcolor="#F7F1C5"  class="tbl_gleft"><p>중국 사회의 문화 특징을 이해하고 중국 문화콘텐츠 산업의 시장진출에 활용할 수 있다. 또한 중국문화콘텐츠와 한국문화콘텐츠의 특수성을 비교 분석하여 중국 문화콘텐츠 산업의 진출 전략을 세울 수 있다.</p></td>
                                                    <td>&nbsp;</td>
                                                  </tr>
                                                  <tr> 
                                                    <td height="7" colspan="8"></td>
                                    ...
                                    <table width="631" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr> 
                                        ...
                                        <td width="480"><strong>미국 문화콘텐츠 산업의 이해</strong></td>
                                        <td width="76"><div align="right"></div></td>
                                        <td width="58"><!--a href="#"><img src="/images/user/kocca/course/i_sample_class.gif" border="0"></a--></td>
                                      </tr>
                                      <tr> 
                                                  ...
                                                  <tr> 
                                                    ...
                                                    <td width="95"><table width="86" border="0" cellpadding="0" cellspacing="3" bgcolor="#e7e7e7">
                                                        <tr> 
                                                          <td bgcolor="#FFFFFF"><table width="80" border="0" cellpadding="0" cellspacing="2" bgcolor="#cccccc">
                                                              <tr> 
                                                                <td><img src="/images/user/kocca/course/jason.jpg"></td>
                                                              </tr>
                                                            </table></td>
                                                        </tr>
                                                      </table></td>
                                                    <td width="1"><img src="/images/user/kocca/course/vline.gif" ></td>
                                                    <td width="150" class="tbl_grc">Jason Lee<br>
                                                    (ascend world wide LLC)</td>
                                                    <td width="1"><img src="/images/user/kocca/course/vline.gif" ></td>
                                                    <td>&nbsp;</td>
                                                    <td width="360" bgcolor="#F7F1C5"  class="tbl_gleft"><p>미국 엔터테인먼트산업 시장 개관 외에 출판만화, 애니메이션, 차세대 텔레비전, 음악, 영화 등의 다양한 세부 시장에 대해 이해할 수 있다.</p></td>
                                                    <td>&nbsp;</td>
                                                  </tr>
                                                  <tr> 
                                                    <td height="7" colspan="8"></td>
                         ...
                         cellpadding="3"   style="border-collapse:collapse;" bordercolor="#DFDFE0"  frame="hsides">
                                            ...
                                            <tr> 
                                              ...
                                              <td rowspan="4" bgcolor="#ECF2E3" class="tbl_grc"><font color="#000000">일본문화콘덴츠<br>
                                                산업의 이해</font></td>
                                            ...
                                            <tr> 
                                              ...
                                              <td rowspan="4" bgcolor="#E6EACA" class="tbl_grc"><font color="#000000">중국문화콘덴츠<br>
                                                산업의 이해</font></td>
                                            ...
                                            <tr> 
                                              ...
                                              <td rowspan="4" bgcolor="#ECF2E3" class="tbl_grc"><font color="#000000">미국문화콘덴츠<br>
                                                산업의 이해</font></td>
