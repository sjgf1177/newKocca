...
//**********************************************************
//  1. 제      목: SUBJECT LIST
//  2. 프로그램명:  ku_CourseIntroSometime_L.jsp
//  3. 개      요: 과정조회 (수시과정)
//  4. 환      경: JDK 1.3
//  5. 버      젼: 1.0
//  6. 작      성: 2004.01.12
...
<form name="form1" method="post" >
    ...
    <input type='hidden' name='p_subjtype'    value="sometime">
                        ...
                        <table width="680" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="102">
                              <a href="javascript:whenTabSelect('')"><img src="/images/user/kocca/course/tab_som06.gif" name="Image316"  id="Image316" onMouseOver="MM_swapImage('Image316','','/images/user/kocca/course/tab_som06_on.gif',1)" onMouseOut="MM_swapImgRestore()""></a>
                            </td>
							<td width="3">&nbsp;</td>
							<td width="94">
                            <% if (v_sphere.equals("1")) {                   %>
                              <img src="/images/user/kocca/course/tab_som01_on.gif">
                            <% } else {                                             %>
                              <a href="javascript:whenTabSelect('1')"><img src="/images/user/kocca/course/tab_som01.gif" name="Image311"  id="Image311" onMouseOver="MM_swapImage('Image311','','/images/user/kocca/course/tab_som01_on.gif',1)" onMouseOut="MM_swapImgRestore()"></a>
                            <% }                                                    %>
                            </td>
                            <td width="3">&nbsp;</td>
                            <td width="94">
                            <% if (v_sphere.equals("2")) {                   %>
                              <img src="/images/user/kocca/course/tab_som02_on.gif">
                            <% } else {                                             %>
                              <a href="javascript:whenTabSelect('2')"><img src="/images/user/kocca/course/tab_som02.gif" name="Image312"  id="Image312" onMouseOver="MM_swapImage('Image312','','/images/user/kocca/course/tab_som02_on.gif',1)" onMouseOut="MM_swapImgRestore()"></a>
                            <% }                                                    %>
                            </td>
                            <td width="3">&nbsp;</td>
                            <td width="94">
                            <% if (v_sphere.equals("3")) {                   %>
                              <img src="/images/user/kocca/course/tab_som03_on.gif">
                            <% } else {                                             %>
                              <a href="javascript:whenTabSelect('3')"><img src="/images/user/kocca/course/tab_som03.gif" name="Image313"  id="Image313" onMouseOver="MM_swapImage('Image313','','/images/user/kocca/course/tab_som03_on.gif',1)" onMouseOut="MM_swapImgRestore()"></a>
                            <% }                                                    %>
                            </td>
                            <td width="3">&nbsp;</td>
                            <td width="94">
                            <% if (v_sphere.equals("4")) {                   %>
                              <img src="/images/user/kocca/course/tab_som04_on.gif">
                            <% } else {                                             %>
                              <a href="javascript:whenTabSelect('4')"><img src="/images/user/kocca/course/tab_som04.gif" name="Image314"  id="Image34" onMouseOver="MM_swapImage('Image314','','/images/user/kocca/course/tab_som04_on.gif',1)" onMouseOut="MM_swapImgRestore()"></a>
                            <% }                                                    %>
                            </td>
                            <td width="3">&nbsp;</td>
                            <td width="94">
                            <% if (v_sphere.equals("5")) {                   %>
                              <img src="/images/user/kocca/course/tab_som05_on.gif">
                            <% } else {                                             %>
                              <a href="javascript:whenTabSelect('5')"><img src="/images/user/kocca/course/tab_som05.gif" name="Image315"  id="Image315" onMouseOver="MM_swapImage('Image315','','/images/user/kocca/course/tab_som05_on.gif',1)" onMouseOut="MM_swapImgRestore()"></a>
                            <% }                                                    %>
                            </td>
                            <td width="295">&nbsp;</td>
                          </tr>
                        ...
                        <!--장르별분야_서브텍스트-->
                          <table width="680" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="144"><div align="center"><img src="/images/user/kocca/course/text_sub_sp<%=v_img_type%>.gif" ></div></td>
                            <td width="1" class="tbl_bleft5"><img src="/images/user/kocca/course/vline.gif" ></td>
                            <td class="tbl_bleft5"><img src="/images/user/kocca/course/text_sub_sp06-1.gif" ></td>
                          </tr>
                          <tr>
