...
<%
	...
	box.put("leftmenu","04");        
	//String v_grcode = box.getStringDefault("p_grcode","K01");
...
<table cellpadding="0" cellspacing="0" width="680">
  ...
  <col width="3">
  <col width="590">
  <tr valign="bottom" bgcolor="#F3D1B5" height="25"> 
    <td style="padding:0 0 4 10;color:#000000;">분류</td>
    <td><img src="/images/user/game/apply/tbl_bar.gif"></td>
    <td style="padding:0 0 4 10;font-weight:bold;"><%=v_gubunnm %></td>
  </tr>
  <tr height="1" id="tr_subjLine1"> 
    <td colspan="3" background="/images/user/kocca/apply/tbl_dot.gif"></td>
  </tr>
  ...
  <tr valign="bottom" bgcolor="#F3D1B5" height="25" id="tr_subjseq"> 
  ...
  <tr valign="bottom" bgcolor="#F3D1B5" height="25"> 
    ...
    <td><img src="/images/user/game/apply/tbl_bar.gif"></td>
    <td style="padding:0 0 4 10;font-weight:bold;"><%= v_subjnm%></td>
  </tr>
  <tr height="1"> 
    <td colspan="3" background="/images/user/kocca/apply/tbl_dot.gif"></td>
  </tr>
  ...
  <tr height="4"> 
    <td colspan="3" bgcolor="#E6BA95"></td>
  </tr>
</table>
<table width="680" border="0" cellspacing="0" cellpadding="0">
  <tr>
  ...
  <tr> 
    <td><img src="/images/user/kocca/myclass/st_offline_guide.gif" ></td>
  </tr>
  <tr> 
    <td height="10">&nbsp;</td>
  </tr>
</table>
<table width="680" border="0" cellpadding="0" cellspacing="0" background="/images/user/kocca/myclass/off_box_bg.gif">
  <tr>
    <td valign="top"><img src="/images/user/kocca/myclass/off_box_top.gif"></td>
  </tr>
  <tr>
    <td align="center">
	<!-- 안내내용자리테이블 -->
  ...
  <tr>
    <td><img src="/images/user/kocca/myclass/off_box_bo.gif"></td>
  </tr>
</table>
<table width="680" border="0" cellspacing="0" cellpadding="0">
  <tr>
  ...
  <tr>
    <td height="20" align="right"><img src="/images/user/kocca/button/btn_list.gif" onClick="history.back()" style="cursor:hand"></td>
  </tr>
