...
//**********************************************************
//  1. 제      목: SUBJECT LIST
//  2. 프로그램명:  ku_CourseIntroRecognition_L.jsp
//  3. 개      요: 과정조회 (학점인증)
//  4. 환      경: JDK 1.3
//  5. 버      젼: 1.0
//  6. 작      성: 2004.01.12
...
<!--
    ...
    function whenSubjInfo(subj,sphere){
        ...
        document.form1.p_rprocess.value = 'SubjectListRecognition';
        document.form1.action='/servlet/controller.course.KCourseIntroServlet';
        document.form1.target = "_self";
        document.form1.submit();
    }
...
<form name="form1" method="post" >
    ...
    <input type='hidden' name='p_subjtype'    value="recognition">
                        ...
                        <table width="680" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td width="94"><a href="javascript:whenTabSelect('')"><img src="/images/user/kocca/course/tab_reco02.gif" name="Image312"  id="Image312" onMouseOver="MM_swapImage('Image312','','/images/user/kocca/course/tab_reco02_on.gif',1)" onMouseOut="MM_swapImgRestore()"></a></td>
							<td width="3">&nbsp;</td>
							<td width="94"><img src="/images/user/kocca/course/tab_reco01_on.gif"></td>
                            <td width="490">&nbsp;</td>                         
                          </tr>
                          <tr> 
                        ...
                        <table width="680" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td width="144"><div align="center"><img src="/images/user/kocca/course/text_t_reco.gif" ></div></td>
                            <td width="1" class="tbl_bleft5"><img src="/images/user/kocca/course/vline.gif" ></td>
                            <td class="tbl_bleft5"><img src="/images/user/kocca/course/text_t_reco_02.gif" ></td>
                          </tr>
                          <tr> 
