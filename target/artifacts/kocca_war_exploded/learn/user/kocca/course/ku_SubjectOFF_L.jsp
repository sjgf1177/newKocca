            ...
            <table width="730" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                ...
                <table width="675" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td width="75"><img src="/images/user/support/search_img.gif"></td>
                      <td width="75">
                      ...
                      <td width="394"><a href="javascript:subjSearch()"><img src="/images/user/button/btn_search.gif"></a></td>
                    </tr>
                    <tr> 
                  ...
                  <table width="675" border="0" cellspacing="0" cellpadding="0" bgcolor="EBF6EE">
                    ...
                    <tr> 
                      <td width="98" valign="top"><a href="javascript:whenSelect('ON','<%=v_gubun%>')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image28','','/images/user/apply/tab_cyber_on.gif',1)"><img src="/images/user/apply/tab_cyber.gif" name="Image28" width="98" height="22" border="0"></a> 
                      </td>
                      <td width="98" valign="top" ><img src="/images/user/apply/tab_jib_on.gif" width="98" height="22"></td>
                      <td width="98" >&nbsp;</td>
                      <td width="377" >&nbsp;</td>
                    </tr>
                    <tr> 
