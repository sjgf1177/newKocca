    ...
    <input type='hidden' name='p_subj'     value="">
                        ...
                        <table width="680" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td>&nbsp;</td>
                            <td width="66"><img src="/images/user/kocca/course/tab_ct_on.gif" name="Image13" width="66" height="30" border="0"  id="Image13"></td>
                            <td>&nbsp;</td>
                        ...
                        <table width="680" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td width="144"><div align="center"><img src="/images/user/kocca/course/text_sub_ct01.gif"></div></td>
                            <td width="1" class="tbl_bleft5"><img src="/images/user/kocca/course/vline.gif" width="1" height="43" ></td>
                            <td class="tbl_bleft5"><img src="/images/user/kocca/course/text_sub_ct02.gif" ></td>
                          </tr>
                          <tr> 
                                ...
                                <tr> 
                                  ...
                                  <td><table width="631" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr> 
                                        ...
                                        <td width="554"><img src="/images/user/kocca/course/im_ct.gif" width="230" height="80"></td>
                                      </tr>
                                    </table>
                                    ...
                                    <table width="631" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr> 
                                        ...
                                        <td width="479"><strong>차세대기술 CT개론</strong></td>
                                                    ...
                                                    <td width="95"><table width="86" border="0" cellpadding="0" cellspacing="3" bgcolor="#e7e7e7">
                                                        <tr> 
                                                          <td bgcolor="#FFFFFF"><table width="80" border="0" cellpadding="0" cellspacing="2" bgcolor="#cccccc">
                                                              <tr> 
                                                                <td><img src="/images/user/kocca/course/ct_ljd.jpg" width="80" height="70" border="0"></td>
                                                              </tr>
                                                            </table></td>
                                                        </tr>
                                                      </table></td>
                                                    <td width="1"><img src="/images/user/kocca/course/vline.gif" ></td>
                                                    <td width="150" class="tbl_grc">이재동<br>(단국대학교 교수)</td>
                                                    <td width="1"><img src="/images/user/kocca/course/vline.gif" ></td>
                                                    <td>&nbsp;</td>
                                                    <td width="360" bgcolor="#F7F1C5"  class="tbl_gleft"><p>CT 산업에 대해 이해하고, 이론과 사례를 통해 CT의 활용 방안을 정립해 본다.</p></td>
                                                    <td>&nbsp;</td>
                                                  </tr>
                                                  <tr> 
                                                    <td height="7" colspan="8"></td>
                                    ...
                                    <table width="631" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr> 
                                        ...
                                        <td width="480"><strong>사례로 알아보는 CT</strong> 
                                        </td>
                                        <td width="76"><div align="right"></div></td>
                                        <td width="58"><!--a href="#"><img src="/images/user/kocca/course/i_sample_class.gif" border="0"></a--></td>
                                      </tr>
                                                  ...
                                                  <tr> 
                                                    ...
                                                    <td width="95"><table width="86" border="0" cellpadding="0" cellspacing="3" bgcolor="#e7e7e7">
                                                        <tr> 
                                                          <td bgcolor="#FFFFFF"><table width="80" border="0" cellpadding="0" cellspacing="2" bgcolor="#cccccc">
                                                              <tr> 
                                                                <td><img src="/images/user/kocca/course/ct_pym.jpg" width="80" height="70" border="0"></td>
                                                              </tr>
                                                            </table></td>
                                                        </tr>
                                                      </table></td>
                                                    <td width="1"><img src="/images/user/kocca/course/vline.gif" ></td>
                                                    <td width="150" class="tbl_grc">박영민<br>(인디펜던스 상무이사)</td>
                                                    <td width="1"><img src="/images/user/kocca/course/vline.gif" ></td>
                                                    <td>&nbsp;</td>
                                                    <td width="360" bgcolor="#F7F1C5"  class="tbl_gleft"><p>문화 콘텐츠 산업에서의 핵심 기술로 자리잡은 CG 영상기술의 개념적 이해와 각 산업별 실제 적용사례를 통해, 그 가능성과 향후 다양한 비즈니스 모델을 예측한다.</p></td>
                                                    <td>&nbsp;</td>
                                                  </tr>
                                                  <tr> 
                                                    <td height="7" colspan="8"></td>
                                    ...
                                    <table width="631" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr> 
                                        ...
                                        <td width="480"><strong>차세대 블루오션 CT비즈니스전략</strong></td>
                                        <td width="76"><div align="right"></div></td>
                                        <td width="58"><!--a href="#"><img src="/images/user/kocca/course/i_sample_class.gif" border="0"></a--></td>
                                      </tr>
                                      <tr> 
                                                  ...
                                                  <tr> 
                                                    ...
                                                    <td width="95"><table width="86" border="0" cellpadding="0" cellspacing="3" bgcolor="#e7e7e7">
                                                        <tr> 
                                                          <td bgcolor="#FFFFFF"><table width="80" border="0" cellpadding="0" cellspacing="2" bgcolor="#cccccc">
                                                              <tr> 
                                                                <td><img src="/images/user/kocca/course/ct_kwj.jpg" width="80" height="70" border="0"></td>
                                                              </tr>
                                                            </table></td>
                                                        </tr>
                                                      </table></td>
                                                    <td width="1"><img src="/images/user/kocca/course/vline.gif" ></td>
                                                    <td width="150" class="tbl_grc">김원제<br>(유플러스연구소 소장)</td>
                                                    <td width="1"><img src="/images/user/kocca/course/vline.gif" ></td>
                                                    <td>&nbsp;</td>
                                                    <td width="360" bgcolor="#F7F1C5"  class="tbl_gleft"><p>CT에 대한 비즈니스 관점을 구축하고, CT의 비지니스화를 위한 방법론을 알 수 있다.</p></td>
                                                    <td>&nbsp;</td>
                                                  </tr>
                                                  <tr> 
                                                    <td height="7" colspan="8"></td>
                                        ...
                                        <td>
                                          <table width="625" border="2" cellspacing="0" cellpadding="3"   style="border-collapse:collapse;" bordercolor="#DFDFE0"  frame="hsides">
                                            ...
                                            <tr> 
                                              ...
                                              <td rowspan="4" bgcolor="#ECF2E3" class="tbl_grc"><font color="#000000">차세대기술<br>CT개론</font></td>
                                            ...
                                            <tr> 
                                              ...
                                              <td rowspan="4" bgcolor="#E6EACA" class="tbl_grc"><font color="#000000">사례로<br>알아보는 CT</font></td>
                                            ...
                                            <tr> 
                                              ...
                                              <td rowspan="4" bgcolor="#ECF2E3" class="tbl_grc"><font color="#000000">차세대<br>블루오션<br>CT비즈니스전략</font></td>
