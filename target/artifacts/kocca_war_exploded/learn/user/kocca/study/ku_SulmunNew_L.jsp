...
// 가입경로 설문응시
function registWright(p_subj, p_grcode, p_gyear, p_subjseq, p_sulpapernum, p_sulpapernm, p_sulstart, p_sulend){
        ...
        document.form1.action = "/servlet/controller.research.SulmunRegistUserServlet";
...
function contentsWright(p_subj, p_grcode, p_gyear, p_subjseq, p_sulpapernum, p_sulpapernm, p_sulstart, p_sulend){
        ...
        farwindow = window.open("", "openSubjChange", "toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,copyhistory=no, width = 680, height = 538, top=0, left=0");
        document.form1.target = "openSubjChange";
        document.form1.action = "/servlet/controller.research.KSulmunContentsUserServlet";
        document.form1.p_process.value = "SulmunUserPaperListPage";
        document.form1.submit();
...
function contentsWright1(p_subjnm, p_subj, p_grcode, p_gyear, p_subjseq, p_sulpapernum, p_sulpapernm, p_sulstart, p_sulend, p_sulnums){
        ...
        farwindow = window.open("", "openSubjChange", "toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,copyhistory=no, width = 680, height = 538, top=0, left=0");
        document.form1.target = "openSubjChange";
        document.form1.action = "/servlet/controller.research.KSulmunSubjUserServlet";
        document.form1.p_process.value = "SulmunUserPaperListPage";
        document.form1.submit();
...
function targetWright(p_subj, p_grcode, p_gyear, p_subjseq, p_sulpapernum, p_sulpapernm, p_sulstart, p_sulend){
        ...
        document.form1.action = "/servlet/controller.research.KSulmunTargetUserServlet";
        document.form1.p_process.value = "SulmunUserPaperListPage";
        document.form1.submit();
...
function commonWright(p_subj, p_grcode, p_sulpapernum){
        ...
        farwindow = window.open("", "openSubjChange", "toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,copyhistory=no, width = 680, height = 538, top=0, left=0");
        document.form1.target = "openSubjChange";
        document.form1.action = "/servlet/controller.research.KSulmunCommonUserServlet";
        document.form1.p_process.value = "SulmunUserPaperListPage";
        document.form1.submit();
...
//-->
		 ...
		 <form name="form1" method="post" action="/servlet/controller.research.SulmunCommonUserServlet">
				...
				<input type="hidden" name="p_listok"  value="">
                          ...
                          <tr> 
                            <td  class="location">  HOME &gt; 마이클래스 &gt; 나의 설문</td>
                          </tr>
                        </table>
                        <table width="680" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td><img src="/images/user/kocca/myclass/<%=tem_subimgpath%>/tit_mypool.gif"></td>
                          </tr>
                          <tr> 
                            <td height="21"></td>
                          </tr>
						...
						<table width="680" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td><img src="/images/user/kocca/myclass/text_mypool.gif"></td>
                          </tr>
                          <tr> 
                            <td height="17"></td>
                          </tr>
						...
						<table width="680" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
							...
							<td width="67"><a href="javascript:showTab(1);" onMouseOver="MM_swapImage('Image31','','/images/user/kocca/myclass/tab_course_on.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="/images/user/kocca/myclass/tab_course_on.gif" name="Image31" border="0" id="Image31"></a></td>
							<td width="68"><a href="javascript:showTab(2);;" onMouseOver="MM_swapImage('Image32','','/images/user/kocca/myclass/tab_common_on.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="/images/user/kocca/myclass/tab_common.gif" name="Image32" border="0" id="Image32"></a></td>
							<td width="90"><a href="javascript:showTab(3);;" onMouseOver="MM_swapImage('Image33','','/images/user/kocca/myclass/tab_joinpass_on.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="/images/user/kocca/myclass/tab_joinpass.gif" name="Image33" border="0" id="Image33"></a></td>
							<td width="90"><a href="javascript:showTab(4);;" onMouseOver="MM_swapImage('Image34','','/images/user/kocca/myclass/tab_wealthy_on.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="/images/user/kocca/myclass/tab_wealthy.gif" name="Image34" border="0" id="Image34"></a></td>
							<td width="238"><img src="/images/user/kocca/myclass/tab_tail.gif"></td>
                          </tr>
						  <tr>
							<td colspan="7"><img src="/images/user/kocca/myclass/st_course.gif"></td>
						  </tr>
                          <tr> 
                       ...
                       <table width="675"  border="2" cellspacing="0" 
                          ...
                          <tr> 
                            <td width="5%" class="tbl_ptit2">번호</td>      
                         ...
                         <%    
                          ...
                          %>
                          <tr>
                            <td height="3" colspan="6" align="center">설문이 없습니다.</td>
                          </tr>
                          <% } %>   
                            </td>
...
%>                          
						...
						<table width="680" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td width="117"><img src="/images/user/kocca/myclass/ico_tab.gif"></td>
							<td width="10"><img src="/images/user/kocca/myclass/tab_first.gif"></td>
							<td width="67"><a href="javascript:showTab(1);" onMouseOver="MM_swapImage('Image31','','/images/user/kocca/myclass/tab_course_on.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="/images/user/kocca/myclass/tab_course.gif" name="Image31" border="0" id="Image31"></a></td>
							<td width="68"><a href="javascript:showTab(2);;" onMouseOver="MM_swapImage('Image32','','/images/user/kocca/myclass/tab_common_on.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="/images/user/kocca/myclass/tab_common_on.gif" name="Image32" border="0" id="Image32"></a></td>
							<td width="90"><a href="javascript:showTab(3);;" onMouseOver="MM_swapImage('Image33','','/images/user/kocca/myclass/tab_joinpass_on.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="/images/user/kocca/myclass/tab_joinpass.gif" name="Image33" border="0" id="Image33"></a></td>
							<td width="90"><a href="javascript:showTab(4);;" onMouseOver="MM_swapImage('Image34','','/images/user/kocca/myclass/tab_wealthy_on.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="/images/user/kocca/myclass/tab_wealthy.gif" name="Image34" border="0" id="Image34"></a></td>
							<td width="238"><img src="/images/user/kocca/myclass/tab_tail.gif"></td>
                          </tr>
						  <tr>
							<td colspan="7"><img src="/images/user/kocca/myclass/st_common.gif"></td>
						  </tr>
                          <tr> 
                            <td height="17" colspan="7"></td>
                          </tr>
                        ...
                        <table width="675" border="2" cellspacing="0" 
                         cellpadding="3"   style="border-collapse:collapse;" bordercolor="#ededed"  frame="hsides">
                          ...
                          <tr> 
                            <td class="tbl_grc"><%=i+1%></td>                                                                                
                            <td  class="tbl_bleft">
                            <%if(v_issul.equals("0")){%><a href="javascript:commonWright('<%=dbox2.getString("d_subj")%>', '<%=dbox2.getString("d_grcode")%>', '<%=v_sulpapernum%>')"><u><%=String.valueOf(dbox2.getString("d_sulpapernm"))%></u></a>                                                      
						...
						<table width="680" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
							...
							<td width="67"><a href="javascript:showTab(1);" onMouseOver="MM_swapImage('Image31','','/images/user/kocca/myclass/tab_course_on.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="/images/user/kocca/myclass/tab_course.gif" name="Image31" border="0" id="Image31"></a></td>
							<td width="68"><a href="javascript:showTab(2);;" onMouseOver="MM_swapImage('Image32','','/images/user/kocca/myclass/tab_common_on.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="/images/user/kocca/myclass/tab_common.gif" name="Image32" border="0" id="Image32"></a></td>
							<td width="90"><a href="javascript:showTab(3);;" onMouseOver="MM_swapImage('Image33','','/images/user/kocca/myclass/tab_joinpass_on.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="/images/user/kocca/myclass/tab_joinpass_on.gif" name="Image33" border="0" id="Image33"></a></td>
							<td width="90"><a href="javascript:showTab(4);;" onMouseOver="MM_swapImage('Image34','','/images/user/kocca/myclass/tab_wealthy_on.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="/images/user/kocca/myclass/tab_wealthy.gif" name="Image34" border="0" id="Image34"></a></td>
							<td width="238"><img src="/images/user/kocca/myclass/tab_tail.gif"></td>
                          </tr>
						  <tr>
							<td colspan="7"><img src="/images/user/kocca/myclass/st_joinpass.gif"></td>
						  </tr>
                          <tr> 
                            <td height="17" colspan="7"></td>
                          </tr>
			...
			if(list3.size() != 0){		// 내용이 있다면
                          ...
                          <tr> 
                            ...
                            <td  class="tbl_bleft">
                                ...
                                <a href="javascript:registWright('<%=v_subj%>', '<%=v_grcode%>', '<%=v_year%>', '<%=v_subjseq%>', '<%=v_sulpapernum%>', '<%=v_sulpapernm%>', '<%=v_sulstart%>', '<%=v_sulend%>')"><u><%=String.valueOf(dbox3.getString("d_sulpapernm"))%></u></a>
                                <%}else{%>
...
%>
						...
						<table width="680" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
							...
							<td width="68"><a href="javascript:showTab(2);;" onMouseOver="MM_swapImage('Image32','','/images/user/kocca/myclass/tab_common_on.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="/images/user/kocca/myclass/tab_common.gif" name="Image32" border="0" id="Image32"></a></td>
							<td width="90"><a href="javascript:showTab(3);;" onMouseOver="MM_swapImage('Image33','','/images/user/kocca/myclass/tab_joinpass_on.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="/images/user/kocca/myclass/tab_joinpass.gif" name="Image33" border="0" id="Image33"></a></td>
							<td width="90"><a href="javascript:showTab(4);;" onMouseOver="MM_swapImage('Image34','','/images/user/kocca/myclass/tab_wealthy_on.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="/images/user/kocca/myclass/tab_wealthy_on.gif" name="Image34" border="0" id="Image34"></a></td>
							<td width="238"><img src="/images/user/kocca/myclass/tab_tail.gif"></td>
                          </tr>
						  <tr>
							<td colspan="7"><img src="/images/user/kocca/myclass/st_wealthy.gif"></td>
						  </tr>
                          <tr> 
                            <td height="17" colspan="7"></td>
                          </tr>
