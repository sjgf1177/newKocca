...
function selectList() {
    if (form1.p_searchtext.value == ""){
        ...
        var url =  "/servlet/controller.study.KMyQnaServlet?p_process=MyQnaStudyListPage&p_pageno=1";
...
function goPage(pageNum) {
    ...
    document.form1.action = "/servlet/controller.study.KMyQnaServlet";
...
<!-- title -->
                       <table width="680" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <table width="680" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><img src="/images/user/kocca/myclass/text_myconsult_new.gif"></td>
                          </tr>
                          <tr>
                            <td height="15"></td>
                          </tr>
						...
						<table width="680" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td><img src="/images/user/kocca/myclass/ico_tab.gif"></td>
							<td valign="bottom"><img src="/images/user/kocca/myclass/tab_first.gif"></td>
							<td valign="bottom"><a href="javascript:showTab(1);" onMouseOver="MM_swapImage('Image31','','/images/user/kocca/myclass/tab_myconsult01_on.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="/images/user/kocca/myclass/tab_myconsult01_off.gif" name="Image31" border="0" id="Image31"></a></td>
							<td valign="bottom"><a href="javascript:showTab(2);;" onMouseOver="MM_swapImage('Image32','','/images/user/kocca/myclass/tab_myconsult02_on.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="/images/user/kocca/myclass/tab_myconsult02_off.gif" name="Image32" border="0" id="Image32"></a></td>
							<td valign="bottom"><img src="/images/user/kocca/myclass/tab_myconsult_end.gif"></td>
                          </tr>
						  <tr>
							<td colspan="7"><!-- 학습관련 --><img src="/images/user/kocca/myclass/st_myconsult01.gif"></td>
						  </tr>
						  <!--tr>
							<td colspan="7"><!-- 사이트 관련 --><img src="/images/user/kocca/myclass/st_myconsult02.gif"></td>
						  </tr-->
                          <tr> 
                        ...
                        <table width="680" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><img src="/images/user/kocca/myclass/st_myconsult.gif" width="132" height="13" ></td>
                          </tr>
                          <tr>
                            <td height="9"><table width="680" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                  <td><table border="0" align="right" cellpadding="0" cellspacing="0">
                                      <tr>
                                        <td>&nbsp;</td>
                                        <td width="10"><select name="select2" class="input2">
                                            <option>:: 상세과정</option>
                                          </select></td>
                                        <td width="6">&nbsp;</td>
                                        <td width="135"> <input name="textfield" type="text" class="input4">
                                        </td>
                                        <td width="4"><div align="right"></div></td>
                                        <td width="37"><a href="#"><img src="/images/user/kocca/button/btn_search.gif"  border="0"></a></td>
                                      </tr>
                                    </table></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  ...
                                  <td width="269" class="tbl_gleft">
                                        ...
                                        <%if (FormatDate.getDate("yyyyMMdd").equals(FormatDate.getFormatDate(v_indate, "yyyyMMdd"))){%>
                                            <IMG src="/images/user/kocca/button/b_re.gif" border="0">
