                            ...
                            <td height="20"><table width="680" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr> 
                                  <td height="27" class="linecolor_notice"><table width="52" border="0" align="right" cellpadding="0" cellspacing="0">
                                      <tr> 
                                        <td><a href="/servlet/controller.study.KMyClassServlet?p_process=MyQnaSiteListPage&p_pageno=<%=v_pageno%>"><img src="/images/user/kocca/button/btn_list.gif" border="0"></a></td>
                                      </tr>
                                    </table></td>
                                </tr>
                                <tr> 
