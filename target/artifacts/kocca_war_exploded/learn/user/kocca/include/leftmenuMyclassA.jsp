<%@ page import = "com.credu.templet.*" %>
                  ...
                  <table width="195" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><img src="/images/user/kocca/myclass/type1/lm_tit.gif"></td>
                    </tr>
                  </table>
<%
...
%>                
                  ...
                  <% if (!lmenu_menuname.equals("마일리지")) { %>
                  <table width="195" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a href="javascript:menuForward('<%=topmenu%>', '<%=lmenu_menuid%>', '<%=lmenu_orders%>')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2<%=m%>','','/images/user/kocca/myclass/type1/<%=lmenu_menuoverimg%>',1)"><img src="/images/user/kocca/myclass/type1/<%=lmenu_selmenuimg%>" name="Image2<%=m%>" border="0"></a><br>
                      </td>
                    </tr>
                  </table>
                  <% } %>
...
%>
                  ...
                  <table width="195" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td><img src="/images/user/kocca/myclass/type1/lm_bo.gif" width="195" height="22"></td>
                    </tr>
                  </table>
