...
<body bgcolor="#FFFFFF" background="/images/user/kocca/member/<%=tem_subimgpath%>/subbg.jpg" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
<!----------------- 공통폼 / 메뉴이동스크립트 시작 ----------------->
        ...
        <tr> 
          <td width="916">
            <table width="916" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td rowspan="3" valign="top"><img src="/images/user/kocca/logo/type2/logo.jpg" ></td>
                <td colspan="2"> 
                </td>
              </tr>
              <tr>
          ...
          <td width="916" valign="top"><table width="916" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td width="195" valign="top">
                  ...
                  <!-----------------  left menu 시작 ----------------->
                  <%@ include file="/learn/user/kocca/include/leftmenuSiteMapB.jsp"%>
                  <!-----------------  left menu 끝 ------------------>
                ...
                <td width="721" valign="top">
                  <table width="721" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td valign="bottom"><img src="/images/user/kocca/common/type2/top_center.gif" width="721" height="10"></td>
                    </tr>
                  </table>
