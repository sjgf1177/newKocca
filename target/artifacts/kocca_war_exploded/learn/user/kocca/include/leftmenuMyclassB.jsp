                 <table width="195" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td align="right"><img src="/images/user/kocca/myclass/type2/lm_tit.gif"></td>
                    </tr>
                  </table>
<%
...
%>
                  ...
                  <table width="195" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a href="javascript:menuForward('<%=topmenu%>', '<%=lmenu_menuid%>', '<%=lmenu_orders%>')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2<%=m%>','','/images/user/kocca/myclass/type2/<%=lmenu_menuoverimg%>',1)"><img src="/images/user/kocca/myclass/type2/<%=lmenu_selmenuimg%>" name="Image2<%=m%>" border="0"></a><br>
                      </td>
                    </tr>
                  </table>
