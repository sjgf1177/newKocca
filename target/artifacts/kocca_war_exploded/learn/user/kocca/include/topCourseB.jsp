...
<body bgcolor="#FFFFFF" background="/images/user/kocca/course/<%=tem_subimgpath%>/<%=tem_subbg1%>" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" <%=onLoad%> >
          ...
          <td width="916" valign="top"><table width="916" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td width="195" valign="top">
                  ...
                  <!-----------------  left menu 시작 ----------------->
                        <%@ include file="/learn/user/kocca/include/leftmenuCourseB.jsp"%>
                  <!-----------------  left menu 끝 ------------------>
                ...
                <td width="721" valign="top">
                  <table width="721" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td valign="bottom"><img src="/images/user/kocca/course/type2/top_center.gif"></td>
                    </tr>
                  </table>
                  <table width="721" border="0" cellpadding="0" cellspacing="0" background="/images/user/kocca/course/type2/bg_center.gif" bgcolor="#FFFFFF">
                    <tr> 
                      <td width="20">&nbsp;</td>
                      <td valign="top">