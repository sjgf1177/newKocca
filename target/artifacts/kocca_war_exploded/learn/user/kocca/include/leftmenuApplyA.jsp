                  <table width="195" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><img src="/images/user/kocca/apply/type1/lm_tit.gif"></td>
                    </tr>
                  </table> 
<%
...
%>
				  ...
				  <% if (!lmenu_menuname.equals("±³À°ÀÏÁ¤")) { %>
                  <table width="195" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td valign="top"><a href="javascript:menuForward('<%=topmenu%>', '<%=lmenu_menuid%>', '<%=lmenu_orders%>')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2<%=m%>','','/images/user/kocca/apply/type1/<%=lmenu_menuoverimg%>',1)"><img src="/images/user/kocca/apply/type1/<%=lmenu_selmenuimg%>" name="Image2<%=m%>" border="0"></a></td>
                    </tr>
                  </table> 
                  <% } %>
...
%>
                  <table width="195" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td valign="top"><img src="/images/user/kocca/apply/type1/lm_bo.gif"></td>
                    </tr>
                  </table>
				  <table width="195" border="0" cellspacing="0" cellpadding="0">
				    <tr> 
