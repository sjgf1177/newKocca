...
<body bgcolor="#FFFFFF" background="/images/user/kocca/aboutus/<%=tem_subimgpath%>/<%=tem_subbg4%>" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" <%=onLoad%>>
        ...
        <tr> 
          <td width="916">
            <table width="916" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td rowspan="3" width="203" height="83" valign="top"><a href="/"><img src="<%=tem_imgpath%><%=tem_toplogo%>" border="0"></a></td>
                <td colspan="2"> 
                </td>
              </tr>
              <tr>
          ...
          <td width="916" valign="top"><table width="916" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td width="195" valign="top">
                  ...
                  <!-----------------  left menu 시작 ----------------->
                  <%@ include file="/learn/user/kocca/include/leftmenuAboutB.jsp"%>
                  <!-----------------  left menu 끝 ------------------>
                ...
                <td width="721" valign="top">
                  <table width="721" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td valign="bottom"><img src="/images/user/kocca/aboutus/type2/top_center.gif"></td>
                    </tr>
                  </table>
                  <table width="721" border="0" cellpadding="0" cellspacing="0" background="/images/user/kocca/aboutus/type2/bg_center.gif" bgcolor="#FFFFFF">
                    <tr>
                      <td width="20">&nbsp;</td>
                      <td valign="top">