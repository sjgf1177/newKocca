...
<body bgcolor="#FFFFFF" background="/images/user/kocca/common/<%=tem_subimgpath%>/<%=tem_subbg5%>" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" <%=onLoad%>>
          ...
          <td width="916" valign="top"><table width="916" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td width="195" valign="top"><table width="195" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <!-----------------  left menu 시작 ----------------->
                  <%@ include file="/learn/user/kocca/include/leftmenuOpenkoccaA.jsp"%>
                  <!-----------------  left menu 끝 ------------------>
                </td>
                <td width="721" valign="top"><table width="721" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><img src="/images/user/kocca/openkocca/<%=tem_subimgpath%>/<%=tem_subtopimg5%>" ></td>
                    </tr>
                  </table>
