...
<title>[특강] 3월 29일 열린 강좌 안내</title>
...
<map name="Map">
    ...
    <area shape="rect" coords="136,156,255,192" href="http://contents.connect.or.kr/servlet/controller.homepage.KHomeNoticeServlet?p_process=selectView&p_seq=343" onFocus="this.blur()" target="_blank"/>
</map>
