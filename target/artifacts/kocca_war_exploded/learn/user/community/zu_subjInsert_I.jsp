...
<%= CodeConfigBean.getCodeSelect("noticeCategory","",1,"p_types",v_types,"onChange='javascript:selectCategory()'",0,"") %>
<!-- 공지구분 SELECT BOX  END     -->
            </td>
        ...
        <table  border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td align="center"><a href='javascript:insert_check()'><img src="/images/admin/button/btn_save.gif" alt="저장" border="0"></a></td>
			<td width=8></td>
            <td align="center"><a href='javascript:list()'><img src="/images/admin/button/btn_cancel.gif" alt="취소" border="0"></a></td>
          </tr>
        </table>
        <!----------------- 저장, 취소 버튼 끝 ----------------->
