...
<form name = "form1" enctype = "multipart/form-data" method = "post">
    ...
    <input type = "hidden" name = "p_parentseq" value="0"   >
            ...
            <tr class="bo">
                <th class="th">제목</th>
                <td colspan="3" class="td"><input name="p_title" id="subject" type="text" class="inbox" style="width:500px;" value="<%=v_title%>"/></td>
            </tr>
            <tr class="bo">
            ...
            String i_ServletName       = "RiskMenagermentServlet";                        // 저장 서블릿 이름
            ...
            <p class="board_btn"><a href="javascript:insert();" class="board_blue mg_r5"><span>저장</span></a><a href="javascript:history.back(-1);" class="board_blue mg_r5"><span>취소</span></a><a href="javascript:history.back(-1);" class="board_blue"><span>목록</span></a></p>
