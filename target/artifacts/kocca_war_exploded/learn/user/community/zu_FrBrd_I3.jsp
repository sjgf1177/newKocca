...
<% for(int k=0;k<Integer.parseInt((String)request.getAttribute("fielcnt"));k++){%>
                        <input name="p_file<%=(k+1)%>" id="hFileMainBg" type="file" class="input" oncontextmenu="return false" onkeydown="return File_CancelKeyInput();" style="IME-MODE: disabled; HEIGHT: 22px" size="45" /><br>
<%}%>
                                          </div>
                                      ...
                                      <tr> 
                                        ...
                                        <td valign="top" class="tbl_gleft" ><input name="p_title" type="text" class="input2" size="92"></td>
                                      </tr>
