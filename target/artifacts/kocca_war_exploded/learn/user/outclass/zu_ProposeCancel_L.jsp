              ...
              <tr> 
                <td align="center" valign="top">
                  <table width="675" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td valign="top"><img src="/images/user/<%=site%>/tit_apply_c.jpg"></td>
                    </tr>
                    <tr> 
                      <td height="20"></td>
                    </tr>
                       ...
                       for(i = 0; i < list1.size(); i++) {
                           ...
                           if(v_cancelkind.equals("")){
                             if (v_chkfinal.equals("Y")){
                               v_FinalStatusImg = "<img src=/images/user/"+site+"/btn_approve.gif >";
                             }else if (v_chkfinal.equals("N")){
                               v_FinalStatusImg = "<img src=/images/user/"+site+"/btn_ban.gif >";
                             }else if (v_chkfinal.equals("B")){
//                               v_FinalStatusImg = "<img src=/images/user/myhome/b_submiting.gif >";
                                 v_FinalStatusImg = "<a href=\"javascript:whenProposeCancel('"+v_userid+"','"+v_subj+"','"+v_year+"','"+v_subjseq+"')\"><img src='/images/user/"+site+"/btn_apply_cancel.gif' border='0'></a>";
