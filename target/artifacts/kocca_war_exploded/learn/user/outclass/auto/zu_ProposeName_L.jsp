            ...
            <table width="730" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td align="center" valign="top">
                  ...
                  <table width="675" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td width="565" valign="top"><img src="/images/user/<%=site%>/st_applyview.gif"></td>
                      <td width="110" align="right" valign="top"><a href="javascript:history.back()"><img src="/images/user/<%=site%>/btn_list.gif" border="0"></a> 
                      </td>
                    </tr>
                    <tr> 
