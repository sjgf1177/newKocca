                    ...
                    <tr>
                      ...
                      <td width="547" align="right" valign="top">
                       ...
                       <table width="400" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="84"><a href="javascript:whenSubjBest()"><img src="/images/user/<%=site%>/btn_c_bestinfo.gif" border="0"></a></td>
                            ...
                            <%}%>
                            <td width="83"><a href="javascript:whenSubjList('<%=v_subj%>')" onfocus="this.blur()"><img src="/images/user/<%=site%>/btn_c_totalview.gif" border="0"></a></td>
                          </tr>
                        </table>
...
-->
                    ...
                    <tr>
                      <td height="15" colspan="2"><img src="/images/user/<%=site%>/st_edudate.gif"></td>
                    </tr>
                    <tr>
                      <td height="5" colspan="2"></td>
                    </tr>
