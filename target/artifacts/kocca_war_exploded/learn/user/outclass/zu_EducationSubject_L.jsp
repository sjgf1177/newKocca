...
<form name= "form1" method= "post">
    ...
    <input type='hidden' name='p_kind' value="">
              ...
              <tr> 
                <td align="center" valign="top"> 
                  <table width="675" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td valign="top"><img src="/images/user/<%=site%>/tit_myclass.jpg"></td>
                    </tr>
                    <tr> 
                      <td height="20"></td>
                    </tr>
      ...
      <table width="675" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="474" valign="top"><img src="/images/user/<%=site%>/st_study1.gif"> 
          </td>
        ...
        <tr> 
          <td colspan="2" class="font_ex">과정명을 클릭하시면 학습창으로 이동합니다. 학습하시고자 하는 과정명을 
            클릭하세요.</td>
        </tr>
        <tr> 
          <td height="5" colspan="2"></td>
...
%>
              <tr> 
                ...
                <td class="tbl_grc"><% if(v_isonoff.equals("ON")){ %>
                  <a href="javascript:whenEdulist('<%=v_subjnm%>','<%=v_ieduurl%>','','<%=v_edulist_value%>')"><img src="/images/user/<%=site%>/btn_m_studyview.gif" border="0"></a>
                  <%}else{%>
                  -
                  <%}%></td>
                <td class="tbl_grc"><% if(v_isonoff.equals("ON")){ %>
                    <% if (v_controlstudy >0) {         %>
                          <a href="javascript:controlstudy()"><img src="/images/user/<%=site%>/btn_m_studydo.gif" width="60" height="17" border="0"></a>
                    <% } else {                         %>
                          <a href="javascript:studyOpen('<%=v_eduurl%>','<%=v_ieduurl%>')"><img src="/images/user/<%=site%>/btn_m_studydo.gif" width="60" height="17" border="0"></a>
                    <% }                                %>
                  <%}else{%>
                  -
                  <%}%></td>
...
%>
        ...
        <tr> 
          <td colspan="2"><img src="/images/user/<%=site%>/st_study2.gif"></td>
        </tr>
        <tr> 
          <td height="5" colspan="2"></td>
        </tr>
...
%>
              <tr> 
                ...
                <td class="tbl_grc"><% if (v_hasPreviewObj.equals("Y")) { %>
                  <a href="javascript:studyOpen1('/servlet/controller.contents.EduStart?p_subj=<%=v_subj%>&p_year=2000&p_subjseq=0001&p_ispreview=Y', '<%=v_subj%>')" onfocus=this.blur()><img src="/images/user/<%=site%>/btn_m_preview.gif" border="0"></a>
                  <% } else { %>
                  <% if(!v_preurl.equals("")){ %>
                  <a href="javascript:whenPreShow('<%=v_preurl%>', '<%=v_subj%>')" onfocus=this.blur()><img src="/images/user/<%=site%>/btn_m_preview.gif" border="0"></a>
                  <%}%>
                  <% } %></td>
              </tr>
              <%
...
%>
        ...
        <tr> 
          <td colspan="2"><img src="/images/user/<%=site%>/st_study3.gif"></td>
        </tr>
        <tr> 
          <td height="5" colspan="2"></td>
        </tr>
        ...
        <tr>
          <td colspan="2" class="font_ex"><img src="/images/user/<%=site%>/class_text.gif"></td>
        </tr>
        <tr> 
...
%>
              <tr> 
                ...
                <td class="tbl_grc">-</td>
                <%}%>
                <td class="tbl_grc"><a href="javascript:whenEdulist('<%=v_subjnm%>','<%=v_ieduurl%>','Y','<%=v_edulist_value%>')"><img src="/images/user/<%=site%>/btn_m_sungview.gif" border="0"></a></td>
                <td class="tbl_grc"> <%if(v_isablereview.equals("Y")){%> <a href="javascript:studyOpen('<%=v_eduurl%>','<%=v_ieduurl%>')"><img src="/images/user/<%=site%>/btn_m_exdo.gif" border="0"></a> 
                  <%}%> </td>
                <td class="tbl_grc">
