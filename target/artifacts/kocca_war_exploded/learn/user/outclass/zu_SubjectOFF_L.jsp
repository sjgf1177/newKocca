              ...
              <tr> 
                <td align="center" valign="top">
                  ...
                  <table width="675" border="0" cellspacing="0" cellpadding="0" bgcolor="EBF6EE">
                    ...
                    <tr> 
                      <td width="98" valign="top"><a href="javascript:whenSelect('ON','<%=v_gubun%>')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image28','','/images/user/<%=site%>/tab_cyber_on.gif',1)"><img src="/images/user/<%=site%>/tab_cyber.gif" name="Image28" width="98" height="22" border="0"></a> 
                      </td>
                      <td width="98" valign="top" ><img src="/images/user/<%=site%>/tab_jib_on.gif" width="98" height="22"></td>
                      <td width="98" >&nbsp;</td>
                      <td width="377" >&nbsp;</td>
                    </tr>
                    <tr> 
                  ...
                  <table width="675" border="0" cellpadding="0" cellspacing="0" bgcolor="EBF6EE">
                    <tr> 
                      <td width="105"> <table width="105" border="0" cellpadding="0" cellspacing="0" background="/images/user/<%=site%>/tab_bg_on.gif">
                          <tr> 
