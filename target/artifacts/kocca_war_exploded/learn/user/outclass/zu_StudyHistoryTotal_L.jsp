              ...
              <tr> 
                <td align="center" valign="top"> 
                  <table width="675" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td valign="top"><img src="/images/user/<%=site%>/tit_personal.jpg"></td>
                    </tr>
                    <tr> 
                      <td height="20"></td>
                    </tr>
                  ...
                  <table width="675" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td height="5" colspan="2" valign="top"> 
                        <!-- 개인정보 table -->
                        <table width="675" border="0" cellpadding="0" cellspacing="0" background="/images/user/<%=site%>/pe_box_bg.gif">
                          <tr> 
                            <td><img src="/images/user/<%=site%>/pe_box_top.gif"></td>
                          </tr>
                          <tr> 
                            <td align="center"><table width="630" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="96" rowspan="3" align="center" valign="top"><img src="/images/user/<%=site%>/pe_img.gif" ></td>
                                  <td width="275" class="tbl_ble"><strong>I&nbsp;&nbsp;&nbsp;&nbsp;D :</strong> <%=v_user_id%></td>
                                  <td>&nbsp;</td>
                                  <td class="tbl_ble"><strong>이 름 :</strong> <%=v_name%></td>
                                </tr>
                                <tr> 
                                  <td height="4" background="/images/user/<%=site%>/stu_box_vline2.gif"></td>
                                  <td width="13" height="4"></td>
                                  <td width="246" height="4" background="/images/user/<%=site%>/stu_box_vline2.gif"></td>
                                </tr>
                                <tr> 
                          ...
                          <tr> 
                            <td><img src="/images/user/<%=site%>/pe_box_bo.gif"></td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr> 
                    ...
                    <tr> 
                      <td width="474" valign="top"><img src="/images/user/<%=site%>/st_pe1.gif" > 
                      </td>
                      <td width="201" align="right" valign="top"><a href="javascript:whenExcel()"><img src="/images/user/<%=site%>/btn_print.gif" border="0"></a></td>
                    </tr>
                    <tr> 
...
%>
                          <tr> 
                            ...
                            <td class="tbl_grc">
                            <%if (!v_subj.equals("")) {  %>
                                <a href="javascript:whenEdulist('<%=v_subjnm%>','Y','<%=v_edulist_value%>')"><img src="/images/user/<%=site%>/btn_m_sungview.gif" border="0"></a>
                            <%}else{%>
                              -
                            <%}%>
                            </td>
                            ...
                            <%if(!v_subj.equals("") && v_isgraduated.equals("이수")){%>
                              <a href="javascript:suRoyJeung('<%=v_subj%>','<%=v_year%>','<%=v_subjseq%>','<%=v_user_id%>','<%=v_kind%>')"><img src="/images/user/<%=site%>/btn_m_print.gif" border="0"></a>
                            <%}else{%>
                              -
                            <%}%>
                            </td>
