              ...
              <tr> 
                <td align="center" valign="top"> 
                  <table width="675" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td valign="top"><img src="/images/user/<%=site%>/tit_poll.jpg"></td>
                    </tr>
                    <tr> 
                      <td height="20"></td>
                    </tr>
                  ...
                  <table width="675" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td width="474" valign="top"><img src="/images/user/<%=site%>/st_pollist.gif"> 
                      </td>
                    ...
                    <tr> 
                      <td colspan="2"> 
                        ...
                        <table width="675" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr> 
                            <!--<td width="61" valign="top" style="cursor:hand;" onClick="showTab(1);" >
                                <img src="/images/user/<%=site%>/tab_total_on.gif">
                            </td>
                            <td width="61" valign="top" align=left style="cursor:hand;" onClick="showTab(2);" >
                                <img src="/images/user/<%=site%>/tab_course_on.gif" name="Image29" border="0">
                            </td>
                            <td width="61" valign="top"  align=left style="cursor:hand;" onClick="showTab(3);" >
                                <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image30','','/images/user/<%=site%>/tab_general_on.gif',1)"><img src="/images/user/<%=site%>/tab_general.gif" name="Image30" border="0"></a>
                            </td>
                            <td width="74" valign="top"  align=left style="cursor:hand;" onClick="showTab(4);" >
                                <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image31','','/images/user/<%=site%>/tab_contents_on.gif',1)"><img src="/images/user/<%=site%>/tab_contents.gif" name="Image31" border="0"></a>
                            </td>
                            <td width="479" valign="top"  align=left style="cursor:hand;" onClick="showTab(5);">
                                <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image33','','/images/user/<%=site%>/tab_object_on.gif',1)"><img src="/images/user/<%=site%>/tab_object.gif" name="Image33" border="0"></a>
                            </td>
                          </tr>
                          <tr> 
                        ...
                        <table width="675" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr> 
                            <!--<td width="61" valign="top" style="cursor:hand;" onClick="showTab(1);" >
                                <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image28','','/images/user/<%=site%>/tab_total_on.gif',1)"><img src="/images/user/<%=site%>/tab_total.gif" name="Image28" border="0"></a>
                            </td>-->
                            <td width="61" valign="top" style="cursor:hand;" onClick="showTab(1);" >
                                <img src="/images/user/<%=site%>/tab_course_on.gif" name="Image29" border="0"><!--과정-->
                            </td>
...
%>                          
                        ...
                        <table width="675" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr> 
                            ...
                            <td width="61" valign="top" style="cursor:hand;" onClick="showTab(1);" >
                                <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image29','','/images/user/<%=site%>/tab_course_on.gif',1)"><img src="/images/user/<%=site%>/tab_course.gif" name="Image29" border="0"></a>
                            </td>
                            <td width="61" valign="top" style="cursor:hand;" onClick="showTab(2);" >
                                <img src="/images/user/<%=site%>/tab_general_on.gif" name="Image30" border="0"><!--일반-->
                            </td>
                            <td width="74" valign="top" style="cursor:hand;" onClick="showTab(3);" >
                                <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image31','','/images/user/<%=site%>/tab_contents_on.gif',1)"><img src="/images/user/<%=site%>/tab_contents.gif" name="Image31" border="0"></a>
                            </td>
                        ...
                        <table width="675" border="2" cellspacing="0" 
                         cellpadding="3"   style="border-collapse:collapse;" bordercolor="#ededed"  frame="hsides">
                          ...
                          <tr> 
                            ...
                            <td  class="tbl_bleft">
                                <%if(v_sulresult==0){%>
                                    ...
                                    <%}else{%>
                                    <a href="javascript:contentsWright('ALL', 'ALL', 'ALL', 'ALL', '<%=v_sulpapernum%>', '<%=v_sulpapernm%>', '<%=v_sulstart%>', '<%=v_sulend%>')"><u><%=String.valueOf(dbox3.getString("d_sulpapernm"))%></u></a>
                                    <%}%>                            
                                <%}else{%>
                                    <%=String.valueOf(dbox3.getString("d_sulpapernm"))%>
                                <%}%>                            
                          ...
                          %>
                          <tr>
                            <td height="3" colspan="6" class="tbl_ptit2">해당 설문이 없습니다.</td>
                          </tr>
                          <% } %>   
                        </table>
		                </div>
                        ...
                        <table width="675" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr> 
                            ...
                            <td width="74" valign="top" style="cursor:hand;" onClick="showTab(3);" >
                                <img src="/images/user/<%=site%>/tab_contents_on.gif" name="Image31" border="0"><!--콘텐츠-->
                            </td>
                            <td width="479" valign="top" style="cursor:hand;" onClick="showTab(4);">
                                <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image33','','/images/user/<%=site%>/tab_object_on.gif',1)"><img src="/images/user/<%=site%>/tab_object.gif" name="Image33" border="0"></a>
                            </td>
                        ...
                        <table width="675" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr> 
                            ...
                            <td width="479" valign="top" style="cursor:hand;" onClick="showTab(4);">
                                <img src="/images/user/<%=site%>/tab_object_on.gif" name="Image33" border="0"><!--대상자-->
                            </td>
                          </tr>
                          <tr> 
                            <td height="10" colspan="5"></td>
                          ...
                          <tr> 
                            ...
                            <td  class="tbl_bleft">
                                <%if(v_sulresult==0){%>
                                    ...
                                    <%=String.valueOf(dbox2.getString("d_sulpapernm"))%>
                                    <%}else{%>
                                    <a href="javascript:contentsWright('ALL', 'ALL', 'ALL', 'ALL', '<%=v_sulpapernum%>', '<%=v_sulpapernm%>', '<%=v_sulstart%>', '<%=v_sulend%>')"><u><%=String.valueOf(dbox2.getString("d_sulpapernm"))%></u></a>
                                    <%}%>                            
                                <%}else{%>
                                    <%=String.valueOf(dbox2.getString("d_sulpapernm"))%>
                                <%}%>                            
