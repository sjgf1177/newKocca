...
<title>한국콘텐츠아카데미 <%= box.getString("top_title") %></title>
...
<div id="wrap">
    ...
    <div id="sideMenu">
        <div class="search">
            <fieldset>
                <legend>빠른 검색</legend>
                <label for="topWarp_searchText" style="display:none;">검색어</label><input type="text" name="topWarp_searchText" onkeyup="searchtotal_enter(event); " id="topWarp_searchText" title="검색어" class="keyword" />
        ...
        <div style="padding-top:18px; padding-left:3px;">
            <ul>
        ...
        <div style="padding-top:18px; padding-left:3px;">
            <ul>
                <li><a href="http://www.ckl.or.kr" target="_blank"><img src="/images/common/right_banner_ckl_20140625.jpg" alt="상상력이 창작으로, 창작이 창업으로. 콘텐츠코리아랩" /></a></li>
            </ul>
        </div>
...
<!--            <p class="link"><span><a href="#">9월 현장교육 과정 안내를 확인 할 수 있습니다. 나에게 필요한 <strong>교육과정 알아보기</strong></a></span></p>-->
        ...
        <!-- 열린강좌 -->
        <!-- 2014-06-10 열린강좌(콘텐츠온)가 분류별로 조회하도록 변경되어 기존 내용을 주석처리함.
        <div id="quickEdu3" class="cont">
            <div class="pointer"></div>
            <h3>
            //-->
        ...
        <div id="totalmenu" class="totalmenu">
            ...
            <ul class="group">
                ...
                <li class="d1"><a href="/servlet/controller.off.ProposeOffServlet?p_process=SubjectList&amp;p_area=004"><strong>과정안내</strong></a>
                //-->
