...
<%
    ...
    box.put("title_str", "이용약관-이용안내, 학습지원");
%>
...
<div id="container-new">
        ...
        <div id="mainMenu">
            ...
            <ul class="location">
                ...
                <li>
                    이용약관 <a href="#" class="unfold"><img src="/images/2013/btn/btn_menuview.gif" alt="메뉴 보기" /></a>
                    <ul>
                        <!-- 활성화된 메뉴에  class="active" 삽입 -->
...
%>
                    <!--<li><a href="/servlet/controller.homepage.MainMemberJoinServlet?p_process=MemberInfoUpdate">내 정보 관리</a></li>-->
                        ...
                        <li><a href="/servlet/controller.homepage.MainMemberJoinServlet?p_process=UserAgree" class="active">이용약관</a></li>
...
%>
                    <!--<li><a href="/servlet/controller.homepage.MainMemberJoinServlet?p_process=MemberInfoUpdate">내 정보 관리</a></li>-->
                    <li><a href="/servlet/controller.homepage.MainMemberJoinServlet?p_process=PersonalNew">개인정보처리방침</a></li>
                    <li><a href="/servlet/controller.homepage.MainMemberJoinServlet?p_process=UserAgree"><strong><u>이용약관</u></strong></a></li>
                    <li><a href="/servlet/controller.homepage.HomePageHelpServlet?p_process=Footer&amp;p_code=FOOTER_EMAIL">이메일무단수집거부</a></li>
                    <li><a href="/servlet/controller.homepage.HomePageContactServlet?p_process=webReport">홈페이지 개선의견</a></li>
                </ul>
            </div>
        ...
        <div id="contents">
            ...
            <h2 class="subTit">이용약관<!-- <img src="../images/2013/support/agreement_title.gif" alt="이용약관" /> //--></h2>

            <div id="subCont">

                <div class="privaterule">
                    <h3 class="subTit2">제1장 총칙</h3>

                    <p class="title">제1조 목적</p>
                    <div class="txt">
                        1. 이 약관은 "한국콘텐츠아카데미 (이하 "아카데미"라 한다.)에서 운영하는 웹서비스의 이용조건 및 절차에 관한 사항을 명시합니다.<br />
                        2. 회원가입에 대한 내용을 충분히 숙지하신 후 가입하여 주시고, 이 약관은 본 아카데미에서 운영하는 모든 웹서비스를 이용하는 모든 회원에게 적용되며 이를 읽고 이해하는 것은 귀하의 책임입니다.
                    </div>

                    <p class="title">제2조 약관의 공지 및 효력</p>
                    <div class="txt">
                        ...
                        3. 회원가입이란 아카데미에서 제공하는 웹서비스에 가입하는 것으로 웹서비스의 조건과 규정에 합의함을 의미하며, 아카데미는 웹서비스의 조건과 조항을 항시 통고와 함께 또는 통고 없이 전부 또는 일부를 바꿀 권리를 갖습니다. 이런 변화에 대해 빠른 회신을 못하거나, 고지 받지 못했다는 사유로 이의를 제기할 수 없으므로 추후에 착오 없으시길 당부 드립니다.
                    </div>


                    <p class="title">제3조 약관 외 준칙</p>
                    <div class="txt">
                        이 약관에 명시되지 않은 사항은 전기통신기본법, 전기통신사업법, 전자거래 기본법, 전자서명법, 통신판매법 및 기타 관계법령의 규정에 의합니다.
                    </div>

                    <p class="title">제4조 용어의 정의</p>
                    <div class="txt">
                        ...
                        (단, 휴면계정 일괄 삭제 후에는 기존에 사용하던 아이디로 아카데미 사이트에 재가입할 수 없으니 이점 유의하시기 바랍니다.)
                    </div>

                    <h3 class="subTit2">제2장 서비스 이용계약</h3>
                    <p class="title">제1조 이용 계약의 성립</p>
                    <div class="txt">
                    ...
                    <p class="title">제2조 이용신청</p>
                    <div class="txt">
                    이용신청은 온라인상의 가입신청 양식에 준합니다.
                    </div>

                    <p class="title">제3조 이용신청의 승낙</p>
                    <div class="txt">
                        회원이 제2장 제2조에서 정한 모든 사항을 정확히 기재하여 이용신청을 하였을 때 승낙합니다.
                    </div>

                    <p class="title">제4조 이용신청의 불 승낙</p>
                    <div class="txt">
                    ...
                    <h3 class="subTit2">제3장 서비스 이용</h3>
                    <p class="title">제1조 서비스 이용</p>
                    <div class="txt">
                        서비스 이용은 아카데미의 업무상 또는 기술상 특별한 지장이 없는 한 연중무휴, 1일 24시간을 원칙으로 합니다.<br/>
                        단, 정기점검 등 서비스 개선을 위하여 아카데미가 필요하다고 인정되는 때에는 미리 공지한 후 서비스가 일시 중지될 수 있습니다.
                    </div>

                    <p class="title">제2조 서비스 제공의 중지</p>
                    <div class="txt">
                        아카데미는 다음 항에 해당하는 경우 서비스의 제공을 중지할 수 있습니다.<br />
                        1. 설비의 보수 등을 위하여 부득이한 경우<br />
                        2. 전기통신사업법에 규정된 기간통신사업자가 전기통신서비스를 중지하는 경우<br />
                        3. 기타 서비스를 제공할 수 없는 사유가 발생한 경우
                    </div>

                    <p class="title">제3조 파일정보의 소거 및 회원 권한의 삭제</p>
                    <div class="txt">
                        ...
                        3. 제1항의 경우에 아카데미는 해당 사항을 사전에 서비스 또는 전자우편을 통하여 공지합니다.
                    </div>

                    <h3 class="subTit2">제4장 서비스 사용 제한 및 계약 해지</h3>
                    <p class="title">제1조 서비스 사용 제한</p>
                    <div class="txt">
                    ...
                    <p class="title">제2조 계약 해지</p>
                    <div class="txt">
                        1. 회원이 이용계약을 해지하고자 하는 때에는 본인이 서비스 또는 전자우편을 통하여 해지하고자 하는 날의 1일전까지(단, 해지일이 법정공휴일인 경우 공휴일 개시 2일전까지) 이를 아카데미에 신청하여야 합니다.<br/>
                        2. 아카데미는 회원이 제4장 제1조의 내용을 위반하고, 아카데미 소정의 기간 이내에 이를 해소하지 아니하는 경우 서비스 이용계약을 해지할 수 있습니다.<br/>
                        3. 아카데미는 제2항에 의해 해지된 회원이 다시 이용신청을 하는 경우 일정기간 그 승낙을 제한할 수 있습니다.
                    </div>

                    <h3 class="subTit2">제5장 책임</h3>
                    <p class="title">제1조 회원의 의무</p>
                    <div class="txt">
                    ...
                    <div class="txt">
                        ...
                        4. 아카데미는 회원으로부터 제기되는 의견이나 불만이 정당하다고 인정되는 경우에는 즉시 처리해야 합니다. 다만 즉시 처리가 곤란한 경우에는 회원에게 그 사유와 처리일정을 통보하여야 합니다.
                    </div>

                    <p class="title">제3조 게시물 또는 내용물의 삭제</p>
                    <div class="txt">
                        아카데미는 서비스의 게시물 또는 내용물이 제4장 제1조의 규정에 위반되거나 아카데미 소정의 게시기간을 초과하는 경우 사전 통지나 동의 없이 이를 삭제할 수 있습니다.
                    </div>

                    <h3 class="subTit2">제6장 손해배상 및 면책조항</h3>
                    <p class="title">제1조 손해배상</p>
                    <div class="txt">
                        아카데미는 서비스 이용과 관련하여 회원에게 어떠한 손해가 발생하더라도 동 손해가 아카데미의 중대한 과실에 의한 경우를 제외하고 이에 대하여 책임을 지지 않습니다.
                    </div>

                    <p class="title">제2조 면책조항</p>
                    <div class="txt">
                        ...
                        6. 회원이 제4장 제1조, 기타 이 약관의 규정을 위반함으로 인하여 아카데미가 회원 또는 제3자에 대하여 책임을 부담하게 되고, 이로써 아카데미에게 손해가 발생하게 되는 경우, 이 약관을 위반한 회원은 아카데미에게 발생하는 모든 손해를 배상하여야 하며, 동 손해로부터 아카데미를 면책시켜야 합니다.
                    </div>

                    <h3 class="subTit2">제7장 커뮤니티 이용</h3>
                    <p class="title">제1조 커뮤니티 이용 제한</p>
                    <div class="txt">
                        ...
                        3. 아카데미는 언제든지 어떤 이유로든 아무런 통지 없이 귀하가 커뮤니티의 일부 또는 전부에 접속하는 것을 종료시킬 수 있는 권한을 보유합니다.
                    </div>

                    <p class="title">제2조 아카데미의 책임</p>
                    <div class="txt">
                        ...
                        3. 아카데미는 커뮤니티에 관한 책임 및 이용자가 커뮤니티에 참여함으로써 발생하는 어떠한 사건에 대한 책임을 명백히 부인합니다.
                    </div>

                    <h3 class="subTit2">제8장 기타</h3>
                    <p class="title">제1조 약관의 변동</p>
                    <div class="txt">
                        이용약관 개정 시 최소 7일 이전 고지의 의무가 있고 소비자에게 불리한 경우 30일 이전 고지해야 합니다.
                    </div>

                    <p class="title">제2조 분쟁의 해결</p>
                    <div class="txt">
                    ...
                    <h3 class="subTit2">부칙</h3>
                    <div class="txt">
                        이 개인정보 처리방침은 2014. 3. 11 고지합니다.<br/>
                        이 개인정보 처리방침은 2014. 3. 14 부터 적용됩니다.<br/>
                        이전의 개인정보 처리방침은 아래에서 확인하실 수 있습니다.
                    </div>
                    <div style="font-weight:bold;">
                        <a href="/learn/user/2013/portal/member/zu_UserAgree_old.jsp">- 2014년 3월 10일 이전 내용 보기</a>
                    </div>
