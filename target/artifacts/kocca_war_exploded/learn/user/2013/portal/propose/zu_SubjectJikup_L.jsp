...
<%
    ...
    if(v_gubun_1.equals("B0S01")){v_gubunnm_1="방송영상_기획";}
    else if(v_gubun_1.equals("B0S01")){v_gubunnm_1="방송영상_기획";}
    else if(v_gubun_1.equals("B0S02")){v_gubunnm_1="방송영상_제작";}
    else if(v_gubun_1.equals("B0S03")){v_gubunnm_1="방송영상_비즈니스";}
    else if(v_gubun_1.equals("G0S01")){v_gubunnm_1="게임_기획";}
    else if(v_gubun_1.equals("G0S02")){v_gubunnm_1="게임_제작";}
    else if(v_gubun_1.equals("G0S03")){v_gubunnm_1="게임_비즈니스";}
    else if(v_gubun_1.equals("K0S01")){v_gubunnm_1="만화애니캐릭터_기획";}
    else if(v_gubun_1.equals("K0S02")){v_gubunnm_1="만화애니캐릭터_제작";}
    else if(v_gubun_1.equals("K0S03")){v_gubunnm_1="만화애니캐릭터_비즈니스";}
    else if(v_gubun_1.equals("M0S01")){v_gubunnm_1="음악공연_기획";}
    else if(v_gubun_1.equals("M0S02")){v_gubunnm_1="음악공연_제작";}
    else if(v_gubun_1.equals("M0S03")){v_gubunnm_1="음악공연_비즈니스";}
    else{                              v_gubunnm_1="전체";}
...
<script language="JavaScript">
    ...
    function search_enter(e)  {
        if (e.keyCode =='13'){  fnSubjectSearch("<%=v_gubun_1 %>","<%=v_gubun_2 %>","<%=v_gubun_3 %>");  }
    }
    ...
    function fnSubjectSearch(p_gubun_1, p_gubun_2, p_gubun_3) {
        ...
        // document.form1.p_process.value = "SubjectListJikup";
        // document.form1.submit();
        var url = "/servlet/controller.propose.ProposeCourseServlet";
        var param = "?p_process=SubjectListJikup&p_pageno=1&p_gubun_1=" + p_gubun_1 + "&p_gubun_2=" + p_gubun_2 + "&p_gubun_3=" + p_gubun_3;

        location.href = url + param;
    }

    /**
     * 직업별분류에서 1번째 분야, 2번째 직업 카테고리 선택을 이용하여 과정을 검색한다.
     */
    ...
    function fnViewSubjectInfo(subj, subjnm, courseyn, upperclass, upperclassnm, year, subjseq){
        ...
        document.form1.p_rprocess.value = "SubjectListJikup";
    ...
    <form name="form1" action="/servlet/controller.propose.ProposeCourseServlet" method="post">
        ...
        <div id="mainMenu">
            ...
            <ul class="location">
                ...
                <li>온라인 교육</li>
                <li>
                    직업별 <a href="#" class="unfold"><img src="/images/2013/btn/btn_menuview.gif" alt="메뉴 보기" /></a>
                    <ul>
                        <!-- 활성화된 메뉴에  class="active" 삽입 -->
                        <li><a href="/servlet/controller.propose.ProposeCourseServlet?p_process=SubjectList" >분야별</a></li>
                        <li><a href="/servlet/controller.propose.ProposeCourseServlet?p_process=SubjectListJikup" class="active">직업별</a></li>
...
%>
    ...
    -->
        ...
        <!-- 컨텐츠 영역 시작 -->
        <div id="contents">
            <h2 class="subTit">직업별<!-- <img src="/images/2013/field_edu/courseguide_title.gif" alt="과정안내" /> //--></h2>
                <div id="subCont">
                    ...
                    <ul class="tabCus">
                        ...
                        <li><a href="/servlet/controller.propose.ProposeCourseServlet?p_process=SubjectListJikup"><img src="/images/2013/online_edu/tabcurs3_on.jpg" alt="작업별 분류" /></a></li>
    ...
    %>
                    ...
                    //-->
                    <div class="noticBox">
                        온라인과정의 직업별 분류에 따라 교육과정을 확인 하실 수 있습니다.<br/>
                    ...
                    <div class="selectBox">
                        ...
                        <div class="mtstepWrap">
                            <p class="steptit"><img src="/images/2013/online_edu/tit_step2.gif" alt="직업을 선택해 주세요" /></p>
                            ...
                            <div class="scroll" tabindex="0">
                                <ul>
                                    ...
                                    %>
                                            ...
                                            <li>&nbsp;</li>
                                            <li>&nbsp;</li>
                                            <li style="text-align: center;"><a><strong>직업</strong>를 선택해 주세요.</a></li>
                                    <%
                                        }
                                    %>
                                </ul>
                    ...
                    <%if(!v_gubun_2.equals("A")){ %>
                        <img src="/images/2013/online_edu/subjjikup_script/<%=v_gubun_1 %><%=v_gubun_2 %>.gif" alt="<%=v_gubunnm_1 %> <%=v_gubunnm_2.replaceAll("_","에 ") %>에 대한 직업소개" style="margin-bottom: 30px;"/>
                    <%} %>
    ...
    <!--                                 span class="btn_three2"><a href="#">기획</a></span>-->
    <!--                                <span class="btn_three3"><a href="#">실무</a></span-->
    <!--                            </span>-->
                            </dt>
