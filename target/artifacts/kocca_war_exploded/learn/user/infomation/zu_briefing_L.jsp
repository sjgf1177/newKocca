    ...
    <td align="center" valign="top">
      ...
      <br>
        ...
        <table width="97%" border="0" cellpadding="0" cellspacing="0">
          <tr> 
            <td align="right" height="20"><a href="javascript:insert()"><img src="/images/admin/button/btn_add.gif"  alt="등록" border="0"></a></td>
          </tr>
          <tr> 
            <td height="3"></td>
          </tr>
...
<%  } %>
      ...
      <table  border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td align="center">&nbsp;</td>
          <td align="center"><a href="javascript:goSubjectListPage()"><img src="/images/admin/button/btn_list.gif"  alt="목록으로" border="0"></a></td>
        </tr>
      </table>
      <!----------------- 저장, 삭제, 리스트 버튼 끝 ----------------->
     </td>
