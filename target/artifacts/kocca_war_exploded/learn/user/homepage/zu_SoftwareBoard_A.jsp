...
//**********************************************************
//  1. 제      목: 서식자료실
//  2. 프로그램명 : zu_SoftwareBoard_A.jsp
//  3. 개      요: 서식자료실 답변
//  4. 환      경: JDK 1.3
//  5. 버      젼: 1.0
//  6. 작      성: 2004.1.19
...
-->
    ...
    <input type = "hidden" name = "p_content"    value="">
              ...
              <table cellspacing="0" cellpadding="0" class="route_table">
                <tr> 
                  <td class="route_text">HOME &gt; 사이버연수원 &gt;<b> 서식 자료실</b></td>
                </tr>
                  ...
                  <td> 
                    <table cellspacing="1" cellpadding="1" class="table2">
                      <tr> 
                        ...
                        <td class="table_text3"> <input size="80" maxlength="100" name="p_title" class="inputsub" value ="<%= v_title %>"></td>
                      </tr>
					  <tr> 
                        <td class="information_board_title_bg2">작성자</td><td class="table_text3"><%=s_name%></td>
                      </tr>
                      <tr> 
             ...
             <!----------------- 저장, 취소 버튼 시작 ---------------->
              <table width="18%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  <td align="center"><a href = "javascript:insert();"><img src="/images/user/homepage/save_butt1.gif" width="45" height="16" border="0"></a></td>
                  <td align="center"><a href = "javascript:cancel();"><img src="/images/user/homepage/cancel_butt1.gif" width="45" height="16" border="0"></a></td>
                </tr>
              </table>
              <!----------------- 저장, 취소 버튼 끝 ---------------->
              <br>
