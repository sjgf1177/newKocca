...
<table border="0" cellspacing="0" cellpadding="0" >
  <tr valign="bottom">
    <td><input type="checkbox" name="checkbox" onclick="javascript:notice_closeWin()"><font style=font-family:"굴림","굴림체"; font-size: 9pt; color: #666666;line-height:1.4;>오늘하루 이 창을 그만 봅니다.</td>
  </tr>
</table>