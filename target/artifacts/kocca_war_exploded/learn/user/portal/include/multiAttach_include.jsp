...
<table cellpadding="0" cellspacing="0" border="0">
            ...
            <% } %>
            <tr class="bgn bon">
                <td class="tit_table"><label for="file"><%=i_fileLimit == 1 ? "대표이미지 등록" : "첨부파일" %></label></td>
                <td class="ct_tit_table_lright">
                    <div id="div_inputFile">
                    <table border=0><tr><td width="70px">
                    ...
                    </div><div id="div_fileName" style="width:300px;display:none;"></div>
                </td>
            </tr>
            <tr class="file_add">
				...
				%>
                    ...
                    <input type = "text"    name = "p_fileseq"   value = "<%= v_fileseq%>">
                    <input type = "text"    name = "p_realfile"  value = "<%=v_realfile%>">
                    <input type = "text"    name = "p_savefile"  value = "<%=v_savefile%>">
                    <input type = "text"    name = "p_filevalue" value = "">
			...
			<tr>
			  <td colspan="2" height="4" bgcolor="#F7F7F7"></td>
			</tr>
        </table>
...
%>
            ...
            <% } %>
            <tr class="bgn bon">
                <th class="th" style="text-align:center; padding-left:4px;"><label for="file"><%=i_fileLimit == 1 ? "대표이미지 등록" : "첨부파일" %></label></th>
                <td class="td pd_ln">
                    <div id="div_inputFile">
                    <table border=0><tr><td width="70px">
                    <!--input type="text" name="TX_TMP_FILENAME" id="tempFileText" class="inbox fl_l mg_r6" style="width:300px;" readonly/-->
