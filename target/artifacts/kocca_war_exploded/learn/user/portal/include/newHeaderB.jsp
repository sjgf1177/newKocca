        ...
        window.open("/servlet/controller.community.CommunityIndexServlet?p_process=selectmyindex&p_cmuno="+document.getElementById('p_project').value, "openWinCommunity", "toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no,resizable=no, width = 920, height = 660, top=0, left=0");
	    	...
	    	<div class="header_topmenu">
	        	<div class="header_topmenu_mid">
	                ...
	                <!--//오버시 나타나는 메뉴 -->
	            	<h1><!-- 로고 --><a href="/servlet/controller.homepage.MainServlet"><img src="/images/newmain_20100625/<%=s_tem_grcodeGLB%>.gif" alt="logo" style="height:83px;"/></a></h1>
	            	<p style="float:right;padding:53px 12px 0 0;font-size:11.5px;font-weight:800;">
	            		<%if(box.getSession("userid").equals("")){%>
		            		<%
			               	if ( isReject ) {
			            		if (ser_nm.equals("mcst.kocca.or.kr") || ser_nm.equals("mcst.edukocca.or.kr") ) {
							%>
				                	<span style="margin-right:10px;"><a href="javascript:alert('아이나루를 통하여 접속해 주세요');" >회원가입</a></span>
				                    <span><a href="javascript:mainmenu('2');" >아이디/패스워드 찾기</a></span>
							<%
			           			}
			        		} else {
							%>
				                	<span style="margin-right:10px;"><a href="javascript:mainmenu('1');" >회원가입</a></span>
				                    <span><a href="javascript:mainmenu('2');" >아이디/패스워드 찾기</a></span>
							<%
			        		}
							%>
						<%}else{%>
		                	<span style="margin-right:10px;"><a href="javascript:mainmenu('3');" >로그아웃</a></span>
		                    <span><a href="javascript:mainmenu('4');" >개인정보변경</a></span>
						<%}%>
	                </p>
	                <div class="mainmenu_all">
		                <div class="mainmenu">
		                    <!--상단메뉴 -->
		                	<ul>
		                    	<li style="color:#000"><a href="javascript:menuForward('8', '01');">과정안내</a></li>
		                        <li style="color:#000"><a href="javascript:menuForward('9', '01');">수강신청</a></li>
		                        <li style="color:#000"><a href="javascript:menuForward('5', '01');">열린강좌</a></li>
		                        <li><a href="javascript:menuForward('3', '11');" style="color:#1a74fc">나의강의실</a></li>
		                        <li><a href="javascript:menuForward('4', '07');" style="color:#1a74fc">학습지원센터</a></li>
		                    </ul>
		                    <!--//상단메뉴 -->
		                </div>
		                <div class="searchzone">
		                	<ul>
		                    	<li style="float:left;width:60px;font-size:14px;border-right:1px solid #fff;font-weight:600;line-height:11px;margin-top:6px;margin-left:10px;color:#fff;">과정검색</li>
		                        <li style="float:left;width:110px;"><input type="text" id="topWarp_searchText" name="topWarp_searchText" style="width:102px;height:21px;border:none;margin-left:3px;color:#fff;background-color:#1a74fc;z-index:300;" onkeypress="javascript:fnKeyPressEnter(event, 'totalSubjSearch');" /></li>
		                        <li style="width:25px;float:left;"><img src="/images/portal/asp/typeB/main/icon_search.png" style="cursor:pointer" onclick="totalSubjSearch();"/></li>
		                    </ul>
		                </div>
	                </div>
