...
<%
    ...
    System.out.println(" ASP tem_grcode : " + tem_grcode);

    // KOCCA 사이트 유무 
    boolean koccaYn = ((String)box.getSession("KoccaYn")).equals("Y") ? true : false;
    
 	// Direct Link
	String top_grcode = box.getSession("tem_grcode");
	
	if(top_grcode == null || top_grcode.equals("")) { 
		koccaYn = true;
		box.setSession("s_gubun", box.getString("gubun"));
		box.setSession("tem_grcode", box.getString("tem_grcode"));
	}
