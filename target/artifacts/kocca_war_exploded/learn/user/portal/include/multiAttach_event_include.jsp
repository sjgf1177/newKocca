...
<div id="div_attachMain">
            ...
            <% } %>
            <tr class="bgn bon">
                <th class="th"><label for="file"><%=i_fileLimit == 1 ? "대표이미지 등록" : "" %></label></th>
                <td class="td pd_ln">
                    ...
                    <input type="file" name="p_file" id="p_file" imageswap="true" imagesrc="/images/portal/btn/file_search.gif"  onChange="fnFileFocus()" style="vertical-align:7px;cursor:pointer;"  />
                    </td><td>
                ...
                <th class="th"></th>
                <td class="td" id="docfile"><div id="div_attach">
				<%
            ...
            <th class="th"></th>
            <tr>
                <td class="td pd_ln" colspan="4">※ 입사일이 기재된 재직증명서, 4대보험 납입증명서, 근로계약서 중 택 1</td>
            </tr>
        </table>
