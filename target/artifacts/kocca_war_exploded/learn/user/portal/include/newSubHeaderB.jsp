	        	...
	        	<div class="header_topmenu_mid">
	                ...
	                <div class="mainmenu_all">
		                <div class="mainmenu">
		                    <!--상단메뉴 -->
		                	<ul>
		                    	<li><a href="javascript:menuForward('8', '01');" style="color:#000">과정안내</a></li>
		                        <li><a href="javascript:menuForward('9', '01');" style="color:#000">수강신청</a></li>
		                        <li><a href="javascript:menuForward('5', '01');" style="color:#000">열린강좌</a></li>
