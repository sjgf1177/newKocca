...
%>
       				  <td width="415" bgcolor="FFFFFF"><a href="/servlet/controller.homepage.HomePageAboutUsServlet?p_process=tab1"><img src="/images/user/portal/homepage/type1/footer_m1.gif" border="0"></a><a href="/servlet/controller.homepage.MemberJoinServlet?p_process=user"><img src="/images/user/portal/homepage/type1/footer_m2.gif" border="0"></a><a href="/servlet/controller.homepage.MemberJoinServlet?p_process=personal"><img src="/images/user/portal/homepage/type1/footer_m3.gif" border="0"></a></td>
<%
} else {
%>
		      		  <td width="415" bgcolor="FFFFFF"><img src="/images/user/portal/homepage/type1/N000012_bottom_03.gif" border="0"></td>
<%
}
%>
                    </tr>
