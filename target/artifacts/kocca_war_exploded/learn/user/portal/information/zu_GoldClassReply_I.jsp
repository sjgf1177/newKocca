        ...
        <div id="contentwrap" class="message_top">
            <ul class="information_opinion">
                <li style="width:600px;">
                    <input name="p_point" type="radio" value="5" checked class="first"/><img src="/images/portal/ico/ico_star5.gif" alt="" />
                    <input name="p_point" type="radio" value="4" /><img src="/images/portal/ico/ico_star4.gif" alt="" />
                    <input name="p_point" type="radio" value="3" /><img src="/images/portal/ico/ico_star3.gif" alt="" />
                    <input name="p_point" type="radio" value="2" /><img src="/images/portal/ico/ico_star2.gif" alt="" />
                    <input name="p_point" type="radio" value="1" /><img src="/images/portal/ico/ico_star1.gif" alt="" />
                </li>
