...
%>
    <br>
            <img src="/images/portal/homepage_renewal//support/stitle_04.gif" alt="Q&A" class="fl_l" /><p align="right">Home > 학습지원안내 > <strong>Q&A</strong></p>
        <br/>
            ...
            <tr>
                <td class="tit_table" width="100"><label for="lab">분류</label></td>
                <td class="ct_tit_table_left">
                    <kocca_select:select name="p_categorycd" sqlNum="0001" param="0088" onChange="" attr= "분류"
                        selectedValue="" isLoad="true" type="1" styleClass="" all="false" />
                </td>
                <td class="tit_table"><img src="/images/portal/homepage_renewal/support/lock_on.jpg" /><label for="secret">비밀글</label></td>
...
%>
            ...
            <tr class="bo">
                ...
                <th class="th"><img src="/images/portal/ico/ico_board_s.gif" alt="" class="va_m mg_r7" /><label for="secret">비밀글</label></th>
