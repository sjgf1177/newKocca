...
<%
//**********************************************************
//  1. 제      목: 오프라인 수강신청 취소 신청
//  2. 프로그램명: gu_ProposeOffCancelApply_I.jsp
//  3. 개      요: 오프라인 수강신청 취소 신청
//  4. 환      경: JDK 1.5
//  5. 버      젼: 1.0
//  6. 작      성: 2009.12.15
//  7. 수      정:
...
function cancelApply() {
	...
	if(confirm('수강 취소 신청 하시겠습니까?')){
	    document.form2.action = "/servlet/controller.study.MyClassServlet";
		document.form2.p_process.value = "ProposeOffCancelApply";
