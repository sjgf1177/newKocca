...
//	MasterFormData	da	=(MasterFormData)request.getAttribute("MasterFormData");
	String	v_mftype 	= box.getSession("s_mftype");
...
<%	} 							%>
	...
	<table border="0" cellpadding="0" cellspacing="0" align="center" width="1020" valign="TOP" leftmargin="0" topmargin="0">
<%	if (v_mftype.equals("NU")||v_mftype.equals("ND")) {	%>
	<TR align=center>
	 <td align=center background="<%=v_imgURL%>/menu_bg.gif"><table border="0" cellpadding="0" cellspacing="0" align=center><tr align=center>
<%	}	%>
	<%  for (int i=0; i<20; i++) {
