...
<frameset rows="68,*" cols="*" frameborder="NO" border="0" framespacing="0"> 
  ...
  <frame name="ebody" src="/servlet/controller.study.SubjGongStudyServlet?p_process=Offselect&p_subj=<%=p_subj%>&p_year=<%=p_year%>&p_subjseq=<%=p_subjseq%>" frameborder="NO" scrolling="AUTO" allowfullscreen="true">
</frameset>
<noframes> 
