...
<%
	...
	out.println("p_oid="+p_oid);    out.println("p_lesson="+p_lesson);	out.println("commit_value="+commit_value);	out.println("p_userid="+p_userid);	out.println("s_name="+s_name);	out.println("p_subj="+p_subj);	out.println("p_year="+p_year);	out.println("p_subjseq="+p_subjseq);%>
...
<SCRIPT LANGUAGE="JAVASCRIPT">
	...
	************************************************************/	
	...
	var objectives = new Array(3);
	for ( var i=0; i<3; i++){objectives[i] = new Array(7);}

	var interactions = new Array(3);	
	for ( var i=0; i<3; i++){interactions[i] = new Array(9);}

	var interactions_objectives = new Array(3);
	for ( var i=0; i<3; i++){interactions_objectives[i] = new Array(4);}

	var interactions_correct_responses = new Array(3);
	for ( var i=0; i<3; i++){interactions_correct_responses[i] = new Array(4);}
