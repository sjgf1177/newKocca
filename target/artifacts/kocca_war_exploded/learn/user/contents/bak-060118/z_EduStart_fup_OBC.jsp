...
<!-- CopyRight. Credu.Corp.  written by LeeSuMin -->
	...
	<table  width="100%" border="0" cellpadding="0" cellspacing="0" width="100%" align="LEFT" valign="TOP" marginwidth="0" marginheight="0" leftmargin="0" topmargin="0" background="<%=v_imgURL%>/m_bg.gif">	
		<form name="sel">
		<TR>
			<TD height=50 width=100% align="left" valign=top>
				<img src="<%=v_imgURL%>/title.gif" valign=top border=0 height=50>
			</TD>
