<%
//**********************************************************
//  1. 제      목: SCORM MasterForm - main FrameSet 
//  2. 프로그램명: z_EduStart_fset_SCORM.jsp
//  3. 개      요: SCORM MasterForm - main FrameSet 
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
...
<%
    ...
    String  v_base_url      = "/servlet/controller.contents.EduStart?p_sitegubun="+v_sitegubun+"&p_ispreview="+v_ispreview+"&p_process=";
    ...
    String  v_url_gong      = "/servlet/controller.study.SubjGongStudyServlet?p_process=select&p_subj="
                            + p_subj+"&p_year="+p_year+"&p_subjseq="+p_subjseq+"&p_sitegubun="+v_sitegubun+"&p_ispreview="+v_ispreview;
                            
    System.out.println("fset SCORM v_url_gong = "+v_url_gong);
