...
<%
    ...
    EduScoreData    sd = (EduScoreData)request.getAttribute("getEduScoreList");
    EduScoreDataSub sds;
        ...
        <td>
            ...
            <!----------------- 타이틀 시작 ----------------->
                        <table cellspacing="0" cellpadding="0" class="open_table_out">
                            ...
                            <tr>
                                <td background="/images/user/study/b_title_dot.gif"><img src="/images/user/study/course_detail_title1.gif" alt="과정상세정보" width="240" height="37" border="0"></td>
                            </tr>
                            <tr>
                                <td height="7"></td>
                            </tr>
