...
<%
	...
	//	Log.sys.println("strRecord_count="+strRecord_count);
		...
		//System.out.println("strStudent_preferencestrStudent_preferencestrStudent_preferencestrStudent_preferencestrStudent_preferencestrStudent_preferencestrStudent_preferencestrStudent_preferencestrStudent_preferencestrStudent_preference="+strStudent_preference);
	...
	//	sco.ScoJindo(strCourse_children, strCourse_info_sco, strLecture_info_detail, strUser_sco_info, strStudent_preference, strError_info ,  strMember_info, strError_init, strRecord_count );
