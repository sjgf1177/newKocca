...
<!-- 공통파일 끝-->
   <param name="connection.reportname" value="cp/cp_student.ozr">
   <param name="viewer.configmode" value="html">
   <param name="viewer.isframe" value="false">
   <param name="odi.odinames" value="cp_student">
   <param name="odi.cp_student.pcount" value="4">
   <param name="odi.cp_student.args1" value="year=<%=v_year%>">
   <param name="odi.cp_student.args2" value="subj=<%=v_subj%>">
   <param name="odi.cp_student.args3" value="subjseq=<%=v_subjseq%>">
   <param name="odi.cp_student.args4" value="comp=<%=v_comp%>">
</OBJECT>
