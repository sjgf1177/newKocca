<%
//**********************************************************
//  1. 제      목: 외주관리 시스템 노동부자료실 리스트화면
//  2. 프로그램명: zu_CpWork_L.jsp
//  3. 개      요: 외주관리 시스템 노동부자료실 리스트화면
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
...
//out.println("s_gadmin:::::::::::::::::::"+s_gadmin);
//out.println("v_cpseq:::::::::::::::::::"+v_cpseq);
//out.println("s_cpseq:::::::::::::::::::"+s_cpseq);
%>
      ...
      <table width="97%" border="0" cellspacing="0" cellpadding="0" class=page_title>
        ...
        <table width="97%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td  class=sub_title>노동부자료실 리스트 조회</td>
		  </tr>
          <tr>
            <td height="8"></td>
          </tr>
        ...
        <table class="table_out" cellspacing="1" cellpadding="5">
          ...
          <tr>
			...
			<tr> 
                ...
                <td class="table_02_1"><a href="javascript:select('<%=v_seq%>','<%=v_upfilecnt%>')" target="_self"><%=v_title%></a></td>
