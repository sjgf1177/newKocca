...
//**********************************************************
//  1. 제      목: 교육과정 입과인원조회
//  2. 프로그램명: za_cpeduProposeuser_l.jsp
//  3. 개      요: 수강신청자명단 리스트화면
//  4. 환      경: JDK 1.3
//  5. 버      젼: 1.0
...
String v_userid = "", v_name = "", v_email = "", v_comptel = "", v_handphone = "", v_eduurl = "";

ArrayList list = (ArrayList)request.getAttribute("selectProposeUserList");
...
function MoveLink(act) {
	if(act == "1"){
	    ...
	    document.form1.action            = "/servlet/controller.cp.CPEduStudentServlet";
	    document.form1.p_downgubun.value = "3";
	    document.form1.submit();	
	}
}
	...
	<table width="970" border="0" cellspacing="0" cellpadding="0" class=page_title>
      ...
      <table width="970"  border="0"  cellpadding="0" cellspacing="1" class="table_out">
        ...
        <tr> 
          ...
          <td class="table_title"  width="26%">E-mail</td>
          <td class="table_title"  width="15%">사무실전화</td>
          <td class="table_title"  width="15%">휴대전화</td>
          <td class="table_title"  width="10%">링크</td>
        </tr>
<%
...
%>
        <tr> 
          <td class="table_02_1" width="5%"><%=v_dispnum%></td>
          <td class="table_02_1"  width="15%"><%=v_userid%></td>
          <td class="table_02_1"  width="15%"><%=v_name%></td>
          <td class="table_02_1"  width="25%"><%=v_email%></td>
          <td class="table_02_1"  width="15%"><%=v_comptel%></td>
          <td class="table_02_1"  width="15%"><%=v_handphone%></td>
          <td class="table_02_1"  width="10%"><%=v_eduurl%></td>
        </tr>
<%
	}
%>
      ...
      <table width="970" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          ...
          <td width="32" align="right"><a href="javascript:MoveLink(2)"><img src="/images/admin/button/btn_excel.gif" border="0"></a></td>
          <td width="10">&nbsp;</td>
