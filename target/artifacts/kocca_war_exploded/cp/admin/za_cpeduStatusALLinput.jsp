...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      for (i=2; i < sheet.getRows() ; i++ ) {
        ...
        v_sangdamtxt = sheet.getCell(9,i).getContents();
        
        //소문자로변경
        v_userid = v_userid.toLowerCase();

        if(v_subj2.equals("")){
          out.println("<font color=red><b>엑셀양식Error</b><br><b>subject code error</b></font>");
          return;
        }

        if(v_subjseq2.equals("")){
          out.println("<font color=red><b>엑셀양식Error</b><br><b>차수정보error</b></font>");
          return;
        }

        //out.println(v_subjseq2);
        //if(true) return;
        ...
        insertData.put("score",       new Double(0) );
        ...
        insertData.put("sangdamtxt",   v_sangdamtxt);
...
%>
  ...
  <table width="97%" cellpadding="3" bgcolor="#cccccc" border="0" cellspacing="1">
    ...
    <%
      ...
      for(j=0; j<exclist.size(); j++){
        ...
        if(v_errvalue1.equals("0")){
          //if(!d_iscpflag.equals("") && !d_iscpflag.equals("N")){ //파일등록여부체크
          //  v_errvalue2 = "33";
          //}else{
          //  v_errvalue2 = "0";
          //}
        
          //if(d_isclosed.equals("Y")){ ///수료처리여부체크
          //  v_errvalue2 = "32";
          //}else{
          //  v_errvalue2 = "0";
          //}
          
          if(!d_eduterm.equals("4")){  //교육기간중체크
            v_errvalue2 = "34";
          }else{
            v_errvalue2 = "0";
          }
    ...
    <%
      if (v_process.equals("insertFileToDBALL")) {
	   	//외부교육과정결과 파일등록 정보저장
	   	//isOK3 = cpResult.update_cpresult(d_year, d_subj, d_subjseq, v_realFileName, v_newFileName);
	   	isOK3 = cpResult.update_cpstatus(connMgr, d_year, d_subj, d_subjseq, v_realFileName, v_newFileName, v_luserid);
      ...
      <table width="630" border="0" cellspacing="0" cellpadding="0">
        <tr align="center">
          ...
          <%}%>
            ...
            <a href="javascript:action('listPage','')"><img src="/images/admin/button/btn_list.gif"  border="0"></a>&nbsp;&nbsp;
