...
function cpApproval( p_cpapproval){
  ...
  document.form2.action="/servlet/controller.cp.BPCourseServlet";
...
<form name="form2" enctype= "multipart/form-data"  method="post" action="/servlet/controller.cp.BPCourseServlet">
  ...
  <tr>
    <td align="center" valign="top">
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        ...
        %>
           <td valign="middle" align="center"><a href="javascript:cpApproval('Y')"><img src="/images/admin/button/btn_resang.gif" border="0"></a>&nbsp;</td>
           <td valign="middle" align="center"><a href="javascript:UpdateSubject()"><img src="/images/admin/button/btn_save.gif" border="0"></a>&nbsp;</td>
        <%
            }
          }%>
