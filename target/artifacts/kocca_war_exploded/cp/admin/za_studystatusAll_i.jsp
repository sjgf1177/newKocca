...
<table width="650" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center"> 
      <table width="630" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          ...
          <td class=dir_txt style="line-height:18px">교육결과 데이터를 엑셀로 등록하시려면 정해진 아래의 양식에 맞추어 엑셀파일을 준비해주십시오.<br>             
            ...
            <b><a href="/servlet/controller.library.DownloadServlet?p_savefile=Sample_CPStatusALL.xls&p_realfile=Sample_CPStatusALL.xls">[ 엑셀형식보기 ]</a></b>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <b><a href="javascript:whenExcelDown()">[ 과정코드표down ]</a></b>
          </td>
        </tr>
        <tr> 
      ...
      <table width="630" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="413"> <input name="p_file" type="FILE" class="input" style="width:650"> 
          </td>
          <td width="217"></td>
        </tr>
        <tr> 
      ...
      <table width="630" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="591" align="right"><a href="javascript:action('statusInsertAll')"><img src="/images/admin/button/btn_save.gif"  border="0"></a></td>
          <td width="7"></td>
