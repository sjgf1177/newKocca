...
//**********************************************************
//  1. 제      목: 교육과정 입과인원조회
//  2. 프로그램명: za_cpeduCanceluser_l.jsp
//  3. 개      요: 수강취소자명단 리스트화면
//  4. 환      경: JDK 1.3
//  5. 버      젼: 1.0
...
String v_userid = "", v_name = "", v_email = "", v_comptel = "", v_handphone = "", v_eduurl = "", v_canceldate ="", v_reason = "";
...
function MoveLink(act) {
	if(act == "1"){
		...
		//명단 다운로드
		document.form1.p_process.value   = "cancelexcelDown";
	    document.form1.action            = "/servlet/controller.cp.CPEduStudentServlet";
	    document.form1.p_downgubun.value = "2";
	    document.form1.submit();	
	}
}
	...
	<table width="970" border="0" cellspacing="0" cellpadding="0" class=page_title>
      ...
      <table width="970"  border="0"  cellpadding="0" cellspacing="1" class="table_out">
        ...
        <tr> 
          ...
          <td class="table_title"  width="25%">E-mail</td>
          <td class="table_title"  width="10%">사무실전화</td>
          <td class="table_title"  width="10%">휴대전화</td>
          <td class="table_title"  width="10%">취소일</td>
          <td class="table_title"  width="20%">취소사유</td>
        </tr>
<%
	for(i = 0; i < list.size(); i++) {
        DataBox dbox = (DataBox)list.get(i);  

		//sql  = "select a.userid, a.name, a.email, a.handphone, c.subjnm, c.eduurl, c.cpsubj, b.canceldate, b.reason ";
        ...
        v_canceldate   = FormatDate.getFormatDate(dbox.getString("d_canceldate"),"yyyy/MM/dd");
        v_reason   = dbox.getString("d_reason");
        
        if(!(v_reason.length() > 1)){
        	v_reason = "-";
        }
