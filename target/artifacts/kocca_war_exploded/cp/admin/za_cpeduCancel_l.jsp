...
function MoveLink(act,year,subj,subjseq) {
	...
	if(act == "1"){
		...
		//수강취소자 명단리스트
	    document.form1.p_process.value   = "cancelList";
	    document.form1.action            = "/servlet/controller.cp.CPEduStudentServlet";
                ...
                <td align="center"> 
                  <table  border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
					  ...
					  <td>과정명&nbsp;<input name="p_searchtext" type="text" class="input" style="width:150" value="<%=v_searchtext %>"></td>
					  <td></td>
					  <td></td>
					  <td align="right"></td>
					  <td></td>
                ...
                <tr>
                  <td width="110">
                    <table cellspacing="0" cellpadding="0" class="s_table">
                      ...
                      <tr>
                        ...
                        <td class="black_butt_middle"><a href="javascript:MoveLink(1)"><font color="#FFFFFF">수강확정자명단</font></a></td>
                      </tr>
                      <tr>
                  ...
                  <td width="110" height="23" align="center" valign="middle">
                    <table cellspacing="0" cellpadding="0" class="s_table">
                      ...
                      <tr>
                        <td class="blue_butt_middle">수강취소자명단</td>
                      </tr>
                      <tr>
...
if (box.getString("p_action").equals("go")) {
	ArrayList list = (ArrayList)request.getAttribute("selectCancelList");
