<%
//**********************************************************
//  1. 제      목: 외주관리 시스템 서식자료실 수정화면
//  2. 프로그램명: zu_CpForm_U.jsp
//  3. 개      요: 외주관리 시스템 서식자료실 수정화면
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
        ...
        <tr> 
          ...
          <td width="25">&nbsp;</td>
            ...
            <table width="785" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="60" class=b_write><div align="justify">제목</div></td>
				...
				<!-- 제목입력란-->
                            ...
                            <tr>
                                ...
                                <td class=b_write width="60"> <div align="justify">작성자</div></td>
                                <td colspan="2" align = "left" class = "table-content"> &nbsp;&nbsp;<%= v_name %></td>
                                <!--작성자이름값 얻어오기-->
              </tr>
                            <tr>
                                <td valign="top" class=b_write style="padding-top:10px" width="60"><div align="justify">내용</div></td>
                                <!--내용입력란-->
                            ...
                            <tr>
	                                        <td width="60" class=b_write align = "center"><div align="left">첨부파일</div></td>
	                                        <td width="715"  align = "left" class = "table-content">
					...
					<tr>
                                                <td width="60" class=b_write align = "center"><div align="left">파일첨부</div></td>
