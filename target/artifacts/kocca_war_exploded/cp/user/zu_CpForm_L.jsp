<%
//**********************************************************
//  1. 제      목: 외주관리 시스템 서식자료실 리스트화면
//  2. 프로그램명: zu_CpForm_L.jsp
//  3. 개      요: 외주관리 시스템 서식자료실 리스트화면
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
        ...
        <tr> 
          ...
          <td width="775"><table width="775" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td width="190" align="right">                                        <p><input type = "text" onFocus = "this.style.background='#FFFAE1'" onBlur = "this.style.background='#ffffff'" 
                name = "p_searchtext"  size = "25" maxlength = "30"> </p>
</td>
                                    <td width="1%" align="right">&nbsp;</td>
                                    <td width="50" align="right" valign="middle">                                        <p><img src="/images/gate/btn_search.gif" width="50" height="22"border="0" align="middle"></p>
</td>
                                    <td width="1%" align="right">&nbsp;</td>
                                ...
                                <tr>
                                    <td height="8" align="right" colspan="6" width="775"></td>
              </tr>
            </table>
