<%
//**********************************************************
//  1. 제      목: 외주관리 시스템 자료실 수정화면
//  2. 프로그램명: zu_CpMateria_U.jsp
//  3. 개      요: 외주관리 시스템 자료실 수정화면
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
...
v_userid   = dbox.getString("d_luserid");
        ...
        <tr> 
          ...
          <td width="25">&nbsp;</td>
            ...
            <table width="785" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="785" class=b_write><div align="justify">제목</div></td>

				<!-- 제목입력란-->
                                <td class=b_textarea width="717"><input style="padding:1; border:1 solid #D1D1D1;" type = "text"  onFocus = "this.style.background = '#FFFAE1'" onBlur = "this.style.background = '#ffffff'" 
                            ...
                            <tr>
                                ...
                                <td class=b_write width="785"> <div align="justify">작성자</div></td>
                                <td class = "table-content" width = "1429" align = "left">
                                    <p>&nbsp;&nbsp;  <%= v_name %></p>
</td>
                                <!--작성자이름값 얻어오기-->
              </tr>
                            <tr>
                                <td valign="top" class=b_write style="padding-top:10px" width="785"><div align="justify">내용</div></td>
                                <!--내용입력란-->
                                <td class=b_textarea width="717">
								<!-- DHTML Editor  -->
								...
								<!-- DHTML Editor  -->	
	                                        ...
	                                        <td width="785" class=b_write align = "center"><div align="left">첨부파일</div></td>
					...
					<tr>
                                                <td width="785" class=b_write align = "center"><div align="left">파일첨부</div></td>
                                                <td class = "table-content"  align = "left">
                            ...
                            <tr>
                                <td height="5" colspan="2" width="785" ></td>
              </tr>
			  <tr> 
                <td colspan="3" class=b_list_bottom></td>
                       ...
                       <tr>
                                ...
                                <td width="717">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td width="100%" align="right" valign="bottom"><a href = "javascript:update();"><img src="/images/gate/btn_save.gif" width="50" height="22" border="0"></a></td>
                                            <td width="50" align="right" valign="middle">&nbsp;</td>
                                            <td width="75"><a href = "javascript:cancel();"><img src="/images/gate/btn_cancel.gif" width="50" height="22" border="0"></a></td>
                                            <td width="1%">&nbsp;</td>
										
												
										
                                            <td width="114" align="right" valign="middle">                                                <p><a href = "javascript:selectList();"><img src="/images/gate/btn_list.gif" width="74" height="22" border="0"></a></p>
</td>
                    </tr>
                  </table></td>
              </tr>
