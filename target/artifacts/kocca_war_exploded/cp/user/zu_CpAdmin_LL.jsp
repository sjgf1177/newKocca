          ...
          <td width="775"> <table width="775" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td height=6><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td width="13%"><a href="javascript:hyundaiList()"><img src="/images/gate/hyndai_tab.gif" width="103" height="25" border="0"></a></td>
                      <td width="2%">&nbsp;</td>
                      <td width="85%"><img src="/images/gate/kia_tab_on.gif" width="123" height="25" border="0"></td>
                    </tr>
                  </table></td>
              </tr>
              <tr> 
