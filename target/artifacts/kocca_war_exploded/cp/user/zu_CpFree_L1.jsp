    ...
    <td><table width="949" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          ...
          <td width="775"><table width="775" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td width="518" align="right" valign="middle">
                                    ...
                                    <td width="193" align="right" valign="middle">
                                        <p><input type = "text" onFocus = "this.style.background='#FFFAE1'" onBlur = "this.style.background='#ffffff'" 
              ...
              <tr> 
                <td height="8" align="right" colspan="2" width="711"></td>
                <td height="8" width="1%"></td>
                <td height="8" align="right" width="50"></td>
              </tr>
            </table>
...
<%if(list.size() != 0){%>
              ...
              <tr class = "table_contents">  
                <td width="64" align="center" class="<%=v_classname%>"><%=v_dispnum%></td>
                <td valign="bottom" class="<%=v_classname%>"><img src="/images/gate/L_board_Lg.gif" width="1"></td>
                <td width="366" class="<%=v_classname%>" style="padding-left:10"><a href="javascript:select(<%=v_seq%>)" target="_self"><%=v_title%></a></td>
                <td valign="bottom" class="<%=v_classname%>"><img src="/images/gate/L_board_Lg.gif" width="1"></td>
                <td width="123" align="center" class="<%=v_classname%>"><%=v_name%></td>
                <td valign="bottom" class="<%=v_classname%>"><img src="/images/gate/L_board_Lg.gif" width="1"></td>
                <td width="154" align="center" class="<%=v_classname%>"><%= FormatDate.getFormatDate(v_indate, "yyyy-MM-dd") %></td>
                <td valign="bottom" class="<%=v_classname%>"><img src="/images/gate/L_board_Lg.gif" width="1"></td>
                <td width="64" align="center" class="<%=v_classname%>"><%=v_readcnt%></td>
              </tr>
              ...
              <tr> 
                <td height=20 colspan="9"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="1%" height="30" align="right" valign="bottom">&nbsp;</td>
