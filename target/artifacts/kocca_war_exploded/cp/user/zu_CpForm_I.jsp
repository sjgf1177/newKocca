<%
//**********************************************************
//  1. 제      목: 외주관리 시스템 서식자료실 등록화면
//  2. 프로그램명: zu_CpForm_I.jsp
//  3. 개      요: 외주관리 시스템 서식자료실 등록화면
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
...
<table width="950" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><table width="949" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="25">&nbsp;</td>
          <td width="85" valign="top"><img src="/images/gate/O_title04.gif" width="85" height="80"></td>
          <td width="25">&nbsp;</td>
          <td width="775"><table width="775" border="0" cellspacing="0" cellpadding="0">
            ...
            <table width="788" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td width="70" class=b_write><div align="justify">                                            <p align="center">제목</p></div></td>

			    <td colspan="2" class=b_textarea width="715"><input style="padding:1; border:1 solid #D1D1D1;" type = "text"  onFocus = "this.style.background='#FFFAE1'" onBlur = "this.style.background='#ffffff'" 
              ...
              <tr> 
				 ...
				 <td class=b_write width="70"> <div align="justify">                                            <p align="center">작성자</p>
</div></td>
				<td class = "table-content" width = "5" align = "left">&nbsp; </td>
				<!--작성자이름값 얻어오기-->
              ...
              <!--내용입력란-->
			  <tr> 
                <td valign="top" class=b_write style="padding-top:10px" width="70"><div align="justify">                                            <p align="center">내용</p>
</div></td>
				
                <td colspan="2" class=b_textarea width="715"> 
				<!-- DHTML Editor  -->
              ...
              <!--파일업로드-->
									...
									<tr>
										<td class = "b_write" width = "9%" align = "center"><div align="justify">                                            <p align="center">파일첨부</p>
</div></td>
										<td class = "table-content" width = "5" align = "left">&nbsp; </td>
										<td class = "table-content" width = "90%" align = "left" colspan="2">
              ...
              <tr> 
                <td width="70">&nbsp;</td>
                <td colspan="2" width="715"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					<!--등록하기-->
                      <td width="100%" align="right" valign="middle"><a href = "javascript:insert();"><img src="/images/gate/btn_save.gif" width="50" height="22" border="0"></a></td>
                      <td width="1%">&nbsp;</td>
					  <!--취소하기-->
                      <td width="74" align="right" valign="middle"><a href = "javascript:cancel();"><img src="/images/gate/btn_list.gif" width="74" height="22" border="0"></a></td>
                    </tr>
                  </table></td>
              </tr>
              <tr> 
                <td width="70">&nbsp;</td>
                <td colspan="2" width="715">&nbsp;</td>
              </tr>
            </table></td>
          <td width="10">&nbsp;</td>
        </tr>
