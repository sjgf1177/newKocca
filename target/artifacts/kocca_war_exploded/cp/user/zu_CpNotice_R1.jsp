...
<table width="950" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><table width="949" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="25">&nbsp;</td>
          <td width="85" valign="top"><img src="/images/gate/O_title00.gif" width="85" height="80"></td>
          <td width="25">&nbsp;</td>
            ...
            <table width="775" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                ...
                <td align="center"><table width="690" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td><%= StringManager.replace(v_content,"&amp;","&") %>                       </p></td>
                    </tr>
                    <tr> 
                      <td>&nbsp;</td>
                    </tr>
              ...
              <tr align="right"> 
                <td colspan="3"><a href="javascript:selectList()" target="_self" onfocus=this.blur()><img src="/images/gate/btn_list.gif" width="74" height="22" border="0"></a></td>
              </tr>
            </table></td>
          <td width="10">&nbsp;</td>
        </tr>
