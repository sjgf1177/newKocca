<%
//**********************************************************
//  1. 제      목: 외주관리 시스템 자료실 등록화면
//  2. 프로그램명: zu_CpMateria_I.jsp
//  3. 개      요: 외주관리 시스템 자료실 등록화면
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
          ...
          <td width="775"><table width="775" border="0" cellspacing="0" cellpadding="0">
            ...
            <table width="788" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
			    ...
			    <td colspan="2" class=b_textarea width="715"><input type = "text"  style="padding:1; border:1 solid #D1D1D1;" onFocus = "this.style.background='#FFFAE1'" onBlur = "this.style.background='#ffffff'" 
                ...
                <td colspan="2" width="715"><table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<!--등록하기-->
                                                <td width="100%" align="right" valign="middle">
                                                    <p align="right"><a href = "javascript:insert();"><img src="/images/gate/btn_save.gif" width="50" height="22" border="0"></a></p>
</td>
                      <td width="1%">&nbsp;</td>
					  <!--취소하기-->
