<%
//**********************************************************
//  1. 제      목: 외주관리 시스템 Q&A등록화면
//  2. 프로그램명: zu_CpQna_I.jsp
//  3. 개      요: 외주관리 시스템 Q&A등록화면
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
    ...
    <td><table width="949" border="0" cellspacing="0" cellpadding="0">
        <tr> 
         ...
         <table width="814" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td width="88" class=b_write><div align="justify">                                            <p align="left">질문제목</p></div></td>

			    <td colspan="2" class=b_textarea width="726"><input style="padding:1; border:1 solid #D1D1D1;" type = "text"  onFocus = "this.style.background='#FFFAE1'" onBlur = "this.style.background='#ffffff'" 
              ...
              <tr> 
				 ...
				 <td class=b_write width="88"> <div align="justify">                                            <p align="left">작성자</p>
</div></td>
              ...
              <tr> 
                                    <td class=b_write width="88">
                                        <p align="left">질문작성일</p>
</td>
                <td class="table_text3" width="16">&nbsp;&nbsp;<%= FormatDate.getDate("yyyy/MM/dd") %></td>
              </tr>
			  <tr> <!--내용입력란-->
                <td valign="top" class=b_write style="padding-top:10px" width="88"><div align="justify">                                            <p align="left">내용</p>
</div></td>
				
                <td colspan="2" class=b_textarea width="726"> 
				<!-- DHTML Editor  -->
