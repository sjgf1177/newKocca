        ...
        <tr> 
          ...
          <td width="775"><table width="775" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td width="194" align="right" valign="middle">                                        <p><input type = "text" onFocus = "this.style.background='#FFFAE1'" onBlur = "this.style.background='#ffffff'" 
