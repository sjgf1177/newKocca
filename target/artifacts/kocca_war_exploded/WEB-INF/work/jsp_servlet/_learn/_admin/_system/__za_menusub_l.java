...
public final class __za_menusub_l extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/learn/admin/system/za_MenuSub_L.jsp", 1422235945524L ,"9.2.3.0","Asia/Seoul")) return true;
    ...
    private final static String  _wl_block14 ="</a></td>\r\n            <td class=\"table_02_5\">\r\n";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static String  _wl_block15 ="\r\n\t\t\t  <a href=\"javascript:move_menusubprocess(\'";
    private final static byte[]  _wl_block15Bytes = _getBytes( _wl_block15 );

    private final static String  _wl_block16 ="\',\'";
    private final static byte[]  _wl_block16Bytes = _getBytes( _wl_block16 );

    private final static String  _wl_block17 ="\')\">프로세스리스트</a>\r\n";
