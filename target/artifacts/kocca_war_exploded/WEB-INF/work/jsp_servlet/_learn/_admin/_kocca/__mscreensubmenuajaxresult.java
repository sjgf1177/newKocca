...
public final class __mscreensubmenuajaxresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/learn/admin/kocca/mScreenSubMenuAjaxResult.jsp", 1422235940938L ,"9.2.3.0","Asia/Seoul")) return true;
        return false;
    }
    ...
    throws javax.servlet.ServletException, java.io.IOException {
        ...
        response.setHeader("Content-Type", "application/json;charset=euc-kr");
