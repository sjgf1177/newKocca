...
function object_patch(p_gubun){
  ...
  if(p_gubun == "leftmenuA"){
    ...
    cont = '<applet NAME="ICARUS" CODEBASE="/myclasses/OBC" CODE="creTreeApplet.class" WIDTH=170 HEIGHT=480 MAYSCRIPT>';
    	//cont  ='<OBJECT classid = "clsid:CAFEEFAC-0014-0001-0001-ABCDEFFEDCBA" codebase = "http://java.sun.com/products/plugin/autodl/jinstall-1_4_2_05-windows-i586.cab#Version=1,4,2,05" WIDTH = "170" HEIGHT = "500" NAME = "manifestTable" ALIGN = "middle" VSPACE = "0" HSPACE = "0" >'
  	//+'<PARAM NAME = CODE VALUE = "creTreeApplet.class" >'
  	//+'<PARAM NAME = CODEBASE VALUE = "/myclasses/OBC" >'
  	//+'<PARAM NAME = NAME VALUE = "ICARUS" >'
  	...
  	//+'		CODE = "creTreeApplet.class"'
  	//+'		JAVA_CODEBASE = "/myclasses/OBC"'
  	//+'		NAME = "ICARUS"'
  	//+'		WIDTH = "170"'
  	//+'		HEIGHT = "500"'
  	//+'		MAYSCRIPT = "true" '
  ...
  else if(p_gubun == "obc_menuapplet3"){
  	alert("Applet Start");
  	cont = '<applet NAME="ICARUS" CODEBASE="/myclasses/OBC" CODE="creTreeApplet.class" WIDTH="' + param1 +'" HEIGHT="' + param2 + '" MAYSCRIPT>';
	//cont='<OBJECT classid = "clsid:CAFEEFAC-0014-0002-0010-ABCDEFFEDCBA"'
	//+'    codebase = "http://java.sun.com/update/1.4.2/jinstall-1_4_2_10-windows-i586.cab#Version=1,4,2,100"'
	//+'    WIDTH = "170" HEIGHT = "500" NAME = "ICARUS" >'
	//+'    <PARAM NAME = CODE VALUE = "creTreeApplet.class" >'
	//+'    <PARAM NAME = CODEBASE VALUE = "/myclasses/OBC" >'
	//+'    <PARAM NAME = NAME VALUE = "ICARUS" >'
