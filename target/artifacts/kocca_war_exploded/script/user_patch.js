...
function object_namoActivepatch(width, height){
	
	var strScripts ="<OBJECT ID='Wec' CLASSID='CLSID:43088818-69F9-4852-8ED5-9C4FA514D995' WIDTH='"+width+"' HEIGHT='"+height+"' CodeBase='/namo_active/NamoWec.cab#Version=7,0,0,97'>";
	strScripts +="<PARAM NAME='UserLang' VALUE=kor>";
	strScripts +="<PARAM NAME='InitFileURL' VALUE='/namo_active/kor/As7Init.xml'>";
...
function namoActiveInitCompleted(ContentParamName) {
	var wec = document.form1.Wec;
	var sContent   = document.getElementById(ContentParamName).value;
	wec.Value = sContent;
}
...
function object_menuflash(filepath){
	var cont = '';
	if(filepath != null) {
	cont += '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" width="920" height="149" id="top1" align="middle">';
    cont += '<param name="allowScriptAccess" value="sameDomain" />';
    cont += '<param name="movie" value="'+filepath+'" />';
    cont += '<param name="quality" value="high" />';
    cont += '<param name="wmode" value="transparent" />';
    cont += '<embed src="'+filepath+'" wmode="transparent" quality="high" bgcolor="#ffffff" width="920" height="149" name="top1" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />  ';
    cont += '</object>';
	} else {
		cont += '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" width="920" height="149" id="top1" align="middle">';       
	    cont += '<param name="allowScriptAccess" value="sameDomain" />';
	    cont += '<param name="movie" value="/images/portal/flash/top7.swf" />';
	    cont += '<param name="quality" value="high" />';
	    cont += '<param name="wmode" value="transparent" />';
	    cont += '<embed src="/images/portal/flash/top7.swf" wmode="transparent" quality="high" bgcolor="#ffffff" width="920" height="149" name="top1" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />  ';
	    cont += '</object>';
	}
