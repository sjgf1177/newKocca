...
function Datepicker() {
	...
	this.regional[''] = { // Default regional settings
		...
		prevText: '이전달', //'Prev', // Display text for previous month link
		prevBigText: '&#x3c;&#x3c;', // Display text for previous year link
		nextText: '다음달', //'Next', // Display text for next month link
...
//		dayNamesMin: ['Su','Mo','Tu','We','Th','Fr','Sa'], // Column headings for days starting at Sunday
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		buttonImage: "/images/ui/calendar.gif", //'', // URL for trigger button image
		align: "abmiddle",
		...
		showMonthAfterYear: true,//false, // True if the year select precedes month, false for month then year
...
$.extend(Datepicker.prototype, {
	...
	_connectDatepicker: function(target, inst) {
		...
		if (showOn == 'button' || showOn == 'both') { // pop-up date picker when button clicked
			...
			// calendar image align 2010-02-18
