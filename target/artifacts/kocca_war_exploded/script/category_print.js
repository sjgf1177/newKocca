...
var webFXTreeConfig = {
	rootIcon        : '/images/admin/portal/blank.gif',
	openRootIcon    : '/images/admin/portal/openfoldericon.gif',  //'/images/admin/portal/blank.gif',	
	folderIcon      : '/images/admin/portal/tree_space.gif',	
	openFolderIcon  : '/images/admin/portal/tree_space.gif',
	fileIcon        : '/images/admin/portal/c_new.gif',
	iIcon           : '/images/admin/portal/I.gif',
	lIcon           : '/images/admin/portal/L.gif',	
	lMinusIcon      : '/images/admin/portal/tree_minus_02.gif',
	lPlusIcon       : '/images/admin/portal/tree_plus_02.gif',
	tIcon           : '/images/admin/portal/T.gif',	
	tMinusIcon      : '/images/admin/portal/tree_minus.gif',
	tPlusIcon       : '/images/admin/portal/tree_plus.gif',
	blankIcon       : '/images/admin/portal/blank_15.gif',	
...
//	str += "<img id=\"" + this.id + "-icon\" class=\"webfx-tree-icon\" src=\"" + ((webFXTreeHandler.behavior == 'classic' && this.open)?this.openIcon:this.icon) + "\" onmousedown=\"webFXTreeHandler.checkmouse(this);\"><a target='' href=\"" + this.action + "\" id=\"" + this.id + "-anchor\" onmousedown=\"webFXTreeHandler.toggle(this.parentElement);\" onblur=\"webFXTreeHandler.blur(this);\">" + this.text + "</a></div>";		
	str += "<img id=\"" + this.id + "-icon\" class=\"webfx-tree-icon\" src=\"" + ((webFXTreeHandler.behavior == 'classic' && this.open)?this.openIcon:this.icon) + "\" onmousedown=\"webFXTreeHandler.checkmouse(this);\"><a target='' href=\"" + this.action + "\" id=\"" + this.id + "-anchor\" onblur=\"webFXTreeHandler.blur(this);\"><font style=\"font-size:9pt;font-weight:bold;\"     > " + this.text + "</font></a></div>";		
...
//	var str = "<div id=\"" + this.id + "\" onClick=\"hideMenu();\" ondblclick=\"webFXTreeHandler.toggle(this);\" class=\"webfx-tree-item\" onkeydown=\"return webFXTreeHandler.keydown(this, event)\">";
	...
	//2004.11.24, modifid by 이연주 
	//-- 파일 아이콘 제거
	if(this.icon != webFXTreeConfig.fileIcon) {
		str += "<img id=\"" + this.id + "-icon\" class=\"" + ((this.icon == webFXTreeConfig.folderIcon)?'webfx-tree-icon-s':'webfx-tree-icon') + "\" src=\"" + ((webFXTreeHandler.behavior == 'classic' && this.open)?this.openIcon:this.icon) + "\" onmousedown=\"webFXTreeHandler.checkmouse(this);\"><a target='' href=\"" + this.action + "\" id=\"" + this.id + "-anchor\" onmousedown=\"webFXTreeHandler.toggle2(parentElement);\" onblur=\"webFXTreeHandler.blur(this);\" class='666666'>" + label + "</a></div>";		
	}else {
	str += "<a target='' href=\"" + this.action + "\" id=\"" + this.id + "-anchor\" onmousedown=\"webFXTreeHandler.toggle2(parentElement);\" onblur=\"webFXTreeHandler.blur(this);\" class='666666'>" + label + "</a></div>";				
	}	
