...
function whenSelection(arg){
	...
	document.form1.action = "/servlet/controller.beta.BPCourseServlet";
...
function updateapproval(subj,cpapproval){
  ...
  document.form1.p_process.value = 'BpApproval1';
  document.form1.submit();
}
-->
</script>
    ...
    <td align="center">
      ...
      <table width="970" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td class=sub_title>교육과정 리스트</td>
        </tr>
        <tr> 
          <td height=6></td>
          <td height=6></td>
      ...
      <table width="970"  border="0"  cellpadding="0" cellspacing="1" class="table_out">
        ...
        <%if(!ss_gadmin.equals("S1") && !ss_gadmin.equals("T1") && !ss_gadmin.equals("M1")){%>
          ...
          <td class="table_title" width="10%">과정코드</td>
          <td class="table_title">과정명</td>
          <td class="table_title" width="15%">업체명</td>
          <td class="table_title" width="8%">교육형태</td>
        ...
        <%}else{%>
          <td class="table_title" width="5%">번호</td>
          <td class="table_title" width="15%">업체과정코드</td>
          <td class="table_title">과정명</td>
          <td class="table_title" width="15%">업체명</td>
