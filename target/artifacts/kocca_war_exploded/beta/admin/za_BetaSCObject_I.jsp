...
function whenSubmit(){
    ...
    if (document.form1.p_producer.value == "") {
        alert("제공회사를 입력하십시오.");
        return;
    }
...
<table width="1000" border="0" cellspacing="0" cellpadding="0" height="663">
  <tr>
    <td align="center" valign="top">
     ...
     <table width="97%" border="0" cellspacing="0" cellpadding="0" class=page_title>
        <tr> 
          <td><img src="/images/admin/beta/tit_object.gif" ></td>
 ...
 <table width="970" border="0" cellspacing="0" cellpadding="0">
      ...
      <FORM name="form1" method="post" action="/servlet/controller.beta.BetaSCObjectServlet" enctype = "multipart/form-data">
        ...
        <tr>
          <td class="table_title" width="18%"><b>Short Description</b></td>
        ...
        <tr>
          <td class="table_title" width="18%"><b>Starting Point</b></td>
          <td class="table_02_2"></td>
        </tr>
        <tr>
          <td class="table_title" width="18%"><b>Master</b></td>
          <td class="table_02_2">
      ...
      <table cellpadding="0" cellspacing="0" >
        <tr>
		  ...
		  <td width=8></td>
          <td><a href='javascript:whenList()'><img src="/images/admin/button/btn_cancel.gif" border="0"></a></td>	 
        </tr>
        <tr>
          <td height="3"></td>
		  <td height="3"></td>
