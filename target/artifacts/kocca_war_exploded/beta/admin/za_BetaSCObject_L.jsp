   ...
   타이틀 백업 2004.12.21 끝------------->
     ...
     <table width="97%" border="0" cellspacing="0" cellpadding="0" class=page_title>
      ...
      <table cellspacing="0" cellpadding="1" class="form_table_out">
        <FORM name="form1" method="post" action="/servlet/controller.beta.BetaSCObjectServlet">
                ...
                <td align="center" width="99%" valign="middle">
                  <table width="99%" cellspacing="0" cellpadding="0" class=""form_table">
                    <tr>
                      <td align=center>
                      사용과정 
                      <%=BetaSCObjectBean.makeObcSubjSelect(box,s_subj,"")%>  
                      &nbsp;&nbsp;
                      검색어
...
<%  }   %>
      ...
      <table cellspacing="1" cellpadding="5" class="table_out">
        ...
        <tr>
          ...
          <td class="table_title"><b>Num.of.Pages</b></td>
...
<%
    if (box.getString("p_action").equals("go")){
        ...
        BetaSCObjectData d = null;
        Hashtable   ht;
        
        for (int i=0; i<list.size(); i++) {
            d = (BetaSCObjectData)list.get(i); 
