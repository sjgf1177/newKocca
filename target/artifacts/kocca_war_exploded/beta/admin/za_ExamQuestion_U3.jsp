<%
/**
 * file name : za_ExamQuestion_U3.jsp
 * date      : 2005/08/20
 * programmer:
 * function  : 평가 문제관리 OX식 - 수정페이지
 */
%>
      ...
      <form name="form2" method="post" enctype="multipart/form-data">
		...
		<tr>
          ...
          <td class="table_02_1" valign="top" colspan="3">
            <textarea name="p_examtext" cols="70" rows="7" class="input"><%=dbox0.getString("d_examtext")%></textarea>
		  </td>
        </tr>
		<tr>
...
%>
        <tr>
          ...
          <td class="table_02_1">
             <input name="p_seltext<%=String.valueOf(k)%>" type="text" class="input2" size="3" value=`<%=StringManager.replace(dbox.getString("d_seltext"), "`", "'")%>`>
          </td>
