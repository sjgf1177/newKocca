...
<%
	...
	ArrayList  list =  bean.performScoPackageListBeta(box);
 ...
 <table width="97%" border="0" cellspacing="0" cellpadding="0">
      ...
      <table cellspacing="1" cellpadding="5" class="table_out">
        ...
        <tr>
          ...
          <td class="table_title" width="70%"><b>패키지 명</b></td>          
          <td class="table_title" width="24%"><b>기능</b></td>
        </tr>
        ...
        <tr>
          ...
          <td class="table_02_1" align=center><a href="javascript:whenContent('<%=d.getScolocate()%>')"><%=d.getScoTitle()%></a></td>
