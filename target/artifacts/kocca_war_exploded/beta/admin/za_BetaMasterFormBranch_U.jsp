  ...
  <table width="1000" border="0" cellspacing="0" cellpadding="0" height="663">
    ...
    <td align="center" valign="top">
      ...
      <table width="97%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td background="/images/admin/beta/tit_masterform.gif"><img src="/images/admin/contents/contents_title5.gif" width="206" height="36" border="0"></td>
        </tr>
      </table>
        <!----------------- title 끝 ----------------->
        <br>
                ...
                data1  = (MfBranchData)list1.get(i); %>
                      <tr>
                        ...
                        <td bgcolor="#F7F7F7" align="left">&nbsp;&nbsp;&nbsp;
                            ...
                            <a href="javascript:whenDeleteBranch('<%=data1.getBranch()%>')"><img src="/images/admin/button/btn_del.gif" border=0></a>
                        </td>
                      </tr>
<%          }
