...
<% 
	...
	for (int i=0; i<list.size(); i++) {
			...
			if (d.getMasteryscore() == 0 ) {
				...
				v_objdelbutton		= "<a href=javascript:whenUpdate('"+d.getOid()+"','"+d.getScolocate()+"')><img src='/images/admin/common/modify_butt.gif' width='37' height='18' border='0'></a> &nbsp <a href=javascript:whenDelete('"+d.getOid()+"','"+d.getScolocate()+"')> 삭제</a>";
...
%>
	...
	<table border=0 width=100%><tr><td align=center><a href="javascript:whenSelection()">리스트</a></td></tr></table>
