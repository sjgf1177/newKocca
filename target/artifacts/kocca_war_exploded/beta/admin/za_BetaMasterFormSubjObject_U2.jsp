<%
//********************************************************************
//  1. 제      목: 마스터폼 Lesson에 Object지정 화면
//  2. 프로그램명 :za_MasterFormSubjObject_U.jsp
//  3. 개      요: 마스터폼 Lesson에 Object지정 화면
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
//  6. 작      성: 강성욱 2004. 12. 3
//  7. 수      정:
...
<%
	...
	if (list1 != null){
		for(int i=0; i<list1.size(); i++){
			...
			%><option value="<%=d.getOid()%>">[<%=d.getOid()%>] <%=d.getSdesc()%></option><br><%
		}
	}
...
%>						
                ...
                <tr>
                  <td class="table_title" width="18%"><b>FileUpload</b></td>
                  <td class="table_02_2">
	      ...
	      <table cellpadding="0" cellspacing="0" class="table1">
	        <tr>
	          ...
	          <a href='javascript:whenList()'><img src="/images/admin/system/cancel1_butt.gif" width="37" height="18" border="0"></a></td>
	        </tr>
	        <tr>
	          <td height="3"></td>
	        </tr>
