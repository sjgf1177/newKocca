...
<!--
    ...
    function projectList() {
        document.form1.action='/servlet/controller.beta.BPProjectAdminServlet';
    ...
    <td align="center" valign="top"> 
	  ...
	  <!----------------- title 끝 ----------------->
        ...
        <table width="97%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td class=sub_title><img src="/images/admin/common/icon.gif"> <%=v_subjnm%> 과정 &gt; <%=v_subjseq%>차</td>
          </tr>
        </table>
        ...
        <%
          ...
          String v_cpapproval = "";
          v_cpapproval = scbean.getCpApproval(v_subj);
          //cpapproval c: 취소 y:승인 n:미승인 b:상신중
          String s_gadmin = box.getSession("gadmin");
          String v_gadmin = s_gadmin.substring(0,1);
          //out.println("v_cpapproval==>>"+v_cpapproval);
          //out.println("v_gadmin==>>"+v_gadmin);
          
        %>
        <table width="97%" border="0" cellpadding="0" cellspacing="0">
          <tr> 
            <td width="735" height="20" valign="bottom">&nbsp;</td>
            <td align="right" width="155"><%if((!v_cpapproval.equals("B")&&!v_cpapproval.equals("Y"))||v_gadmin.equals("A")){%><a href="javascript:project_insert('<%=v_subj%>','<%=v_subjnm%>','<%=v_year%>','<%=v_subjseq%>','<%=v_lesson%>')"><img src="/images/admin/button/btn_add.gif" border="0"></a><%}else{%>&nbsp;<%}%></td>
			<td width=8></td>      
