<%
/**
 * file name : za_ExamQuestion_I3.jsp
 * date      : 2005/08/20
 * programmer:
 * function  : 평가 문항관리 - OX식
 */
%>
  ...
  <tr>
   ...
   <!----------------- title 시작 ----------------->
      <table width="97%" border="0" cellspacing="0" cellpadding="0" class=page_title>
        <tr> 
            <td><img src="/images/admin/beta/tit_testman.gif"></td>
     ...
     <br>
      ...
      <table cellspacing="1" cellpadding="5" class="table_out" ID="examtype1" STYLE="display:">
		...
		<!--보기-->
        <tr>
          <td class="table_01" width="15%">1번</td>
          <td class="table_02_1">
             <input name="p_seltext1" type="text" class="input2" size="3" value="○">
          </td>
          <td class="table_02_1" width="30%">
             <input type="checkbox" name="p_isanswer1" value="">정답여부
          </td>
        </tr>
        <tr>
          <td class="table_01" width="15%">2번</td>
          <td class="table_02_1">
             <input name="p_seltext2" type="text" class="input2" size="3" value="X">
          </td>
          <td class="table_02_1" width="30%">
             <input type="checkbox" name="p_isanswer2" value="">정답여부
          </td>
        </tr>        
