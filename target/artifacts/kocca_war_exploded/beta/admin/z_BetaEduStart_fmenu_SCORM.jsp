<%
//**********************************************************
//  1. 제      목: SCORM MasterForm Menu Frame
//  2. 프로그램명 : z_EduStart_fmenu_SCORM.jsp
//  3. 개      요: SCORM MasterForm Menu Frame
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
...
<%!
private 	String	makeMenuLink(String p_menu, BetaMfSubjData m, String p_imgURL, RequestBox box, int p_imgw, int p_imgh){
    String  s_subj   	= box.getSession("s_subj");
    String  s_year   	= box.getSession("s_year");
    String  s_subjseq  	= box.getSession("s_subjseq");
