...
//********************************************************************
//  1. 제      목: 마스터폼 -진도/목차화면
//  2. 프로그램명 : z_EduChk_List_SCORM.jsp
//  3. 개      요: 마스터폼 -진도/목차화면
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
//  6. 작      성: 강성욱 2004. 12. 7
...
<%
    ...
    BetaMasterFormData  md  = (BetaMasterFormData)request.getAttribute("BetaMasterFormData");
    ArrayList   brlist  = null;

    ArrayList  list = (ArrayList)request.getAttribute("EduList");
    BetaEduListData x = null;

    //BetaEduScoreData    sd = (BetaEduScoreData)request.getAttribute("EduScore");
    //BetaEduScoreDataSub sds;
...
<script language="javascript">
    ...
    function whenExamSelect(ptype,lesson){
        //var url = '/servlet/controller.beta.BetaEduStart?p_process=exam&p_lesson='+lesson+'&p_type='+ptype;
                                ...
                                <td>
                                    <table cellspacing="1" cellpadding="3" class="table2">
                                        ...
                                        <!--tr>
                                            ...
                                            <td class="board_title_bg3" width="28%"><%//=FormatDate.getFormatDate(sd.getEdustart(),"yyyy/MM/dd")%>~<%//=FormatDate.getFormatDate(sd.getEduend(),"yyyy/MM/dd")%></td>
...
<%/*                     Hashtable ht;
                           ...
                           if(sd!=null) {
                               ...
                               for (int i=0; i<htsize; i++) {
                                   //sds = (BetaEduScoreDataSub)sd.eduScoreList.get(String.valueOf(i));
                                   if((Hashtable)sd.getEduScoreList() != null){
                                       ht  = (Hashtable)sd.getEduScoreList();
                                       sds = (BetaEduScoreDataSub)ht.get(String.valueOf(i));
