...
%>
	...
	<script language="javascript">
		...
		function whenList(){
			var url="/servlet/controller.beta.BetaMasterFormServlet?p_process=updateLessonPage";
	...
	<table width="95%" border="0" cellspacing="0" cellpadding="0">
		<FORM name=ff method=post action="/servlet/controller.beta.BetaMasterFormServlet">
			...
			<table width="97%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<td width="10%" valign=top>
						<select size ="7" style="border: 1px solid rgb(99,99,99)" class="input" align='center' name='p_obj' multiple>
<%
	ArrayList		list1 = (ArrayList)request.getAttribute("BetaMfSubjObject");
	BetaMfLessonDataSub  d = null;
out.println("test1");
	if (list1 != null){
		for(int i=0; i<list1.size(); i++){
			d = (BetaMfLessonDataSub)list1.get(i);
...
%>						
					...
					<a href="javascript:moveTo(-1)"><img src="/images/admin/button/up_b.gif"  border="0" align=absmiddle></a> <Br>
					<a href="javascript:moveTo(1)"><img src="/images/admin/button/down_b.gif" border="0" align=absmiddle></a> <Br>
					<a href="javascript:delObj()"><img src="/images/admin/button/btn_del.gif"  border="0" align=absmiddle></a></td>
				</tr>
			</table>
			<!----------------- 설문첨부 끝 ----------------->
	      <br>
