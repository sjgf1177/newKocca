<%
//********************************************************************
//  1. 제      목: 마스터폼 Lesson 수정화면
//  2. 프로그램명 : za_BetaMasterFormLessonOBC_U.jsp
//  3. 개      요: 마스터폼 Lesson 수정화면
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
//  6. 작      성: 강성욱 2004. 12. 25
//  7. 수      정:
//********************************************************************
%>
...
function whenAssign(module,lesson){
	...
	window.open(url,"assignWin","width=1000,height=800");
}
...
<%
				...
				for(int j=0;j<ht.size();j++){
					BetaMfLessonDataSub ds = (BetaMfLessonDataSub)ht.get(String.valueOf(j));
