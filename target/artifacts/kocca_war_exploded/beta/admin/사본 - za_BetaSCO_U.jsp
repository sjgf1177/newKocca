	        ...
	        <tr>
			  ...
			  <table border=0 cellspacing=0 cellpadding=0>
	           ...
	           <OBJECT ID="ETNG_FTP" CLASSID="CLSID:526A654F-760C-49DD-B971-5517ECB98B12"
						...
						<td>&nbsp;</td>
						<td>
						<input type="button" value="파일찾기" class="onbut" onmousedown="this.className='downbut'" onmouseup="this.className='onbut'" onclick="WinSearch_Open('D:/hkmotor/contents/scobject/<%= d.getScolocate()%>', 'p_starting')" >
						</td>
				</tr>
				</table>
	          </td>
