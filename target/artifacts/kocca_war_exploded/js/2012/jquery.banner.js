$(function() {
    ...
    $.f_varBanner = {
        defaults: {
            ...
            isBtnAct: "focus",  // 버튼 작동방식 mouseover,click,focus
            isBtnType: "a", // 버튼 타입 img,li,a
    ...
    function jsBanBtnBind(config) {
        ...
        } else if (config.isBtnAct=="focus") {
            $(config.objBtn+" "+config.isBtnType).focus(function(){
                var nImgNo = $(this).attr("btnno");
    ...
    function jsBanBtnRO (config,nSel) {
        if (config.isBtnType=="a") {        	
            $(config.objBtn+" img").each(function(i){     	
                if (nSel==i) {                	                	
                	$(this).attr("src","/images/2012/main/banner/number/num"+(nSel+1)+"on.png");
                } else {                
                	$(this).attr("src","/images/2012/main/banner/number/num"+(i+1)+".png");
                }
            });
